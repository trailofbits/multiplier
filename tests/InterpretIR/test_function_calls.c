 ...
 *   objects:
 *     obj_0 LOCAL_VALUE size=8 align=8 (fp)
 *     obj_1 PARAMETER size=4 align=4
 *     obj_2 PARAMETER size=4 align=4
 *     obj_3 RETURN_SLOT size=4 align=4
 *     obj_4 PARAMETER size=4 align=4
 *     obj_5 RETURN_SLOT size=4 align=4
 ...
 *          %24 = ALLOCA/ARG size=4 align=4  // 5
 *          %23 = CONST/INT32 5  // 5
 *     >> %25 = MEMORY/STORE_LE_32 [%24, %23]  // 5
 *     >> %30 = EXIT_SCOPE
 *          %27 = CALL @factorial [%24]  // factorial(5)
 *          %28 = CONST/INT32 120  // 120
 ...
 *          %43 = ALLOCA/ARG size=4 align=4  // 10
 *          %42 = CONST/INT32 10  // 10
 *     >> %44 = MEMORY/STORE_LE_32 [%43, %42]  // 10
 *          %46 = ALLOCA/ARG size=4 align=4  // 20
 *          %45 = CONST/INT32 20  // 20
 *     >> %47 = MEMORY/STORE_LE_32 [%46, %45]  // 20
 *     >> %52 = EXIT_SCOPE
 *          %41 = MEMORY/LOAD_LE_64 [%fp.0]  // fp
 *          %49 = CALL indirect [%41, %43, %46]  // fp(10, 20)
 *          %50 = CONST/INT32 30  // 30
 ...
 *          %62 = ALLOCA/ARG size=8 align=8  // add
 *          %61 = FUNC_PTR  // add
 *     >> %63 = MEMORY/STORE_LE_64 [%62, %61]  // add
 *          %65 = ALLOCA/ARG size=4 align=4  // 5
 *          %64 = CONST/INT32 5  // 5
 *     >> %66 = MEMORY/STORE_LE_32 [%65, %64]  // 5
 *          %68 = ALLOCA/ARG size=4 align=4  // 6
 *          %67 = CONST/INT32 6  // 6
 *     >> %69 = MEMORY/STORE_LE_32 [%68, %67]  // 6
 *     >> %74 = EXIT_SCOPE
 *          %71 = CALL @apply [%62, %65, %68]  // apply(add, 5, 6)
 *          %72 = CONST/INT32 11  // 11
 ...
 *          %84 = ALLOCA/ARG size=4 align=4  // 3
 *          %83 = CONST/INT32 3  // 3
 *     >> %85 = MEMORY/STORE_LE_32 [%84, %83]  // 3
 *          %87 = ALLOCA/ARG size=4 align=4  // 10
 *          %86 = CONST/INT32 10  // 10
 *     >> %88 = MEMORY/STORE_LE_32 [%87, %86]  // 10
 *          %90 = ALLOCA/ARG size=4 align=4  // 20
 *          %89 = CONST/INT32 20  // 20
 *     >> %91 = MEMORY/STORE_LE_32 [%90, %89]  // 20
 *          %93 = ALLOCA/ARG size=4 align=4  // 30
 *          %92 = CONST/INT32 30  // 30
 *     >> %94 = MEMORY/STORE_LE_32 [%93, %92]  // 30
 *     >> %99 = EXIT_SCOPE
 *          %96 = CALL @va_sum [%84, %87, %90, %93]  // va_sum(3, 10, 20, 30)
 *          %97 = CONST/INT32 60  // 60
