 ...
 *   objects:
 *     obj_0 LOCAL_VALUE size=4 align=4 (r1)
 *     obj_1 LOCAL_VALUE size=4 align=4 (r2)
 *     obj_2 LOCAL_VALUE size=4 align=4 (r3)
 *     obj_3 LOCAL_VALUE size=4 align=4 (r4)
 *     obj_4 LOCAL_VALUE size=4 align=4 (r5)
 *     obj_5 LOCAL_VALUE size=4 align=4 (r6)
 *     obj_6 LOCAL_VALUE size=4 align=4 (r7)
 *     obj_7 LOCAL_VALUE size=4 align=4 (r8)
 *     obj_8 LOCAL_VALUE size=4 align=4 (r9)
 *     obj_9 LOCAL_VALUE size=4 align=4 (x)
 *     obj_10 LOCAL_VALUE size=4 align=4 (r10)
 *     obj_11 LOCAL_VALUE size=4 align=4 (r11)
 *     obj_12 LOCAL_VALUE size=4 align=4 (r12)
 *     obj_13 LOCAL_VALUE size=4 align=4 (r13)
 *     obj_14 LOCAL_VALUE size=4 align=4 (r14)
 *     obj_15 LOCAL_VALUE size=4 align=4 (r15)
 *     obj_16 LOCAL_VALUE size=4 align=4 (a)
 *     obj_17 LOCAL_VALUE size=4 align=4 (b)
 *     obj_18 LOCAL_VALUE size=4 align=4 (c)
 *     obj_19 LOCAL_VALUE size=4 align=4 (r16)
 *     obj_20 LOCAL_VALUE size=4 align=4 (r17)
 *     obj_21 LOCAL_VALUE size=4 align=4 (r18)
 *     obj_22 LOCAL_VALUE size=4 align=4 (r19)
 *     obj_23 LOCAL_VALUE size=4 align=4 (r20)
 *     obj_24 PARAMETER size=4 align=4
 *     obj_25 RETURN_SLOT size=4 align=4
 *     obj_26 RETURN_SLOT size=4 align=4
 *     obj_27 RETURN_SLOT size=4 align=4
 *     obj_28 RETURN_SLOT size=4 align=4
 *   body_scope: FUNCTION_SCOPE
 * 
 *   blocks:
 *   block_0 FRAME:
 *     >> %r1.0 = ALLOCA/LOCAL size=4 align=4
 *     >> %r2.1 = ALLOCA/LOCAL size=4 align=4
 *     >> %r3.2 = ALLOCA/LOCAL size=4 align=4
 *     >> %r4.3 = ALLOCA/LOCAL size=4 align=4
 *     >> %r5.4 = ALLOCA/LOCAL size=4 align=4
 *     >> %r6.5 = ALLOCA/LOCAL size=4 align=4
 *     >> %r7.6 = ALLOCA/LOCAL size=4 align=4
 *     >> %r8.7 = ALLOCA/LOCAL size=4 align=4
 *     >> %r9.8 = ALLOCA/LOCAL size=4 align=4
 *     >> %x.9 = ALLOCA/LOCAL size=4 align=4
 *     >> %r10.10 = ALLOCA/LOCAL size=4 align=4
 *     >> %r11.11 = ALLOCA/LOCAL size=4 align=4
 *     >> %r12.12 = ALLOCA/LOCAL size=4 align=4
 *     >> %r13.13 = ALLOCA/LOCAL size=4 align=4
 *     >> %r14.14 = ALLOCA/LOCAL size=4 align=4
 *     >> %r15.15 = ALLOCA/LOCAL size=4 align=4
 *     >> %a.16 = ALLOCA/LOCAL size=4 align=4
 *     >> %b.17 = ALLOCA/LOCAL size=4 align=4
 *     >> %c.18 = ALLOCA/LOCAL size=4 align=4
 *     >> %r16.19 = ALLOCA/LOCAL size=4 align=4
 *     >> %r17.20 = ALLOCA/LOCAL size=4 align=4
 *     >> %r18.21 = ALLOCA/LOCAL size=4 align=4
 *     >> %r19.22 = ALLOCA/LOCAL size=4 align=4
 *     >> %r20.23 = ALLOCA/LOCAL size=4 align=4
 *     >> %24 = IMPLICIT_GOTO
 *     -> [block_1]
 ...
 *          %32 = ALLOCA/ARG size=4 align=4  // 1
 *          %31 = CONST/INT32 1  // 1
 *     >> %33 = MEMORY/STORE_LE_32 [%32, %31]  // 1
 *          %r1.0 = ALLOCA/LOCAL size=4 align=4
 *          %29 = CONST/INT32 0  // 0
 *          %35 = CALL @increment_and_return [%32]  // increment_and_return(1)
 *          %36 = LOGICAL_AND [%29, %35]  // 0 && increment_and_return(1)
 *     >> %r1.37 = MEMORY/STORE_LE_32 [%r1.0, %36]
 *     >> %41 = EXIT_SCOPE
 *          %38 = MEMORY/LOAD_LE_32 [%r1.0]  // r1
 *          %39 = CONST/INT32 0  // 0
 ...
 *          %r4.3 = ALLOCA/LOCAL size=4 align=4
 *          %78 = CONST/INT32 1  // 1
 *          %81 = CALL @unreachable_function  // unreachable_function()
 *          %82 = LOGICAL_OR [%78, %81]  // 1 || unreachable_function()
 *     >> %r4.83 = MEMORY/STORE_LE_32 [%r4.3, %82]
 *     >> %87 = EXIT_SCOPE
 *          %84 = MEMORY/LOAD_LE_32 [%r4.3]  // r4
 *          %85 = CONST/INT32 1  // 1
 ...
 *          %r7.6 = ALLOCA/LOCAL size=4 align=4
 *          %124 = CONST/INT32 1  // 1
 *          %125 = CONST/INT32 42  // 42
 *          %128 = CALL @unreachable_function  // unreachable_function()
 *          %129 = SELECT [%124, %125, %128]  // 1 ? 42 : unreachable_function()
 *     >> %r7.130 = MEMORY/STORE_LE_32 [%r7.6, %129]
 *     >> %134 = EXIT_SCOPE
 *          %131 = MEMORY/LOAD_LE_32 [%r7.6]  // r7
 *          %132 = CONST/INT32 42  // 42
 ...
 *          %r8.7 = ALLOCA/LOCAL size=4 align=4
 *          %143 = CONST/INT32 0  // 0
 *          %146 = CALL @unreachable_function  // unreachable_function()
 *          %147 = CONST/INT32 43  // 43
 *          %148 = SELECT [%143, %146, %147]  // 0 ? unreachable_function() : 43
 *     >> %r8.149 = MEMORY/STORE_LE_32 [%r8.7, %148]
 *     >> %153 = EXIT_SCOPE
 *          %150 = MEMORY/LOAD_LE_32 [%r8.7]  // r8
 *          %151 = CONST/INT32 43  // 43
 ...
 *          %162 = CONST/INT32 1  // 1
 *          %163 = CONST/INT32 0  // 0
 *          %164 = CONST/INT32 100  // 100
 *          %165 = CONST/INT32 200  // 200
 *          %166 = SELECT [%163, %164, %165]  // 0 ? 100 : 200
 *          %167 = CONST/INT32 300  // 300
 *          %168 = SELECT [%162, %166, %167]  // 1 ? (0 ? 100 : 200) : 300
 *     >> %r9.169 = MEMORY/STORE_LE_32 [%r9.8, %168]
 *          %170 = MEMORY/LOAD_LE_32 [%r9.8]  // r9
 *          %171 = CONST/INT32 200  // 200
 ...
 *          %r10.10 = ALLOCA/LOCAL size=4 align=4
 *          %182 = MEMORY/LOAD_LE_32 [%x.9]  // x
 *          %183 = CONST/INT32 5  // 5
 *          %184 = CMP_GT [%182, %183]  // x > 5
 *          %185 = MEMORY/LOAD_LE_32 [%x.9]  // x
 *          %186 = CONST/INT32 1  // 1
 *          %187 = ADD [%185, %186]  // x + 1
 *          %188 = MEMORY/LOAD_LE_32 [%x.9]  // x
 *          %189 = CONST/INT32 1  // 1
 *          %190 = SUB [%188, %189]  // x - 1
 *          %191 = SELECT [%184, %187, %190]  // (x > 5) ? (x + 1) : (x - 1)
 *     >> %r10.192 = MEMORY/STORE_LE_32 [%r10.10, %191]
 *          %193 = MEMORY/LOAD_LE_32 [%r10.10]  // r10
 *          %194 = CONST/INT32 11  // 11
 ...
 *          %r11.11 = ALLOCA/LOCAL size=4 align=4
 *          %x.9 = ALLOCA/LOCAL size=4 align=4
 *          %203 = MEMORY/LOAD_LE_32 [%x.9]  // x
 *          %204 = CONST/INT32 5  // 5
 *          %205 = CMP_LT [%203, %204]  // x < 5
 *          %206 = MEMORY/LOAD_LE_32 [%x.9]  // x
 *          %207 = CONST/INT32 1  // 1
 *          %208 = ADD [%206, %207]  // x + 1
 *          %209 = MEMORY/LOAD_LE_32 [%x.9]  // x
 *          %210 = CONST/INT32 1  // 1
 *          %211 = SUB [%209, %210]  // x - 1
 *          %212 = SELECT [%205, %208, %211]  // (x < 5) ? (x + 1) : (x - 1)
 *     >> %r11.213 = MEMORY/STORE_LE_32 [%r11.11, %212]
 *          %214 = MEMORY/LOAD_LE_32 [%r11.11]  // r11
 *          %215 = CONST/INT32 9  // 9
 ...
 *          %r14.14 = ALLOCA/LOCAL size=4 align=4
 *          %256 = CONST/INT32 0  // 0
 *          %257 = LOGICAL_NOT [%256]  // !0
 *          %258 = CONST/INT32 0  // 0
 *          %259 = LOGICAL_NOT [%258]  // !0
 *          %260 = LOGICAL_AND [%257, %259]  // !0 && !0
 *     >> %r14.261 = MEMORY/STORE_LE_32 [%r14.14, %260]
 *          %262 = MEMORY/LOAD_LE_32 [%r14.14]  // r14
 *          %263 = CONST/INT32 1  // 1
 ...
 *          %r15.15 = ALLOCA/LOCAL size=4 align=4
 *          %272 = CONST/INT32 1  // 1
 *          %273 = LOGICAL_NOT [%272]  // !1
 *          %274 = CONST/INT32 0  // 0
 *          %275 = LOGICAL_NOT [%274]  // !0
 *          %276 = LOGICAL_OR [%273, %275]  // !1 || !0
 *     >> %r15.277 = MEMORY/STORE_LE_32 [%r15.15, %276]
 *          %278 = MEMORY/LOAD_LE_32 [%r15.15]  // r15
 *          %279 = CONST/INT32 1  // 1
 ...
 *          %r16.19 = ALLOCA/LOCAL size=4 align=4
 *          %294 = MEMORY/LOAD_LE_32 [%a.16]  // a
 *          %295 = MEMORY/LOAD_LE_32 [%b.17]  // b
 *          %296 = LOGICAL_AND [%294, %295]  // a && b
 *     >> %r16.297 = MEMORY/STORE_LE_32 [%r16.19, %296]
 *          %298 = MEMORY/LOAD_LE_32 [%r16.19]  // r16
 *          %299 = CONST/INT32 0  // 0
 ...
 *          %r17.20 = ALLOCA/LOCAL size=4 align=4
 *          %a.16 = ALLOCA/LOCAL size=4 align=4
 *          %308 = MEMORY/LOAD_LE_32 [%a.16]  // a
 *          %b.17 = ALLOCA/LOCAL size=4 align=4
 *          %309 = MEMORY/LOAD_LE_32 [%b.17]  // b
 *          %310 = LOGICAL_OR [%308, %309]  // a || b
 *     >> %r17.311 = MEMORY/STORE_LE_32 [%r17.20, %310]
 *          %312 = MEMORY/LOAD_LE_32 [%r17.20]  // r17
 *          %313 = CONST/INT32 1  // 1
 ...
 *          %r18.21 = ALLOCA/LOCAL size=4 align=4
 *          %b.17 = ALLOCA/LOCAL size=4 align=4
 *          %322 = MEMORY/LOAD_LE_32 [%b.17]  // b
 *          %c.18 = ALLOCA/LOCAL size=4 align=4
 *          %323 = MEMORY/LOAD_LE_32 [%c.18]  // c
 *          %324 = LOGICAL_OR [%322, %323]  // b || c
 *     >> %r18.325 = MEMORY/STORE_LE_32 [%r18.21, %324]
 *          %326 = MEMORY/LOAD_LE_32 [%r18.21]  // r18
 *          %327 = CONST/INT32 1  // 1
 ...
 *          %r19.22 = ALLOCA/LOCAL size=4 align=4
 *          %a.16 = ALLOCA/LOCAL size=4 align=4
 *          %336 = MEMORY/LOAD_LE_32 [%a.16]  // a
 *          %b.17 = ALLOCA/LOCAL size=4 align=4
 *          %337 = MEMORY/LOAD_LE_32 [%b.17]  // b
 *          %c.18 = ALLOCA/LOCAL size=4 align=4
 *          %338 = MEMORY/LOAD_LE_32 [%c.18]  // c
 *          %339 = SELECT [%336, %337, %338]  // a ? b : c
 *     >> %r19.340 = MEMORY/STORE_LE_32 [%r19.22, %339]
 *          %341 = MEMORY/LOAD_LE_32 [%r19.22]  // r19
 *          %342 = CONST/INT32 0  // 0
 ...
 *          %r20.23 = ALLOCA/LOCAL size=4 align=4
 *          %b.17 = ALLOCA/LOCAL size=4 align=4
 *          %351 = MEMORY/LOAD_LE_32 [%b.17]  // b
 *          %a.16 = ALLOCA/LOCAL size=4 align=4
 *          %352 = MEMORY/LOAD_LE_32 [%a.16]  // a
 *          %c.18 = ALLOCA/LOCAL size=4 align=4
 *          %353 = MEMORY/LOAD_LE_32 [%c.18]  // c
 *          %354 = SELECT [%351, %352, %353]  // b ? a : c
 *     >> %r20.355 = MEMORY/STORE_LE_32 [%r20.23, %354]
 *          %356 = MEMORY/LOAD_LE_32 [%r20.23]  // r20
 *          %357 = CONST/INT32 3  // 3
