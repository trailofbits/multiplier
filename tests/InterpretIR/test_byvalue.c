 ...
 *     >> %17 = RET [%13]  // return s
 * }
 * function make_large (NORMAL) {
 *   objects:
 *     obj_0 PARAMETER_VALUE size=4 align=1 (base)
 *     obj_1 RETURN_SLOT size=20 align=1
 *     obj_2 LOCAL_VALUE size=20 align=1 (l)
 *   body_scope: FUNCTION_SCOPE
 *   blocks:
 *   block_0 FRAME:
 *     >> %base.0 = ALLOCA/LOCAL size=4 align=1
 *     >> %2 = IMPLICIT_GOTO
 *     -> [block_1]
 *   block_1 ENTRY  <- [block_0]:
 *     >> %3 = ENTER_SCOPE  // {     struct Large l;     l.a = base;     l.b =...
 *          %5 = GEP_FIELD offset=0 .a [%l.1]  // l.a
 *          %6 = MEMORY/LOAD_LE_32 [%base.4]  // base
 *     >> %7 = MEMORY/STORE_LE_32 [%5, %6]  // l.a = base
 *          %8 = GEP_FIELD offset=4 .b [%l.1]  // l.b
 *          %11 = ADD [%9, %10]  // base + 1
 *     >> %12 = MEMORY/STORE_LE_32 [%8, %11]  // l.b = base + 1
 *          %13 = GEP_FIELD offset=8 .c [%l.1]  // l.c
 *          %16 = ADD [%14, %15]  // base + 2
 *     >> %17 = MEMORY/STORE_LE_32 [%13, %16]  // l.c = base + 2
 *          %18 = GEP_FIELD offset=12 .d [%l.1]  // l.d
 *          %21 = ADD [%19, %20]  // base + 3
 *     >> %22 = MEMORY/STORE_LE_32 [%18, %21]  // l.d = base + 3
 *          %23 = GEP_FIELD offset=16 .e [%l.1]  // l.e
 *          %26 = ADD [%24, %25]  // base + 4
 ...
 *     -> [block_1]
 *   block_1 ENTRY  <- [block_0]:
 *     >> %2 = ENTER_SCOPE  // {     return s.x + s.y; }
 *          %9 = RETURN_PTR  // return s.x + s.y
 *          %8 = ADD [%5, %7]  // s.x + s.y
 *     >> %10 = MEMORY/STORE_LE_32 [%9, %8]  // return s.x + s.y
 *     >> %11 = EXIT_SCOPE  // {     return s.x + s.y; }
 *          %8 = ADD [%5, %7]  // s.x + s.y
 *     >> %12 = RET [%8]  // return s.x + s.y
 * }
 ...
 * }
 * function sum_packed3 (NORMAL) {
 *   objects:
 *     obj_0 PARAMETER_VALUE size=3 align=1 (p)
 *     obj_1 RETURN_SLOT size=4 align=1
 *   body_scope: FUNCTION_SCOPE
 *   blocks:
 *   block_0 FRAME:
 *     >> %p.0 = ALLOCA/LOCAL size=3 align=1
 *     >> %1 = IMPLICIT_GOTO
 *     -> [block_1]
 *   block_1 ENTRY  <- [block_0]:
 *     >> %2 = ENTER_SCOPE  // {     return p.a + p.b + p.c; }
 *          %15 = RETURN_PTR  // return p.a + p.b + p.c
 *          %14 = ADD [%10, %13]  // p.a + p.b + p.c
 *     >> %16 = MEMORY/STORE_LE_32 [%15, %14]  // return p.a + p.b + p.c
 *     >> %17 = EXIT_SCOPE  // {     return p.a + p.b + p.c; }
 *          %14 = ADD [%10, %13]  // p.a + p.b + p.c
 *     >> %18 = RET [%14]  // return p.a + p.b + p.c
 * }
 * function identity_small (NORMAL) {
 *   objects:
 *     obj_0 PARAMETER_VALUE size=8 align=1 (s)
 ...
 *     -> [block_1]
 *   block_1 ENTRY  <- [block_0]:
 *     >> %2 = ENTER_SCOPE  // {     return s; }
 *          %5 = RETURN_PTR  // return s
 *          %4 = MEMORY/LOAD_LE_64 [%s.3]  // s
 *     >> %6 = MEMORY/STORE_LE_64 [%5, %4]  // return s
 *     >> %7 = EXIT_SCOPE  // {     return s; }
 *          %4 = MEMORY/LOAD_LE_64 [%s.3]  // s
 *     >> %8 = RET [%4]  // return s
 * }
 * function chain_test (NORMAL) {
 *   objects:
 *     obj_0 PARAMETER_VALUE size=4 align=1 (x)
 *     obj_1 PARAMETER_VALUE size=4 align=1 (y)
 ...
 *     -> [block_1]
 *   block_1 ENTRY  <- [block_0]:
 *     >> %4 = ENTER_SCOPE  // {     struct Small s = make_small(x, y);     re...
 *     >> %7 = ENTER_SCOPE  // make_small(x, y)
 *          %9 = ALLOCA/ARG size=4 align=1  // x
 *          %8 = MEMORY/LOAD_LE_32 [%x.5]  // x
 *     >> %10 = MEMORY/STORE_LE_32 [%9, %8]  // x
 *          %12 = ALLOCA/ARG size=4 align=1  // y
 *          %11 = MEMORY/LOAD_LE_32 [%y.6]  // y
 *     >> %13 = MEMORY/STORE_LE_32 [%12, %11]  // y
 *          %s.2 = ALLOCA/LOCAL size=8 align=1
 *          %15 = CALL @make_small [%9, %12]  // make_small(x, y)
 *     >> %s.16 = MEMORY/STORE_LE_64 [%s.2, %15]
 *          %18 = ALLOCA/ARG size=8 align=1  // s
 *          %17 = MEMORY/LOAD_LE_64 [%s.2]  // s
 *     >> %19 = MEMORY/STORE_LE_64 [%18, %17]  // s
 *     >> %22 = EXIT_SCOPE
 *          %23 = RETURN_PTR  // return sum_small(s)
 *          %21 = CALL @sum_small [%18]  // sum_small(s)
 *     >> %24 = MEMORY/STORE_LE_32 [%23, %21]  // return sum_small(s)
 *     >> %25 = EXIT_SCOPE  // {     struct Small s = make_small(x, y);     re...
 *          %21 = CALL @sum_small [%18]  // sum_small(s)
 *     >> %26 = RET [%21]  // return sum_small(s)
 * }
