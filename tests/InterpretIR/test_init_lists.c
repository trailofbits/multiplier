 ...
 *   objects:
 *     obj_0 LOCAL_VALUE size=16 align=4 (arr)
 *     obj_1 LOCAL_VALUE size=20 align=4 (partial)
 *     obj_2 LOCAL_VALUE size=8 align=4 (s)
 *     obj_3 LOCAL_VALUE size=12 align=4 (o)
 *     obj_4 LOCAL_VALUE size=8 align=4 (d)
 *     obj_5 LOCAL_VALUE size=8 align=4 (cl)
 *     obj_6 LOCAL_VALUE size=12 align=4 (z)
 *     obj_7 COMPOUND_LITERAL size=8 align=4
 *   body_scope: FUNCTION_SCOPE
 * 
 *   blocks:
 *   block_0 FRAME:
 *     >> %arr.0 = ALLOCA/LOCAL size=16 align=4
 *     >> %partial.1 = ALLOCA/LOCAL size=20 align=4
 *     >> %s.2 = ALLOCA/LOCAL size=8 align=4
 *     >> %o.3 = ALLOCA/LOCAL size=12 align=4
 *     >> %d.4 = ALLOCA/LOCAL size=8 align=4
 *     >> %cl.5 = ALLOCA/LOCAL size=8 align=4
 *     >> %z.6 = ALLOCA/LOCAL size=12 align=4
 *     >> %7 = IMPLICIT_GOTO
 *     -> [block_1]
 ...
 *          %arr.0 = ALLOCA/LOCAL size=16 align=4
 *          %38 = CONST/INT32 3  // 3
 *          %39 = PTR_ADD elem_size=4 [%arr.0, %38]  // arr[3]
 *          %40 = MEMORY/LOAD_LE_32 [%39]  // arr[3]
 *          %41 = CONST/INT32 40  // 40
 ...
 *          %partial.55 = CONST/INT64 1
 *          %partial.56 = PTR_ADD elem_size=4 [%partial.1, %partial.55]
 *          %57 = CONST/INT32 2  // 2
 *     >> %partial.58 = MEMORY/STORE_LE_32 [%partial.56, %57]
 *          %59 = CONST/INT32 0  // 0
 *          %60 = PTR_ADD elem_size=4 [%partial.1, %59]  // partial[0]
 *          %61 = MEMORY/LOAD_LE_32 [%60]  // partial[0]
 *          %62 = CONST/INT32 1  // 1
 ...
 *          %partial.1 = ALLOCA/LOCAL size=20 align=4
 *          %71 = CONST/INT32 1  // 1
 *          %72 = PTR_ADD elem_size=4 [%partial.1, %71]  // partial[1]
 *          %73 = MEMORY/LOAD_LE_32 [%72]  // partial[1]
 *          %74 = CONST/INT32 2  // 2
 ...
 *          %partial.1 = ALLOCA/LOCAL size=20 align=4
 *          %83 = CONST/INT32 2  // 2
 *          %84 = PTR_ADD elem_size=4 [%partial.1, %83]  // partial[2]
 *          %85 = MEMORY/LOAD_LE_32 [%84]  // partial[2]
 *          %86 = CONST/INT32 0  // 0
 ...
 *          %partial.1 = ALLOCA/LOCAL size=20 align=4
 *          %95 = CONST/INT32 4  // 4
 *          %96 = PTR_ADD elem_size=4 [%partial.1, %95]  // partial[4]
 *          %97 = MEMORY/LOAD_LE_32 [%96]  // partial[4]
 *          %98 = CONST/INT32 0  // 0
 ...
 *          %116 = GEP_FIELD offset=0 .a [%s.2]  // s.a
 *          %117 = MEMORY/LOAD_LE_32 [%116]  // s.a
 *          %118 = CONST/INT32 100  // 100
 ...
 *          %s.2 = ALLOCA/LOCAL size=8 align=4
 *          %127 = GEP_FIELD offset=4 .b [%s.2]  // s.b
 *          %128 = MEMORY/LOAD_LE_32 [%127]  // s.b
 *          %129 = CONST/INT32 200  // 200
 ...
 *          %154 = GEP_FIELD offset=0 .inner [%o.3]  // o.inner
 *          %155 = GEP_FIELD offset=0 .a [%154]  // o.inner.a
 *          %156 = MEMORY/LOAD_LE_32 [%155]  // o.inner.a
 *          %157 = CONST/INT32 5  // 5
 ...
 *          %o.3 = ALLOCA/LOCAL size=12 align=4
 *          %166 = GEP_FIELD offset=0 .inner [%o.3]  // o.inner
 *          %167 = GEP_FIELD offset=4 .b [%166]  // o.inner.b
 *          %168 = MEMORY/LOAD_LE_32 [%167]  // o.inner.b
 *          %169 = CONST/INT32 6  // 6
 ...
 *          %o.3 = ALLOCA/LOCAL size=12 align=4
 *          %178 = GEP_FIELD offset=8 .c [%o.3]  // o.c
 *          %179 = MEMORY/LOAD_LE_32 [%178]  // o.c
 *          %180 = CONST/INT32 7  // 7
 ...
 *          %198 = GEP_FIELD offset=0 .a [%d.4]  // d.a
 *          %199 = MEMORY/LOAD_LE_32 [%198]  // d.a
 *          %200 = CONST/INT32 10  // 10
 ...
 *          %d.4 = ALLOCA/LOCAL size=8 align=4
 *          %209 = GEP_FIELD offset=4 .b [%d.4]  // d.b
 *          %210 = MEMORY/LOAD_LE_32 [%209]  // d.b
 *          %211 = CONST/INT32 42  // 42
 ...
 *          %220 = ALLOCA/LOCAL size=8 align=4  // (struct Inner){99, 88}
 ...
 *          %cl.5 = ALLOCA/LOCAL size=8 align=4
 *          %230 = CONST/UINT64 8
 *     >> %cl.231 = MEMORY/MEMCPY [%cl.5, %220, %230]
 *          %232 = GEP_FIELD offset=0 .a [%cl.5]  // cl.a
 *          %233 = MEMORY/LOAD_LE_32 [%232]  // cl.a
 *          %234 = CONST/INT32 99  // 99
 ...
 *          %cl.5 = ALLOCA/LOCAL size=8 align=4
 *          %243 = GEP_FIELD offset=4 .b [%cl.5]  // cl.b
 *          %244 = MEMORY/LOAD_LE_32 [%243]  // cl.b
 *          %245 = CONST/INT32 88  // 88
 ...
 *          %270 = GEP_FIELD offset=0 .inner [%z.6]  // z.inner
 *          %271 = GEP_FIELD offset=0 .a [%270]  // z.inner.a
 *          %272 = MEMORY/LOAD_LE_32 [%271]  // z.inner.a
 *          %273 = CONST/INT32 0  // 0
 ...
 *          %z.6 = ALLOCA/LOCAL size=12 align=4
 *          %282 = GEP_FIELD offset=8 .c [%z.6]  // z.c
 *          %283 = MEMORY/LOAD_LE_32 [%282]  // z.c
 *          %284 = CONST/INT32 0  // 0
