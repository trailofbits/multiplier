 ...
 *     obj_3 LOCAL_VALUE size=4 align=1 (y)
 *     obj_4 LOCAL_VALUE size=4 align=1 (bin)
 *     obj_5 LOCAL_VALUE size=4 align=1 (big)
 *     obj_6 LOCAL_VALUE size=8 align=1 (np)
 *     obj_7 LOCAL_VALUE size=1 align=1 (u8c)
 *     obj_8 LOCAL_VALUE size=4 align=1 (z)
 *     obj_9 LOCAL_VALUE size=8 align=1 (ull)
 ...
 *          %bin.4 = ALLOCA/LOCAL size=4 align=1
 ...
 *          %big.5 = ALLOCA/LOCAL size=4 align=1
 ...
 *          %np.6 = ALLOCA/LOCAL size=8 align=1
 ...
 *          %z.8 = ALLOCA/LOCAL size=4 align=1
 ...
 *          %ull.9 = ALLOCA/LOCAL size=8 align=1
