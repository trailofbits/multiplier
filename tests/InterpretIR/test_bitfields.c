 ...
 *   objects:
 *     obj_0 LOCAL_VALUE size=4 align=4 (f)
 *     obj_1 LOCAL_VALUE size=4 align=4 (g)
 *   body_scope: FUNCTION_SCOPE
 * 
 *   blocks:
 *   block_0 FRAME:
 *     >> %f.0 = ALLOCA/LOCAL size=4 align=4
 *     >> %g.1 = ALLOCA/LOCAL size=4 align=4
 *     >> %2 = IMPLICIT_GOTO
 *     -> [block_1]
 ...
 *          %30 = MEMORY/BIT_READ_LE off=0 w=1 [%f.0]  // f.read
 *          %31 = CAST/IDENTITY [%30]  // f.read
 *          %32 = CONST/INT32 1  // 1
 ...
 *          %f.0 = ALLOCA/LOCAL size=4 align=4
 *          %41 = MEMORY/BIT_READ_LE off=1 w=1 [%f.0]  // f.write
 *          %42 = CAST/IDENTITY [%41]  // f.write
 *          %43 = CONST/INT32 0  // 0
 ...
 *          %f.0 = ALLOCA/LOCAL size=4 align=4
 *          %52 = MEMORY/BIT_READ_LE off=2 w=1 [%f.0]  // f.exec
 *          %53 = CAST/IDENTITY [%52]  // f.exec
 *          %54 = CONST/INT32 1  // 1
 ...
 *          %f.0 = ALLOCA/LOCAL size=4 align=4
 *          %63 = MEMORY/BIT_READ_LE off=3 w=4 [%f.0]  // f.mode
 *          %64 = CAST/IDENTITY [%63]  // f.mode
 *          %65 = CONST/INT32 7  // 7
 ...
 *          %91 = MEMORY/BIT_READ_LE off=0 w=1 [%g.1]  // g.read
 *          %92 = CAST/IDENTITY [%91]  // g.read
 *          %93 = CONST/INT32 1  // 1
 ...
 *          %g.1 = ALLOCA/LOCAL size=4 align=4
 *          %102 = MEMORY/BIT_READ_LE off=1 w=1 [%g.1]  // g.write
 *          %103 = CAST/IDENTITY [%102]  // g.write
 *          %104 = CONST/INT32 1  // 1
 ...
 *          %g.1 = ALLOCA/LOCAL size=4 align=4
 *          %113 = MEMORY/BIT_READ_LE off=2 w=1 [%g.1]  // g.exec
 *          %114 = CAST/IDENTITY [%113]  // g.exec
 *          %115 = CONST/INT32 0  // 0
 ...
 *          %g.1 = ALLOCA/LOCAL size=4 align=4
 *          %124 = MEMORY/BIT_READ_LE off=3 w=4 [%g.1]  // g.mode
 *          %125 = CAST/IDENTITY [%124]  // g.mode
 *          %126 = CONST/INT32 5  // 5
 ...
 *          %f.0 = ALLOCA/LOCAL size=4 align=4
 *          %135 = MEMORY/BIT_READ_LE off=3 w=4 [%f.0]  // f.mode
 *          %136 = CAST/IDENTITY [%135]  // f.mode
 *          %137 = CONST/INT32 3  // 3
 *          %138 = BIT_AND [%136, %137]  // f.mode & 3
 *          %139 = CAST/IDENTITY [%138]  // f.mode & 3
 *     >> %140 = MEMORY/BIT_WRITE_LE off=3 w=4 [%f.0, %139]  // f.mode = f.mode & 3
 *          %141 = MEMORY/BIT_READ_LE off=3 w=4 [%f.0]  // f.mode
 *          %142 = CAST/IDENTITY [%141]  // f.mode
 *          %143 = CONST/INT32 3  // 3
