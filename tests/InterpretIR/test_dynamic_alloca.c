 ...
 *   objects:
 *     obj_0 LOCAL_VALUE size=4 align=4 (n)
 *     obj_1 LOCAL_VALUE size=0 align=4 (vla)
 *     obj_2 LOCAL_VALUE size=4 align=4 (i)
 *     obj_3 LOCAL_VALUE size=4 align=4 (m)
 *     obj_4 LOCAL_VALUE size=0 align=4 (inner_vla)
 *     obj_5 LOCAL_VALUE size=4 align=4 (sz)
 *     obj_6 LOCAL_VALUE size=0 align=4 (bigger_vla)
 *   body_scope: FUNCTION_SCOPE
 * 
 *   blocks:
 *   block_0 FRAME:
 *     >> %n.0 = ALLOCA/LOCAL size=4 align=4
 *     >> %i.1 = ALLOCA/LOCAL size=4 align=4
 *     >> %m.2 = ALLOCA/LOCAL size=4 align=4
 *     >> %sz.3 = ALLOCA/LOCAL size=4 align=4
 *     >> %4 = IMPLICIT_GOTO
 *     -> [block_1]
 ...
 *          %8 = MEMORY/LOAD_LE_32 [%n.0]  // n
 *          %9 = CONST/UINT64 4
 *          %vla.10 = MUL [%8, %9]
 *     >> %vla.11 = ALLOCA/DYNAMIC size=0 align=4 [%vla.10]
 ...
 *          %i.1 = ALLOCA/LOCAL size=4 align=4
 *          %17 = MEMORY/LOAD_LE_32 [%i.1]  // i
 *          %n.0 = ALLOCA/LOCAL size=4 align=4
 *          %18 = MEMORY/LOAD_LE_32 [%n.0]  // n
 *          %19 = CMP_LT [%17, %18]  // i < n
 ...
 *          %vla.11 = ALLOCA/DYNAMIC size=0 align=4 [%vla.10]
 *          %34 = CONST/INT32 0  // 0
 *          %35 = PTR_ADD elem_size=4 [%vla.11, %34]  // vla[0]
 *          %36 = MEMORY/LOAD_LE_32 [%35]  // vla[0]
 *          %37 = CONST/INT32 0  // 0
 ...
 *          %vla.11 = ALLOCA/DYNAMIC size=0 align=4 [%vla.10]
 *          %46 = CONST/INT32 4  // 4
 *          %47 = PTR_ADD elem_size=4 [%vla.11, %46]  // vla[4]
 *          %48 = MEMORY/LOAD_LE_32 [%47]  // vla[4]
 *          %49 = CONST/INT32 40  // 40
 ...
 *          %61 = MEMORY/LOAD_LE_32 [%m.2]  // m
 *          %62 = CONST/UINT64 4
 *          %inner_vla.63 = MUL [%61, %62]
 *     >> %inner_vla.64 = ALLOCA/DYNAMIC size=0 align=4 [%inner_vla.63]
 *          %inner_vla.64 = ALLOCA/DYNAMIC size=0 align=4 [%inner_vla.63]
 *          %65 = CONST/INT32 0  // 0
 ...
 *          %73 = CONST/INT32 0  // 0
 *          %74 = PTR_ADD elem_size=4 [%inner_vla.64, %73]  // inner_vla[0]
 *          %75 = MEMORY/LOAD_LE_32 [%74]  // inner_vla[0]
 *          %76 = CONST/INT32 100  // 100
 ...
 *          %inner_vla.64 = ALLOCA/DYNAMIC size=0 align=4 [%inner_vla.63]
 *          %86 = CONST/INT32 2  // 2
 *          %87 = PTR_ADD elem_size=4 [%inner_vla.64, %86]  // inner_vla[2]
 *          %88 = MEMORY/LOAD_LE_32 [%87]  // inner_vla[2]
 *          %89 = CONST/INT32 300  // 300
 ...
 *          %sz.3 = ALLOCA/LOCAL size=4 align=4
 *          %n.0 = ALLOCA/LOCAL size=4 align=4
 *          %100 = MEMORY/LOAD_LE_32 [%n.0]  // n
 *          %101 = CONST/INT32 3  // 3
 *          %102 = ADD [%100, %101]  // n + 3
 *     >> %sz.103 = MEMORY/STORE_LE_32 [%sz.3, %102]
 *          %104 = MEMORY/LOAD_LE_32 [%sz.3]  // sz
 *          %105 = CONST/UINT64 4
 *          %bigger_vla.106 = MUL [%104, %105]
 *     >> %bigger_vla.107 = ALLOCA/DYNAMIC size=0 align=4 [%bigger_vla.106]
 *          %bigger_vla.107 = ALLOCA/DYNAMIC size=0 align=4 [%bigger_vla.106]
 *          %108 = CONST/INT32 0  // 0
 *          %109 = PTR_ADD elem_size=4 [%bigger_vla.107, %108]  // bigger_vla[0]
 *          %110 = CONST/INT32 1  // 1
 *     >> %111 = MEMORY/STORE_LE_32 [%109, %110]  // bigger_vla[0] = 1
 *          %112 = MEMORY/LOAD_LE_32 [%sz.3]  // sz
 *          %113 = CONST/INT32 1  // 1
 *          %114 = SUB [%112, %113]  // sz - 1
 ...
 *          %118 = CONST/INT32 0  // 0
 *          %119 = PTR_ADD elem_size=4 [%bigger_vla.107, %118]  // bigger_vla[0]
 *          %120 = MEMORY/LOAD_LE_32 [%119]  // bigger_vla[0]
 *          %121 = CONST/INT32 1  // 1
 ...
 *          %bigger_vla.107 = ALLOCA/DYNAMIC size=0 align=4 [%bigger_vla.106]
 *          %130 = CONST/INT32 7  // 7
 *          %131 = PTR_ADD elem_size=4 [%bigger_vla.107, %130]  // bigger_vla[7]
 *          %132 = MEMORY/LOAD_LE_32 [%131]  // bigger_vla[7]
 *          %133 = CONST/INT32 99  // 99
 ...
 *          %vla.11 = ALLOCA/DYNAMIC size=0 align=4 [%vla.10]
 *          %i.1 = ALLOCA/LOCAL size=4 align=4
 *          %22 = MEMORY/LOAD_LE_32 [%i.1]  // i
 *          %23 = PTR_ADD elem_size=4 [%vla.11, %22]  // vla[i]
 *          %24 = MEMORY/LOAD_LE_32 [%i.1]  // i
 *          %25 = CONST/INT32 10  // 10
 *          %26 = MUL [%24, %25]  // i * 10
