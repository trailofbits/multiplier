 ...
 *     >> %9 = SWITCH cases=4 [%8]  // switch (val) {         case 1: result = 10; bre...
 *     -> [block_3, block_4, block_5, block_6]
 *   block_6 SWITCH_DEFAULT  <- [block_1, block_9]:
 *          %result.1 = ALLOCA/LOCAL size=4 align=1
 *          %23 = NEG [%22]  // -1
 ...
 *     >> %12 = BREAK  // break
 *     -> [block_2]
 *   block_2 SWITCH_EXIT  <- [block_3, block_4, block_5, block_6, block_10]:
 ...
 *     >> %38 = SWITCH cases=2 [%37]  // switch (99) {         case 1: result = 10; brea...
 *     -> [block_15, block_16]
 *   block_16 SWITCH_DEFAULT  <- [block_13, block_17]:
 *          %result.1 = ALLOCA/LOCAL size=4 align=1
 ...
 *     >> %41 = BREAK  // break
 *     -> [block_14]
 *   block_14 SWITCH_EXIT  <- [block_15, block_16, block_18]:
 ...
 *          %59 = CONST/INT32 1  // 1
 *     >> %60 = SWITCH cases=4 [%59]  // switch (1) {         case 1: result += 1;      ...
 *     -> [block_23, block_24, block_25, block_26]
 *   block_26 SWITCH_DEFAULT  <- [block_21, block_27]:
 *          %result.1 = ALLOCA/LOCAL size=4 align=1
 *          %72 = NEG [%71]  // -1
 ...
 *     >> %69 = BREAK  // break
 *     -> [block_22]
 *   block_22 SWITCH_EXIT  <- [block_25, block_26, block_28]:
 ...
 *          %88 = CONST/INT32 2  // 2
 *     >> %89 = SWITCH cases=4 [%88]  // switch (2) {         case 1:         case 2:   ...
 *     -> [block_33, block_34, block_35, block_36]
 *   block_36 SWITCH_DEFAULT  <- [block_31, block_37]:
 *          %result.1 = ALLOCA/LOCAL size=4 align=1
 *          %97 = NEG [%96]  // -1
 ...
 *     >> %94 = BREAK  // break
 *     -> [block_32]
 *   block_32 SWITCH_EXIT  <- [block_35, block_36, block_38]:
