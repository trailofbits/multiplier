...
class OperationKind(IntEnum):
  ...
  HL_WHILE = 384
  HL_IMAG = 385
  HL_IMPLICIT_CAST = 386
  HL_INDIRECT_CALL = 387
  HL_INITLIST = 388
  HL_CONST_INIT = 389
  HL_LNOT = 390
  HL_MINUS = 391
  ...
  HL_MUL = 395
  HL_NOT = 396
  HL_OFFSETOF_EXPR = 397
  HL_PLUS = 398
  HL_POST_DEC = 399
  HL_POST_INC = 400
  HL_PRE_DEC = 401
  HL_PRE_INC = 402
  HL_PREDEFINED_EXPR = 403
  HL_PREFERRED_ALIGNOF_EXPR = 404
  HL_PREFERRED_ALIGNOF_TYPE = 405
  HL_REAL = 406
  HL_MEMBER = 407
  HL_ASSIGN_FREM = 408
  HL_FREM = 409
