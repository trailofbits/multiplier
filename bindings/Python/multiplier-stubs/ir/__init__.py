...
class AttributeKind(IntEnum):
  ...
  BUILTIN_DATA_LAYOUT_SPEC = 23
  LLVM_C_CONV = 24
  LLVM_COMDAT = 25
  LLVM_LINKAGE = 26
  LLVM_FRAME_POINTER_KIND = 27
  LLVM_LOOP_VECTORIZE = 28
  LLVM_LOOP_INTERLEAVE = 29
  LLVM_LOOP_UNROLL = 30
  LLVM_LOOP_UNROLL_AND_JAM = 31
  LLVM_LOOP_LICM = 32
  LLVM_LOOP_DISTRIBUTE = 33
  LLVM_LOOP_PIPELINE = 34
  LLVM_LOOP_PEELED = 35
  LLVM_LOOP_UNSWITCH = 36
  LLVM_LOOP_ANNOTATION = 37
  LLVM_DI_EXPRESSION_ELEM = 38
  LLVM_DI_EXPRESSION = 39
  LLVM_DI_NULL_TYPE = 40
  LLVM_DI_BASIC_TYPE = 41
  LLVM_DI_COMPILE_UNIT = 42
  LLVM_DI_COMPOSITE_TYPE = 43
  LLVM_DI_DERIVED_TYPE = 44
  LLVM_DI_FILE = 45
  LLVM_DI_GLOBAL_VARIABLE_EXPRESSION = 46
  LLVM_DI_GLOBAL_VARIABLE = 47
  LLVM_DI_LEXICAL_BLOCK = 48
  LLVM_DI_LEXICAL_BLOCK_FILE = 49
  LLVM_DI_LOCAL_VARIABLE = 50
  LLVM_DI_SUBPROGRAM = 51
  LLVM_DI_MODULE = 52
  LLVM_DI_NAMESPACE = 53
  LLVM_DI_SUBRANGE = 54
  LLVM_DI_SUBROUTINE_TYPE = 55
  LLVM_DI_LABEL = 56
  LLVM_MEMORY_EFFECTS = 57
  LLVM_ALIAS_SCOPE_DOMAIN = 58
  LLVM_ALIAS_SCOPE = 59
  LLVM_ACCESS_GROUP = 60
  LLVM_TBAA_ROOT = 61
  LLVM_TBAA_MEMBER = 62
  LLVM_TBAA_TYPE_DESCRIPTOR = 63
  LLVM_TBAA_TAG = 64
  LLVM_V_SCALE_RANGE = 65
  LLVM_TARGET_FEATURES = 66
  LLVM_INTEGER_OVERFLOW_FLAGS = 67
  LLVM_FASTMATH_FLAGS = 68
  HL_ANNOTATION = 69
  HL_FORMAT = 70
  HL_SECTION = 71
  HL_ALIAS = 72
  ...
  HL_NO_INLINE = 78
  HL_CONST = 79
  HL_LOADER_UNINITIALIZED = 80
  HL_NO_INSTRUMENT_FUNCTION = 81
  HL_PACKED = 82
  HL_PURE = 83
  HL_WARN_UNUSED_RESULT = 84
  HL_RESTRICT = 85
  HL_NO_THROW = 86
  HL_NON_NULL = 87
  HL_LEAF = 88
  HL_COLD = 89
  HL_TRANSPARENT_UNION = 90
  HL_RETURNS_TWICE = 91
  HL_MAY_ALIAS = 92
  HL_UNUSED = 93
  HL_USED = 94
  HL_GNU_INLINE = 95
  HL_NO_CF_CHECK = 96
  HL_AVAILABLE_ONLY_IN_DEFAULT_EVAL_METHOD = 97
  HL_AVAILABILITY_ATTR = 98
  HL_FALLTHROUGH = 99
  HL_NO_PROFILE_INSTRUMENT_FUNCTION = 100
  HL_ASM_LABEL = 101
  HL_MODE = 102
  HL_BUILTIN = 103
  HL_ALLOC_ALIGN = 104
  HL_ALLOC_SIZE = 105
  HL_DEPRECATED = 106
  HL_MAX_FIELD_ALIGNMENT = 107
  HL_VISIBILITY = 108
  HL_ASSUME_ALIGNED = 109
  HL_CV_QUALIFIERS = 110
  HL_UCV_QUALIFIERS = 111
  HL_CVR_QUALIFIERS = 112
  HL_OFFSET_OF_NODE = 113
  CORE_BOOLEAN = 114
  CORE_INTEGER = 115
  CORE_FLOAT = 116
  CORE_VOID = 117
  CORE_SOURCE_LANGUAGE = 118
  CORE_GLOBAL_LINKAGE_KIND = 119
  META_IDENTIFIER = 120
...
class OperationKind(IntEnum):
  ...
  HL_ASM = 321
  HL_ASSIGN = 322
  HL_ATTRIBUTED_STMT = 323
  HL_ASSIGN_BIN_ASHR = 324
  HL_BIN_ASHR = 325
  HL_ASSIGN_BIN_AND = 326
  HL_BIN_AND = 327
  HL_BIN_COMMA = 328
  HL_BIN_LAND = 329
  HL_BIN_LOR = 330
  HL_ASSIGN_BIN_LSHR = 331
  HL_BIN_LSHR = 332
  HL_ASSIGN_BIN_OR = 333
  HL_BIN_OR = 334
  HL_ASSIGN_BIN_SHL = 335
  HL_BIN_SHL = 336
  HL_ASSIGN_BIN_XOR = 337
  HL_BIN_XOR = 338
  HL_BINARY_COND = 339
  HL_BREAK = 340
  HL_BUILTIN_BITCAST = 341
  HL_BUILTIN_TYPES_COMPATIBLE_P_TYPE = 342
  HL_CSTYLE_CAST = 343
  HL_CALL = 344
  HL_CASE = 345
  HL_CHOOSE_EXPR = 346
  ...
  HL_ENUMREF = 369
  HL_EXPR = 370
  HL_GNU_EXTENSION = 371
  HL_FCMP = 372
  HL_FIELD = 373
  HL_FILE_SCOPE_ASM = 374
  HL_FOR = 375
  HL_FUNC = 376
  HL_FUNCREF = 377
  HL_GENERIC_ASOC = 378
  ...
  HL_IF = 382
  HL_IMAG = 383
  HL_IMPLICIT_CAST = 384
  HL_INDIRECT_CALL = 385
  HL_INDIRECT_GOTO = 386
  HL_INITLIST = 387
  HL_CONST_INIT = 388
  HL_LNOT = 389
  HL_LABEL_DECL = 390
  ...
  HL_PRE_DEC = 404
  HL_PRE_INC = 405
  HL_PREDEFINED_EXPR = 406
  HL_PREFERRED_ALIGNOF_EXPR = 407
  HL_PREFERRED_ALIGNOF_TYPE = 408
  HL_REAL = 409
  HL_MEMBER = 410
  HL_ASSIGN_FREM = 411
  HL_FREM = 412
