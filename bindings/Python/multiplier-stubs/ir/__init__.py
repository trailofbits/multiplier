...
class AttributeKind(IntEnum):
  ...
  HL_ALLOC_SIZE = 91
  HL_DEPRECATED = 92
  HL_MAX_FIELD_ALIGNMENT = 93
  HL_CV_QUALIFIERS = 94
  HL_UCV_QUALIFIERS = 95
  HL_CVR_QUALIFIERS = 96
  CORE_BOOLEAN = 97
  CORE_INTEGER = 98
  CORE_FLOAT = 99
  CORE_VOID = 100
  CORE_SOURCE_LANGUAGE = 101
  CORE_GLOBAL_LINKAGE_KIND = 102
  META_IDENTIFIER = 103
...
class OperationKind(IntEnum):
  ...
  HL_PRE_DEC = 400
  HL_PRE_INC = 401
  HL_PREDEFINED_EXPR = 402
  HL_PREFERRED_ALIGNOF_EXPR = 403
  HL_PREFERRED_ALIGNOF_TYPE = 404
  HL_REAL = 405
  HL_MEMBER = 406
  HL_ASSIGN_FREM = 407
  HL_FREM = 408
