...
enum class BPFPreserveStaticOffsetAttrSpelling : uint8_t;
...
enum class CodeAlignAttrSpelling : uint8_t;
enum class CodeModelAttrSpelling : uint8_t;
...
enum class CoroDisableLifetimeBoundAttrSpelling : uint8_t;
enum class CoroLifetimeBoundAttrSpelling : uint8_t;
enum class CoroOnlyDestroyWhenCompleteAttrSpelling : uint8_t;
enum class CoroReturnTypeAttrSpelling : uint8_t;
enum class CoroWrapperAttrSpelling : uint8_t;
enum class CountedByAttrSpelling : uint8_t;
...
enum class FunctionTypeAArch64SMETypeAttributes : uint8_t;
enum class FunctionTypeArmStateValue : uint8_t;
...
enum class HLSLParamModifierAttrSpelling : uint8_t;
...
enum class M68kRTDAttrSpelling : uint8_t;
...
enum class NoUniqueAddressAttrSpelling : uint8_t;
...
enum class PreferredTypeAttrSpelling : uint8_t;
...
enum class QualifiedTypeNonConstantStorageReason : uint8_t;
...
enum class SuppressAttrSpelling : uint8_t;
...
enum class ArraySizeModifier : uint8_t;
...
enum class CXXConstructionKind : uint8_t;
enum class CXXNewInitializationStyle : uint8_t;
enum class CallingConv : uint8_t;
enum class CanThrowResult : uint8_t;
enum class CapturedRegionKind : uint8_t;
enum class CastKind : uint8_t;
enum class CharacterLiteralKind : uint8_t;
...
enum class ComplexRangeKind : uint8_t;
enum class ConstantResultStorageKind : uint8_t;
...
enum class ImplicitParamKind : uint8_t;
...
enum class LinkageSpecLanguageIDs : uint8_t;
...
enum class OMPDeclareReductionInitKind : uint8_t;
enum class ObjCBridgeCastKind : uint8_t;
enum class ObjCImplementationControl : uint8_t;
...
enum class PragmaFPKind : uint8_t;
...
enum class SourceLocIdentKind : uint8_t;
...
enum class StringLiteralKind : uint8_t;
...
enum class VisibilityForcedKinds : uint8_t;
enum class VisibilityFromDLLStorageClassKinds : uint8_t;
...
class IRObject;
class IRStructure;
class IRScopeStructure;
class IRIfStructure;
class IRIfThenStructure;
class IRIfElseStructure;
class IRForStructure;
class IRWhileStructure;
class IRDoWhileStructure;
class IRSwitchStructure;
class IRSwitchCaseStructure;
class IRExpressionScopeStructure;
class TokenContext;
...
class MacroVAOpt;
class TokenTree;
enum class TokenTreeNodeKind : int32_t;
class TokenTreeNode;
...
class ConstInst;
class AllocaInst;
class LocalAllocaInst;
class ArgAllocaInst;
class ReturnAllocaInst;
class DynamicAllocaInst;
class MemoryInst;
class GEPFieldInst;
class PtrAddInst;
class PtrDiffInst;
class BinaryInst;
class ComparisonInst;
class UnaryInst;
class CastInst;
class CallInst;
...
class UndefinedInst;
class EnterScopeInst;
class ExitScopeInst;
class VAStartInst;
class VAEndInst;
class VACopyInst;
class ConsumeVAParamInst;
class RetInst;
class BranchInst;
