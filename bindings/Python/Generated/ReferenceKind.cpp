    ...
    reinterpret_cast<PyCFunction>(
        +[] (BorrowedPyObject *self, BorrowedPyObject * const *args, int num_args) -> SharedPyObject * {
          ...
          while (num_args == 2) {
            ...
            auto arg_1 = PythonBinding<mx::BuiltinReferenceKind>::from_python(args[1]);
            if (!arg_1.has_value()) {
              break;
            }
          ...
          while (num_args == 2) {
            ...
            auto arg_1 = PythonBinding<std::string_view>::from_python(args[1]);
            if (!arg_1.has_value()) {
              break;
            }
...
PyTypeObject *InitType(void) noexcept {
  ...
  tp->tp_init = [] (BorrowedPyObject *self, BorrowedPyObject *args, BorrowedPyObject *kwargs) -> int {
    if (kwargs && (!PyMapping_Check(kwargs) || PyMapping_Size(kwargs))) {
      PyErrorStreamer(PyExc_TypeError)
          << "'ReferenceKind.__init__' does not take any keyword arguments";
      return -1;
    }

    if (!args || !PySequence_Check(args)) {
      PyErrorStreamer(PyExc_TypeError)
          << "Invalid positional arguments passed to 'ReferenceKind.__init__'";
      return -1;
    }
