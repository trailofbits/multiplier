...
template MX_EXPORT std::optional<FromPythonReturnType<std::variant<std::monostate, mx::Fragment, mx::Decl, mx::Stmt, mx::Attr, mx::Macro, mx::Type, mx::File, mx::Token, mx::TemplateArgument, mx::TemplateParameterList, mx::CXXBaseSpecifier, mx::Designator, mx::Compilation, mx::ir::Operation>>::Type>
from_python<std::variant<std::monostate, mx::Fragment, mx::Decl, mx::Stmt, mx::Attr, mx::Macro, mx::Type, mx::File, mx::Token, mx::TemplateArgument, mx::TemplateParameterList, mx::CXXBaseSpecifier, mx::Designator, mx::Compilation, mx::ir::Operation>>(BorrowedPyObject *obj) noexcept;
...
template MX_EXPORT SharedPyObject *to_python<gap::generator<std::pair<mx::ClassScopeFunctionSpecializationDecl, mx::ir::Operation>>>(gap::generator<std::pair<mx::ClassScopeFunctionSpecializationDecl, mx::ir::Operation>>) noexcept;
