...
template MX_EXPORT std::optional<FromPythonReturnType<std::optional<mx::MacroSubstitution>>::Type>
from_python<std::optional<mx::MacroSubstitution>>(BorrowedPyObject *obj) noexcept;
