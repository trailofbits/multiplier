...
std::optional<T> PythonBinding<T>::from_python(BorrowedPyObject *obj) noexcept {
  ...
  if (tp < &(gTypes[998]) || tp >= &(gTypes[1458])) {
    return std::nullopt;
  }
...
SharedPyObject *PythonBinding<T>::to_python(T val) noexcept {
  ...
  switch (val.kind()) {
    ...
    case mx::ir::hl::AttributedStmtOp::static_kind():
      tp = &(gTypes[1332]);
      break;
    ...
    case mx::ir::hl::FileScopeAsmOp::static_kind():
      tp = &(gTypes[1381]);
      break;
    ...
    case mx::ir::hl::GenericAssocExprOp::static_kind():
      tp = &(gTypes[1384]);
      break;
    ...
    case mx::ir::hl::NullStmtOp::static_kind():
      tp = &(gTypes[1403]);
      break;
    ...
    case mx::ir::hl::StaticAssertDeclOp::static_kind():
      tp = &(gTypes[1425]);
      break;
...
static PyGetSetDef gProperties[] = {
  ...
  },
  {
    ...
    reinterpret_cast<getter>(
        +[] (BorrowedPyObject *self, void * /* closure */) -> SharedPyObject * {
          return ::mx::to_python(T_cast(self)->previous());
        }),
    nullptr,
    PyDoc_STR("Wrapper for mx::ir::Operation::previous"),
    nullptr,
  },
  {
    "next",
    reinterpret_cast<getter>(
        +[] (BorrowedPyObject *self, void * /* closure */) -> SharedPyObject * {
          return ::mx::to_python(T_cast(self)->next());
        }),
    nullptr,
    PyDoc_STR("Wrapper for mx::ir::Operation::next"),
    nullptr,
  },
  {
    "is_terminator",
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::ir::Operation::is_terminator"),
    nullptr,
  },
  {
    "defined_symbol",
    reinterpret_cast<getter>(
        +[] (BorrowedPyObject *self, void * /* closure */) -> SharedPyObject * {
          return ::mx::to_python(T_cast(self)->defined_symbol());
        }),
    nullptr,
    PyDoc_STR("Wrapper for mx::ir::Operation::defined_symbol"),
    nullptr,
  },
  {}  // Sentinel.
};
  ...
  },
  {
    ...
    reinterpret_cast<PyCFunction>(
        +[] (BorrowedPyObject *, BorrowedPyObject * const *args, int num_args) -> SharedPyObject * {
          (void) args;
          while (num_args == 1) {
            auto arg_0 = ::mx::from_python<mx::ir::Symbol>(args[0]);
            if (!arg_0.has_value()) {
              break;
            }

            return ::mx::to_python(T::defining(arg_0.value()));
          }

          PyErrorStreamer(PyExc_TypeError)
              << "Invalid arguments passed to 'defining'";
          return nullptr;
        }),
    METH_FASTCALL | METH_STATIC,
    PyDoc_STR("Wrapper for mx::ir::Operation::defining"),
  },
  {
    "nth_operand",
    reinterpret_cast<PyCFunction>(
...
PyTypeObject *InitType(void) noexcept {
  PyTypeObject * const tp = &(gTypes[998]);
