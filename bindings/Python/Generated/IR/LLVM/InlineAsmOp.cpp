...
namespace {
using T = mx::ir::llvm::InlineAsmOp;
...
std::optional<T> PythonBinding<T>::from_python(BorrowedPyObject *obj) noexcept {
  ...
  if (tp < &(gTypes[978]) || tp >= &(gTypes[979])) {
    return std::nullopt;
  }
...
bool PythonBinding<T>::load(BorrowedPyObject *module) noexcept {
  ...
  if (0 != PyModule_AddObjectRef(module, "InlineAsmOp", tp_obj)) {
    return false;
  }
...
static PyGetSetDef gProperties[] = {
  {
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::ir::llvm::InlineAsmOp::operands"),
    nullptr,
  },
  {
    "res",
  ...
  },
  {
    ...
    reinterpret_cast<getter>(
        +[] (BorrowedPyObject *self, void * /* closure */) -> SharedPyObject * {
          return ::mx::to_python(T_cast(self)->constraints());
        }),
    nullptr,
    PyDoc_STR("Wrapper for mx::ir::llvm::InlineAsmOp::constraints"),
    nullptr,
  },
  {
    "has_side_effects",
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::ir::llvm::InlineAsmOp::has_side_effects"),
    nullptr,
  },
  {
    "is_align_stack",
    reinterpret_cast<getter>(
        +[] (BorrowedPyObject *self, void * /* closure */) -> SharedPyObject * {
          return ::mx::to_python(T_cast(self)->is_align_stack());
        }),
    nullptr,
    PyDoc_STR("Wrapper for mx::ir::llvm::InlineAsmOp::is_align_stack"),
    nullptr,
  },
  {}  // Sentinel.
};
...
static PyMethodDef gMethods[] = {
  {
    ...
    PyDoc_STR("Wrapper for mx::ir::llvm::InlineAsmOp::static_kind"),
  },
  {
    "FROM",
    reinterpret_cast<PyCFunction>(
    ...
    METH_FASTCALL | METH_STATIC,
    PyDoc_STR("Wrapper for mx::ir::llvm::InlineAsmOp::from"),
  },
  {
    "producing",
    reinterpret_cast<PyCFunction>(
    ...
    METH_FASTCALL | METH_STATIC,
    PyDoc_STR("Wrapper for mx::ir::llvm::InlineAsmOp::producing"),
  },
  {}  // Sentinel.
};
}  // namespace
...
PyTypeObject *InitType(void) noexcept {
  PyTypeObject * const tp = &(gTypes[978]);
  ...
  tp->tp_name = "multiplier.ir.llvm.InlineAsmOp";
  tp->tp_flags = Py_TPFLAGS_DEFAULT | Py_TPFLAGS_DISALLOW_INSTANTIATION;
  tp->tp_doc = PyDoc_STR("Wrapper for mx::ir::llvm::::InlineAsmOp");
