...
static PyGetSetDef gProperties[] = {
  ...
  },
  {
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::ir::llvm::GlobalOp::constant"),
    nullptr,
  },
  {
    "sym_name",
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::ir::llvm::GlobalOp::sym_name"),
    nullptr,
  },
  {
    "dso_local",
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::ir::llvm::GlobalOp::dso_local"),
    nullptr,
  },
  {
    "thread_local__",
    reinterpret_cast<getter>(
        +[] (BorrowedPyObject *self, void * /* closure */) -> SharedPyObject * {
          return ::mx::to_python(T_cast(self)->thread_local__());
        }),
    nullptr,
    PyDoc_STR("Wrapper for mx::ir::llvm::GlobalOp::thread_local__"),
    nullptr,
  },
  {
    "addr_space",
    reinterpret_cast<getter>(
        +[] (BorrowedPyObject *self, void * /* closure */) -> SharedPyObject * {
          return ::mx::to_python(T_cast(self)->addr_space());
        }),
    nullptr,
...
static PyMethodDef gMethods[] = {
  {
    ...
    PyDoc_STR("Wrapper for mx::ir::llvm::GlobalOp::static_kind"),
  },
  {
    "FROM",
    reinterpret_cast<PyCFunction>(
    ...
    METH_FASTCALL | METH_STATIC,
    PyDoc_STR("Wrapper for mx::ir::llvm::GlobalOp::from"),
  },
  {
    "producing",
    reinterpret_cast<PyCFunction>(
    ...
    METH_FASTCALL | METH_STATIC,
    PyDoc_STR("Wrapper for mx::ir::llvm::GlobalOp::producing"),
  },
  {}  // Sentinel.
};
}  // namespace
...
PyTypeObject *InitType(void) noexcept {
  ...
  tp->tp_name = "multiplier.ir.llvm.GlobalOp";
  tp->tp_flags = Py_TPFLAGS_DEFAULT | Py_TPFLAGS_DISALLOW_INSTANTIATION;
  tp->tp_doc = PyDoc_STR("Wrapper for mx::ir::llvm::::GlobalOp");
