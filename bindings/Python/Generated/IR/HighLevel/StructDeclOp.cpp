...
bool PythonBinding<T>::load(BorrowedPyObject *module) noexcept {
  ...
  if (0 != PyModule_AddObjectRef(module, "StructDeclOp", tp_obj)) {
    return false;
  }
...
static PyGetSetDef gProperties[] = {
  ...
  },
  {
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::ir::hl::StructDeclOp::sym_name"),
    nullptr,
  },
  {
    "field_types",
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::ir::hl::StructDeclOp::field_types"),
    nullptr,
  },
  {
    "defined_type",
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::ir::hl::StructDeclOp::defined_type"),
    nullptr,
  },
  {
  ...
  },
  {
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::ir::hl::StructDeclOp::fields_block"),
    nullptr,
  },
  {}  // Sentinel.
};
...
static PyMethodDef gMethods[] = {
  {
    ...
    PyDoc_STR("Wrapper for mx::ir::hl::StructDeclOp::static_kind"),
  },
  {
    "FROM",
    reinterpret_cast<PyCFunction>(
    ...
    METH_FASTCALL | METH_STATIC,
    PyDoc_STR("Wrapper for mx::ir::hl::StructDeclOp::from"),
  },
  {
    "producing",
    reinterpret_cast<PyCFunction>(
    ...
    METH_FASTCALL | METH_STATIC,
    PyDoc_STR("Wrapper for mx::ir::hl::StructDeclOp::producing"),
  },
  {}  // Sentinel.
};
}  // namespace
...
PyTypeObject *InitType(void) noexcept {
  ...
  tp->tp_name = "multiplier.ir.highlevel.StructDeclOp";
  tp->tp_flags = Py_TPFLAGS_DEFAULT | Py_TPFLAGS_DISALLOW_INSTANTIATION;
  tp->tp_doc = PyDoc_STR("Wrapper for mx::ir::hl::::StructDeclOp");
  ...
  tp->tp_init = [] (BorrowedPyObject *self, BorrowedPyObject *args, BorrowedPyObject *kwargs) -> int {
    if (kwargs && (!PyMapping_Check(kwargs) || PyMapping_Size(kwargs))) {
      PyErrorStreamer(PyExc_TypeError)
          << "'StructDeclOp.__init__' does not take any keyword arguments";
      return -1;
    }

    if (!args || !PySequence_Check(args)) {
      PyErrorStreamer(PyExc_TypeError)
          << "Invalid positional arguments passed to 'StructDeclOp.__init__'";
      return -1;
    }
    ...
    (void) num_args;
    PyErrorStreamer(PyExc_TypeError)
        << "Class 'StructDeclOp' cannot be directly instantiated";
    return -1;
