...
bool PythonBinding<T>::load(BorrowedPyObject *module) noexcept {
  ...
  if (0 != PyModule_AddObjectRef(module, "DefaultStmt", tp_obj)) {
    return false;
  }
...
static PyGetSetDef gProperties[] = {
  {
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::DefaultStmt::default_token"),
    nullptr,
  },
  {}  // Sentinel.
};
...
static PyMethodDef gMethods[] = {
  {
    ...
    PyDoc_STR("Wrapper for mx::DefaultStmt::in"),
  },
  {
    "containing",
    reinterpret_cast<PyCFunction>(
    ...
    METH_FASTCALL | METH_STATIC,
    PyDoc_STR("Wrapper for mx::DefaultStmt::containing"),
  },
  {
    "static_kind",
    reinterpret_cast<PyCFunction>(
    ...
    METH_FASTCALL | METH_STATIC,
    PyDoc_STR("Wrapper for mx::DefaultStmt::static_kind"),
  },
  {
    "by_id",
    reinterpret_cast<PyCFunction>(
    ...
    METH_FASTCALL | METH_STATIC,
    PyDoc_STR("Wrapper for mx::DefaultStmt::by_id"),
  },
  {
    "from_base",
    reinterpret_cast<PyCFunction>(
    ...
    METH_FASTCALL | METH_STATIC,
    PyDoc_STR("Wrapper for mx::DefaultStmt::from_base"),
  },
  {
    "FROM",
    reinterpret_cast<PyCFunction>(
    ...
    METH_FASTCALL | METH_STATIC,
    PyDoc_STR("Wrapper for mx::DefaultStmt::from"),
  },
  {}  // Sentinel.
};
}  // namespace
...
PyTypeObject *InitType(void) noexcept {
  ...
  tp->tp_name = "multiplier.ast.DefaultStmt";
  tp->tp_flags = Py_TPFLAGS_DEFAULT | Py_TPFLAGS_DISALLOW_INSTANTIATION;
  tp->tp_doc = PyDoc_STR("Wrapper for mx::::DefaultStmt");
  tp->tp_as_number = nullptr;
  tp->tp_as_sequence = nullptr;
  tp->tp_as_mapping = nullptr;
  tp->tp_hash = gTypes[724].tp_hash;
  tp->tp_richcompare = gTypes[724].tp_richcompare;
  tp->tp_iter = nullptr;
  tp->tp_methods = gMethods;
  tp->tp_getset = gProperties;
  tp->tp_base = &(gTypes[724]);
  tp->tp_init = [] (BorrowedPyObject *self, BorrowedPyObject *args, BorrowedPyObject *kwargs) -> int {
    if (kwargs && (!PyMapping_Check(kwargs) || PyMapping_Size(kwargs))) {
      PyErrorStreamer(PyExc_TypeError)
          << "'DefaultStmt.__init__' does not take any keyword arguments";
      return -1;
    }

    if (!args || !PySequence_Check(args)) {
      PyErrorStreamer(PyExc_TypeError)
          << "Invalid positional arguments passed to 'DefaultStmt.__init__'";
      return -1;
    }
    ...
    (void) num_args;
    PyErrorStreamer(PyExc_TypeError)
        << "Class 'DefaultStmt' cannot be directly instantiated";
    return -1;
