...
namespace {
using T = mx::OSReturnsRetainedOnZeroAttr;
...
std::optional<T> PythonBinding<T>::from_python(BorrowedPyObject *obj) noexcept {
  ...
  if (tp < &(gTypes[329]) || tp >= &(gTypes[330])) {
    return std::nullopt;
  }
...
bool PythonBinding<T>::load(BorrowedPyObject *module) noexcept {
  ...
  if (0 != PyModule_AddObjectRef(module, "OSReturnsRetainedOnZeroAttr", tp_obj)) {
    return false;
  }
...
static PyMethodDef gMethods[] = {
  {
    ...
    PyDoc_STR("Wrapper for mx::OSReturnsRetainedOnZeroAttr::in"),
  },
  {
    "containing",
    reinterpret_cast<PyCFunction>(
    ...
    METH_FASTCALL | METH_STATIC,
    PyDoc_STR("Wrapper for mx::OSReturnsRetainedOnZeroAttr::containing"),
  },
  {
    "static_kind",
    reinterpret_cast<PyCFunction>(
    ...
    METH_FASTCALL | METH_STATIC,
    PyDoc_STR("Wrapper for mx::OSReturnsRetainedOnZeroAttr::static_kind"),
  },
  {
    "by_id",
    reinterpret_cast<PyCFunction>(
    ...
    METH_FASTCALL | METH_STATIC,
    PyDoc_STR("Wrapper for mx::OSReturnsRetainedOnZeroAttr::by_id"),
  },
  {
    "from_base",
    reinterpret_cast<PyCFunction>(
    ...
    METH_FASTCALL | METH_STATIC,
    PyDoc_STR("Wrapper for mx::OSReturnsRetainedOnZeroAttr::from_base"),
  },
  {
    "FROM",
    reinterpret_cast<PyCFunction>(
    ...
    METH_FASTCALL | METH_STATIC,
    PyDoc_STR("Wrapper for mx::OSReturnsRetainedOnZeroAttr::from"),
  },
  {
    "contains",
    reinterpret_cast<PyCFunction>(
    ...
    METH_FASTCALL,
    PyDoc_STR("Wrapper for mx::OSReturnsRetainedOnZeroAttr::contains"),
  },
  {}  // Sentinel.
};
}  // namespace
...
PyTypeObject *InitType(void) noexcept {
  PyTypeObject * const tp = &(gTypes[329]);
  ...
  tp->tp_name = "multiplier.ast.OSReturnsRetainedOnZeroAttr";
  tp->tp_flags = Py_TPFLAGS_DEFAULT | Py_TPFLAGS_DISALLOW_INSTANTIATION;
  tp->tp_doc = PyDoc_STR("Wrapper for mx::::OSReturnsRetainedOnZeroAttr");
  ...
  tp->tp_init = [] (BorrowedPyObject *self, BorrowedPyObject *args, BorrowedPyObject *kwargs) -> int {
    if (kwargs && (!PyMapping_Check(kwargs) || PyMapping_Size(kwargs))) {
      PyErrorStreamer(PyExc_TypeError)
          << "'OSReturnsRetainedOnZeroAttr.__init__' does not take any keyword arguments";
      return -1;
    }

    if (!args || !PySequence_Check(args)) {
      PyErrorStreamer(PyExc_TypeError)
          << "Invalid positional arguments passed to 'OSReturnsRetainedOnZeroAttr.__init__'";
      return -1;
    }
    ...
    (void) num_args;
    PyErrorStreamer(PyExc_TypeError)
        << "Class 'OSReturnsRetainedOnZeroAttr' cannot be directly instantiated";
    return -1;
