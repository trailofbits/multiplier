...
static PyGetSetDef gProperties[] = {
  {
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::LValueReferenceType::desugar"),
    nullptr,
  },
  {
    "is_sugared",
...
PyTypeObject *InitType(void) noexcept {
  ...
  tp->tp_hash = PythonBinding<mx::ReferenceType>::type()->tp_hash;
  tp->tp_richcompare = nullptr;
  tp->tp_iter = nullptr;
  tp->tp_methods = gMethods;
  tp->tp_getset = gProperties;
  tp->tp_base = PythonBinding<mx::ReferenceType>::type();
