...
namespace {
using T = mx::CXXDependentScopeMemberExpr;
...
std::optional<T> PythonBinding<T>::from_python(BorrowedPyObject *obj) noexcept {
  ...
  if (tp < &(gTypes[637]) || tp >= &(gTypes[638])) {
    return std::nullopt;
  }
...
bool PythonBinding<T>::load(BorrowedPyObject *module) noexcept {
  ...
  if (0 != PyModule_AddObjectRef(module, "CXXDependentScopeMemberExpr", tp_obj)) {
    return false;
  }
...
static PyGetSetDef gProperties[] = {
  {
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::CXXDependentScopeMemberExpr::base"),
    nullptr,
  },
  {
    "base_type",
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::CXXDependentScopeMemberExpr::base_type"),
    nullptr,
  },
  {
    ...
    reinterpret_cast<getter>(
        +[] (BorrowedPyObject *self, void * /* closure */) -> SharedPyObject * {
          return ::mx::to_python(T_cast(self)->first_qualifier_found_in_scope());
        }),
    nullptr,
    PyDoc_STR("Wrapper for mx::CXXDependentScopeMemberExpr::first_qualifier_found_in_scope"),
    nullptr,
  },
  {
    "l_angle_token",
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::CXXDependentScopeMemberExpr::l_angle_token"),
    nullptr,
  },
  {
    "member_token",
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::CXXDependentScopeMemberExpr::member_token"),
    nullptr,
  },
  {
    "operator_token",
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::CXXDependentScopeMemberExpr::operator_token"),
    nullptr,
  },
  {
    "r_angle_token",
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::CXXDependentScopeMemberExpr::r_angle_token"),
    nullptr,
  },
  {
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::CXXDependentScopeMemberExpr::template_keyword_token"),
    nullptr,
  },
  {
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::CXXDependentScopeMemberExpr::has_explicit_template_arguments"),
    nullptr,
  },
  {
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::CXXDependentScopeMemberExpr::has_template_keyword"),
    nullptr,
  },
  {
    "is_arrow",
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::CXXDependentScopeMemberExpr::is_arrow"),
    nullptr,
  },
  {
    "is_implicit_access",
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::CXXDependentScopeMemberExpr::is_implicit_access"),
    nullptr,
  },
  {}  // Sentinel.
};
...
static PyMethodDef gMethods[] = {
  {
    ...
    PyDoc_STR("Wrapper for mx::CXXDependentScopeMemberExpr::in"),
  },
  {
    "containing",
    reinterpret_cast<PyCFunction>(
    ...
    METH_FASTCALL | METH_STATIC,
    PyDoc_STR("Wrapper for mx::CXXDependentScopeMemberExpr::containing"),
  },
  {
    "static_kind",
    reinterpret_cast<PyCFunction>(
    ...
    METH_FASTCALL | METH_STATIC,
    PyDoc_STR("Wrapper for mx::CXXDependentScopeMemberExpr::static_kind"),
  },
  {
    "by_id",
    reinterpret_cast<PyCFunction>(
    ...
    METH_FASTCALL | METH_STATIC,
    PyDoc_STR("Wrapper for mx::CXXDependentScopeMemberExpr::by_id"),
  },
  {
    "from_base",
    reinterpret_cast<PyCFunction>(
    ...
    METH_FASTCALL | METH_STATIC,
    PyDoc_STR("Wrapper for mx::CXXDependentScopeMemberExpr::from_base"),
  },
  {
    "FROM",
    reinterpret_cast<PyCFunction>(
    ...
    METH_FASTCALL | METH_STATIC,
    PyDoc_STR("Wrapper for mx::CXXDependentScopeMemberExpr::from"),
  },
  {}  // Sentinel.
};
}  // namespace
...
PyTypeObject *InitType(void) noexcept {
  PyTypeObject * const tp = &(gTypes[637]);
  ...
  tp->tp_name = "multiplier.ast.CXXDependentScopeMemberExpr";
  tp->tp_flags = Py_TPFLAGS_DEFAULT | Py_TPFLAGS_DISALLOW_INSTANTIATION;
  tp->tp_doc = PyDoc_STR("Wrapper for mx::::CXXDependentScopeMemberExpr");
  tp->tp_as_number = nullptr;
  tp->tp_as_sequence = nullptr;
  tp->tp_as_mapping = nullptr;
  tp->tp_hash = gTypes[590].tp_hash;
  tp->tp_richcompare = gTypes[590].tp_richcompare;
  tp->tp_iter = nullptr;
  tp->tp_methods = gMethods;
  tp->tp_getset = gProperties;
  tp->tp_base = &(gTypes[590]);
  tp->tp_init = [] (BorrowedPyObject *self, BorrowedPyObject *args, BorrowedPyObject *kwargs) -> int {
    if (kwargs && (!PyMapping_Check(kwargs) || PyMapping_Size(kwargs))) {
      PyErrorStreamer(PyExc_TypeError)
          << "'CXXDependentScopeMemberExpr.__init__' does not take any keyword arguments";
      return -1;
    }

    if (!args || !PySequence_Check(args)) {
      PyErrorStreamer(PyExc_TypeError)
          << "Invalid positional arguments passed to 'CXXDependentScopeMemberExpr.__init__'";
      return -1;
    }
    ...
    (void) num_args;
    PyErrorStreamer(PyExc_TypeError)
        << "Class 'CXXDependentScopeMemberExpr' cannot be directly instantiated";
    return -1;
