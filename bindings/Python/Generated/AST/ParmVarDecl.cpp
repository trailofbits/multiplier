...
bool PythonBinding<T>::load(BorrowedPyObject *module) noexcept {
  ...
  if (0 != PyModule_AddObjectRef(module, "ParmVarDecl", tp_obj)) {
    return false;
  }
...
static PyGetSetDef gProperties[] = {
  ...
  {
    "explicit_object_parameter_this_token",
    reinterpret_cast<getter>(
        +[] (BorrowedPyObject *self, void * /* closure */) -> SharedPyObject * {
          return ::mx::to_python(T_cast(self)->explicit_object_parameter_this_token());
        }),
    nullptr,
    PyDoc_STR("Wrapper for mx::ParmVarDecl::explicit_object_parameter_this_token"),
    nullptr,
  },
  {
    "depth",
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::ParmVarDecl::depth"),
    nullptr,
  },
  {
    "index",
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::ParmVarDecl::index"),
    nullptr,
  },
  {
  ...
  },
  {
    ...
    reinterpret_cast<getter>(
        +[] (BorrowedPyObject *self, void * /* closure */) -> SharedPyObject * {
          return ::mx::to_python(T_cast(self)->is_explicit_object_parameter());
        }),
    nullptr,
    PyDoc_STR("Wrapper for mx::ParmVarDecl::is_explicit_object_parameter"),
    nullptr,
  },
  {
    "is_knr_promoted",
...
static PyMethodDef gMethods[] = {
  {
    ...
    PyDoc_STR("Wrapper for mx::ParmVarDecl::in"),
  },
  {
    "containing",
    reinterpret_cast<PyCFunction>(
    ...
    METH_FASTCALL | METH_STATIC,
    PyDoc_STR("Wrapper for mx::ParmVarDecl::containing"),
  },
  {
    "FROM",
    reinterpret_cast<PyCFunction>(
  ...
  },
  {
    ...
    METH_FASTCALL | METH_STATIC,
    PyDoc_STR("Wrapper for mx::ParmVarDecl::static_kind"),
  },
  {
    "by_id",
    reinterpret_cast<PyCFunction>(
    ...
    METH_FASTCALL | METH_STATIC,
    PyDoc_STR("Wrapper for mx::ParmVarDecl::by_id"),
  },
  {
    "from_base",
    reinterpret_cast<PyCFunction>(
    ...
    METH_FASTCALL | METH_STATIC,
    PyDoc_STR("Wrapper for mx::ParmVarDecl::from_base"),
  },
  {}  // Sentinel.
};
}  // namespace
...
PyTypeObject *InitType(void) noexcept {
  ...
  tp->tp_name = "multiplier.ast.ParmVarDecl";
  tp->tp_flags = Py_TPFLAGS_DEFAULT | Py_TPFLAGS_DISALLOW_INSTANTIATION;
  tp->tp_doc = PyDoc_STR("Wrapper for mx::::ParmVarDecl");
  ...
  tp->tp_init = [] (BorrowedPyObject *self, BorrowedPyObject *args, BorrowedPyObject *kwargs) -> int {
    if (kwargs && (!PyMapping_Check(kwargs) || PyMapping_Size(kwargs))) {
      PyErrorStreamer(PyExc_TypeError)
          << "'ParmVarDecl.__init__' does not take any keyword arguments";
      return -1;
    }

    if (!args || !PySequence_Check(args)) {
      PyErrorStreamer(PyExc_TypeError)
          << "Invalid positional arguments passed to 'ParmVarDecl.__init__'";
      return -1;
    }
    ...
    (void) num_args;
    PyErrorStreamer(PyExc_TypeError)
        << "Class 'ParmVarDecl' cannot be directly instantiated";
    return -1;
