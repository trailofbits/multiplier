...
std::optional<T> PythonBinding<T>::from_python(BorrowedPyObject *obj) noexcept {
  ...
  if (tp < &(gTypes[808]) || tp >= &(gTypes[809])) {
    return std::nullopt;
  }
...
bool PythonBinding<T>::load(BorrowedPyObject *module) noexcept {
  ...
  if (0 != PyModule_AddObjectRef(module, "ObjCCategoryDecl", tp_obj)) {
    return false;
  }
...
static PyGetSetDef gProperties[] = {
  {
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::ObjCCategoryDecl::canonical_declaration"),
    nullptr,
  },
  {
    "definition",
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::ObjCCategoryDecl::definition"),
    nullptr,
  },
  {
    "redeclarations",
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::ObjCCategoryDecl::redeclarations"),
    nullptr,
  },
  {
    "is_class_extension",
    reinterpret_cast<getter>(
        +[] (BorrowedPyObject *self, void * /* closure */) -> SharedPyObject * {
          return ::mx::to_python(T_cast(self)->is_class_extension());
        }),
    nullptr,
    PyDoc_STR("Wrapper for mx::ObjCCategoryDecl::is_class_extension"),
    nullptr,
  },
  {
    "category_name_token",
    reinterpret_cast<getter>(
        +[] (BorrowedPyObject *self, void * /* closure */) -> SharedPyObject * {
          return ::mx::to_python(T_cast(self)->category_name_token());
        }),
    nullptr,
    PyDoc_STR("Wrapper for mx::ObjCCategoryDecl::category_name_token"),
    nullptr,
  },
  {
    "class_interface",
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::ObjCCategoryDecl::class_interface"),
    nullptr,
  },
  {
    "implementation",
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::ObjCCategoryDecl::implementation"),
    nullptr,
  },
  {
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::ObjCCategoryDecl::instance_variable_l_brace_token"),
    nullptr,
  },
  {
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::ObjCCategoryDecl::instance_variable_r_brace_token"),
    nullptr,
  },
  {
    "next_class_category",
    reinterpret_cast<getter>(
        +[] (BorrowedPyObject *self, void * /* closure */) -> SharedPyObject * {
          return ::mx::to_python(T_cast(self)->next_class_category());
        }),
    nullptr,
    PyDoc_STR("Wrapper for mx::ObjCCategoryDecl::next_class_category"),
    nullptr,
  },
  {
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::ObjCCategoryDecl::num_instance_variables"),
    nullptr,
  },
  {
    "instance_variables",
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::ObjCCategoryDecl::instance_variables"),
    nullptr,
  },
  {
    "num_protocol_tokens",
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::ObjCCategoryDecl::num_protocol_tokens"),
    nullptr,
  },
  {
    "protocol_tokens",
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::ObjCCategoryDecl::protocol_tokens"),
    nullptr,
  },
  {
    "num_protocols",
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::ObjCCategoryDecl::num_protocols"),
    nullptr,
  },
  {
    "protocols",
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::ObjCCategoryDecl::protocols"),
    nullptr,
  },
  {}  // Sentinel.
};
...
static PyMethodDef gMethods[] = {
  {
    ...
    PyDoc_STR("Wrapper for mx::ObjCCategoryDecl::in"),
  },
  {
    "containing",
    reinterpret_cast<PyCFunction>(
    ...
    METH_FASTCALL | METH_STATIC,
    PyDoc_STR("Wrapper for mx::ObjCCategoryDecl::containing"),
  },
  {
    "static_kind",
    reinterpret_cast<PyCFunction>(
    ...
    METH_FASTCALL | METH_STATIC,
    PyDoc_STR("Wrapper for mx::ObjCCategoryDecl::static_kind"),
  },
  {
    "by_id",
    reinterpret_cast<PyCFunction>(
    ...
    METH_FASTCALL | METH_STATIC,
    PyDoc_STR("Wrapper for mx::ObjCCategoryDecl::by_id"),
  },
  {
    "from_base",
    reinterpret_cast<PyCFunction>(
    ...
    METH_FASTCALL | METH_STATIC,
    PyDoc_STR("Wrapper for mx::ObjCCategoryDecl::from_base"),
  },
  {
    "FROM",
    reinterpret_cast<PyCFunction>(
    ...
    METH_FASTCALL | METH_STATIC,
    PyDoc_STR("Wrapper for mx::ObjCCategoryDecl::from"),
  },
  {
    ...
    METH_FASTCALL,
    PyDoc_STR("Wrapper for mx::ObjCCategoryDecl::nth_instance_variable"),
  },
  {
    "nth_protocol_token",
    reinterpret_cast<PyCFunction>(
    ...
    METH_FASTCALL,
    PyDoc_STR("Wrapper for mx::ObjCCategoryDecl::nth_protocol_token"),
  },
  {
    "nth_protocol",
    reinterpret_cast<PyCFunction>(
    ...
    METH_FASTCALL,
    PyDoc_STR("Wrapper for mx::ObjCCategoryDecl::nth_protocol"),
  },
  {}  // Sentinel.
};
}  // namespace
...
PyTypeObject *InitType(void) noexcept {
  PyTypeObject * const tp = &(gTypes[808]);
  ...
  tp->tp_name = "multiplier.ast.ObjCCategoryDecl";
  tp->tp_flags = Py_TPFLAGS_DEFAULT | Py_TPFLAGS_DISALLOW_INSTANTIATION;
  tp->tp_doc = PyDoc_STR("Wrapper for mx::::ObjCCategoryDecl");
  tp->tp_as_number = nullptr;
  tp->tp_as_sequence = nullptr;
  tp->tp_as_mapping = nullptr;
  tp->tp_hash = gTypes[807].tp_hash;
  tp->tp_richcompare = gTypes[807].tp_richcompare;
  tp->tp_iter = nullptr;
  tp->tp_methods = gMethods;
  tp->tp_getset = gProperties;
  tp->tp_base = &(gTypes[807]);
  tp->tp_init = [] (BorrowedPyObject *self, BorrowedPyObject *args, BorrowedPyObject *kwargs) -> int {
    if (kwargs && (!PyMapping_Check(kwargs) || PyMapping_Size(kwargs))) {
      PyErrorStreamer(PyExc_TypeError)
          << "'ObjCCategoryDecl.__init__' does not take any keyword arguments";
      return -1;
    }

    if (!args || !PySequence_Check(args)) {
      PyErrorStreamer(PyExc_TypeError)
          << "Invalid positional arguments passed to 'ObjCCategoryDecl.__init__'";
      return -1;
    }
    ...
    (void) num_args;
    PyErrorStreamer(PyExc_TypeError)
        << "Class 'ObjCCategoryDecl' cannot be directly instantiated";
    return -1;
