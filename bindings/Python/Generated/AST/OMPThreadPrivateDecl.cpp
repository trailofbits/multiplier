...
std::optional<T> PythonBinding<T>::from_python(BorrowedPyObject *obj) noexcept {
  ...
  if (tp < &(gTypes[703]) || tp >= &(gTypes[704])) {
    return std::nullopt;
  }
    ...
    reinterpret_cast<PyCFunction>(
        +[] (BorrowedPyObject *self, BorrowedPyObject * const *args, int num_args) -> SharedPyObject * {
          ...
          while (num_args == 1) {
            ...
            return ::mx::to_python(obj->nth_varlist(arg_0.value()));
          }
...
static PyGetSetDef gProperties[] = {
  ...
  },
  {
    ...
    reinterpret_cast<getter>(
        +[] (BorrowedPyObject *self, void * /* closure */) -> SharedPyObject * {
          return ::mx::to_python(T_cast(self)->varlists());
        }),
    nullptr,
...
PyTypeObject *InitType(void) noexcept {
  PyTypeObject * const tp = &(gTypes[703]);
  ...
  tp->tp_hash = PythonBinding<mx::OMPDeclarativeDirectiveDecl>::type()->tp_hash;
  tp->tp_richcompare = nullptr;
  tp->tp_iter = nullptr;
  tp->tp_methods = gMethods;
  tp->tp_getset = gProperties;
  tp->tp_base = PythonBinding<mx::OMPDeclarativeDirectiveDecl>::type();
