...
SharedPyObject *PythonBinding<T>::to_python(T val) noexcept {
  ...
  switch (val.kind()) {
    ...
    case mx::CountedByAttr::static_kind():
      tp = &(gTypes[127]);
      break;

    case mx::CoroWrapperAttr::static_kind():
      tp = &(gTypes[128]);
      break;

    case mx::CoroReturnTypeAttr::static_kind():
      tp = &(gTypes[129]);
      break;

    case mx::CoroOnlyDestroyWhenCompleteAttr::static_kind():
      tp = &(gTypes[130]);
      break;

    case mx::CoroLifetimeBoundAttr::static_kind():
      tp = &(gTypes[131]);
      break;

    case mx::CoroDisableLifetimeBoundAttr::static_kind():
      tp = &(gTypes[132]);
      break;
    ...
    case mx::CodeModelAttr::static_kind():
      tp = &(gTypes[143]);
      break;
    ...
    case mx::BPFPreserveStaticOffsetAttr::static_kind():
      tp = &(gTypes[173]);
      break;
    ...
    case mx::ArmNewAttr::static_kind():
      tp = &(gTypes[184]);
      break;

    case mx::ArmLocallyStreamingAttr::static_kind():
      tp = &(gTypes[185]);
      break;
    ...
    case mx::SwiftImportPropertyAsAccessorsAttr::static_kind():
      tp = &(gTypes[252]);
      break;

    case mx::SwiftImportAsNonGenericAttr::static_kind():
      tp = &(gTypes[253]);
      break;
    ...
    case mx::PreferredTypeAttr::static_kind():
      tp = &(gTypes[294]);
      break;
    ...
    case mx::MSConstexprAttr::static_kind():
      tp = &(gTypes[381]);
      break;
    ...
    case mx::M68kRTDAttr::static_kind():
      tp = &(gTypes[385]);
      break;
...
bool PythonBinding<T>::load(BorrowedPyObject *module) noexcept {
  ...
  if (0 != PyModule_AddObjectRef(module, "InheritableAttr", tp_obj)) {
    return false;
  }
...
static PyMethodDef gMethods[] = {
  {
    ...
    PyDoc_STR("Wrapper for mx::InheritableAttr::in"),
  },
  {
    "containing",
    reinterpret_cast<PyCFunction>(
    ...
    METH_FASTCALL | METH_STATIC,
    PyDoc_STR("Wrapper for mx::InheritableAttr::containing"),
  },
  {
    "by_id",
    reinterpret_cast<PyCFunction>(
    ...
    METH_FASTCALL | METH_STATIC,
    PyDoc_STR("Wrapper for mx::InheritableAttr::by_id"),
  },
  {
    "from_base",
    reinterpret_cast<PyCFunction>(
    ...
    METH_FASTCALL | METH_STATIC,
    PyDoc_STR("Wrapper for mx::InheritableAttr::from_base"),
  },
  {
    "FROM",
    reinterpret_cast<PyCFunction>(
    ...
    METH_FASTCALL | METH_STATIC,
    PyDoc_STR("Wrapper for mx::InheritableAttr::from"),
  },
  {
    "contains",
    reinterpret_cast<PyCFunction>(
...
PyTypeObject *InitType(void) noexcept {
  PyTypeObject * const tp = &(gTypes[80]);
  ...
  tp->tp_name = "multiplier.ast.InheritableAttr";
  tp->tp_flags = Py_TPFLAGS_DEFAULT | Py_TPFLAGS_DISALLOW_INSTANTIATION;
  tp->tp_doc = PyDoc_STR("Wrapper for mx::::InheritableAttr");
  ...
  tp->tp_init = [] (BorrowedPyObject *self, BorrowedPyObject *args, BorrowedPyObject *kwargs) -> int {
    if (kwargs && (!PyMapping_Check(kwargs) || PyMapping_Size(kwargs))) {
      PyErrorStreamer(PyExc_TypeError)
          << "'InheritableAttr.__init__' does not take any keyword arguments";
      return -1;
    }

    if (!args || !PySequence_Check(args)) {
      PyErrorStreamer(PyExc_TypeError)
          << "Invalid positional arguments passed to 'InheritableAttr.__init__'";
      return -1;
    }
    ...
    (void) num_args;
    PyErrorStreamer(PyExc_TypeError)
        << "Class 'InheritableAttr' cannot be directly instantiated";
    return -1;
