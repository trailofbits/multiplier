...
namespace {
using T = mx::DependentScopeDeclRefExpr;
...
std::optional<T> PythonBinding<T>::from_python(BorrowedPyObject *obj) noexcept {
  ...
  if (tp < &(gTypes[593]) || tp >= &(gTypes[594])) {
    return std::nullopt;
  }
...
bool PythonBinding<T>::load(BorrowedPyObject *module) noexcept {
  ...
  if (0 != PyModule_AddObjectRef(module, "DependentScopeDeclRefExpr", tp_obj)) {
    return false;
  }
...
static PyGetSetDef gProperties[] = {
  {
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::DependentScopeDeclRefExpr::l_angle_token"),
    nullptr,
  },
  {
    "r_angle_token",
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::DependentScopeDeclRefExpr::r_angle_token"),
    nullptr,
  },
  {
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::DependentScopeDeclRefExpr::template_keyword_token"),
    nullptr,
  },
  {
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::DependentScopeDeclRefExpr::has_explicit_template_arguments"),
    nullptr,
  },
  {
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::DependentScopeDeclRefExpr::has_template_keyword"),
    nullptr,
  },
  {}  // Sentinel.
};
...
static PyMethodDef gMethods[] = {
  {
    ...
    PyDoc_STR("Wrapper for mx::DependentScopeDeclRefExpr::in"),
  },
  {
    "containing",
    reinterpret_cast<PyCFunction>(
    ...
    METH_FASTCALL | METH_STATIC,
    PyDoc_STR("Wrapper for mx::DependentScopeDeclRefExpr::containing"),
  },
  {
    "static_kind",
    reinterpret_cast<PyCFunction>(
    ...
    METH_FASTCALL | METH_STATIC,
    PyDoc_STR("Wrapper for mx::DependentScopeDeclRefExpr::static_kind"),
  },
  {
    "by_id",
    reinterpret_cast<PyCFunction>(
    ...
    METH_FASTCALL | METH_STATIC,
    PyDoc_STR("Wrapper for mx::DependentScopeDeclRefExpr::by_id"),
  },
  {
    "from_base",
    reinterpret_cast<PyCFunction>(
    ...
    METH_FASTCALL | METH_STATIC,
    PyDoc_STR("Wrapper for mx::DependentScopeDeclRefExpr::from_base"),
  },
  {
    "FROM",
    reinterpret_cast<PyCFunction>(
    ...
    METH_FASTCALL | METH_STATIC,
    PyDoc_STR("Wrapper for mx::DependentScopeDeclRefExpr::from"),
  },
  {}  // Sentinel.
};
}  // namespace
...
PyTypeObject *InitType(void) noexcept {
  PyTypeObject * const tp = &(gTypes[593]);
  ...
  tp->tp_name = "multiplier.ast.DependentScopeDeclRefExpr";
  tp->tp_flags = Py_TPFLAGS_DEFAULT | Py_TPFLAGS_DISALLOW_INSTANTIATION;
  tp->tp_doc = PyDoc_STR("Wrapper for mx::::DependentScopeDeclRefExpr");
  ...
  tp->tp_init = [] (BorrowedPyObject *self, BorrowedPyObject *args, BorrowedPyObject *kwargs) -> int {
    if (kwargs && (!PyMapping_Check(kwargs) || PyMapping_Size(kwargs))) {
      PyErrorStreamer(PyExc_TypeError)
          << "'DependentScopeDeclRefExpr.__init__' does not take any keyword arguments";
      return -1;
    }

    if (!args || !PySequence_Check(args)) {
      PyErrorStreamer(PyExc_TypeError)
          << "Invalid positional arguments passed to 'DependentScopeDeclRefExpr.__init__'";
      return -1;
    }
    ...
    (void) num_args;
    PyErrorStreamer(PyExc_TypeError)
        << "Class 'DependentScopeDeclRefExpr' cannot be directly instantiated";
    return -1;
