...
PyTypeObject *InitType(void) noexcept {
  PyTypeObject * const tp = &(gTypes[78]);
  ...
  tp->tp_hash = PythonBinding<mx::HLSLAnnotationAttr>::type()->tp_hash;
  tp->tp_richcompare = nullptr;
  tp->tp_iter = nullptr;
  tp->tp_methods = gMethods;
  tp->tp_getset = gProperties;
  tp->tp_base = PythonBinding<mx::HLSLAnnotationAttr>::type();
