...
bool PythonBinding<T>::load(BorrowedPyObject *module) noexcept {
  ...
  if (0 != PyModule_AddObjectRef(module, "CUDAConstantAttr", tp_obj)) {
    return false;
  }
...
static PyMethodDef gMethods[] = {
  {
    ...
    PyDoc_STR("Wrapper for mx::CUDAConstantAttr::in"),
  },
  {
    "containing",
    reinterpret_cast<PyCFunction>(
    ...
    METH_FASTCALL | METH_STATIC,
    PyDoc_STR("Wrapper for mx::CUDAConstantAttr::containing"),
  },
  {
    "static_kind",
    reinterpret_cast<PyCFunction>(
    ...
    METH_FASTCALL | METH_STATIC,
    PyDoc_STR("Wrapper for mx::CUDAConstantAttr::static_kind"),
  },
  {
    "by_id",
    reinterpret_cast<PyCFunction>(
    ...
    METH_FASTCALL | METH_STATIC,
    PyDoc_STR("Wrapper for mx::CUDAConstantAttr::by_id"),
  },
  {
    "from_base",
    reinterpret_cast<PyCFunction>(
    ...
    METH_FASTCALL | METH_STATIC,
    PyDoc_STR("Wrapper for mx::CUDAConstantAttr::from_base"),
  },
  {
    "FROM",
    reinterpret_cast<PyCFunction>(
    ...
    METH_FASTCALL | METH_STATIC,
    PyDoc_STR("Wrapper for mx::CUDAConstantAttr::from"),
  },
  {
    "contains",
    reinterpret_cast<PyCFunction>(
    ...
    METH_FASTCALL,
    PyDoc_STR("Wrapper for mx::CUDAConstantAttr::contains"),
  },
  {}  // Sentinel.
};
}  // namespace
...
PyTypeObject *InitType(void) noexcept {
  ...
  tp->tp_name = "multiplier.ast.CUDAConstantAttr";
  tp->tp_flags = Py_TPFLAGS_DEFAULT | Py_TPFLAGS_DISALLOW_INSTANTIATION;
  tp->tp_doc = PyDoc_STR("Wrapper for mx::::CUDAConstantAttr");
  ...
  tp->tp_init = [] (BorrowedPyObject *self, BorrowedPyObject *args, BorrowedPyObject *kwargs) -> int {
    if (kwargs && (!PyMapping_Check(kwargs) || PyMapping_Size(kwargs))) {
      PyErrorStreamer(PyExc_TypeError)
          << "'CUDAConstantAttr.__init__' does not take any keyword arguments";
      return -1;
    }

    if (!args || !PySequence_Check(args)) {
      PyErrorStreamer(PyExc_TypeError)
          << "Invalid positional arguments passed to 'CUDAConstantAttr.__init__'";
      return -1;
    }
    ...
    (void) num_args;
    PyErrorStreamer(PyExc_TypeError)
        << "Class 'CUDAConstantAttr' cannot be directly instantiated";
    return -1;
