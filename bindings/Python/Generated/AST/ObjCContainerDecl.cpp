...
std::optional<T> PythonBinding<T>::from_python(BorrowedPyObject *obj) noexcept {
  ...
  if (tp < &(gTypes[807]) || tp >= &(gTypes[814])) {
    return std::nullopt;
  }
...
bool PythonBinding<T>::load(BorrowedPyObject *module) noexcept {
  ...
  if (0 != PyModule_AddObjectRef(module, "ObjCContainerDecl", tp_obj)) {
    return false;
  }
...
static PyGetSetDef gProperties[] = {
  {
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::ObjCContainerDecl::canonical_declaration"),
    nullptr,
  },
  {
    "definition",
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::ObjCContainerDecl::definition"),
    nullptr,
  },
  {
    "redeclarations",
  ...
  },
  {
    ...
    reinterpret_cast<getter>(
        +[] (BorrowedPyObject *self, void * /* closure */) -> SharedPyObject * {
          return ::mx::to_python(T_cast(self)->num_class_methods());
        }),
    nullptr,
    PyDoc_STR("Wrapper for mx::ObjCContainerDecl::num_class_methods"),
    nullptr,
  },
  {
    "class_methods",
  ...
  },
  {
    ...
    reinterpret_cast<getter>(
        +[] (BorrowedPyObject *self, void * /* closure */) -> SharedPyObject * {
          return ::mx::to_python(T_cast(self)->num_class_properties());
        }),
    nullptr,
    PyDoc_STR("Wrapper for mx::ObjCContainerDecl::num_class_properties"),
    nullptr,
  },
  {
    "class_properties",
  ...
  },
  {
    ...
    reinterpret_cast<getter>(
        +[] (BorrowedPyObject *self, void * /* closure */) -> SharedPyObject * {
          return ::mx::to_python(T_cast(self)->at_end_range());
        }),
    nullptr,
    PyDoc_STR("Wrapper for mx::ObjCContainerDecl::at_end_range"),
    nullptr,
  },
  {
    "at_start_token",
    reinterpret_cast<getter>(
        +[] (BorrowedPyObject *self, void * /* closure */) -> SharedPyObject * {
          return ::mx::to_python(T_cast(self)->at_start_token());
        }),
    nullptr,
    PyDoc_STR("Wrapper for mx::ObjCContainerDecl::at_start_token"),
    nullptr,
  },
  {
    "num_instance_methods",
    reinterpret_cast<getter>(
        +[] (BorrowedPyObject *self, void * /* closure */) -> SharedPyObject * {
          return ::mx::to_python(T_cast(self)->num_instance_methods());
        }),
    nullptr,
    PyDoc_STR("Wrapper for mx::ObjCContainerDecl::num_instance_methods"),
    nullptr,
  },
  {
    "instance_methods",
  ...
  {
    "num_instance_properties",
    reinterpret_cast<getter>(
        +[] (BorrowedPyObject *self, void * /* closure */) -> SharedPyObject * {
          return ::mx::to_python(T_cast(self)->num_instance_properties());
        }),
    nullptr,
    PyDoc_STR("Wrapper for mx::ObjCContainerDecl::num_instance_properties"),
    nullptr,
  },
  {
    "instance_properties",
  ...
  },
  {
    ...
    reinterpret_cast<getter>(
        +[] (BorrowedPyObject *self, void * /* closure */) -> SharedPyObject * {
          return ::mx::to_python(T_cast(self)->num_methods());
        }),
    nullptr,
    PyDoc_STR("Wrapper for mx::ObjCContainerDecl::num_methods"),
    nullptr,
  },
  {
    "methods",
  ...
  },
  {
    ...
    reinterpret_cast<getter>(
        +[] (BorrowedPyObject *self, void * /* closure */) -> SharedPyObject * {
          return ::mx::to_python(T_cast(self)->num_properties());
        }),
    nullptr,
    PyDoc_STR("Wrapper for mx::ObjCContainerDecl::num_properties"),
    nullptr,
  },
  {
    "properties",
  ...
  },
  {
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::ObjCContainerDecl::contained_declarations"),
    nullptr,
  },
  {}  // Sentinel.
};
...
static PyMethodDef gMethods[] = {
  {
    ...
    PyDoc_STR("Wrapper for mx::ObjCContainerDecl::in"),
  },
  {
    "containing",
    reinterpret_cast<PyCFunction>(
    ...
    METH_FASTCALL | METH_STATIC,
    PyDoc_STR("Wrapper for mx::ObjCContainerDecl::containing"),
  },
  {
    "by_id",
    reinterpret_cast<PyCFunction>(
    ...
    METH_FASTCALL | METH_STATIC,
    PyDoc_STR("Wrapper for mx::ObjCContainerDecl::by_id"),
  },
  {
    "from_base",
    reinterpret_cast<PyCFunction>(
    ...
    METH_FASTCALL | METH_STATIC,
    PyDoc_STR("Wrapper for mx::ObjCContainerDecl::from_base"),
  },
  {
    "FROM",
    reinterpret_cast<PyCFunction>(
    ...
    METH_FASTCALL | METH_STATIC,
    PyDoc_STR("Wrapper for mx::ObjCContainerDecl::from"),
  },
  {
    "nth_class_method",
    reinterpret_cast<PyCFunction>(
        +[] (BorrowedPyObject *self, BorrowedPyObject * const *args, int num_args) -> SharedPyObject * {
          ...
          PyErrorStreamer(PyExc_TypeError)
              << "Invalid arguments passed to 'nth_class_method'";
          return nullptr;
        }),
    METH_FASTCALL,
    PyDoc_STR("Wrapper for mx::ObjCContainerDecl::nth_class_method"),
  },
  {
    "nth_class_propertie",
    reinterpret_cast<PyCFunction>(
        +[] (BorrowedPyObject *self, BorrowedPyObject * const *args, int num_args) -> SharedPyObject * {
          ...
          PyErrorStreamer(PyExc_TypeError)
              << "Invalid arguments passed to 'nth_class_propertie'";
          return nullptr;
        }),
    METH_FASTCALL,
    PyDoc_STR("Wrapper for mx::ObjCContainerDecl::nth_class_propertie"),
  },
  {
    "nth_instance_method",
    reinterpret_cast<PyCFunction>(
        +[] (BorrowedPyObject *self, BorrowedPyObject * const *args, int num_args) -> SharedPyObject * {
          ...
          PyErrorStreamer(PyExc_TypeError)
              << "Invalid arguments passed to 'nth_instance_method'";
          return nullptr;
        }),
    METH_FASTCALL,
    PyDoc_STR("Wrapper for mx::ObjCContainerDecl::nth_instance_method"),
  },
  {
    "nth_instance_propertie",
    reinterpret_cast<PyCFunction>(
        +[] (BorrowedPyObject *self, BorrowedPyObject * const *args, int num_args) -> SharedPyObject * {
          T *obj = T_cast(self);
          (void) args;
          ...
          PyErrorStreamer(PyExc_TypeError)
              << "Invalid arguments passed to 'nth_instance_propertie'";
          return nullptr;
        }),
    METH_FASTCALL,
    PyDoc_STR("Wrapper for mx::ObjCContainerDecl::nth_instance_propertie"),
  },
  {
    "nth_method",
    reinterpret_cast<PyCFunction>(
        +[] (BorrowedPyObject *self, BorrowedPyObject * const *args, int num_args) -> SharedPyObject * {
          ...
          PyErrorStreamer(PyExc_TypeError)
              << "Invalid arguments passed to 'nth_method'";
          return nullptr;
        }),
    METH_FASTCALL,
    PyDoc_STR("Wrapper for mx::ObjCContainerDecl::nth_method"),
  },
  {
    "nth_propertie",
    reinterpret_cast<PyCFunction>(
        +[] (BorrowedPyObject *self, BorrowedPyObject * const *args, int num_args) -> SharedPyObject * {
          ...
          PyErrorStreamer(PyExc_TypeError)
              << "Invalid arguments passed to 'nth_propertie'";
          return nullptr;
        }),
    METH_FASTCALL,
    PyDoc_STR("Wrapper for mx::ObjCContainerDecl::nth_propertie"),
  },
  {}  // Sentinel.
};
}  // namespace
...
PyTypeObject *InitType(void) noexcept {
  ...
  tp->tp_name = "multiplier.ast.ObjCContainerDecl";
  tp->tp_flags = Py_TPFLAGS_DEFAULT | Py_TPFLAGS_DISALLOW_INSTANTIATION;
  tp->tp_doc = PyDoc_STR("Wrapper for mx::::ObjCContainerDecl");
  ...
  tp->tp_init = [] (BorrowedPyObject *self, BorrowedPyObject *args, BorrowedPyObject *kwargs) -> int {
    if (kwargs && (!PyMapping_Check(kwargs) || PyMapping_Size(kwargs))) {
      PyErrorStreamer(PyExc_TypeError)
          << "'ObjCContainerDecl.__init__' does not take any keyword arguments";
      return -1;
    }

    if (!args || !PySequence_Check(args)) {
      PyErrorStreamer(PyExc_TypeError)
          << "Invalid positional arguments passed to 'ObjCContainerDecl.__init__'";
      return -1;
    }
    ...
    (void) num_args;
    PyErrorStreamer(PyExc_TypeError)
        << "Class 'ObjCContainerDecl' cannot be directly instantiated";
    return -1;
