...
std::optional<T> PythonBinding<T>::from_python(BorrowedPyObject *obj) noexcept {
  ...
  if (tp < &(gTypes[385]) || tp >= &(gTypes[448])) {
    return std::nullopt;
  }
...
static PyGetSetDef gProperties[] = {
  ...
  },
  {
    ...
    reinterpret_cast<getter>(
        +[] (BorrowedPyObject *self, void * /* closure */) -> SharedPyObject * {
          return ::mx::to_python(T_cast(self)->is_vlst_builtin_type());
        }),
    nullptr,
    PyDoc_STR("Wrapper for mx::Type::is_vlst_builtin_type"),
    nullptr,
  },
  {}  // Sentinel.
};
    ...
    reinterpret_cast<PyCFunction>(
        +[] (BorrowedPyObject *self, BorrowedPyObject * const *args, int num_args) -> SharedPyObject * {
          ...
          while (num_args == 2) {
            ...
            auto arg_1 = PythonBinding<std::span<mx::TypeKind>>::from_python(args[1]);
            if (!arg_1.has_value()) {
              break;
            }

            return ::mx::to_python(obj->in(arg_0.value(), arg_1.value()));
          }
          while (num_args == 1) {
            auto arg_0 = PythonBinding<mx::Index>::from_python(args[0]);
            if (!arg_0.has_value()) {
