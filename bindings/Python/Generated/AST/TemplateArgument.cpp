...
bool PythonBinding<T>::load(BorrowedPyObject *module) noexcept {
  ...
  if (0 != PyModule_AddObjectRef(module, "TemplateArgument", tp_obj)) {
    return false;
  }
...
static PyGetSetDef gProperties[] = {
  {
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::TemplateArgument::parent_declaration"),
    nullptr,
  },
  {
    "parent_statement",
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::TemplateArgument::parent_statement"),
    nullptr,
  },
  {
    "id",
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::TemplateArgument::id"),
    nullptr,
  },
  {
    "kind",
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::TemplateArgument::kind"),
    nullptr,
  },
  {
    "is_empty",
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::TemplateArgument::is_empty"),
    nullptr,
  },
  {
    "is_dependent",
    reinterpret_cast<getter>(
        +[] (BorrowedPyObject *self, void * /* closure */) -> SharedPyObject * {
          return ::mx::to_python(T_cast(self)->is_dependent());
        }),
    nullptr,
    PyDoc_STR("Wrapper for mx::TemplateArgument::is_dependent"),
    nullptr,
  },
  {
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::TemplateArgument::is_instantiation_dependent"),
    nullptr,
  },
  {
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::TemplateArgument::contains_unexpanded_parameter_pack"),
    nullptr,
  },
  {
    "is_pack_expansion",
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::TemplateArgument::is_pack_expansion"),
    nullptr,
  },
  {
    "declaration",
  ...
  },
  {
    ...
    reinterpret_cast<getter>(
        +[] (BorrowedPyObject *self, void * /* closure */) -> SharedPyObject * {
          return ::mx::to_python(T_cast(self)->parameter_type_for_declaration());
        }),
    nullptr,
    PyDoc_STR("Wrapper for mx::TemplateArgument::parameter_type_for_declaration"),
    nullptr,
  },
  {
    "null_pointer_type",
    reinterpret_cast<getter>(
        +[] (BorrowedPyObject *self, void * /* closure */) -> SharedPyObject * {
          return ::mx::to_python(T_cast(self)->null_pointer_type());
        }),
    nullptr,
    PyDoc_STR("Wrapper for mx::TemplateArgument::null_pointer_type"),
    nullptr,
  },
  {
    "expression",
...
static PyMethodDef gMethods[] = {
  {
    ...
    PyDoc_STR("Wrapper for mx::TemplateArgument::static_category"),
  },
  {
    "IN",
    reinterpret_cast<PyCFunction>(
    ...
    METH_FASTCALL | METH_STATIC,
    PyDoc_STR("Wrapper for mx::TemplateArgument::in"),
  },
  {
    "containing",
    reinterpret_cast<PyCFunction>(
    ...
    METH_FASTCALL | METH_STATIC,
    PyDoc_STR("Wrapper for mx::TemplateArgument::containing"),
  },
  {
    "by_id",
    reinterpret_cast<PyCFunction>(
    ...
    METH_FASTCALL | METH_STATIC,
    PyDoc_STR("Wrapper for mx::TemplateArgument::by_id"),
  },
  {
    "FROM",
    reinterpret_cast<PyCFunction>(
        +[] (BorrowedPyObject *, BorrowedPyObject * const *args, int num_args) -> SharedPyObject * {
          ...
          while (num_args == 1) {
            auto arg_0 = ::mx::from_python<std::optional<mx::TemplateArgument>>(args[0]);
            if (!arg_0.has_value()) {
              break;
            }
  ...
  },
  {
    ...
    METH_FASTCALL,
    PyDoc_STR("Wrapper for mx::TemplateArgument::contains"),
  },
  {
    "nth_pack_argument",
    reinterpret_cast<PyCFunction>(
...
PyTypeObject *InitType(void) noexcept {
  ...
  tp->tp_name = "multiplier.ast.TemplateArgument";
  tp->tp_flags = Py_TPFLAGS_DEFAULT | Py_TPFLAGS_DISALLOW_INSTANTIATION;
  tp->tp_doc = PyDoc_STR("Wrapper for mx::::TemplateArgument");
  ...
  tp->tp_init = [] (BorrowedPyObject *self, BorrowedPyObject *args, BorrowedPyObject *kwargs) -> int {
    if (kwargs && (!PyMapping_Check(kwargs) || PyMapping_Size(kwargs))) {
      PyErrorStreamer(PyExc_TypeError)
          << "'TemplateArgument.__init__' does not take any keyword arguments";
      return -1;
    }

    if (!args || !PySequence_Check(args)) {
      PyErrorStreamer(PyExc_TypeError)
          << "Invalid positional arguments passed to 'TemplateArgument.__init__'";
      return -1;
    }
    ...
    (void) num_args;
    PyErrorStreamer(PyExc_TypeError)
        << "Class 'TemplateArgument' cannot be directly instantiated";
    return -1;
