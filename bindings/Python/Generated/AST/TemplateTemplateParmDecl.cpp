...
namespace {
using T = mx::TemplateTemplateParmDecl;
...
bool PythonBinding<T>::load(BorrowedPyObject *module) noexcept {
  ...
  if (0 != PyModule_AddObjectRef(module, "TemplateTemplateParmDecl", tp_obj)) {
    return false;
  }
...
static PyGetSetDef gProperties[] = {
  {
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::TemplateTemplateParmDecl::canonical_declaration"),
    nullptr,
  },
  {
    "definition",
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::TemplateTemplateParmDecl::definition"),
    nullptr,
  },
  {
    "redeclarations",
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::TemplateTemplateParmDecl::redeclarations"),
    nullptr,
  },
  {
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::TemplateTemplateParmDecl::default_argument_was_inherited"),
    nullptr,
  },
  {
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::TemplateTemplateParmDecl::default_argument_token"),
    nullptr,
  },
  {
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::TemplateTemplateParmDecl::has_default_argument"),
    nullptr,
  },
  {
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::TemplateTemplateParmDecl::is_expanded_parameter_pack"),
    nullptr,
  },
  {
    "is_pack_expansion",
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::TemplateTemplateParmDecl::is_pack_expansion"),
    nullptr,
  },
  {}  // Sentinel.
};
...
static PyMethodDef gMethods[] = {
  {
    ...
    PyDoc_STR("Wrapper for mx::TemplateTemplateParmDecl::in"),
  },
  {
    "containing",
    reinterpret_cast<PyCFunction>(
    ...
    METH_FASTCALL | METH_STATIC,
    PyDoc_STR("Wrapper for mx::TemplateTemplateParmDecl::containing"),
  },
  {
    "static_kind",
    reinterpret_cast<PyCFunction>(
    ...
    METH_FASTCALL | METH_STATIC,
    PyDoc_STR("Wrapper for mx::TemplateTemplateParmDecl::static_kind"),
  },
  {
    "by_id",
    reinterpret_cast<PyCFunction>(
    ...
    METH_FASTCALL | METH_STATIC,
    PyDoc_STR("Wrapper for mx::TemplateTemplateParmDecl::by_id"),
  },
  {
    "from_base",
    reinterpret_cast<PyCFunction>(
    ...
    METH_FASTCALL | METH_STATIC,
    PyDoc_STR("Wrapper for mx::TemplateTemplateParmDecl::from_base"),
  },
  {
    "FROM",
    reinterpret_cast<PyCFunction>(
    ...
    METH_FASTCALL | METH_STATIC,
    PyDoc_STR("Wrapper for mx::TemplateTemplateParmDecl::from"),
  },
  {}  // Sentinel.
};
}  // namespace
...
PyTypeObject *InitType(void) noexcept {
  ...
  tp->tp_name = "multiplier.ast.TemplateTemplateParmDecl";
  tp->tp_flags = Py_TPFLAGS_DEFAULT | Py_TPFLAGS_DISALLOW_INSTANTIATION;
  tp->tp_doc = PyDoc_STR("Wrapper for mx::::TemplateTemplateParmDecl");
  tp->tp_as_number = nullptr;
  tp->tp_as_sequence = nullptr;
  tp->tp_as_mapping = nullptr;
  tp->tp_hash = gTypes[796].tp_hash;
  tp->tp_richcompare = gTypes[796].tp_richcompare;
  tp->tp_iter = nullptr;
  tp->tp_methods = gMethods;
  tp->tp_getset = gProperties;
  tp->tp_base = &(gTypes[796]);
  tp->tp_init = [] (BorrowedPyObject *self, BorrowedPyObject *args, BorrowedPyObject *kwargs) -> int {
    if (kwargs && (!PyMapping_Check(kwargs) || PyMapping_Size(kwargs))) {
      PyErrorStreamer(PyExc_TypeError)
          << "'TemplateTemplateParmDecl.__init__' does not take any keyword arguments";
      return -1;
    }

    if (!args || !PySequence_Check(args)) {
      PyErrorStreamer(PyExc_TypeError)
          << "Invalid positional arguments passed to 'TemplateTemplateParmDecl.__init__'";
      return -1;
    }
    ...
    (void) num_args;
    PyErrorStreamer(PyExc_TypeError)
        << "Class 'TemplateTemplateParmDecl' cannot be directly instantiated";
    return -1;
