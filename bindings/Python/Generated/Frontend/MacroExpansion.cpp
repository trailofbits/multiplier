...
bool PythonBinding<T>::load(BorrowedPyObject *module) noexcept {
  ...
  if (0 != PyModule_AddObjectRef(module, "MacroExpansion", tp_obj)) {
    return false;
  }
...
static PyGetSetDef gProperties[] = {
  ...
  },
  {
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::MacroExpansion::definition"),
    nullptr,
  },
  {
    "num_arguments",
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::MacroExpansion::num_arguments"),
    nullptr,
  },
  {
    "arguments",
...
static PyMethodDef gMethods[] = {
  ...
  },
  {
    ...
    METH_FASTCALL | METH_STATIC,
    PyDoc_STR("Wrapper for mx::MacroExpansion::static_kind"),
  },
  {
    "containing",
    reinterpret_cast<PyCFunction>(
  ...
  },
  {
    ...
    METH_FASTCALL | METH_STATIC,
    PyDoc_STR("Wrapper for mx::MacroExpansion::from_base"),
  },
  {
    "FROM",
    reinterpret_cast<PyCFunction>(
    ...
    METH_FASTCALL | METH_STATIC,
    PyDoc_STR("Wrapper for mx::MacroExpansion::from"),
  },
  {
    "nth_argument",
    reinterpret_cast<PyCFunction>(
    ...
    METH_FASTCALL,
    PyDoc_STR("Wrapper for mx::MacroExpansion::nth_argument"),
  },
  {}  // Sentinel.
};
}  // namespace
...
PyTypeObject *InitType(void) noexcept {
  ...
  tp->tp_name = "multiplier.frontend.MacroExpansion";
  tp->tp_flags = Py_TPFLAGS_DEFAULT | Py_TPFLAGS_DISALLOW_INSTANTIATION;
  tp->tp_doc = PyDoc_STR("Wrapper for mx::::MacroExpansion");
  ...
  tp->tp_init = [] (BorrowedPyObject *self, BorrowedPyObject *args, BorrowedPyObject *kwargs) -> int {
    if (kwargs && (!PyMapping_Check(kwargs) || PyMapping_Size(kwargs))) {
      PyErrorStreamer(PyExc_TypeError)
          << "'MacroExpansion.__init__' does not take any keyword arguments";
      return -1;
    }

    if (!args || !PySequence_Check(args)) {
      PyErrorStreamer(PyExc_TypeError)
          << "Invalid positional arguments passed to 'MacroExpansion.__init__'";
      return -1;
    }
    ...
    (void) num_args;
    PyErrorStreamer(PyExc_TypeError)
        << "Class 'MacroExpansion' cannot be directly instantiated";
    return -1;
