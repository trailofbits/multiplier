...
std::optional<T> PythonBinding<T>::from_python(BorrowedPyObject *obj) noexcept {
  ...
  if (tp < &(gTypes[823]) || tp >= &(gTypes[824])) {
    return std::nullopt;
  }
...
bool PythonBinding<T>::load(BorrowedPyObject *module) noexcept {
  ...
  if (0 != PyModule_AddObjectRef(module, "Compilation", tp_obj)) {
    return false;
  }
...
static PyGetSetDef gProperties[] = {
  {
    ...
    nullptr,
    PyDoc_STR("Wrapper for mx::Compilation::id"),
    nullptr,
  },
  {
    "ir",
    reinterpret_cast<getter>(
        +[] (BorrowedPyObject *self, void * /* closure */) -> SharedPyObject * {
          return ::mx::to_python(T_cast(self)->ir());
        }),
    nullptr,
    PyDoc_STR("Wrapper for mx::Compilation::ir"),
    nullptr,
  },
  {
    "fragments",
  ...
  },
  {
    ...
    reinterpret_cast<getter>(
        +[] (BorrowedPyObject *self, void * /* closure */) -> SharedPyObject * {
          return ::mx::to_python(T_cast(self)->main_source_file());
        }),
    nullptr,
    PyDoc_STR("Wrapper for mx::Compilation::main_source_file"),
    nullptr,
  },
  {
    ...
    reinterpret_cast<getter>(
        +[] (BorrowedPyObject *self, void * /* closure */) -> SharedPyObject * {
          return ::mx::to_python(T_cast(self)->main_source_file_path());
        }),
    nullptr,
    PyDoc_STR("Wrapper for mx::Compilation::main_source_file_path"),
    nullptr,
  },
  {
    ...
    reinterpret_cast<getter>(
        +[] (BorrowedPyObject *self, void * /* closure */) -> SharedPyObject * {
          return ::mx::to_python(T_cast(self)->compiler_executable_path());
        }),
    nullptr,
    PyDoc_STR("Wrapper for mx::Compilation::compiler_executable_path"),
    nullptr,
  },
  {
    "compiler_installation_directory",
    reinterpret_cast<getter>(
        +[] (BorrowedPyObject *self, void * /* closure */) -> SharedPyObject * {
          return ::mx::to_python(T_cast(self)->compiler_installation_directory());
        }),
    nullptr,
    PyDoc_STR("Wrapper for mx::Compilation::compiler_installation_directory"),
    nullptr,
  },
  {
    "working_directory",
    reinterpret_cast<getter>(
        +[] (BorrowedPyObject *self, void * /* closure */) -> SharedPyObject * {
          return ::mx::to_python(T_cast(self)->working_directory());
        }),
    nullptr,
    PyDoc_STR("Wrapper for mx::Compilation::working_directory"),
    nullptr,
  },
  {
    ...
    reinterpret_cast<getter>(
        +[] (BorrowedPyObject *self, void * /* closure */) -> SharedPyObject * {
          return ::mx::to_python(T_cast(self)->system_root_directory());
        }),
    nullptr,
    PyDoc_STR("Wrapper for mx::Compilation::system_root_directory"),
    nullptr,
  },
  {
    "system_root_directory_include_path",
    reinterpret_cast<getter>(
        +[] (BorrowedPyObject *self, void * /* closure */) -> SharedPyObject * {
          return ::mx::to_python(T_cast(self)->system_root_directory_include_path());
        }),
    nullptr,
    PyDoc_STR("Wrapper for mx::Compilation::system_root_directory_include_path"),
    nullptr,
  },
  {
    "resource_directory",
    reinterpret_cast<getter>(
        +[] (BorrowedPyObject *self, void * /* closure */) -> SharedPyObject * {
          return ::mx::to_python(T_cast(self)->resource_directory());
        }),
    nullptr,
    PyDoc_STR("Wrapper for mx::Compilation::resource_directory"),
    nullptr,
  },
  {
    "target_triple",
    reinterpret_cast<getter>(
        +[] (BorrowedPyObject *self, void * /* closure */) -> SharedPyObject * {
          return ::mx::to_python(T_cast(self)->target_triple());
        }),
    nullptr,
    PyDoc_STR("Wrapper for mx::Compilation::target_triple"),
    nullptr,
  },
  {
    ...
    reinterpret_cast<getter>(
        +[] (BorrowedPyObject *self, void * /* closure */) -> SharedPyObject * {
          return ::mx::to_python(T_cast(self)->auxiliary_target_triple());
        }),
    nullptr,
    PyDoc_STR("Wrapper for mx::Compilation::auxiliary_target_triple"),
    nullptr,
  },
  {
    "arguments",
...
static PyMethodDef gMethods[] = {
  {
    ...
    reinterpret_cast<PyCFunction>(
        +[] (BorrowedPyObject *, BorrowedPyObject * const *args, int num_args) -> SharedPyObject * {
          ...
          while (num_args == 1) {
            auto arg_0 = ::mx::from_python<std::optional<mx::Fragment>>(args[0]);
            if (!arg_0.has_value()) {
              break;
            }
  ...
  },
  {
    ...
    METH_FASTCALL | METH_STATIC,
    PyDoc_STR("Wrapper for mx::Compilation::in"),
  },
  {}  // Sentinel.
};
}  // namespace
...
PyTypeObject *InitType(void) noexcept {
  PyTypeObject * const tp = &(gTypes[823]);
  ...
  tp->tp_name = "multiplier.frontend.Compilation";
  tp->tp_flags = Py_TPFLAGS_DEFAULT | Py_TPFLAGS_DISALLOW_INSTANTIATION;
  tp->tp_doc = PyDoc_STR("Wrapper for mx::::Compilation");
  ...
  tp->tp_init = [] (BorrowedPyObject *self, BorrowedPyObject *args, BorrowedPyObject *kwargs) -> int {
    if (kwargs && (!PyMapping_Check(kwargs) || PyMapping_Size(kwargs))) {
      PyErrorStreamer(PyExc_TypeError)
          << "'Compilation.__init__' does not take any keyword arguments";
      return -1;
    }

    if (!args || !PySequence_Check(args)) {
      PyErrorStreamer(PyExc_TypeError)
          << "Invalid positional arguments passed to 'Compilation.__init__'";
      return -1;
    }
    ...
    (void) num_args;
    PyErrorStreamer(PyExc_TypeError)
        << "Class 'Compilation' cannot be directly instantiated";
    return -1;
