...
std::optional<DisableSanitizerInstrumentationAttr> DisableSanitizerInstrumentationAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<DisableSanitizerInstrumentationAttr> DisableSanitizerInstrumentationAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
...
gap::generator<DisableSanitizerInstrumentationAttr> DisableSanitizerInstrumentationAttr::in(const Index &index) {
  ...
  for (AttrKind k : kDisableSanitizerInstrumentationAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<DisableSanitizerInstrumentationAttr> e = from_base(std::move(eptr))) {
...
gap::generator<DisableSanitizerInstrumentationAttr> DisableSanitizerInstrumentationAttr::in(const File &file) {
...
std::optional<DisableSanitizerInstrumentationAttr> DisableSanitizerInstrumentationAttr::from(const VariantEntity &e) {
