...
#include <multiplier/Entities/LoaderUninitializedAttrSpelling.h>
...
const char *EnumeratorName(LoaderUninitializedAttrSpelling e) {
  switch (e) {
    ...
    case LoaderUninitializedAttrSpelling::C23_CLANG_LOADER_UNINITIALIZED: return "C23_CLANG_LOADER_UNINITIALIZED";
