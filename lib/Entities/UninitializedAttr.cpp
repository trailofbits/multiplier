...
std::optional<UninitializedAttr> UninitializedAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<UninitializedAttr> UninitializedAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
...
gap::generator<UninitializedAttr> UninitializedAttr::in(const Index &index) {
  ...
  for (AttrKind k : kUninitializedAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<UninitializedAttr> e = from_base(std::move(eptr))) {
...
gap::generator<UninitializedAttr> UninitializedAttr::in(const File &file) {
...
std::optional<UninitializedAttr> UninitializedAttr::from(const Reference &r) {
  return UninitializedAttr::from(r.as_attribute());
}

std::optional<UninitializedAttr> UninitializedAttr::from(const VariantEntity &e) {
...
std::optional<UninitializedAttr> UninitializedAttr::from(const TokenContext &t) {
