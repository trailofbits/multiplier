...
std::optional<NullabilityKind> Type::nullability(void) const {
  if (!impl->reader.getVal15()) {
    ...
    return static_cast<NullabilityKind>(impl->reader.getVal14());
  }
  return std::nullopt;
}
...
std::optional<TypeScalarTypeKind> Type::scalar_type_kind(void) const {
  if (!impl->reader.getVal20()) {
    ...
    return static_cast<TypeScalarTypeKind>(impl->reader.getVal19());
  }
  return std::nullopt;
}
...
TypeKind Type::kind(void) const {
  return static_cast<TypeKind>(impl->reader.getVal22());
}
...
Visibility Type::visibility(void) const {
  return static_cast<Visibility>(impl->reader.getVal24());
}
...
std::optional<bool> Type::is_aggregate_type(void) const {
  if (!impl->reader.getVal35()) {
    return std::nullopt;
  } else {
    return static_cast<bool>(impl->reader.getVal34());
  }
  return std::nullopt;
}
...
std::optional<bool> Type::is_constant_size_type(void) const {
  if (!impl->reader.getVal65()) {
    return std::nullopt;
  } else {
    return static_cast<bool>(impl->reader.getVal64());
  }
  return std::nullopt;
}
...
std::optional<bool> Type::is_literal_type(void) const {
  if (!impl->reader.getVal102()) {
    ...
    return static_cast<bool>(impl->reader.getVal101());
  }
  return std::nullopt;
}
...
bool Type::is_rvv_sizeless_builtin_type(void) const {
  return impl->reader.getVal189();
}

bool Type::is_rvvvls_builtin_type(void) const {
...
bool Type::is_sve_vls_builtin_type(void) const {
...
bool Type::is_web_assembly_externref_type(void) const {
  return impl->reader.getVal232();
}

bool Type::is_web_assembly_table_type(void) const {
