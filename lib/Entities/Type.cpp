...
std::optional<TypeScalarTypeKind> Type::scalar_type_kind(void) const {
  if (!impl->reader.getVal21()) {
    ...
    return static_cast<TypeScalarTypeKind>(impl->reader.getVal20());
  }
  return std::nullopt;
}
...
TypeKind Type::kind(void) const {
  return static_cast<TypeKind>(impl->reader.getVal23());
}
...
Visibility Type::visibility(void) const {
  return static_cast<Visibility>(impl->reader.getVal25());
}
...
std::optional<bool> Type::is_aggregate_type(void) const {
  if (!impl->reader.getVal36()) {
    return std::nullopt;
  } else {
    return static_cast<bool>(impl->reader.getVal35());
  }
  return std::nullopt;
}
...
std::optional<bool> Type::is_constant_size_type(void) const {
  if (!impl->reader.getVal66()) {
    return std::nullopt;
  } else {
    return static_cast<bool>(impl->reader.getVal65());
  }
  return std::nullopt;
}
...
std::optional<bool> Type::is_literal_type(void) const {
  if (!impl->reader.getVal103()) {
    ...
    return static_cast<bool>(impl->reader.getVal102());
  }
  return std::nullopt;
}
