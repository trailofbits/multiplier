...
Linkage Type::linkage(void) const {
  return static_cast<Linkage>(impl->reader.getVal9());
}
...
std::optional<NullabilityKind> Type::nullability(void) const {
  if (!impl->reader.getVal11()) {
    ...
    return static_cast<NullabilityKind>(impl->reader.getVal10());
  }
  return std::nullopt;
}
...
std::optional<TypeScalarTypeKind> Type::scalar_type_kind(void) const {
  if (!impl->reader.getVal16()) {
    ...
    return static_cast<TypeScalarTypeKind>(impl->reader.getVal15());
  }
  return std::nullopt;
}
...
TypeKind Type::kind(void) const {
  return static_cast<TypeKind>(impl->reader.getVal18());
}
...
Visibility Type::visibility(void) const {
  return static_cast<Visibility>(impl->reader.getVal20());
}
...
std::optional<bool> Type::is_aggregate_type(void) const {
  if (!impl->reader.getVal31()) {
    ...
    return static_cast<bool>(impl->reader.getVal30());
  }
  return std::nullopt;
}
...
std::optional<bool> Type::is_constant_size_type(void) const {
  if (!impl->reader.getVal61()) {
    return std::nullopt;
  } else {
    return static_cast<bool>(impl->reader.getVal60());
  }
  return std::nullopt;
}
