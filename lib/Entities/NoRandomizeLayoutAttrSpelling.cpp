...
#include <multiplier/Entities/NoRandomizeLayoutAttrSpelling.h>
...
const char *EnumeratorName(NoRandomizeLayoutAttrSpelling e) {
  switch (e) {
    ...
    case NoRandomizeLayoutAttrSpelling::C23_GNU_NO_RANDOMIZE_LAYOUT: return "C23_GNU_NO_RANDOMIZE_LAYOUT";
