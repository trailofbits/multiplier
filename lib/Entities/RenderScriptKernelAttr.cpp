...
#include <multiplier/Entities/RenderScriptKernelAttr.h>
...
std::optional<RenderScriptKernelAttr> RenderScriptKernelAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<RenderScriptKernelAttr> RenderScriptKernelAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
    case RenderScriptKernelAttr::static_kind():
...
gap::generator<RenderScriptKernelAttr> RenderScriptKernelAttr::in(const Index &index) {
  ...
  for (AttrKind k : kRenderScriptKernelAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<RenderScriptKernelAttr> e = from_base(std::move(eptr))) {
...
gap::generator<RenderScriptKernelAttr> RenderScriptKernelAttr::in(const File &file) {
...
std::optional<RenderScriptKernelAttr> RenderScriptKernelAttr::from(const Reference &r) {
  return RenderScriptKernelAttr::from(r.as_attribute());
}

std::optional<RenderScriptKernelAttr> RenderScriptKernelAttr::from(const VariantEntity &e) {
...
std::optional<RenderScriptKernelAttr> RenderScriptKernelAttr::from(const TokenContext &t) {
