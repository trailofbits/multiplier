...
gap::generator<ObjCIndependentClassAttr> ObjCIndependentClassAttr::in(const File &file) {
...
std::optional<ObjCIndependentClassAttr> ObjCIndependentClassAttr::from(const Reference &r) {
