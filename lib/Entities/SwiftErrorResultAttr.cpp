...
std::optional<SwiftErrorResultAttr> SwiftErrorResultAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
gap::generator<SwiftErrorResultAttr> SwiftErrorResultAttr::in(const Index &index) {
  ...
  for (AttrKind k : kSwiftErrorResultAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<SwiftErrorResultAttr> e = from_base(std::move(eptr))) {
...
gap::generator<SwiftErrorResultAttr> SwiftErrorResultAttr::in(const File &file) {
...
std::optional<SwiftErrorResultAttr> SwiftErrorResultAttr::from(const VariantEntity &e) {
