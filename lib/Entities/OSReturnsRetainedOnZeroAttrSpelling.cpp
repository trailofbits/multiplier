...
#include <multiplier/Entities/OSReturnsRetainedOnZeroAttrSpelling.h>
...
const char *EnumeratorName(OSReturnsRetainedOnZeroAttrSpelling e) {
  switch (e) {
    ...
    case OSReturnsRetainedOnZeroAttrSpelling::C23_CLANG_OS_RETURNS_RETAINED_ON_ZERO: return "C23_CLANG_OS_RETURNS_RETAINED_ON_ZERO";
