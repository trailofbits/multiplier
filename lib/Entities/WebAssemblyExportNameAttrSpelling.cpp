...
#include <multiplier/Entities/WebAssemblyExportNameAttrSpelling.h>
...
const char *EnumeratorName(WebAssemblyExportNameAttrSpelling e) {
  switch (e) {
    ...
    case WebAssemblyExportNameAttrSpelling::C23_CLANG_EXPORT_NAME: return "C23_CLANG_EXPORT_NAME";
