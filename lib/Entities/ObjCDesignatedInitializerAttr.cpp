...
#include <multiplier/Entities/ObjCDesignatedInitializerAttr.h>
...
std::optional<ObjCDesignatedInitializerAttr> ObjCDesignatedInitializerAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<ObjCDesignatedInitializerAttr> ObjCDesignatedInitializerAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
    case ObjCDesignatedInitializerAttr::static_kind():
...
gap::generator<ObjCDesignatedInitializerAttr> ObjCDesignatedInitializerAttr::in(const Index &index) {
  ...
  for (AttrKind k : kObjCDesignatedInitializerAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<ObjCDesignatedInitializerAttr> e = from_base(std::move(eptr))) {
...
gap::generator<ObjCDesignatedInitializerAttr> ObjCDesignatedInitializerAttr::in(const File &file) {
...
std::optional<ObjCDesignatedInitializerAttr> ObjCDesignatedInitializerAttr::from(const Reference &r) {
  return ObjCDesignatedInitializerAttr::from(r.as_attribute());
}

std::optional<ObjCDesignatedInitializerAttr> ObjCDesignatedInitializerAttr::from(const VariantEntity &e) {
...
std::optional<ObjCDesignatedInitializerAttr> ObjCDesignatedInitializerAttr::from(const TokenContext &t) {
