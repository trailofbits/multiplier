...
#include <multiplier/Entities/SpeculativeLoadHardeningAttrSpelling.h>
...
const char *EnumeratorName(SpeculativeLoadHardeningAttrSpelling e) {
  switch (e) {
    ...
    case SpeculativeLoadHardeningAttrSpelling::C23_CLANG_SPECULATIVE_LOAD_HARDENING: return "C23_CLANG_SPECULATIVE_LOAD_HARDENING";
