...
std::optional<SwiftCallAttr> SwiftCallAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<SwiftCallAttr> SwiftCallAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
...
gap::generator<SwiftCallAttr> SwiftCallAttr::in(const Index &index) {
  ...
  for (AttrKind k : kSwiftCallAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<SwiftCallAttr> e = from_base(std::move(eptr))) {
...
gap::generator<SwiftCallAttr> SwiftCallAttr::in(const File &file) {
...
std::optional<SwiftCallAttr> SwiftCallAttr::from(const VariantEntity &e) {
