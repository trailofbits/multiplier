...
#include <multiplier/Entities/SwiftIndirectResultAttrSpelling.h>
...
const char *EnumeratorName(SwiftIndirectResultAttrSpelling e) {
  switch (e) {
    ...
    case SwiftIndirectResultAttrSpelling::C23_CLANG_SWIFT_INDIRECT_RESULT: return "C23_CLANG_SWIFT_INDIRECT_RESULT";
