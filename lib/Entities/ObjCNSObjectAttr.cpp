...
std::optional<ObjCNSObjectAttr> ObjCNSObjectAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<ObjCNSObjectAttr> ObjCNSObjectAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
...
gap::generator<ObjCNSObjectAttr> ObjCNSObjectAttr::in(const Index &index) {
  ...
  for (AttrKind k : kObjCNSObjectAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<ObjCNSObjectAttr> e = from_base(std::move(eptr))) {
...
gap::generator<ObjCNSObjectAttr> ObjCNSObjectAttr::in(const File &file) {
...
std::optional<ObjCNSObjectAttr> ObjCNSObjectAttr::from(const VariantEntity &e) {
