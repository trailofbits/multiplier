...
std::optional<IntelOclBiccAttr> IntelOclBiccAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<IntelOclBiccAttr> IntelOclBiccAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
...
gap::generator<IntelOclBiccAttr> IntelOclBiccAttr::in(const Index &index) {
  ...
  for (AttrKind k : kIntelOclBiccAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<IntelOclBiccAttr> e = from_base(std::move(eptr))) {
...
gap::generator<IntelOclBiccAttr> IntelOclBiccAttr::in(const File &file) {
...
std::optional<IntelOclBiccAttr> IntelOclBiccAttr::from(const VariantEntity &e) {
