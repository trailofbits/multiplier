...
std::optional<CapturedRecordAttr> CapturedRecordAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<CapturedRecordAttr> CapturedRecordAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
...
gap::generator<CapturedRecordAttr> CapturedRecordAttr::in(const Index &index) {
  ...
  for (AttrKind k : kCapturedRecordAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<CapturedRecordAttr> e = from_base(std::move(eptr))) {
...
std::optional<CapturedRecordAttr> CapturedRecordAttr::from(const VariantEntity &e) {
