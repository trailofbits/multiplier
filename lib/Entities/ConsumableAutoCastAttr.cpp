...
std::optional<ConsumableAutoCastAttr> ConsumableAutoCastAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<ConsumableAutoCastAttr> ConsumableAutoCastAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
...
gap::generator<ConsumableAutoCastAttr> ConsumableAutoCastAttr::in(const Index &index) {
  ...
  for (AttrKind k : kConsumableAutoCastAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<ConsumableAutoCastAttr> e = from_base(std::move(eptr))) {
...
gap::generator<ConsumableAutoCastAttr> ConsumableAutoCastAttr::in(const File &file) {
...
std::optional<ConsumableAutoCastAttr> ConsumableAutoCastAttr::from(const VariantEntity &e) {
