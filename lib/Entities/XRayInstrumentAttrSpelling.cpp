...
#include <multiplier/Entities/XRayInstrumentAttrSpelling.h>
...
const char *EnumeratorName(XRayInstrumentAttrSpelling e) {
  switch (e) {
    ...
    case XRayInstrumentAttrSpelling::C23_CLANG_XRAY_ALWAYS_INSTRUMENT: return "C23_CLANG_XRAY_ALWAYS_INSTRUMENT";
    ...
    case XRayInstrumentAttrSpelling::C23_CLANG_XRAY_NEVER_INSTRUMENT: return "C23_CLANG_XRAY_NEVER_INSTRUMENT";
