...
#include <multiplier/Entities/CFReturnsNotRetainedAttrSpelling.h>
...
const char *EnumeratorName(CFReturnsNotRetainedAttrSpelling e) {
  switch (e) {
    ...
    case CFReturnsNotRetainedAttrSpelling::C23_CLANG_CF_RETURNS_NOT_RETAINED: return "C23_CLANG_CF_RETURNS_NOT_RETAINED";
