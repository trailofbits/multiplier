...
#include <multiplier/Entities/OMPCaptureKindAttr.h>
...
std::optional<OMPCaptureKindAttr> OMPCaptureKindAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<OMPCaptureKindAttr> OMPCaptureKindAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
    case OMPCaptureKindAttr::static_kind():
...
gap::generator<OMPCaptureKindAttr> OMPCaptureKindAttr::in(const Index &index) {
  ...
  for (AttrKind k : kOMPCaptureKindAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<OMPCaptureKindAttr> e = from_base(std::move(eptr))) {
...
gap::generator<OMPCaptureKindAttr> OMPCaptureKindAttr::in(const File &file) {
...
std::optional<OMPCaptureKindAttr> OMPCaptureKindAttr::from(const Reference &r) {
  return OMPCaptureKindAttr::from(r.as_attribute());
}

std::optional<OMPCaptureKindAttr> OMPCaptureKindAttr::from(const VariantEntity &e) {
...
std::optional<OMPCaptureKindAttr> OMPCaptureKindAttr::from(const TokenContext &t) {
