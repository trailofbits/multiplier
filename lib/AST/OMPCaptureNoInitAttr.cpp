...
std::optional<OMPCaptureNoInitAttr> OMPCaptureNoInitAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
gap::generator<OMPCaptureNoInitAttr> OMPCaptureNoInitAttr::in(const Index &index) {
  ...
  for (AttrKind k : kOMPCaptureNoInitAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<OMPCaptureNoInitAttr> e = from_base(std::move(eptr))) {
...
gap::generator<OMPCaptureNoInitAttr> OMPCaptureNoInitAttr::in(const File &file) {
...
std::optional<OMPCaptureNoInitAttr> OMPCaptureNoInitAttr::from(const Reference &r) {
  return OMPCaptureNoInitAttr::from(r.as_attribute());
}

std::optional<OMPCaptureNoInitAttr> OMPCaptureNoInitAttr::from(const VariantEntity &e) {
...
std::optional<OMPCaptureNoInitAttr> OMPCaptureNoInitAttr::from(const TokenContext &t) {
