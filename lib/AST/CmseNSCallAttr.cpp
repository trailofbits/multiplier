...
std::optional<CmseNSCallAttr> CmseNSCallAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<CmseNSCallAttr> CmseNSCallAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
...
gap::generator<CmseNSCallAttr> CmseNSCallAttr::in(const Index &index) {
  ...
  for (AttrKind k : kCmseNSCallAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<CmseNSCallAttr> e = from_base(std::move(eptr))) {
...
gap::generator<CmseNSCallAttr> CmseNSCallAttr::in(const File &file) {
...
std::optional<CmseNSCallAttr> CmseNSCallAttr::from(const Reference &r) {
  return CmseNSCallAttr::from(r.as_attribute());
}

std::optional<CmseNSCallAttr> CmseNSCallAttr::from(const VariantEntity &e) {
...
std::optional<CmseNSCallAttr> CmseNSCallAttr::from(const TokenContext &t) {
