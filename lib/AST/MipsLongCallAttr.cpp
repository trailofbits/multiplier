...
std::optional<MipsLongCallAttr> MipsLongCallAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<MipsLongCallAttr> MipsLongCallAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
...
gap::generator<MipsLongCallAttr> MipsLongCallAttr::in(const Index &index) {
  ...
  for (AttrKind k : kMipsLongCallAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<MipsLongCallAttr> e = from_base(std::move(eptr))) {
...
gap::generator<MipsLongCallAttr> MipsLongCallAttr::in(const File &file) {
...
std::optional<MipsLongCallAttr> MipsLongCallAttr::from(const VariantEntity &e) {
