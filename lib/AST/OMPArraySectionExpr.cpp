...
std::optional<OMPArraySectionExpr> OMPArraySectionExpr::from(const ir::hl::Operation &op) {
...
gap::generator<std::pair<OMPArraySectionExpr, ir::hl::Operation>> OMPArraySectionExpr::in(const Compilation &tu) {
  for (std::pair<Stmt, ir::hl::Operation> res : Stmt::in(tu, kOMPArraySectionExprDerivedKinds)) {
    if (auto val = from_base(res.first)) {
      co_yield std::pair<OMPArraySectionExpr, ir::hl::Operation>(std::move(val.value()), std::move(res.second));
    }
  }
}
...
std::optional<OMPArraySectionExpr> OMPArraySectionExpr::from(const std::optional<Stmt> &parent) {
  if (parent) {
...
std::optional<OMPArraySectionExpr> OMPArraySectionExpr::from_base(const Stmt &parent) {
  switch (parent.kind()) {
...
gap::generator<OMPArraySectionExpr> OMPArraySectionExpr::in(const Index &index) {
  ...
  for (StmtKind k : kOMPArraySectionExprDerivedKinds) {
    for (StmtImplPtr eptr : ep->StmtsFor(ep, k)) {
      if (std::optional<OMPArraySectionExpr> e = from_base(std::move(eptr))) {
...
std::optional<OMPArraySectionExpr> OMPArraySectionExpr::from(const VariantEntity &e) {
