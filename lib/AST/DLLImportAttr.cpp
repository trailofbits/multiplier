...
std::optional<DLLImportAttr> DLLImportAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<DLLImportAttr> DLLImportAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
...
gap::generator<DLLImportAttr> DLLImportAttr::in(const Index &index) {
  ...
  for (AttrKind k : kDLLImportAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<DLLImportAttr> e = from_base(std::move(eptr))) {
...
gap::generator<DLLImportAttr> DLLImportAttr::in(const File &file) {
...
std::optional<DLLImportAttr> DLLImportAttr::from(const Reference &r) {
  return DLLImportAttr::from(r.as_attribute());
}

std::optional<DLLImportAttr> DLLImportAttr::from(const VariantEntity &e) {
...
std::optional<DLLImportAttr> DLLImportAttr::from(const TokenContext &t) {
