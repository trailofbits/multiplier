...
std::optional<PtGuardedByAttr> PtGuardedByAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<PtGuardedByAttr> PtGuardedByAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
...
gap::generator<PtGuardedByAttr> PtGuardedByAttr::in(const Index &index) {
  ...
  for (AttrKind k : kPtGuardedByAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<PtGuardedByAttr> e = from_base(std::move(eptr))) {
...
gap::generator<PtGuardedByAttr> PtGuardedByAttr::in(const File &file) {
...
std::optional<PtGuardedByAttr> PtGuardedByAttr::from(const Reference &r) {
  return PtGuardedByAttr::from(r.as_attribute());
}

std::optional<PtGuardedByAttr> PtGuardedByAttr::from(const VariantEntity &e) {
...
std::optional<PtGuardedByAttr> PtGuardedByAttr::from(const TokenContext &t) {
