...
std::optional<OMPTargetTeamsGenericLoopDirective> OMPTargetTeamsGenericLoopDirective::from(const ir::hl::Operation &op) {
...
gap::generator<std::pair<OMPTargetTeamsGenericLoopDirective, ir::hl::Operation>> OMPTargetTeamsGenericLoopDirective::in(const Compilation &tu) {
  for (std::pair<Stmt, ir::hl::Operation> res : Stmt::in(tu, kOMPTargetTeamsGenericLoopDirectiveDerivedKinds)) {
    if (auto val = from_base(res.first)) {
      co_yield std::pair<OMPTargetTeamsGenericLoopDirective, ir::hl::Operation>(std::move(val.value()), std::move(res.second));
    }
  }
}
...
std::optional<OMPTargetTeamsGenericLoopDirective> OMPTargetTeamsGenericLoopDirective::from(const std::optional<Stmt> &parent) {
  if (parent) {
...
std::optional<OMPTargetTeamsGenericLoopDirective> OMPTargetTeamsGenericLoopDirective::from_base(const Stmt &parent) {
  switch (parent.kind()) {
...
gap::generator<OMPTargetTeamsGenericLoopDirective> OMPTargetTeamsGenericLoopDirective::in(const Index &index) {
  ...
  for (StmtKind k : kOMPTargetTeamsGenericLoopDirectiveDerivedKinds) {
    for (StmtImplPtr eptr : ep->StmtsFor(ep, k)) {
      if (std::optional<OMPTargetTeamsGenericLoopDirective> e = from_base(std::move(eptr))) {
...
std::optional<OMPTargetTeamsGenericLoopDirective> OMPTargetTeamsGenericLoopDirective::from(const VariantEntity &e) {
