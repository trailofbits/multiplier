...
gap::generator<OMPTargetTeamsGenericLoopDirective> OMPTargetTeamsGenericLoopDirective::in(const Compilation &tu) {
  for (Stmt res : Stmt::in(tu, kOMPTargetTeamsGenericLoopDirectiveDerivedKinds)) {
