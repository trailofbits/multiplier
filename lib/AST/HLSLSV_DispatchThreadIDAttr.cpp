...
std::optional<HLSLSV_DispatchThreadIDAttr> HLSLSV_DispatchThreadIDAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<HLSLSV_DispatchThreadIDAttr> HLSLSV_DispatchThreadIDAttr::from(const VariantEntity &e) {
