...
gap::generator<OMPTargetExitDataDirective> OMPTargetExitDataDirective::in(const Compilation &tu) {
  for (Stmt res : Stmt::in(tu, kOMPTargetExitDataDirectiveDerivedKinds)) {
