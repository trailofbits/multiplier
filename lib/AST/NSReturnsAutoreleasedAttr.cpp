...
gap::generator<NSReturnsAutoreleasedAttr> NSReturnsAutoreleasedAttr::in(const Index &index) {
  ...
  for (AttrKind k : kNSReturnsAutoreleasedAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<NSReturnsAutoreleasedAttr> e = from_base(std::move(eptr))) {
...
gap::generator<NSReturnsAutoreleasedAttr> NSReturnsAutoreleasedAttr::in(const File &file) {
...
std::optional<NSReturnsAutoreleasedAttr> NSReturnsAutoreleasedAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<NSReturnsAutoreleasedAttr> NSReturnsAutoreleasedAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
...
std::optional<NSReturnsAutoreleasedAttr> NSReturnsAutoreleasedAttr::from(const VariantEntity &e) {
