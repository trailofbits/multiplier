...
std::optional<OMPTargetSimdDirective> OMPTargetSimdDirective::from(const ir::hl::Operation &op) {
...
gap::generator<std::pair<OMPTargetSimdDirective, ir::hl::Operation>> OMPTargetSimdDirective::in(const Compilation &tu) {
  for (std::pair<Stmt, ir::hl::Operation> res : Stmt::in(tu, kOMPTargetSimdDirectiveDerivedKinds)) {
    if (auto val = from_base(res.first)) {
      co_yield std::pair<OMPTargetSimdDirective, ir::hl::Operation>(std::move(val.value()), std::move(res.second));
    }
  }
}
...
std::optional<OMPTargetSimdDirective> OMPTargetSimdDirective::from(const std::optional<Stmt> &parent) {
  if (parent) {
...
std::optional<OMPTargetSimdDirective> OMPTargetSimdDirective::from_base(const Stmt &parent) {
  switch (parent.kind()) {
...
gap::generator<OMPTargetSimdDirective> OMPTargetSimdDirective::in(const Index &index) {
  ...
  for (StmtKind k : kOMPTargetSimdDirectiveDerivedKinds) {
    for (StmtImplPtr eptr : ep->StmtsFor(ep, k)) {
      if (std::optional<OMPTargetSimdDirective> e = from_base(std::move(eptr))) {
...
gap::generator<OMPTargetSimdDirective> OMPTargetSimdDirective::in(const File &file) {
...
std::optional<OMPTargetSimdDirective> OMPTargetSimdDirective::from(const Reference &r) {
  return OMPTargetSimdDirective::from(r.as_statement());
}

std::optional<OMPTargetSimdDirective> OMPTargetSimdDirective::from(const VariantEntity &e) {
...
std::optional<OMPTargetSimdDirective> OMPTargetSimdDirective::from(const TokenContext &t) {
