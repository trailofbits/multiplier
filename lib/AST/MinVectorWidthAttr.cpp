...
gap::generator<MinVectorWidthAttr> MinVectorWidthAttr::in(const Index &index) {
  ...
  for (AttrKind k : kMinVectorWidthAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<MinVectorWidthAttr> e = from_base(std::move(eptr))) {
...
gap::generator<MinVectorWidthAttr> MinVectorWidthAttr::in(const File &file) {
...
std::optional<MinVectorWidthAttr> MinVectorWidthAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<MinVectorWidthAttr> MinVectorWidthAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
...
std::optional<MinVectorWidthAttr> MinVectorWidthAttr::from(const VariantEntity &e) {
...
uint32_t MinVectorWidthAttr::vector_width(void) const {
