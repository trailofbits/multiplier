...
gap::generator<ConstructorUsingShadowDecl> ConstructorUsingShadowDecl::in(const Compilation &tu) {
  for (Decl res : Decl::in(tu, kConstructorUsingShadowDeclDerivedKinds)) {
