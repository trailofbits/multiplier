...
std::optional<CXXNullPtrLiteralExpr> CXXNullPtrLiteralExpr::from(const ir::hl::Operation &op) {
...
gap::generator<std::pair<CXXNullPtrLiteralExpr, ir::hl::Operation>> CXXNullPtrLiteralExpr::in(const Compilation &tu) {
  for (std::pair<Stmt, ir::hl::Operation> res : Stmt::in(tu, kCXXNullPtrLiteralExprDerivedKinds)) {
    if (auto val = from_base(res.first)) {
      co_yield std::pair<CXXNullPtrLiteralExpr, ir::hl::Operation>(std::move(val.value()), std::move(res.second));
    }
  }
}
