...
gap::generator<OMPTeamsDistributeDirective> OMPTeamsDistributeDirective::in(const Compilation &tu) {
  for (Stmt res : Stmt::in(tu, kOMPTeamsDistributeDirectiveDerivedKinds)) {
