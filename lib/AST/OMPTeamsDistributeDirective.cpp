...
std::optional<OMPTeamsDistributeDirective> OMPTeamsDistributeDirective::from(const ir::hl::Operation &op) {
...
gap::generator<std::pair<OMPTeamsDistributeDirective, ir::hl::Operation>> OMPTeamsDistributeDirective::in(const Compilation &tu) {
  for (std::pair<Stmt, ir::hl::Operation> res : Stmt::in(tu, kOMPTeamsDistributeDirectiveDerivedKinds)) {
    if (auto val = from_base(res.first)) {
      co_yield std::pair<OMPTeamsDistributeDirective, ir::hl::Operation>(std::move(val.value()), std::move(res.second));
    }
  }
}
...
std::optional<OMPTeamsDistributeDirective> OMPTeamsDistributeDirective::from(const std::optional<Stmt> &parent) {
  if (parent) {
...
std::optional<OMPTeamsDistributeDirective> OMPTeamsDistributeDirective::from_base(const Stmt &parent) {
  switch (parent.kind()) {
...
gap::generator<OMPTeamsDistributeDirective> OMPTeamsDistributeDirective::in(const Index &index) {
  ...
  for (StmtKind k : kOMPTeamsDistributeDirectiveDerivedKinds) {
    for (StmtImplPtr eptr : ep->StmtsFor(ep, k)) {
      if (std::optional<OMPTeamsDistributeDirective> e = from_base(std::move(eptr))) {
...
gap::generator<OMPTeamsDistributeDirective> OMPTeamsDistributeDirective::in(const File &file) {
...
std::optional<OMPTeamsDistributeDirective> OMPTeamsDistributeDirective::from(const Reference &r) {
  return OMPTeamsDistributeDirective::from(r.as_statement());
}

std::optional<OMPTeamsDistributeDirective> OMPTeamsDistributeDirective::from(const VariantEntity &e) {
...
std::optional<OMPTeamsDistributeDirective> OMPTeamsDistributeDirective::from(const TokenContext &t) {
