...
std::optional<OMPTargetParallelForDirective> OMPTargetParallelForDirective::from(const std::optional<Stmt> &parent) {
  if (parent) {
...
gap::generator<OMPTargetParallelForDirective> OMPTargetParallelForDirective::in(const Index &index) {
  ...
  for (StmtKind k : kOMPTargetParallelForDirectiveDerivedKinds) {
    for (StmtImplPtr eptr : ep->StmtsFor(ep, k)) {
      if (std::optional<OMPTargetParallelForDirective> e = from_base(std::move(eptr))) {
...
std::optional<OMPTargetParallelForDirective> OMPTargetParallelForDirective::from(const Reference &r) {
  return OMPTargetParallelForDirective::from(r.as_statement());
}

std::optional<OMPTargetParallelForDirective> OMPTargetParallelForDirective::from(const VariantEntity &e) {
...
std::optional<OMPTargetParallelForDirective> OMPTargetParallelForDirective::from(const TokenContext &t) {
