...
std::optional<SwiftAsyncErrorAttr> SwiftAsyncErrorAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<SwiftAsyncErrorAttr> SwiftAsyncErrorAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
...
gap::generator<SwiftAsyncErrorAttr> SwiftAsyncErrorAttr::in(const Index &index) {
  ...
  for (AttrKind k : kSwiftAsyncErrorAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<SwiftAsyncErrorAttr> e = from_base(std::move(eptr))) {
...
std::optional<SwiftAsyncErrorAttr> SwiftAsyncErrorAttr::from(const Reference &r) {
  return SwiftAsyncErrorAttr::from(r.as_attribute());
}

std::optional<SwiftAsyncErrorAttr> SwiftAsyncErrorAttr::from(const VariantEntity &e) {
...
std::optional<SwiftAsyncErrorAttr> SwiftAsyncErrorAttr::from(const TokenContext &t) {
