...
gap::generator<VecReturnAttr> VecReturnAttr::in(const Index &index) {
  ...
  for (AttrKind k : kVecReturnAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<VecReturnAttr> e = from_base(std::move(eptr))) {
...
gap::generator<VecReturnAttr> VecReturnAttr::in(const File &file) {
...
std::optional<VecReturnAttr> VecReturnAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<VecReturnAttr> VecReturnAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
...
std::optional<VecReturnAttr> VecReturnAttr::from(const VariantEntity &e) {
