...
gap::generator<NoMips16Attr> NoMips16Attr::in(const Index &index) {
  ...
  for (AttrKind k : kNoMips16AttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<NoMips16Attr> e = from_base(std::move(eptr))) {
...
gap::generator<NoMips16Attr> NoMips16Attr::in(const File &file) {
...
std::optional<NoMips16Attr> NoMips16Attr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<NoMips16Attr> NoMips16Attr::from_base(const Attr &parent) {
  switch (parent.kind()) {
...
std::optional<NoMips16Attr> NoMips16Attr::from(const VariantEntity &e) {
