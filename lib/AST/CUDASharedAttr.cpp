...
std::optional<CUDASharedAttr> CUDASharedAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<CUDASharedAttr> CUDASharedAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
...
gap::generator<CUDASharedAttr> CUDASharedAttr::in(const Index &index) {
  ...
  for (AttrKind k : kCUDASharedAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<CUDASharedAttr> e = from_base(std::move(eptr))) {
...
gap::generator<CUDASharedAttr> CUDASharedAttr::in(const File &file) {
...
std::optional<CUDASharedAttr> CUDASharedAttr::from(const VariantEntity &e) {
