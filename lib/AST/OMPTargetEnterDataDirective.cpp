...
gap::generator<OMPTargetEnterDataDirective> OMPTargetEnterDataDirective::in(const Compilation &tu) {
  for (Stmt res : Stmt::in(tu, kOMPTargetEnterDataDirectiveDerivedKinds)) {
