...
std::optional<LifetimeBoundAttr> LifetimeBoundAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<LifetimeBoundAttr> LifetimeBoundAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
...
gap::generator<LifetimeBoundAttr> LifetimeBoundAttr::in(const Index &index) {
  ...
  for (AttrKind k : kLifetimeBoundAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<LifetimeBoundAttr> e = from_base(std::move(eptr))) {
...
gap::generator<LifetimeBoundAttr> LifetimeBoundAttr::in(const File &file) {
...
std::optional<LifetimeBoundAttr> LifetimeBoundAttr::from(const VariantEntity &e) {
