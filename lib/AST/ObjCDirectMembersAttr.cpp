...
std::optional<ObjCDirectMembersAttr> ObjCDirectMembersAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<ObjCDirectMembersAttr> ObjCDirectMembersAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
...
gap::generator<ObjCDirectMembersAttr> ObjCDirectMembersAttr::in(const Index &index) {
  ...
  for (AttrKind k : kObjCDirectMembersAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<ObjCDirectMembersAttr> e = from_base(std::move(eptr))) {
...
std::optional<ObjCDirectMembersAttr> ObjCDirectMembersAttr::from(const VariantEntity &e) {
