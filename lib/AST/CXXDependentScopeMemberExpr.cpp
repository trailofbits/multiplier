...
gap::generator<CXXDependentScopeMemberExpr> CXXDependentScopeMemberExpr::in(const Compilation &tu) {
  for (Stmt res : Stmt::in(tu, kCXXDependentScopeMemberExprDerivedKinds)) {
