...
std::optional<HLSLResourceAttr> HLSLResourceAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<HLSLResourceAttr> HLSLResourceAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
...
std::optional<HLSLResourceAttr> HLSLResourceAttr::from(const VariantEntity &e) {
