...
gap::generator<LoaderUninitializedAttr> LoaderUninitializedAttr::in(const Index &index) {
  ...
  for (AttrKind k : kLoaderUninitializedAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<LoaderUninitializedAttr> e = from_base(std::move(eptr))) {
...
std::optional<LoaderUninitializedAttr> LoaderUninitializedAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<LoaderUninitializedAttr> LoaderUninitializedAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
...
std::optional<LoaderUninitializedAttr> LoaderUninitializedAttr::from(const VariantEntity &e) {
