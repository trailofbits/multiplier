...
gap::generator<OMPParallelGenericLoopDirective> OMPParallelGenericLoopDirective::in(const Compilation &tu) {
  for (Stmt res : Stmt::in(tu, kOMPParallelGenericLoopDirectiveDerivedKinds)) {
