...
gap::generator<ObjCRequiresPropertyDefsAttr> ObjCRequiresPropertyDefsAttr::in(const Index &index) {
  ...
  for (AttrKind k : kObjCRequiresPropertyDefsAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<ObjCRequiresPropertyDefsAttr> e = from_base(std::move(eptr))) {
...
std::optional<ObjCRequiresPropertyDefsAttr> ObjCRequiresPropertyDefsAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<ObjCRequiresPropertyDefsAttr> ObjCRequiresPropertyDefsAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
...
std::optional<ObjCRequiresPropertyDefsAttr> ObjCRequiresPropertyDefsAttr::from(const VariantEntity &e) {
