...
std::optional<OMPDeclareVariantAttr> OMPDeclareVariantAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
gap::generator<OMPDeclareVariantAttr> OMPDeclareVariantAttr::in(const Index &index) {
  ...
  for (AttrKind k : kOMPDeclareVariantAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<OMPDeclareVariantAttr> e = from_base(std::move(eptr))) {
...
gap::generator<OMPDeclareVariantAttr> OMPDeclareVariantAttr::in(const File &file) {
...
std::optional<OMPDeclareVariantAttr> OMPDeclareVariantAttr::from(const Reference &r) {
  return OMPDeclareVariantAttr::from(r.as_attribute());
}

std::optional<OMPDeclareVariantAttr> OMPDeclareVariantAttr::from(const VariantEntity &e) {
...
std::optional<OMPDeclareVariantAttr> OMPDeclareVariantAttr::from(const TokenContext &t) {
