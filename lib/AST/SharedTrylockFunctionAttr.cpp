...
std::optional<SharedTrylockFunctionAttr> SharedTrylockFunctionAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
gap::generator<SharedTrylockFunctionAttr> SharedTrylockFunctionAttr::in(const Index &index) {
  ...
  for (AttrKind k : kSharedTrylockFunctionAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<SharedTrylockFunctionAttr> e = from_base(std::move(eptr))) {
...
gap::generator<SharedTrylockFunctionAttr> SharedTrylockFunctionAttr::in(const File &file) {
...
std::optional<SharedTrylockFunctionAttr> SharedTrylockFunctionAttr::from(const VariantEntity &e) {
