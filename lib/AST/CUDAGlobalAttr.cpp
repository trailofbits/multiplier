...
std::optional<CUDAGlobalAttr> CUDAGlobalAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<CUDAGlobalAttr> CUDAGlobalAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
...
gap::generator<CUDAGlobalAttr> CUDAGlobalAttr::in(const Index &index) {
  ...
  for (AttrKind k : kCUDAGlobalAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<CUDAGlobalAttr> e = from_base(std::move(eptr))) {
...
gap::generator<CUDAGlobalAttr> CUDAGlobalAttr::in(const File &file) {
...
std::optional<CUDAGlobalAttr> CUDAGlobalAttr::from(const VariantEntity &e) {
