...
std::optional<OMPMaskedTaskLoopDirective> OMPMaskedTaskLoopDirective::from(const ir::hl::Operation &op) {
...
gap::generator<std::pair<OMPMaskedTaskLoopDirective, ir::hl::Operation>> OMPMaskedTaskLoopDirective::in(const Compilation &tu) {
  for (std::pair<Stmt, ir::hl::Operation> res : Stmt::in(tu, kOMPMaskedTaskLoopDirectiveDerivedKinds)) {
    if (auto val = from_base(res.first)) {
      co_yield std::pair<OMPMaskedTaskLoopDirective, ir::hl::Operation>(std::move(val.value()), std::move(res.second));
    }
  }
}
...
std::optional<OMPMaskedTaskLoopDirective> OMPMaskedTaskLoopDirective::from(const std::optional<Stmt> &parent) {
  if (parent) {
...
std::optional<OMPMaskedTaskLoopDirective> OMPMaskedTaskLoopDirective::from_base(const Stmt &parent) {
  switch (parent.kind()) {
...
std::optional<OMPMaskedTaskLoopDirective> OMPMaskedTaskLoopDirective::from(const VariantEntity &e) {
