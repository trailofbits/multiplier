...
gap::generator<OMPMaskedTaskLoopDirective> OMPMaskedTaskLoopDirective::in(const Compilation &tu) {
  for (Stmt res : Stmt::in(tu, kOMPMaskedTaskLoopDirectiveDerivedKinds)) {
