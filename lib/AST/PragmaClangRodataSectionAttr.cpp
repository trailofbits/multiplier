...
gap::generator<PragmaClangRodataSectionAttr> PragmaClangRodataSectionAttr::in(const Index &index) {
  ...
  for (AttrKind k : kPragmaClangRodataSectionAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<PragmaClangRodataSectionAttr> e = from_base(std::move(eptr))) {
...
std::optional<PragmaClangRodataSectionAttr> PragmaClangRodataSectionAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<PragmaClangRodataSectionAttr> PragmaClangRodataSectionAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
...
std::optional<PragmaClangRodataSectionAttr> PragmaClangRodataSectionAttr::from(const Reference &r) {
  return PragmaClangRodataSectionAttr::from(r.as_attribute());
}

std::optional<PragmaClangRodataSectionAttr> PragmaClangRodataSectionAttr::from(const VariantEntity &e) {
...
std::optional<PragmaClangRodataSectionAttr> PragmaClangRodataSectionAttr::from(const TokenContext &t) {
...
uint32_t PragmaClangRodataSectionAttr::name_length(void) const {
