...
gap::generator<NoDuplicateAttr> NoDuplicateAttr::in(const Index &index) {
  ...
  for (AttrKind k : kNoDuplicateAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<NoDuplicateAttr> e = from_base(std::move(eptr))) {
...
gap::generator<NoDuplicateAttr> NoDuplicateAttr::in(const File &file) {
...
std::optional<NoDuplicateAttr> NoDuplicateAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<NoDuplicateAttr> NoDuplicateAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
...
std::optional<NoDuplicateAttr> NoDuplicateAttr::from(const VariantEntity &e) {
