...
std::optional<UPtrAttr> UPtrAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<UPtrAttr> UPtrAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
...
gap::generator<UPtrAttr> UPtrAttr::in(const Index &index) {
  ...
  for (AttrKind k : kUPtrAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<UPtrAttr> e = from_base(std::move(eptr))) {
...
gap::generator<UPtrAttr> UPtrAttr::in(const File &file) {
...
std::optional<UPtrAttr> UPtrAttr::from(const Reference &r) {
  return UPtrAttr::from(r.as_attribute());
}

std::optional<UPtrAttr> UPtrAttr::from(const VariantEntity &e) {
...
std::optional<UPtrAttr> UPtrAttr::from(const TokenContext &t) {
