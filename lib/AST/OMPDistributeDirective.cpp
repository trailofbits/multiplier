...
std::optional<OMPDistributeDirective> OMPDistributeDirective::from(const ir::hl::Operation &op) {
...
gap::generator<std::pair<OMPDistributeDirective, ir::hl::Operation>> OMPDistributeDirective::in(const Compilation &tu) {
  for (std::pair<Stmt, ir::hl::Operation> res : Stmt::in(tu, kOMPDistributeDirectiveDerivedKinds)) {
    if (auto val = from_base(res.first)) {
      co_yield std::pair<OMPDistributeDirective, ir::hl::Operation>(std::move(val.value()), std::move(res.second));
    }
  }
}
...
std::optional<OMPDistributeDirective> OMPDistributeDirective::from(const std::optional<Stmt> &parent) {
  if (parent) {
...
std::optional<OMPDistributeDirective> OMPDistributeDirective::from_base(const Stmt &parent) {
  switch (parent.kind()) {
...
gap::generator<OMPDistributeDirective> OMPDistributeDirective::in(const Index &index) {
  ...
  for (StmtKind k : kOMPDistributeDirectiveDerivedKinds) {
    for (StmtImplPtr eptr : ep->StmtsFor(ep, k)) {
      if (std::optional<OMPDistributeDirective> e = from_base(std::move(eptr))) {
...
std::optional<OMPDistributeDirective> OMPDistributeDirective::from(const Reference &r) {
  return OMPDistributeDirective::from(r.as_statement());
}

std::optional<OMPDistributeDirective> OMPDistributeDirective::from(const VariantEntity &e) {
...
std::optional<OMPDistributeDirective> OMPDistributeDirective::from(const TokenContext &t) {
