...
gap::generator<CXXUnresolvedConstructExpr> CXXUnresolvedConstructExpr::in(const Compilation &tu) {
  for (Stmt res : Stmt::in(tu, kCXXUnresolvedConstructExprDerivedKinds)) {
