...
std::optional<SwiftAsyncContextAttr> SwiftAsyncContextAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
gap::generator<SwiftAsyncContextAttr> SwiftAsyncContextAttr::in(const Index &index) {
  ...
  for (AttrKind k : kSwiftAsyncContextAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<SwiftAsyncContextAttr> e = from_base(std::move(eptr))) {
...
gap::generator<SwiftAsyncContextAttr> SwiftAsyncContextAttr::in(const File &file) {
...
std::optional<SwiftAsyncContextAttr> SwiftAsyncContextAttr::from(const Reference &r) {
  return SwiftAsyncContextAttr::from(r.as_attribute());
}

std::optional<SwiftAsyncContextAttr> SwiftAsyncContextAttr::from(const VariantEntity &e) {
...
std::optional<SwiftAsyncContextAttr> SwiftAsyncContextAttr::from(const TokenContext &t) {
