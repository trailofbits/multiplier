...
gap::generator<ObjCRootClassAttr> ObjCRootClassAttr::in(const Index &index) {
  ...
  for (AttrKind k : kObjCRootClassAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<ObjCRootClassAttr> e = from_base(std::move(eptr))) {
...
std::optional<ObjCRootClassAttr> ObjCRootClassAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<ObjCRootClassAttr> ObjCRootClassAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
...
std::optional<ObjCRootClassAttr> ObjCRootClassAttr::from(const VariantEntity &e) {
