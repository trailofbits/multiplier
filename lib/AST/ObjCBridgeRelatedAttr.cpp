...
std::optional<ObjCBridgeRelatedAttr> ObjCBridgeRelatedAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<ObjCBridgeRelatedAttr> ObjCBridgeRelatedAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
...
gap::generator<ObjCBridgeRelatedAttr> ObjCBridgeRelatedAttr::in(const Index &index) {
  ...
  for (AttrKind k : kObjCBridgeRelatedAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<ObjCBridgeRelatedAttr> e = from_base(std::move(eptr))) {
...
gap::generator<ObjCBridgeRelatedAttr> ObjCBridgeRelatedAttr::in(const File &file) {
...
std::optional<ObjCBridgeRelatedAttr> ObjCBridgeRelatedAttr::from(const VariantEntity &e) {
