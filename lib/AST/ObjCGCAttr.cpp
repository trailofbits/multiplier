...
gap::generator<ObjCGCAttr> ObjCGCAttr::in(const Index &index) {
  ...
  for (AttrKind k : kObjCGCAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<ObjCGCAttr> e = from_base(std::move(eptr))) {
...
gap::generator<ObjCGCAttr> ObjCGCAttr::in(const File &file) {
...
std::optional<ObjCGCAttr> ObjCGCAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<ObjCGCAttr> ObjCGCAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
...
std::optional<ObjCGCAttr> ObjCGCAttr::from(const VariantEntity &e) {
