...
gap::generator<DLLImportStaticLocalAttr> DLLImportStaticLocalAttr::in(const Index &index) {
  ...
  for (AttrKind k : kDLLImportStaticLocalAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<DLLImportStaticLocalAttr> e = from_base(std::move(eptr))) {
...
std::optional<DLLImportStaticLocalAttr> DLLImportStaticLocalAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<DLLImportStaticLocalAttr> DLLImportStaticLocalAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
...
std::optional<DLLImportStaticLocalAttr> DLLImportStaticLocalAttr::from(const VariantEntity &e) {
