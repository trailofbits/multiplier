...
gap::generator<UnresolvedUsingTypenameDecl> UnresolvedUsingTypenameDecl::in(const Compilation &tu) {
  for (Decl res : Decl::in(tu, kUnresolvedUsingTypenameDeclDerivedKinds)) {
