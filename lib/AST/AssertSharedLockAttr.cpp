...
gap::generator<AssertSharedLockAttr> AssertSharedLockAttr::in(const Index &index) {
  ...
  for (AttrKind k : kAssertSharedLockAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<AssertSharedLockAttr> e = from_base(std::move(eptr))) {
...
gap::generator<AssertSharedLockAttr> AssertSharedLockAttr::in(const File &file) {
...
std::optional<AssertSharedLockAttr> AssertSharedLockAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<AssertSharedLockAttr> AssertSharedLockAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
...
std::optional<AssertSharedLockAttr> AssertSharedLockAttr::from(const VariantEntity &e) {
