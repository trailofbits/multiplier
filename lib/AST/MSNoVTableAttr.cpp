...
std::optional<MSNoVTableAttr> MSNoVTableAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<MSNoVTableAttr> MSNoVTableAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
...
gap::generator<MSNoVTableAttr> MSNoVTableAttr::in(const Index &index) {
  ...
  for (AttrKind k : kMSNoVTableAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<MSNoVTableAttr> e = from_base(std::move(eptr))) {
...
gap::generator<MSNoVTableAttr> MSNoVTableAttr::in(const File &file) {
...
std::optional<MSNoVTableAttr> MSNoVTableAttr::from(const VariantEntity &e) {
