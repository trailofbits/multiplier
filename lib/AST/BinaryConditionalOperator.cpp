...
gap::generator<BinaryConditionalOperator> BinaryConditionalOperator::in(const Compilation &tu) {
  for (Stmt res : Stmt::in(tu, kBinaryConditionalOperatorDerivedKinds)) {
