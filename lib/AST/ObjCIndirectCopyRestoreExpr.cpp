...
gap::generator<ObjCIndirectCopyRestoreExpr> ObjCIndirectCopyRestoreExpr::in(const Compilation &tu) {
  for (Stmt res : Stmt::in(tu, kObjCIndirectCopyRestoreExprDerivedKinds)) {
