...
gap::generator<OMPTargetTeamsDistributeSimdDirective> OMPTargetTeamsDistributeSimdDirective::in(const Compilation &tu) {
  for (Stmt res : Stmt::in(tu, kOMPTargetTeamsDistributeSimdDirectiveDerivedKinds)) {
