...
gap::generator<OMPTeamsDistributeParallelForSimdDirective> OMPTeamsDistributeParallelForSimdDirective::in(const Compilation &tu) {
  for (Stmt res : Stmt::in(tu, kOMPTeamsDistributeParallelForSimdDirectiveDerivedKinds)) {
