...
gap::generator<CXXRewrittenBinaryOperator> CXXRewrittenBinaryOperator::in(const Compilation &tu) {
  for (Stmt res : Stmt::in(tu, kCXXRewrittenBinaryOperatorDerivedKinds)) {
