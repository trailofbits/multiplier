...
std::optional<OpenCLGlobalHostAddressSpaceAttr> OpenCLGlobalHostAddressSpaceAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<OpenCLGlobalHostAddressSpaceAttr> OpenCLGlobalHostAddressSpaceAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
...
gap::generator<OpenCLGlobalHostAddressSpaceAttr> OpenCLGlobalHostAddressSpaceAttr::in(const Index &index) {
  ...
  for (AttrKind k : kOpenCLGlobalHostAddressSpaceAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<OpenCLGlobalHostAddressSpaceAttr> e = from_base(std::move(eptr))) {
...
gap::generator<OpenCLGlobalHostAddressSpaceAttr> OpenCLGlobalHostAddressSpaceAttr::in(const File &file) {
...
std::optional<OpenCLGlobalHostAddressSpaceAttr> OpenCLGlobalHostAddressSpaceAttr::from(const VariantEntity &e) {
