...
gap::generator<TransparentUnionAttr> TransparentUnionAttr::in(const Index &index) {
  ...
  for (AttrKind k : kTransparentUnionAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<TransparentUnionAttr> e = from_base(std::move(eptr))) {
...
gap::generator<TransparentUnionAttr> TransparentUnionAttr::in(const File &file) {
...
std::optional<TransparentUnionAttr> TransparentUnionAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<TransparentUnionAttr> TransparentUnionAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
...
std::optional<TransparentUnionAttr> TransparentUnionAttr::from(const VariantEntity &e) {
