...
gap::generator<OMPTargetTeamsDistributeDirective> OMPTargetTeamsDistributeDirective::in(const Index &index) {
  ...
  for (StmtKind k : kOMPTargetTeamsDistributeDirectiveDerivedKinds) {
    for (StmtImplPtr eptr : ep->StmtsFor(ep, k)) {
      if (std::optional<OMPTargetTeamsDistributeDirective> e = from_base(std::move(eptr))) {
...
gap::generator<OMPTargetTeamsDistributeDirective> OMPTargetTeamsDistributeDirective::in(const Compilation &tu) {
  for (Stmt res : Stmt::in(tu, kOMPTargetTeamsDistributeDirectiveDerivedKinds)) {
...
std::optional<OMPTargetTeamsDistributeDirective> OMPTargetTeamsDistributeDirective::from(const std::optional<Stmt> &parent) {
  if (parent) {
...
std::optional<OMPTargetTeamsDistributeDirective> OMPTargetTeamsDistributeDirective::from_base(const Stmt &parent) {
  switch (parent.kind()) {
...
std::optional<OMPTargetTeamsDistributeDirective> OMPTargetTeamsDistributeDirective::from(const VariantEntity &e) {
