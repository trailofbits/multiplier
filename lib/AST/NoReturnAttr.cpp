...
gap::generator<NoReturnAttr> NoReturnAttr::in(const Index &index) {
  ...
  for (AttrKind k : kNoReturnAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<NoReturnAttr> e = from_base(std::move(eptr))) {
...
gap::generator<NoReturnAttr> NoReturnAttr::in(const File &file) {
...
std::optional<NoReturnAttr> NoReturnAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<NoReturnAttr> NoReturnAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
...
std::optional<NoReturnAttr> NoReturnAttr::from(const VariantEntity &e) {
