...
gap::generator<DependentScopeDeclRefExpr> DependentScopeDeclRefExpr::in(const Compilation &tu) {
  for (Stmt res : Stmt::in(tu, kDependentScopeDeclRefExprDerivedKinds)) {
