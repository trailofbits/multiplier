...
std::optional<OMPParallelMasterDirective> OMPParallelMasterDirective::from(const ir::hl::Operation &op) {
...
gap::generator<std::pair<OMPParallelMasterDirective, ir::hl::Operation>> OMPParallelMasterDirective::in(const Compilation &tu) {
  for (std::pair<Stmt, ir::hl::Operation> res : Stmt::in(tu, kOMPParallelMasterDirectiveDerivedKinds)) {
    if (auto val = from_base(res.first)) {
      co_yield std::pair<OMPParallelMasterDirective, ir::hl::Operation>(std::move(val.value()), std::move(res.second));
    }
  }
}
...
std::optional<OMPParallelMasterDirective> OMPParallelMasterDirective::from(const std::optional<Stmt> &parent) {
  if (parent) {
...
std::optional<OMPParallelMasterDirective> OMPParallelMasterDirective::from_base(const Stmt &parent) {
  switch (parent.kind()) {
...
gap::generator<OMPParallelMasterDirective> OMPParallelMasterDirective::in(const Index &index) {
  ...
  for (StmtKind k : kOMPParallelMasterDirectiveDerivedKinds) {
    for (StmtImplPtr eptr : ep->StmtsFor(ep, k)) {
      if (std::optional<OMPParallelMasterDirective> e = from_base(std::move(eptr))) {
...
std::optional<OMPParallelMasterDirective> OMPParallelMasterDirective::from(const VariantEntity &e) {
