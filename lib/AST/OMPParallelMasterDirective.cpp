...
gap::generator<OMPParallelMasterDirective> OMPParallelMasterDirective::in(const Compilation &tu) {
  for (Stmt res : Stmt::in(tu, kOMPParallelMasterDirectiveDerivedKinds)) {
