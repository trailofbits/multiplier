...
gap::generator<OMPTargetParallelDirective> OMPTargetParallelDirective::in(const Compilation &tu) {
  for (Stmt res : Stmt::in(tu, kOMPTargetParallelDirectiveDerivedKinds)) {
