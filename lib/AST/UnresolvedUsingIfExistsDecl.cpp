...
gap::generator<UnresolvedUsingIfExistsDecl> UnresolvedUsingIfExistsDecl::in(const Compilation &tu) {
  for (Decl res : Decl::in(tu, kUnresolvedUsingIfExistsDeclDerivedKinds)) {
