...
std::optional<CUDAConstantAttr> CUDAConstantAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<CUDAConstantAttr> CUDAConstantAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
...
gap::generator<CUDAConstantAttr> CUDAConstantAttr::in(const Index &index) {
  ...
  for (AttrKind k : kCUDAConstantAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<CUDAConstantAttr> e = from_base(std::move(eptr))) {
...
std::optional<CUDAConstantAttr> CUDAConstantAttr::from(const VariantEntity &e) {
