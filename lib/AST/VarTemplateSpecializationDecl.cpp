...
gap::generator<VarTemplateSpecializationDecl> VarTemplateSpecializationDecl::in(const Compilation &tu) {
  for (Decl res : Decl::in(tu, kVarTemplateSpecializationDeclDerivedKinds)) {
