...
std::optional<OMPFlushDirective> OMPFlushDirective::from(const ir::hl::Operation &op) {
...
gap::generator<std::pair<OMPFlushDirective, ir::hl::Operation>> OMPFlushDirective::in(const Compilation &tu) {
  for (std::pair<Stmt, ir::hl::Operation> res : Stmt::in(tu, kOMPFlushDirectiveDerivedKinds)) {
    if (auto val = from_base(res.first)) {
      co_yield std::pair<OMPFlushDirective, ir::hl::Operation>(std::move(val.value()), std::move(res.second));
    }
  }
}
...
std::optional<OMPFlushDirective> OMPFlushDirective::from(const std::optional<Stmt> &parent) {
  if (parent) {
...
std::optional<OMPFlushDirective> OMPFlushDirective::from_base(const Stmt &parent) {
  switch (parent.kind()) {
...
gap::generator<OMPFlushDirective> OMPFlushDirective::in(const Index &index) {
  ...
  for (StmtKind k : kOMPFlushDirectiveDerivedKinds) {
    for (StmtImplPtr eptr : ep->StmtsFor(ep, k)) {
      if (std::optional<OMPFlushDirective> e = from_base(std::move(eptr))) {
...
gap::generator<OMPFlushDirective> OMPFlushDirective::in(const File &file) {
...
std::optional<OMPFlushDirective> OMPFlushDirective::from(const VariantEntity &e) {
