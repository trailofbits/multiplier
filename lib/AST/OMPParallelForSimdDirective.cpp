...
gap::generator<OMPParallelForSimdDirective> OMPParallelForSimdDirective::in(const Compilation &tu) {
  for (Stmt res : Stmt::in(tu, kOMPParallelForSimdDirectiveDerivedKinds)) {
