...
std::optional<AlwaysInlineAttr> AlwaysInlineAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<AlwaysInlineAttr> AlwaysInlineAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
...
std::optional<AlwaysInlineAttr> AlwaysInlineAttr::from(const VariantEntity &e) {
