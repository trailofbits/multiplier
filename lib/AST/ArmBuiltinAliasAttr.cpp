...
std::optional<ArmBuiltinAliasAttr> ArmBuiltinAliasAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<ArmBuiltinAliasAttr> ArmBuiltinAliasAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
...
gap::generator<ArmBuiltinAliasAttr> ArmBuiltinAliasAttr::in(const Index &index) {
  ...
  for (AttrKind k : kArmBuiltinAliasAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<ArmBuiltinAliasAttr> e = from_base(std::move(eptr))) {
...
gap::generator<ArmBuiltinAliasAttr> ArmBuiltinAliasAttr::in(const File &file) {
...
std::optional<ArmBuiltinAliasAttr> ArmBuiltinAliasAttr::from(const VariantEntity &e) {
