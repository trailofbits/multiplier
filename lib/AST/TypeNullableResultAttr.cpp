...
gap::generator<TypeNullableResultAttr> TypeNullableResultAttr::in(const Index &index) {
  ...
  for (AttrKind k : kTypeNullableResultAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<TypeNullableResultAttr> e = from_base(std::move(eptr))) {
...
gap::generator<TypeNullableResultAttr> TypeNullableResultAttr::in(const File &file) {
...
std::optional<TypeNullableResultAttr> TypeNullableResultAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<TypeNullableResultAttr> TypeNullableResultAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
...
std::optional<TypeNullableResultAttr> TypeNullableResultAttr::from(const VariantEntity &e) {
