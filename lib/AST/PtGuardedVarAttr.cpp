...
std::optional<PtGuardedVarAttr> PtGuardedVarAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<PtGuardedVarAttr> PtGuardedVarAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
...
gap::generator<PtGuardedVarAttr> PtGuardedVarAttr::in(const Index &index) {
  ...
  for (AttrKind k : kPtGuardedVarAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<PtGuardedVarAttr> e = from_base(std::move(eptr))) {
...
gap::generator<PtGuardedVarAttr> PtGuardedVarAttr::in(const File &file) {
...
std::optional<PtGuardedVarAttr> PtGuardedVarAttr::from(const VariantEntity &e) {
