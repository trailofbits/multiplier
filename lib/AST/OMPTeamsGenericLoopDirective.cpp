...
gap::generator<OMPTeamsGenericLoopDirective> OMPTeamsGenericLoopDirective::in(const Compilation &tu) {
  for (Stmt res : Stmt::in(tu, kOMPTeamsGenericLoopDirectiveDerivedKinds)) {
