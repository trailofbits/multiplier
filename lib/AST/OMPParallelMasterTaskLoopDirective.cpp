...
gap::generator<OMPParallelMasterTaskLoopDirective> OMPParallelMasterTaskLoopDirective::in(const Compilation &tu) {
  for (Stmt res : Stmt::in(tu, kOMPParallelMasterTaskLoopDirectiveDerivedKinds)) {
