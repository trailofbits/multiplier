...
std::optional<OMPDepobjDirective> OMPDepobjDirective::from(const ir::hl::Operation &op) {
...
gap::generator<std::pair<OMPDepobjDirective, ir::hl::Operation>> OMPDepobjDirective::in(const Compilation &tu) {
  for (std::pair<Stmt, ir::hl::Operation> res : Stmt::in(tu, kOMPDepobjDirectiveDerivedKinds)) {
    if (auto val = from_base(res.first)) {
      co_yield std::pair<OMPDepobjDirective, ir::hl::Operation>(std::move(val.value()), std::move(res.second));
    }
  }
}
