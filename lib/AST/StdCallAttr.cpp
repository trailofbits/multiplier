...
gap::generator<StdCallAttr> StdCallAttr::in(const Index &index) {
  ...
  for (AttrKind k : kStdCallAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<StdCallAttr> e = from_base(std::move(eptr))) {
...
std::optional<StdCallAttr> StdCallAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<StdCallAttr> StdCallAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
...
std::optional<StdCallAttr> StdCallAttr::from(const Reference &r) {
  return StdCallAttr::from(r.as_attribute());
}

std::optional<StdCallAttr> StdCallAttr::from(const VariantEntity &e) {
...
std::optional<StdCallAttr> StdCallAttr::from(const TokenContext &t) {
