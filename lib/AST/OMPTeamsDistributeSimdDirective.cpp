...
gap::generator<OMPTeamsDistributeSimdDirective> OMPTeamsDistributeSimdDirective::in(const Compilation &tu) {
  for (Stmt res : Stmt::in(tu, kOMPTeamsDistributeSimdDirectiveDerivedKinds)) {
