...
gap::generator<OMPTargetTeamsDistributeParallelForDirective> OMPTargetTeamsDistributeParallelForDirective::in(const Compilation &tu) {
  for (Stmt res : Stmt::in(tu, kOMPTargetTeamsDistributeParallelForDirectiveDerivedKinds)) {
