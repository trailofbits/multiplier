...
std::optional<OMPParallelSectionsDirective> OMPParallelSectionsDirective::from(const ir::hl::Operation &op) {
...
gap::generator<std::pair<OMPParallelSectionsDirective, ir::hl::Operation>> OMPParallelSectionsDirective::in(const Compilation &tu) {
  for (std::pair<Stmt, ir::hl::Operation> res : Stmt::in(tu, kOMPParallelSectionsDirectiveDerivedKinds)) {
    if (auto val = from_base(res.first)) {
      co_yield std::pair<OMPParallelSectionsDirective, ir::hl::Operation>(std::move(val.value()), std::move(res.second));
    }
  }
}
...
std::optional<OMPParallelSectionsDirective> OMPParallelSectionsDirective::from(const std::optional<Stmt> &parent) {
  if (parent) {
...
std::optional<OMPParallelSectionsDirective> OMPParallelSectionsDirective::from_base(const Stmt &parent) {
  switch (parent.kind()) {
...
gap::generator<OMPParallelSectionsDirective> OMPParallelSectionsDirective::in(const Index &index) {
  ...
  for (StmtKind k : kOMPParallelSectionsDirectiveDerivedKinds) {
    for (StmtImplPtr eptr : ep->StmtsFor(ep, k)) {
      if (std::optional<OMPParallelSectionsDirective> e = from_base(std::move(eptr))) {
...
std::optional<OMPParallelSectionsDirective> OMPParallelSectionsDirective::from(const VariantEntity &e) {
