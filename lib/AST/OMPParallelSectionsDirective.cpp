...
gap::generator<OMPParallelSectionsDirective> OMPParallelSectionsDirective::in(const Compilation &tu) {
  for (Stmt res : Stmt::in(tu, kOMPParallelSectionsDirectiveDerivedKinds)) {
