...
std::optional<MSInheritanceAttr> MSInheritanceAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<MSInheritanceAttr> MSInheritanceAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
...
std::optional<MSInheritanceAttr> MSInheritanceAttr::from(const VariantEntity &e) {
