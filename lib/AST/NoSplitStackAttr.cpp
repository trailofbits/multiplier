...
gap::generator<NoSplitStackAttr> NoSplitStackAttr::in(const Index &index) {
  ...
  for (AttrKind k : kNoSplitStackAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<NoSplitStackAttr> e = from_base(std::move(eptr))) {
...
std::optional<NoSplitStackAttr> NoSplitStackAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<NoSplitStackAttr> NoSplitStackAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
...
std::optional<NoSplitStackAttr> NoSplitStackAttr::from(const VariantEntity &e) {
