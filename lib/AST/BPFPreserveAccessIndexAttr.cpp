...
gap::generator<BPFPreserveAccessIndexAttr> BPFPreserveAccessIndexAttr::in(const Index &index) {
  ...
  for (AttrKind k : kBPFPreserveAccessIndexAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<BPFPreserveAccessIndexAttr> e = from_base(std::move(eptr))) {
...
std::optional<BPFPreserveAccessIndexAttr> BPFPreserveAccessIndexAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<BPFPreserveAccessIndexAttr> BPFPreserveAccessIndexAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
...
std::optional<BPFPreserveAccessIndexAttr> BPFPreserveAccessIndexAttr::from(const VariantEntity &e) {
