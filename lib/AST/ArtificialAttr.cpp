...
gap::generator<ArtificialAttr> ArtificialAttr::in(const Index &index) {
  ...
  for (AttrKind k : kArtificialAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<ArtificialAttr> e = from_base(std::move(eptr))) {
...
gap::generator<ArtificialAttr> ArtificialAttr::in(const File &file) {
...
std::optional<ArtificialAttr> ArtificialAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<ArtificialAttr> ArtificialAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
...
std::optional<ArtificialAttr> ArtificialAttr::from(const VariantEntity &e) {
