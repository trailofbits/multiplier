...
std::optional<ConstructorAttr> ConstructorAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<ConstructorAttr> ConstructorAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
...
gap::generator<ConstructorAttr> ConstructorAttr::in(const Index &index) {
  ...
  for (AttrKind k : kConstructorAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<ConstructorAttr> e = from_base(std::move(eptr))) {
...
std::optional<ConstructorAttr> ConstructorAttr::from(const VariantEntity &e) {
