...
gap::generator<ConceptSpecializationExpr> ConceptSpecializationExpr::in(const Compilation &tu) {
  for (Stmt res : Stmt::in(tu, kConceptSpecializationExprDerivedKinds)) {
