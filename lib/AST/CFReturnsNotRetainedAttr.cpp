...
gap::generator<CFReturnsNotRetainedAttr> CFReturnsNotRetainedAttr::in(const Index &index) {
  ...
  for (AttrKind k : kCFReturnsNotRetainedAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<CFReturnsNotRetainedAttr> e = from_base(std::move(eptr))) {
...
std::optional<CFReturnsNotRetainedAttr> CFReturnsNotRetainedAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<CFReturnsNotRetainedAttr> CFReturnsNotRetainedAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
...
std::optional<CFReturnsNotRetainedAttr> CFReturnsNotRetainedAttr::from(const VariantEntity &e) {
