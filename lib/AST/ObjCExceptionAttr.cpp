...
gap::generator<ObjCExceptionAttr> ObjCExceptionAttr::in(const Index &index) {
  ...
  for (AttrKind k : kObjCExceptionAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<ObjCExceptionAttr> e = from_base(std::move(eptr))) {
...
gap::generator<ObjCExceptionAttr> ObjCExceptionAttr::in(const File &file) {
...
std::optional<ObjCExceptionAttr> ObjCExceptionAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<ObjCExceptionAttr> ObjCExceptionAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
...
std::optional<ObjCExceptionAttr> ObjCExceptionAttr::from(const VariantEntity &e) {
