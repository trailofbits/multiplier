...
std::optional<CXXBoolLiteralExpr> CXXBoolLiteralExpr::from(const ir::hl::Operation &op) {
...
gap::generator<std::pair<CXXBoolLiteralExpr, ir::hl::Operation>> CXXBoolLiteralExpr::in(const Compilation &tu) {
  for (std::pair<Stmt, ir::hl::Operation> res : Stmt::in(tu, kCXXBoolLiteralExprDerivedKinds)) {
    if (auto val = from_base(res.first)) {
      co_yield std::pair<CXXBoolLiteralExpr, ir::hl::Operation>(std::move(val.value()), std::move(res.second));
    }
  }
}
...
std::optional<CXXBoolLiteralExpr> CXXBoolLiteralExpr::from(const std::optional<Stmt> &parent) {
  if (parent) {
...
std::optional<CXXBoolLiteralExpr> CXXBoolLiteralExpr::from_base(const Stmt &parent) {
  switch (parent.kind()) {
...
gap::generator<CXXBoolLiteralExpr> CXXBoolLiteralExpr::in(const Index &index) {
  ...
  for (StmtKind k : kCXXBoolLiteralExprDerivedKinds) {
    for (StmtImplPtr eptr : ep->StmtsFor(ep, k)) {
      if (std::optional<CXXBoolLiteralExpr> e = from_base(std::move(eptr))) {
...
std::optional<CXXBoolLiteralExpr> CXXBoolLiteralExpr::from(const VariantEntity &e) {
