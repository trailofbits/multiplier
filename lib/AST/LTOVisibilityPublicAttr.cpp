...
std::optional<LTOVisibilityPublicAttr> LTOVisibilityPublicAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<LTOVisibilityPublicAttr> LTOVisibilityPublicAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
...
gap::generator<LTOVisibilityPublicAttr> LTOVisibilityPublicAttr::in(const Index &index) {
  ...
  for (AttrKind k : kLTOVisibilityPublicAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<LTOVisibilityPublicAttr> e = from_base(std::move(eptr))) {
...
gap::generator<LTOVisibilityPublicAttr> LTOVisibilityPublicAttr::in(const File &file) {
...
std::optional<LTOVisibilityPublicAttr> LTOVisibilityPublicAttr::from(const VariantEntity &e) {
