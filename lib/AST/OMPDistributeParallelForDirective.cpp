...
gap::generator<OMPDistributeParallelForDirective> OMPDistributeParallelForDirective::in(const Compilation &tu) {
  for (Stmt res : Stmt::in(tu, kOMPDistributeParallelForDirectiveDerivedKinds)) {
