...
gap::generator<CXXStdInitializerListExpr> CXXStdInitializerListExpr::in(const Compilation &tu) {
  for (Stmt res : Stmt::in(tu, kCXXStdInitializerListExprDerivedKinds)) {
