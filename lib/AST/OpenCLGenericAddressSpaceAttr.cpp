...
gap::generator<OpenCLGenericAddressSpaceAttr> OpenCLGenericAddressSpaceAttr::in(const Index &index) {
  ...
  for (AttrKind k : kOpenCLGenericAddressSpaceAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<OpenCLGenericAddressSpaceAttr> e = from_base(std::move(eptr))) {
...
std::optional<OpenCLGenericAddressSpaceAttr> OpenCLGenericAddressSpaceAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<OpenCLGenericAddressSpaceAttr> OpenCLGenericAddressSpaceAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
...
std::optional<OpenCLGenericAddressSpaceAttr> OpenCLGenericAddressSpaceAttr::from(const VariantEntity &e) {
