...
std::optional<NoSpeculativeLoadHardeningAttr> NoSpeculativeLoadHardeningAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<NoSpeculativeLoadHardeningAttr> NoSpeculativeLoadHardeningAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
...
gap::generator<NoSpeculativeLoadHardeningAttr> NoSpeculativeLoadHardeningAttr::in(const Index &index) {
  ...
  for (AttrKind k : kNoSpeculativeLoadHardeningAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<NoSpeculativeLoadHardeningAttr> e = from_base(std::move(eptr))) {
...
gap::generator<NoSpeculativeLoadHardeningAttr> NoSpeculativeLoadHardeningAttr::in(const File &file) {
...
std::optional<NoSpeculativeLoadHardeningAttr> NoSpeculativeLoadHardeningAttr::from(const VariantEntity &e) {
