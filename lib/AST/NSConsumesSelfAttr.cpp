...
gap::generator<NSConsumesSelfAttr> NSConsumesSelfAttr::in(const Index &index) {
  ...
  for (AttrKind k : kNSConsumesSelfAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<NSConsumesSelfAttr> e = from_base(std::move(eptr))) {
...
gap::generator<NSConsumesSelfAttr> NSConsumesSelfAttr::in(const File &file) {
...
std::optional<NSConsumesSelfAttr> NSConsumesSelfAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<NSConsumesSelfAttr> NSConsumesSelfAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
...
std::optional<NSConsumesSelfAttr> NSConsumesSelfAttr::from(const VariantEntity &e) {
