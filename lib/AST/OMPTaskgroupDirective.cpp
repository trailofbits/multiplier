...
std::optional<OMPTaskgroupDirective> OMPTaskgroupDirective::from(const ir::hl::Operation &op) {
...
gap::generator<std::pair<OMPTaskgroupDirective, ir::hl::Operation>> OMPTaskgroupDirective::in(const Compilation &tu) {
  for (std::pair<Stmt, ir::hl::Operation> res : Stmt::in(tu, kOMPTaskgroupDirectiveDerivedKinds)) {
    if (auto val = from_base(res.first)) {
      co_yield std::pair<OMPTaskgroupDirective, ir::hl::Operation>(std::move(val.value()), std::move(res.second));
    }
  }
}
...
std::optional<OMPTaskgroupDirective> OMPTaskgroupDirective::from(const std::optional<Stmt> &parent) {
  if (parent) {
...
std::optional<OMPTaskgroupDirective> OMPTaskgroupDirective::from_base(const Stmt &parent) {
  switch (parent.kind()) {
...
gap::generator<OMPTaskgroupDirective> OMPTaskgroupDirective::in(const Index &index) {
  ...
  for (StmtKind k : kOMPTaskgroupDirectiveDerivedKinds) {
    for (StmtImplPtr eptr : ep->StmtsFor(ep, k)) {
      if (std::optional<OMPTaskgroupDirective> e = from_base(std::move(eptr))) {
...
gap::generator<OMPTaskgroupDirective> OMPTaskgroupDirective::in(const File &file) {
...
std::optional<OMPTaskgroupDirective> OMPTaskgroupDirective::from(const VariantEntity &e) {
