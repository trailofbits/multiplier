...
gap::generator<SubstNonTypeTemplateParmPackExpr> SubstNonTypeTemplateParmPackExpr::in(const Compilation &tu) {
  for (Stmt res : Stmt::in(tu, kSubstNonTypeTemplateParmPackExprDerivedKinds)) {
