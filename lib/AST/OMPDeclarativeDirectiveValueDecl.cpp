...
gap::generator<OMPDeclarativeDirectiveValueDecl> OMPDeclarativeDirectiveValueDecl::in(const Compilation &tu) {
  for (Decl res : Decl::in(tu, kOMPDeclarativeDirectiveValueDeclDerivedKinds)) {
