...
gap::generator<OMPParallelMaskedDirective> OMPParallelMaskedDirective::in(const Compilation &tu) {
  for (Stmt res : Stmt::in(tu, kOMPParallelMaskedDirectiveDerivedKinds)) {
