...
gap::generator<ObjCInertUnsafeUnretainedAttr> ObjCInertUnsafeUnretainedAttr::in(const Index &index) {
  ...
  for (AttrKind k : kObjCInertUnsafeUnretainedAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<ObjCInertUnsafeUnretainedAttr> e = from_base(std::move(eptr))) {
...
gap::generator<ObjCInertUnsafeUnretainedAttr> ObjCInertUnsafeUnretainedAttr::in(const File &file) {
...
std::optional<ObjCInertUnsafeUnretainedAttr> ObjCInertUnsafeUnretainedAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<ObjCInertUnsafeUnretainedAttr> ObjCInertUnsafeUnretainedAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
...
std::optional<ObjCInertUnsafeUnretainedAttr> ObjCInertUnsafeUnretainedAttr::from(const VariantEntity &e) {
