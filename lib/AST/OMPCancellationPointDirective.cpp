...
gap::generator<OMPCancellationPointDirective> OMPCancellationPointDirective::in(const Compilation &tu) {
  for (Stmt res : Stmt::in(tu, kOMPCancellationPointDirectiveDerivedKinds)) {
