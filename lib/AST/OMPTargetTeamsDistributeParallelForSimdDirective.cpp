...
gap::generator<OMPTargetTeamsDistributeParallelForSimdDirective> OMPTargetTeamsDistributeParallelForSimdDirective::in(const Compilation &tu) {
  for (Stmt res : Stmt::in(tu, kOMPTargetTeamsDistributeParallelForSimdDirectiveDerivedKinds)) {
