...
gap::generator<AbstractConditionalOperator> AbstractConditionalOperator::in(const Compilation &tu) {
  for (Stmt res : Stmt::in(tu, kAbstractConditionalOperatorDerivedKinds)) {
