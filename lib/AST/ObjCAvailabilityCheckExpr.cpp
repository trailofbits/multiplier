...
gap::generator<ObjCAvailabilityCheckExpr> ObjCAvailabilityCheckExpr::in(const Compilation &tu) {
  for (Stmt res : Stmt::in(tu, kObjCAvailabilityCheckExprDerivedKinds)) {
