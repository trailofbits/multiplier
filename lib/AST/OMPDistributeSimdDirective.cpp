...
gap::generator<OMPDistributeSimdDirective> OMPDistributeSimdDirective::in(const Compilation &tu) {
  for (Stmt res : Stmt::in(tu, kOMPDistributeSimdDirectiveDerivedKinds)) {
