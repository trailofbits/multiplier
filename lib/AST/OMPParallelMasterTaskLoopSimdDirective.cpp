...
std::optional<OMPParallelMasterTaskLoopSimdDirective> OMPParallelMasterTaskLoopSimdDirective::from(const ir::Operation &op) {
...
gap::generator<std::pair<OMPParallelMasterTaskLoopSimdDirective, ir::Operation>> OMPParallelMasterTaskLoopSimdDirective::in(const Compilation &tu) {
  for (std::pair<Stmt, ir::Operation> res : Stmt::in(tu, kOMPParallelMasterTaskLoopSimdDirectiveDerivedKinds)) {
    if (auto val = from_base(res.first)) {
      co_yield std::pair<OMPParallelMasterTaskLoopSimdDirective, ir::Operation>(std::move(val.value()), std::move(res.second));
    }
  }
}
