...
gap::generator<OMPParallelMasterTaskLoopSimdDirective> OMPParallelMasterTaskLoopSimdDirective::in(const Compilation &tu) {
  for (Stmt res : Stmt::in(tu, kOMPParallelMasterTaskLoopSimdDirectiveDerivedKinds)) {
