...
gap::generator<AVRInterruptAttr> AVRInterruptAttr::in(const Index &index) {
  ...
  for (AttrKind k : kAVRInterruptAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<AVRInterruptAttr> e = from_base(std::move(eptr))) {
...
std::optional<AVRInterruptAttr> AVRInterruptAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<AVRInterruptAttr> AVRInterruptAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
...
std::optional<AVRInterruptAttr> AVRInterruptAttr::from(const VariantEntity &e) {
