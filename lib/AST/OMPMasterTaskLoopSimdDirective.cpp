...
gap::generator<OMPMasterTaskLoopSimdDirective> OMPMasterTaskLoopSimdDirective::in(const Compilation &tu) {
  for (Stmt res : Stmt::in(tu, kOMPMasterTaskLoopSimdDirectiveDerivedKinds)) {
