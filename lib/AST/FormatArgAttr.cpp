...
std::optional<FormatArgAttr> FormatArgAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<FormatArgAttr> FormatArgAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
...
gap::generator<FormatArgAttr> FormatArgAttr::in(const Index &index) {
  ...
  for (AttrKind k : kFormatArgAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<FormatArgAttr> e = from_base(std::move(eptr))) {
...
gap::generator<FormatArgAttr> FormatArgAttr::in(const File &file) {
...
std::optional<FormatArgAttr> FormatArgAttr::from(const VariantEntity &e) {
