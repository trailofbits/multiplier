...
gap::generator<OMPMasterTaskLoopDirective> OMPMasterTaskLoopDirective::in(const Compilation &tu) {
  for (Stmt res : Stmt::in(tu, kOMPMasterTaskLoopDirectiveDerivedKinds)) {
