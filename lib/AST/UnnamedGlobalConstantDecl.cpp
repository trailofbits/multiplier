...
gap::generator<UnnamedGlobalConstantDecl> UnnamedGlobalConstantDecl::in(const Compilation &tu) {
  for (Decl res : Decl::in(tu, kUnnamedGlobalConstantDeclDerivedKinds)) {
