...
gap::generator<OMPMaskedTaskLoopSimdDirective> OMPMaskedTaskLoopSimdDirective::in(const Compilation &tu) {
  for (Stmt res : Stmt::in(tu, kOMPMaskedTaskLoopSimdDirectiveDerivedKinds)) {
