...
gap::generator<OMPForSimdDirective> OMPForSimdDirective::in(const Index &index) {
  ...
  for (StmtKind k : kOMPForSimdDirectiveDerivedKinds) {
    for (StmtImplPtr eptr : ep->StmtsFor(ep, k)) {
      if (std::optional<OMPForSimdDirective> e = from_base(std::move(eptr))) {
...
gap::generator<OMPForSimdDirective> OMPForSimdDirective::in(const File &file) {
...
gap::generator<OMPForSimdDirective> OMPForSimdDirective::in(const Compilation &tu) {
  for (Stmt res : Stmt::in(tu, kOMPForSimdDirectiveDerivedKinds)) {
...
std::optional<OMPForSimdDirective> OMPForSimdDirective::from(const std::optional<Stmt> &parent) {
  if (parent) {
...
std::optional<OMPForSimdDirective> OMPForSimdDirective::from(const VariantEntity &e) {
