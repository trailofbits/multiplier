...
const char *EnumeratorName(AtomicExprAtomicOp e) {
  switch (e) {
    ...
    case AtomicExprAtomicOp::SCOPED_ATOMIC_LOAD: return "SCOPED_ATOMIC_LOAD";
    case AtomicExprAtomicOp::SCOPED_ATOMIC_LOAD_N: return "SCOPED_ATOMIC_LOAD_N";
    case AtomicExprAtomicOp::SCOPED_ATOMIC_STORE: return "SCOPED_ATOMIC_STORE";
    case AtomicExprAtomicOp::SCOPED_ATOMIC_STORE_N: return "SCOPED_ATOMIC_STORE_N";
    case AtomicExprAtomicOp::SCOPED_ATOMIC_EXCHANGE: return "SCOPED_ATOMIC_EXCHANGE";
    case AtomicExprAtomicOp::SCOPED_ATOMIC_EXCHANGE_N: return "SCOPED_ATOMIC_EXCHANGE_N";
    case AtomicExprAtomicOp::SCOPED_ATOMIC_COMPARE_EXCHANGE: return "SCOPED_ATOMIC_COMPARE_EXCHANGE";
    case AtomicExprAtomicOp::SCOPED_ATOMIC_COMPARE_EXCHANGE_N: return "SCOPED_ATOMIC_COMPARE_EXCHANGE_N";
    case AtomicExprAtomicOp::SCOPED_ATOMIC_FETCH_ADD: return "SCOPED_ATOMIC_FETCH_ADD";
    case AtomicExprAtomicOp::SCOPED_ATOMIC_FETCH_SUB: return "SCOPED_ATOMIC_FETCH_SUB";
    case AtomicExprAtomicOp::SCOPED_ATOMIC_FETCH_AND: return "SCOPED_ATOMIC_FETCH_AND";
    case AtomicExprAtomicOp::SCOPED_ATOMIC_FETCH_OR: return "SCOPED_ATOMIC_FETCH_OR";
    case AtomicExprAtomicOp::SCOPED_ATOMIC_FETCH_XOR: return "SCOPED_ATOMIC_FETCH_XOR";
    case AtomicExprAtomicOp::SCOPED_ATOMIC_FETCH_NAND: return "SCOPED_ATOMIC_FETCH_NAND";
    case AtomicExprAtomicOp::SCOPED_ATOMIC_ADD_FETCH: return "SCOPED_ATOMIC_ADD_FETCH";
    case AtomicExprAtomicOp::SCOPED_ATOMIC_SUB_FETCH: return "SCOPED_ATOMIC_SUB_FETCH";
    case AtomicExprAtomicOp::SCOPED_ATOMIC_AND_FETCH: return "SCOPED_ATOMIC_AND_FETCH";
    case AtomicExprAtomicOp::SCOPED_ATOMIC_OR_FETCH: return "SCOPED_ATOMIC_OR_FETCH";
    case AtomicExprAtomicOp::SCOPED_ATOMIC_XOR_FETCH: return "SCOPED_ATOMIC_XOR_FETCH";
    case AtomicExprAtomicOp::SCOPED_ATOMIC_MAX_FETCH: return "SCOPED_ATOMIC_MAX_FETCH";
    case AtomicExprAtomicOp::SCOPED_ATOMIC_MIN_FETCH: return "SCOPED_ATOMIC_MIN_FETCH";
    case AtomicExprAtomicOp::SCOPED_ATOMIC_NAND_FETCH: return "SCOPED_ATOMIC_NAND_FETCH";
    case AtomicExprAtomicOp::SCOPED_ATOMIC_FETCH_MIN: return "SCOPED_ATOMIC_FETCH_MIN";
    case AtomicExprAtomicOp::SCOPED_ATOMIC_FETCH_MAX: return "SCOPED_ATOMIC_FETCH_MAX";
