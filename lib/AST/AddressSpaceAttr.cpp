...
gap::generator<AddressSpaceAttr> AddressSpaceAttr::in(const Index &index) {
  ...
  for (AttrKind k : kAddressSpaceAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<AddressSpaceAttr> e = from_base(std::move(eptr))) {
...
std::optional<AddressSpaceAttr> AddressSpaceAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<AddressSpaceAttr> AddressSpaceAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
...
std::optional<AddressSpaceAttr> AddressSpaceAttr::from(const VariantEntity &e) {
