...
gap::generator<OMPTargetParallelForSimdDirective> OMPTargetParallelForSimdDirective::in(const Compilation &tu) {
  for (Stmt res : Stmt::in(tu, kOMPTargetParallelForSimdDirectiveDerivedKinds)) {
