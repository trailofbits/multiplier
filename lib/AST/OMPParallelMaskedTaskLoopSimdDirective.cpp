...
std::optional<OMPParallelMaskedTaskLoopSimdDirective> OMPParallelMaskedTaskLoopSimdDirective::from(const ir::hl::Operation &op) {
...
gap::generator<std::pair<OMPParallelMaskedTaskLoopSimdDirective, ir::hl::Operation>> OMPParallelMaskedTaskLoopSimdDirective::in(const Compilation &tu) {
  for (std::pair<Stmt, ir::hl::Operation> res : Stmt::in(tu, kOMPParallelMaskedTaskLoopSimdDirectiveDerivedKinds)) {
    if (auto val = from_base(res.first)) {
      co_yield std::pair<OMPParallelMaskedTaskLoopSimdDirective, ir::hl::Operation>(std::move(val.value()), std::move(res.second));
    }
  }
}
