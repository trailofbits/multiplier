...
gap::generator<OMPParallelMaskedTaskLoopSimdDirective> OMPParallelMaskedTaskLoopSimdDirective::in(const Compilation &tu) {
  for (Stmt res : Stmt::in(tu, kOMPParallelMaskedTaskLoopSimdDirectiveDerivedKinds)) {
