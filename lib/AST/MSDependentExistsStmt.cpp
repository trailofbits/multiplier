...
std::optional<MSDependentExistsStmt> MSDependentExistsStmt::from(const ir::Operation &op) {
...
gap::generator<std::pair<MSDependentExistsStmt, ir::Operation>> MSDependentExistsStmt::in(const Compilation &tu) {
  for (std::pair<Stmt, ir::Operation> res : Stmt::in(tu, kMSDependentExistsStmtDerivedKinds)) {
    if (auto val = from_base(res.first)) {
      co_yield std::pair<MSDependentExistsStmt, ir::Operation>(std::move(val.value()), std::move(res.second));
    }
  }
}
...
std::optional<MSDependentExistsStmt> MSDependentExistsStmt::from(const std::optional<Stmt> &parent) {
  if (parent) {
...
gap::generator<MSDependentExistsStmt> MSDependentExistsStmt::in(const Index &index) {
  ...
  for (StmtKind k : kMSDependentExistsStmtDerivedKinds) {
    for (StmtImplPtr eptr : ep->StmtsFor(ep, k)) {
      if (std::optional<MSDependentExistsStmt> e = from_base(std::move(eptr))) {
...
std::optional<MSDependentExistsStmt> MSDependentExistsStmt::from(const VariantEntity &e) {
