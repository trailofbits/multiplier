...
std::optional<ArgumentWithTypeTagAttr> ArgumentWithTypeTagAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<ArgumentWithTypeTagAttr> ArgumentWithTypeTagAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
...
gap::generator<ArgumentWithTypeTagAttr> ArgumentWithTypeTagAttr::in(const Index &index) {
  ...
  for (AttrKind k : kArgumentWithTypeTagAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<ArgumentWithTypeTagAttr> e = from_base(std::move(eptr))) {
...
gap::generator<ArgumentWithTypeTagAttr> ArgumentWithTypeTagAttr::in(const File &file) {
...
std::optional<ArgumentWithTypeTagAttr> ArgumentWithTypeTagAttr::from(const VariantEntity &e) {
