...
gap::generator<LocksExcludedAttr> LocksExcludedAttr::in(const Index &index) {
  ...
  for (AttrKind k : kLocksExcludedAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<LocksExcludedAttr> e = from_base(std::move(eptr))) {
...
gap::generator<LocksExcludedAttr> LocksExcludedAttr::in(const File &file) {
...
std::optional<LocksExcludedAttr> LocksExcludedAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<LocksExcludedAttr> LocksExcludedAttr::from(const VariantEntity &e) {
