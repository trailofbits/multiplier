...
std::optional<NoMicroMipsAttr> NoMicroMipsAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<NoMicroMipsAttr> NoMicroMipsAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
...
gap::generator<NoMicroMipsAttr> NoMicroMipsAttr::in(const Index &index) {
  ...
  for (AttrKind k : kNoMicroMipsAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<NoMicroMipsAttr> e = from_base(std::move(eptr))) {
...
gap::generator<NoMicroMipsAttr> NoMicroMipsAttr::in(const File &file) {
...
std::optional<NoMicroMipsAttr> NoMicroMipsAttr::from(const Reference &r) {
  return NoMicroMipsAttr::from(r.as_attribute());
}

std::optional<NoMicroMipsAttr> NoMicroMipsAttr::from(const VariantEntity &e) {
...
std::optional<NoMicroMipsAttr> NoMicroMipsAttr::from(const TokenContext &t) {
