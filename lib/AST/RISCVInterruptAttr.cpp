...
gap::generator<RISCVInterruptAttr> RISCVInterruptAttr::in(const Index &index) {
  ...
  for (AttrKind k : kRISCVInterruptAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<RISCVInterruptAttr> e = from_base(std::move(eptr))) {
...
gap::generator<RISCVInterruptAttr> RISCVInterruptAttr::in(const File &file) {
...
std::optional<RISCVInterruptAttr> RISCVInterruptAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<RISCVInterruptAttr> RISCVInterruptAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
...
std::optional<RISCVInterruptAttr> RISCVInterruptAttr::from(const VariantEntity &e) {
