...
std::optional<ObjCStringLiteral> ObjCStringLiteral::from(const ir::hl::Operation &op) {
...
gap::generator<std::pair<ObjCStringLiteral, ir::hl::Operation>> ObjCStringLiteral::in(const Compilation &tu) {
  for (std::pair<Stmt, ir::hl::Operation> res : Stmt::in(tu, kObjCStringLiteralDerivedKinds)) {
    if (auto val = from_base(res.first)) {
      co_yield std::pair<ObjCStringLiteral, ir::hl::Operation>(std::move(val.value()), std::move(res.second));
    }
  }
}
...
std::optional<ObjCStringLiteral> ObjCStringLiteral::from(const std::optional<Stmt> &parent) {
  if (parent) {
...
std::optional<ObjCStringLiteral> ObjCStringLiteral::from_base(const Stmt &parent) {
  switch (parent.kind()) {
...
gap::generator<ObjCStringLiteral> ObjCStringLiteral::in(const Index &index) {
  ...
  for (StmtKind k : kObjCStringLiteralDerivedKinds) {
    for (StmtImplPtr eptr : ep->StmtsFor(ep, k)) {
      if (std::optional<ObjCStringLiteral> e = from_base(std::move(eptr))) {
...
gap::generator<ObjCStringLiteral> ObjCStringLiteral::in(const File &file) {
...
std::optional<ObjCStringLiteral> ObjCStringLiteral::from(const VariantEntity &e) {
