...
gap::generator<OpenCLUnrollHintAttr> OpenCLUnrollHintAttr::in(const Index &index) {
  ...
  for (AttrKind k : kOpenCLUnrollHintAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<OpenCLUnrollHintAttr> e = from_base(std::move(eptr))) {
...
std::optional<OpenCLUnrollHintAttr> OpenCLUnrollHintAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<OpenCLUnrollHintAttr> OpenCLUnrollHintAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
...
std::optional<OpenCLUnrollHintAttr> OpenCLUnrollHintAttr::from(const VariantEntity &e) {
