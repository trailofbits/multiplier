...
std::optional<ExcludeFromExplicitInstantiationAttr> ExcludeFromExplicitInstantiationAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<ExcludeFromExplicitInstantiationAttr> ExcludeFromExplicitInstantiationAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
...
gap::generator<ExcludeFromExplicitInstantiationAttr> ExcludeFromExplicitInstantiationAttr::in(const Index &index) {
  ...
  for (AttrKind k : kExcludeFromExplicitInstantiationAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<ExcludeFromExplicitInstantiationAttr> e = from_base(std::move(eptr))) {
...
gap::generator<ExcludeFromExplicitInstantiationAttr> ExcludeFromExplicitInstantiationAttr::in(const File &file) {
...
std::optional<ExcludeFromExplicitInstantiationAttr> ExcludeFromExplicitInstantiationAttr::from(const VariantEntity &e) {
