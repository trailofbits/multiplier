...
gap::generator<OSReturnsNotRetainedAttr> OSReturnsNotRetainedAttr::in(const Index &index) {
  ...
  for (AttrKind k : kOSReturnsNotRetainedAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<OSReturnsNotRetainedAttr> e = from_base(std::move(eptr))) {
...
gap::generator<OSReturnsNotRetainedAttr> OSReturnsNotRetainedAttr::in(const File &file) {
...
std::optional<OSReturnsNotRetainedAttr> OSReturnsNotRetainedAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<OSReturnsNotRetainedAttr> OSReturnsNotRetainedAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
...
std::optional<OSReturnsNotRetainedAttr> OSReturnsNotRetainedAttr::from(const Reference &r) {
  return OSReturnsNotRetainedAttr::from(r.as_attribute());
}

std::optional<OSReturnsNotRetainedAttr> OSReturnsNotRetainedAttr::from(const VariantEntity &e) {
...
std::optional<OSReturnsNotRetainedAttr> OSReturnsNotRetainedAttr::from(const TokenContext &t) {
