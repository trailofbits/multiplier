...
std::optional<ReinitializesAttr> ReinitializesAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<ReinitializesAttr> ReinitializesAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
...
gap::generator<ReinitializesAttr> ReinitializesAttr::in(const Index &index) {
  ...
  for (AttrKind k : kReinitializesAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<ReinitializesAttr> e = from_base(std::move(eptr))) {
...
gap::generator<ReinitializesAttr> ReinitializesAttr::in(const File &file) {
...
std::optional<ReinitializesAttr> ReinitializesAttr::from(const VariantEntity &e) {
