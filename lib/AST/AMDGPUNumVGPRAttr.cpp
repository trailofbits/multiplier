...
gap::generator<AMDGPUNumVGPRAttr> AMDGPUNumVGPRAttr::in(const Index &index) {
  ...
  for (AttrKind k : kAMDGPUNumVGPRAttrDerivedKinds) {
    for (AttrImplPtr eptr : ep->AttrsFor(ep, k)) {
      if (std::optional<AMDGPUNumVGPRAttr> e = from_base(std::move(eptr))) {
...
std::optional<AMDGPUNumVGPRAttr> AMDGPUNumVGPRAttr::from(const std::optional<Attr> &parent) {
  if (parent) {
...
std::optional<AMDGPUNumVGPRAttr> AMDGPUNumVGPRAttr::from_base(const Attr &parent) {
  switch (parent.kind()) {
...
std::optional<AMDGPUNumVGPRAttr> AMDGPUNumVGPRAttr::from(const VariantEntity &e) {
