...
std::optional<OMPTargetDataDirective> OMPTargetDataDirective::from(const ir::hl::Operation &op) {
...
gap::generator<std::pair<OMPTargetDataDirective, ir::hl::Operation>> OMPTargetDataDirective::in(const Compilation &tu) {
  for (std::pair<Stmt, ir::hl::Operation> res : Stmt::in(tu, kOMPTargetDataDirectiveDerivedKinds)) {
    if (auto val = from_base(res.first)) {
      co_yield std::pair<OMPTargetDataDirective, ir::hl::Operation>(std::move(val.value()), std::move(res.second));
    }
  }
}
...
std::optional<OMPTargetDataDirective> OMPTargetDataDirective::from(const Reference &r) {
