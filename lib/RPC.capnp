...
struct Fragment @0xe5f27760091f9a3a {
  ...
  irSwitchCasesRemoved @31 :Void;  # Removed: switch cases are now IRStructure entities
  irStructures @34 :List(IR.Structure);
  irEntityPool @32 :List(UInt64);  # Shared entity ID pool for all IR entities
  irIntPool @33 :List(Int64);      # Shared integer/constant pool
}
...
struct Compilation @0xc8b5fa5dd0739e82 {
  ...
  # List of builtin-defined macros that were used during this compilation.
  builtinMacroIds @2 :List(UInt64);

  # List of command-line defined macros used by this compilation.
  commandLineMacroIds @3 :List(UInt64);

  # List of source-defined macros that were used by this compilation.
  macroIds @4 :List(UInt64);
