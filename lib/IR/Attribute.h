...
#define MX_IR_FOR_EACH_MLIR_ATTRIBUTE(_builtin, _llvm, _scf, _memref, _ll, _hl, _core, _meta) \
   ...
   _llvm(DIVoidResultTypeAttr, AttributeKind::DIVOIDRESULTTYPEATTR, mlir::LLVM::DIVoidResultTypeAttr) \
   ...
   _llvm(LoopOptionsAttr, AttributeKind::LOOPOPTIONSATTR, mlir::LLVM::LoopOptionsAttr) \
   _hl(AnnotationAttr, AttributeKind::ANNOTATIONATTR, vast::hl::AnnotationAttr) \
   _hl(BooleanAttr, AttributeKind::BOOLEANATTR, vast::hl::BooleanAttr) \
   ...
   _hl(FloatAttr, AttributeKind::FLOATATTR, vast::hl::FloatAttr) \
   _hl(IntegerAttr, AttributeKind::INTEGERATTR, vast::hl::IntegerAttr) \
   _hl(StringAttr, AttributeKind::STRINGATTR, vast::hl::StringAttr) \
   _hl(StringLiteralAttr, AttributeKind::STRINGLITERALATTR, vast::hl::StringLiteralAttr) \
...
#define MX_IR_NUM_MLIR_ATTRIBUTES 27
