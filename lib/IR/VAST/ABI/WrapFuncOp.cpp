...
#include <multiplier/IR/VAST/ABI/WrapFuncOp.h>
...
::vast::abi::WrapFuncOp WrapFuncOp::underlying_op(void) const noexcept {
  return ::vast::abi::WrapFuncOp(this->Operation::op_);
}
