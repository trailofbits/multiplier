...
#include <multiplier/IR/VAST/HL/RemFAssignOp.h>
...
::vast::hl::RemFAssignOp RemFAssignOp::underlying_op(void) const noexcept {
  return ::vast::hl::RemFAssignOp(this->Operation::op_);
}
