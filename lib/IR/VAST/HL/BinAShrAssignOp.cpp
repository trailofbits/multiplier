...
#include <multiplier/IR/VAST/HL/BinAShrAssignOp.h>
...
::vast::hl::BinAShrAssignOp BinAShrAssignOp::underlying_op(void) const noexcept {
  return ::vast::hl::BinAShrAssignOp(this->Operation::op_);
}
