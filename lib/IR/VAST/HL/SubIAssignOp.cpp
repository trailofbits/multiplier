...
#include <multiplier/IR/VAST/HL/SubIAssignOp.h>
...
::vast::hl::SubIAssignOp SubIAssignOp::underlying_op(void) const noexcept {
  return ::vast::hl::SubIAssignOp(this->Operation::op_);
}
