...
#include <multiplier/IR/VAST/HL/AccessSpecifierOp.h>
...
::vast::hl::AccessSpecifierOp AccessSpecifierOp::underlying_op(void) const noexcept {
  return ::vast::hl::AccessSpecifierOp(this->Operation::op_);
}
