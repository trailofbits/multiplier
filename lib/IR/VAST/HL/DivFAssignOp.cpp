...
#include <multiplier/IR/VAST/HL/DivFAssignOp.h>
...
::vast::hl::DivFAssignOp DivFAssignOp::underlying_op(void) const noexcept {
  return ::vast::hl::DivFAssignOp(this->Operation::op_);
}
