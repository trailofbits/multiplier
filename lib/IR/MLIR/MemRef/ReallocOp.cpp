...
#include <multiplier/IR/MLIR/MemRef/ReallocOp.h>
...
::mlir::memref::ReallocOp ReallocOp::underlying_op(void) const noexcept {
  return ::mlir::memref::ReallocOp(this->Operation::op_);
}
