...
#include <multiplier/IR/MLIR/LLVM/SAddWithOverflowOp.h>
...
::mlir::LLVM::SAddWithOverflowOp SAddWithOverflowOp::underlying_op(void) const noexcept {
  return ::mlir::LLVM::SAddWithOverflowOp(this->Operation::op_);
}
