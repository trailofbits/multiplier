...
#include <multiplier/IR/MLIR/LLVM/VPIntToPtrOp.h>
...
::mlir::LLVM::VPIntToPtrOp VPIntToPtrOp::underlying_op(void) const noexcept {
  return ::mlir::LLVM::VPIntToPtrOp(this->Operation::op_);
}
