...
#include <multiplier/IR/MLIR/LLVM/ConstantOp.h>
...
::mlir::LLVM::ConstantOp ConstantOp::underlying_op(void) const noexcept {
  return ::mlir::LLVM::ConstantOp(this->Operation::op_);
}
