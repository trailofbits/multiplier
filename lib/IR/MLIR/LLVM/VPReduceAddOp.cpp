...
#include <multiplier/IR/MLIR/LLVM/VPReduceAddOp.h>
...
::mlir::LLVM::VPReduceAddOp VPReduceAddOp::underlying_op(void) const noexcept {
  return ::mlir::LLVM::VPReduceAddOp(this->Operation::op_);
}
