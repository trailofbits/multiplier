...
#include <multiplier/IR/MLIR/LLVM/DbgDeclareOp.h>
...
::mlir::LLVM::DbgDeclareOp DbgDeclareOp::underlying_op(void) const noexcept {
  return ::mlir::LLVM::DbgDeclareOp(this->Operation::op_);
}
