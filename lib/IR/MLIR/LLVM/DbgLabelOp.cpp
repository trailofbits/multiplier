...
#include <multiplier/IR/MLIR/LLVM/DbgLabelOp.h>
...
::mlir::LLVM::DbgLabelOp DbgLabelOp::underlying_op(void) const noexcept {
  return ::mlir::LLVM::DbgLabelOp(this->Operation::op_);
}
