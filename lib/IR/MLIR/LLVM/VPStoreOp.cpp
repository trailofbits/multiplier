...
#include <multiplier/IR/MLIR/LLVM/VPStoreOp.h>
...
::mlir::LLVM::VPStoreOp VPStoreOp::underlying_op(void) const noexcept {
  return ::mlir::LLVM::VPStoreOp(this->Operation::op_);
}
