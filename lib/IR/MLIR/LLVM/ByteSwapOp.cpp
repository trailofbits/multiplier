...
#include <multiplier/IR/MLIR/LLVM/ByteSwapOp.h>
...
::mlir::LLVM::ByteSwapOp ByteSwapOp::underlying_op(void) const noexcept {
  return ::mlir::LLVM::ByteSwapOp(this->Operation::op_);
}
