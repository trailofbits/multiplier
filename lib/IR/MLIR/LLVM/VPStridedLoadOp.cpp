...
#include <multiplier/IR/MLIR/LLVM/VPStridedLoadOp.h>
...
::mlir::LLVM::VPStridedLoadOp VPStridedLoadOp::underlying_op(void) const noexcept {
  return ::mlir::LLVM::VPStridedLoadOp(this->Operation::op_);
}
