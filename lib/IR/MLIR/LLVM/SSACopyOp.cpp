...
#include <multiplier/IR/MLIR/LLVM/SSACopyOp.h>
...
::mlir::LLVM::SSACopyOp SSACopyOp::underlying_op(void) const noexcept {
  return ::mlir::LLVM::SSACopyOp(this->Operation::op_);
}
