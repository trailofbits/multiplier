...
#include <multiplier/IR/MLIR/LLVM/SSubWithOverflowOp.h>
...
::mlir::LLVM::SSubWithOverflowOp SSubWithOverflowOp::underlying_op(void) const noexcept {
  return ::mlir::LLVM::SSubWithOverflowOp(this->Operation::op_);
}
