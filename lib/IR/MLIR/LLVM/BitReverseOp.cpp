...
#include <multiplier/IR/MLIR/LLVM/BitReverseOp.h>
...
::mlir::LLVM::BitReverseOp BitReverseOp::underlying_op(void) const noexcept {
  return ::mlir::LLVM::BitReverseOp(this->Operation::op_);
}
