...
#include <multiplier/IR/MLIR/LLVM/VPMergeMinOp.h>
...
::mlir::LLVM::VPMergeMinOp VPMergeMinOp::underlying_op(void) const noexcept {
  return ::mlir::LLVM::VPMergeMinOp(this->Operation::op_);
}
