...
#include <multiplier/IR/MLIR/LLVM/CoroEndOp.h>
...
::mlir::LLVM::CoroEndOp CoroEndOp::underlying_op(void) const noexcept {
  return ::mlir::LLVM::CoroEndOp(this->Operation::op_);
}
