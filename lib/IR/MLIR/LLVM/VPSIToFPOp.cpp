...
#include <multiplier/IR/MLIR/LLVM/VPSIToFPOp.h>
...
::mlir::LLVM::VPSIToFPOp VPSIToFPOp::underlying_op(void) const noexcept {
  return ::mlir::LLVM::VPSIToFPOp(this->Operation::op_);
}
