...
#include <multiplier/IR/MLIR/LLVM/MaximumOp.h>
...
::mlir::LLVM::MaximumOp MaximumOp::underlying_op(void) const noexcept {
  return ::mlir::LLVM::MaximumOp(this->Operation::op_);
}
