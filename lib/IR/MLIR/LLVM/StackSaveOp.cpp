...
#include <multiplier/IR/MLIR/LLVM/StackSaveOp.h>
...
::mlir::LLVM::StackSaveOp StackSaveOp::underlying_op(void) const noexcept {
  return ::mlir::LLVM::StackSaveOp(this->Operation::op_);
}
