...
#include <multiplier/IR/MLIR/LLVM/IntToPtrOp.h>
...
::mlir::LLVM::IntToPtrOp IntToPtrOp::underlying_op(void) const noexcept {
  return ::mlir::LLVM::IntToPtrOp(this->Operation::op_);
}
