...
#include <multiplier/IR/MLIR/LLVM/UnreachableOp.h>
...
::mlir::LLVM::UnreachableOp UnreachableOp::underlying_op(void) const noexcept {
  return ::mlir::LLVM::UnreachableOp(this->Operation::op_);
}
