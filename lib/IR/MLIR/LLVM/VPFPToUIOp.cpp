...
#include <multiplier/IR/MLIR/LLVM/VPFPToUIOp.h>
...
::mlir::LLVM::VPFPToUIOp VPFPToUIOp::underlying_op(void) const noexcept {
  return ::mlir::LLVM::VPFPToUIOp(this->Operation::op_);
}
