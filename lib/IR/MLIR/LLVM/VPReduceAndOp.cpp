...
#include <multiplier/IR/MLIR/LLVM/VPReduceAndOp.h>
...
::mlir::LLVM::VPReduceAndOp VPReduceAndOp::underlying_op(void) const noexcept {
  return ::mlir::LLVM::VPReduceAndOp(this->Operation::op_);
}
