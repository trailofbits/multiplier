...
#include <multiplier/IR/MLIR/LLVM/AtomicRMWOp.h>
...
::mlir::LLVM::AtomicRMWOp AtomicRMWOp::underlying_op(void) const noexcept {
  return ::mlir::LLVM::AtomicRMWOp(this->Operation::op_);
}
