...
#include <multiplier/IR/MLIR/LLVM/VPReduceSMinOp.h>
...
::mlir::LLVM::VPReduceSMinOp VPReduceSMinOp::underlying_op(void) const noexcept {
  return ::mlir::LLVM::VPReduceSMinOp(this->Operation::op_);
}
