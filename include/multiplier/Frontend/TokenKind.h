...
enum class TokenKind : unsigned short {
  ...
  KEYWORD___REFERENCE_CONSTRUCTS_FROM_TEMPORARY,
  ...
  KEYWORD___BUILTIN_VECTORELEMENTS,
  KEYWORD___BUILTIN_BIT_CAST,
  KEYWORD___BUILTIN_AVAILABLE,
  KEYWORD___BUILTIN_SYCL_UNIQUE_STABLE_NAME,
  KEYWORD___ARM_IN,
  KEYWORD___ARM_INOUT,
  KEYWORD___ARM_LOCALLY_STREAMING,
  KEYWORD___ARM_NEW,
  KEYWORD___ARM_OUT,
  KEYWORD___ARM_PRESERVES,
  KEYWORD___ARM_STREAMING,
  KEYWORD___ARM_STREAMING_COMPATIBLE,
