...
class MX_EXPORT MatrixSubscriptExpr : public Expr {
 ...
 public:
  ...
  static std::optional<MatrixSubscriptExpr> from(const ir::Operation &op);
  static gap::generator<std::pair<MatrixSubscriptExpr, ir::Operation>> in(const Compilation &tu);
