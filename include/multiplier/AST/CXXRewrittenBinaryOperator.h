...
class MX_EXPORT CXXRewrittenBinaryOperator : public Expr {
 ...
 public:
  ...
  static std::optional<CXXRewrittenBinaryOperator> from(const ir::hl::Operation &op);
  static gap::generator<std::pair<CXXRewrittenBinaryOperator, ir::hl::Operation>> in(const Compilation &tu);
