...
class MX_EXPORT OMPDepobjDirective : public OMPExecutableDirective {
 ...
 public:
  ...
  static std::optional<OMPDepobjDirective> from(const ir::Operation &op);
  static gap::generator<std::pair<OMPDepobjDirective, ir::Operation>> in(const Compilation &tu);
