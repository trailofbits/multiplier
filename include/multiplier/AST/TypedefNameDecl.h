...
class MX_EXPORT TypedefNameDecl : public TypeDecl {
 private:
 ...
 public:
  ...
  static std::optional<TypedefNameDecl> from(const ir::hl::Operation &op);
  static gap::generator<std::pair<TypedefNameDecl, ir::hl::Operation>> in(const Compilation &tu);
