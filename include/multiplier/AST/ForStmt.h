...
class MX_EXPORT ForStmt : public Stmt {
 private:
 ...
 public:
  ...
  static std::optional<ForStmt> from(const ir::Operation &op);
  static gap::generator<std::pair<ForStmt, ir::Operation>> in(const Compilation &tu);
