...
class MX_EXPORT FunctionParmPackExpr : public Expr {
 ...
 public:
  ...
  static std::optional<FunctionParmPackExpr> from_base(const Stmt &parent);
  inline static std::optional<FunctionParmPackExpr> from(const Stmt &parent) {
    return from_base(parent);
  }
  static std::optional<FunctionParmPackExpr> from(const std::optional<Stmt> &parent);
  static std::optional<FunctionParmPackExpr> from(const Reference &r);
  static std::optional<FunctionParmPackExpr> from(const VariantEntity &e);
