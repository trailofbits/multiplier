...
class MX_EXPORT CoroutineBodyStmt : public Stmt {
 ...
 public:
  ...
  static std::optional<CoroutineBodyStmt> from(const ir::hl::Operation &op);
  static gap::generator<std::pair<CoroutineBodyStmt, ir::hl::Operation>> in(const Compilation &tu);
