...
class MX_EXPORT OMPTaskgroupDirective : public OMPExecutableDirective {
 private:
 ...
 public:
  ...
  static std::optional<OMPTaskgroupDirective> from(const ir::hl::Operation &op);
  static gap::generator<std::pair<OMPTaskgroupDirective, ir::hl::Operation>> in(const Compilation &tu);
