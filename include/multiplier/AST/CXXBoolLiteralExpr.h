...
class MX_EXPORT CXXBoolLiteralExpr : public Expr {
 ...
 public:
  ...
  static std::optional<CXXBoolLiteralExpr> from(const ir::hl::Operation &op);
  static gap::generator<std::pair<CXXBoolLiteralExpr, ir::hl::Operation>> in(const Compilation &tu);
