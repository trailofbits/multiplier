...
class MX_EXPORT CharacterLiteral : public Expr {
 private:
 ...
 public:
  ...
  static std::optional<CharacterLiteral> from(const ir::hl::Operation &op);
  static gap::generator<std::pair<CharacterLiteral, ir::hl::Operation>> in(const Compilation &tu);
  ...
  static std::optional<CharacterLiteral> from_base(const Stmt &parent);
  inline static std::optional<CharacterLiteral> from(const Stmt &parent) {
    return from_base(parent);
  }
  static std::optional<CharacterLiteral> from(const std::optional<Stmt> &parent);
