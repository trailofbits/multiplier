...
class MX_EXPORT CXXDefaultArgExpr : public Expr {
 private:
 ...
 public:
  ...
  static std::optional<CXXDefaultArgExpr> from(const ir::hl::Operation &op);
  static gap::generator<std::pair<CXXDefaultArgExpr, ir::hl::Operation>> in(const Compilation &tu);
