...
class MX_EXPORT OMPCancellationPointDirective : public OMPExecutableDirective {
 private:
 ...
 public:
  ...
  static std::optional<OMPCancellationPointDirective> from(const ir::hl::Operation &op);
  static gap::generator<std::pair<OMPCancellationPointDirective, ir::hl::Operation>> in(const Compilation &tu);
  ...
  static std::optional<OMPCancellationPointDirective> from_base(const Stmt &parent);
  inline static std::optional<OMPCancellationPointDirective> from(const Stmt &parent) {
    return from_base(parent);
  }
  static std::optional<OMPCancellationPointDirective> from(const std::optional<Stmt> &parent);
  static std::optional<OMPCancellationPointDirective> from(const Reference &r);
  static std::optional<OMPCancellationPointDirective> from(const VariantEntity &e);
