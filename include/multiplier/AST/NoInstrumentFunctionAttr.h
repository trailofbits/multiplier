...
class MX_EXPORT NoInstrumentFunctionAttr : public InheritableAttr {
 private:
 ...
 public:
  ...
  static std::optional<NoInstrumentFunctionAttr> from_base(const Attr &parent);
  inline static std::optional<NoInstrumentFunctionAttr> from(const Attr &parent) {
    return from_base(parent);
  }
  static std::optional<NoInstrumentFunctionAttr> from(const std::optional<Attr> &parent);
  static std::optional<NoInstrumentFunctionAttr> from(const Reference &r);
  static std::optional<NoInstrumentFunctionAttr> from(const VariantEntity &e);
