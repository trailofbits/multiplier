...
class MX_EXPORT SwitchStmt : public Stmt {
 private:
 ...
 public:
  ...
  static std::optional<SwitchStmt> from(const ir::hl::Operation &op);
  static gap::generator<std::pair<SwitchStmt, ir::hl::Operation>> in(const Compilation &tu);
  ...
  static std::optional<SwitchStmt> from_base(const Stmt &parent);
  inline static std::optional<SwitchStmt> from(const Stmt &parent) {
    return from_base(parent);
  }
  static std::optional<SwitchStmt> from(const std::optional<Stmt> &parent);
  static std::optional<SwitchStmt> from(const Reference &r);
  static std::optional<SwitchStmt> from(const VariantEntity &e);
