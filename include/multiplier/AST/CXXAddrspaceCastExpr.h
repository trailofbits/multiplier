...
class MX_EXPORT CXXAddrspaceCastExpr : public CXXNamedCastExpr {
 ...
 public:
  ...
  static std::optional<CXXAddrspaceCastExpr> from(const ir::Operation &op);
  static gap::generator<std::pair<CXXAddrspaceCastExpr, ir::Operation>> in(const Compilation &tu);
