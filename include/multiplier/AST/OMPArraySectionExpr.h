...
class MX_EXPORT OMPArraySectionExpr : public Expr {
 private:
 ...
 public:
  ...
  static std::optional<OMPArraySectionExpr> from(const ir::Operation &op);
  static gap::generator<std::pair<OMPArraySectionExpr, ir::Operation>> in(const Compilation &tu);
