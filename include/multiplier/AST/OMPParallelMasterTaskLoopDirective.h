...
class MX_EXPORT OMPParallelMasterTaskLoopDirective : public OMPLoopDirective {
 ...
 public:
  ...
  static std::optional<OMPParallelMasterTaskLoopDirective> from(const ir::hl::Operation &op);
  static gap::generator<std::pair<OMPParallelMasterTaskLoopDirective, ir::hl::Operation>> in(const Compilation &tu);
