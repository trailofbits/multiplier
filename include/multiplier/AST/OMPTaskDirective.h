...
class MX_EXPORT OMPTaskDirective : public OMPExecutableDirective {
 ...
 public:
  ...
  static std::optional<OMPTaskDirective> from(const ir::hl::Operation &op);
  static gap::generator<std::pair<OMPTaskDirective, ir::hl::Operation>> in(const Compilation &tu);
