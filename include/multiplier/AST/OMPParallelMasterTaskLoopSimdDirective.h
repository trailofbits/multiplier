...
class MX_EXPORT OMPParallelMasterTaskLoopSimdDirective : public OMPLoopDirective {
 private:
 ...
 public:
  ...
  static std::optional<OMPParallelMasterTaskLoopSimdDirective> from(const ir::hl::Operation &op);
  static gap::generator<std::pair<OMPParallelMasterTaskLoopSimdDirective, ir::hl::Operation>> in(const Compilation &tu);
