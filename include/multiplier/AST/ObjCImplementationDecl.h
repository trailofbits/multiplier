...
class MX_EXPORT ObjCImplementationDecl : public ObjCImplDecl {
 ...
 public:
  ...
  static std::optional<ObjCImplementationDecl> from(const ir::hl::Operation &op);
  static gap::generator<std::pair<ObjCImplementationDecl, ir::hl::Operation>> in(const Compilation &tu);
