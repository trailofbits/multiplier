...
class MX_EXPORT CXXNullPtrLiteralExpr : public Expr {
 private:
 ...
 public:
  ...
  static gap::generator<CXXNullPtrLiteralExpr> in(const Compilation &tu);
  ...
  static std::optional<CXXNullPtrLiteralExpr> from_base(const Stmt &parent);
  inline static std::optional<CXXNullPtrLiteralExpr> from(const Stmt &parent) {
    return from_base(parent);
  }
  static std::optional<CXXNullPtrLiteralExpr> from(const std::optional<Stmt> &parent);
  static std::optional<CXXNullPtrLiteralExpr> from(const Reference &r);
  static std::optional<CXXNullPtrLiteralExpr> from(const VariantEntity &e);
