...
class MX_EXPORT ObjCIvarRefExpr : public Expr {
 ...
 public:
  ...
  static std::optional<ObjCIvarRefExpr> from(const ir::hl::Operation &op);
  static gap::generator<std::pair<ObjCIvarRefExpr, ir::hl::Operation>> in(const Compilation &tu);
