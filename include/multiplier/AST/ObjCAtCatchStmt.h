...
class MX_EXPORT ObjCAtCatchStmt : public Stmt {
 ...
 public:
  ...
  static std::optional<ObjCAtCatchStmt> from(const ir::hl::Operation &op);
  static gap::generator<std::pair<ObjCAtCatchStmt, ir::hl::Operation>> in(const Compilation &tu);
