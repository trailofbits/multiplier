...
class MX_EXPORT FriendTemplateDecl : public Decl {
 ...
 public:
  ...
  static std::optional<FriendTemplateDecl> from(const ir::hl::Operation &op);
  static gap::generator<std::pair<FriendTemplateDecl, ir::hl::Operation>> in(const Compilation &tu);
