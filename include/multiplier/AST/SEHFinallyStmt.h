...
class MX_EXPORT SEHFinallyStmt : public Stmt {
 private:
 ...
 public:
  ...
  static std::optional<SEHFinallyStmt> from(const ir::Operation &op);
  static gap::generator<std::pair<SEHFinallyStmt, ir::Operation>> in(const Compilation &tu);
