...
class MX_EXPORT UsingEnumDecl : public BaseUsingDecl {
 private:
 ...
 public:
  ...
  static std::optional<UsingEnumDecl> from(const ir::hl::Operation &op);
  static gap::generator<std::pair<UsingEnumDecl, ir::hl::Operation>> in(const Compilation &tu);
