...
class MX_EXPORT ObjCProtocolExpr : public Expr {
 ...
 public:
  ...
  static std::optional<ObjCProtocolExpr> from(const ir::hl::Operation &op);
  static gap::generator<std::pair<ObjCProtocolExpr, ir::hl::Operation>> in(const Compilation &tu);
