...
class MX_EXPORT CXXDeleteExpr : public Expr {
 private:
 ...
 public:
  ...
  static std::optional<CXXDeleteExpr> from(const ir::hl::Operation &op);
  static gap::generator<std::pair<CXXDeleteExpr, ir::hl::Operation>> in(const Compilation &tu);
