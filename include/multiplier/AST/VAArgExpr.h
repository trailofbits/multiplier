...
class MX_EXPORT VAArgExpr : public Expr {
 private:
 ...
 public:
  ...
  static std::optional<VAArgExpr> from(const ir::Operation &op);
  static gap::generator<std::pair<VAArgExpr, ir::Operation>> in(const Compilation &tu);
