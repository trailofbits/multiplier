...
class MX_EXPORT MSGuidDecl : public ValueDecl {
 private:
 ...
 public:
  ...
  static std::optional<MSGuidDecl> from(const ir::Operation &op);
  static gap::generator<std::pair<MSGuidDecl, ir::Operation>> in(const Compilation &tu);
