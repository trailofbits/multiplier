...
class MX_EXPORT NoUwtableAttr : public InheritableAttr {
 private:
 ...
 public:
  ...
  static std::optional<NoUwtableAttr> from_base(const Attr &parent);
  inline static std::optional<NoUwtableAttr> from(const Attr &parent) {
    return from_base(parent);
  }
  static std::optional<NoUwtableAttr> from(const std::optional<Attr> &parent);
  static std::optional<NoUwtableAttr> from(const Reference &r);
  static std::optional<NoUwtableAttr> from(const VariantEntity &e);
