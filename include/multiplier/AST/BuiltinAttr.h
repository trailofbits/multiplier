...
class MX_EXPORT BuiltinAttr : public InheritableAttr {
 private:
 ...
 public:
  ...
  static std::optional<BuiltinAttr> from_base(const Attr &parent);
  inline static std::optional<BuiltinAttr> from(const Attr &parent) {
    return from_base(parent);
  }
  static std::optional<BuiltinAttr> from(const std::optional<Attr> &parent);
  static std::optional<BuiltinAttr> from(const Reference &r);
  static std::optional<BuiltinAttr> from(const VariantEntity &e);
