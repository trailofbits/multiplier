...
class MX_EXPORT OMPDistributeParallelForDirective : public OMPLoopDirective {
 ...
 public:
  ...
  static std::optional<OMPDistributeParallelForDirective> from(const ir::Operation &op);
  static gap::generator<std::pair<OMPDistributeParallelForDirective, ir::Operation>> in(const Compilation &tu);
  ...
  static std::optional<OMPDistributeParallelForDirective> from_base(const Stmt &parent);
  inline static std::optional<OMPDistributeParallelForDirective> from(const Stmt &parent) {
    return from_base(parent);
  }
  static std::optional<OMPDistributeParallelForDirective> from(const std::optional<Stmt> &parent);
  static std::optional<OMPDistributeParallelForDirective> from(const Reference &r);
  static std::optional<OMPDistributeParallelForDirective> from(const VariantEntity &e);
