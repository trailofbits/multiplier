...
class MX_EXPORT OMPSectionsDirective : public OMPExecutableDirective {
 ...
 public:
  ...
  static std::optional<OMPSectionsDirective> from(const ir::hl::Operation &op);
  static gap::generator<std::pair<OMPSectionsDirective, ir::hl::Operation>> in(const Compilation &tu);
