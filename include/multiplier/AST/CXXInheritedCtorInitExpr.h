...
class MX_EXPORT CXXInheritedCtorInitExpr : public Expr {
 ...
 public:
  ...
  static std::optional<CXXInheritedCtorInitExpr> from(const ir::hl::Operation &op);
  static gap::generator<std::pair<CXXInheritedCtorInitExpr, ir::hl::Operation>> in(const Compilation &tu);
