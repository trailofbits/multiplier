...
class MX_EXPORT VarTemplatePartialSpecializationDecl : public VarTemplateSpecializationDecl {
 ...
 public:
  ...
  static std::optional<VarTemplatePartialSpecializationDecl> from(const ir::hl::Operation &op);
  static gap::generator<std::pair<VarTemplatePartialSpecializationDecl, ir::hl::Operation>> in(const Compilation &tu);
