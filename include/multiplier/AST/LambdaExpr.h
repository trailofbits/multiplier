...
class MX_EXPORT LambdaExpr : public Expr {
 ...
 public:
  ...
  static std::optional<LambdaExpr> from(const ir::hl::Operation &op);
  static gap::generator<std::pair<LambdaExpr, ir::hl::Operation>> in(const Compilation &tu);
  ...
  static std::optional<LambdaExpr> from(const std::optional<Stmt> &parent);
  static std::optional<LambdaExpr> from(const Reference &r);
  static std::optional<LambdaExpr> from(const VariantEntity &e);
