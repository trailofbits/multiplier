...
class MX_EXPORT OMPInteropDirective : public OMPExecutableDirective {
 private:
 ...
 public:
  ...
  static std::optional<OMPInteropDirective> from(const ir::hl::Operation &op);
  static gap::generator<std::pair<OMPInteropDirective, ir::hl::Operation>> in(const Compilation &tu);
