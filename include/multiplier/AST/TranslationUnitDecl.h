...
class MX_EXPORT TranslationUnitDecl : public Decl {
 ...
 public:
  ...
  static std::optional<TranslationUnitDecl> from(const ir::Operation &op);
  static gap::generator<std::pair<TranslationUnitDecl, ir::Operation>> in(const Compilation &tu);
