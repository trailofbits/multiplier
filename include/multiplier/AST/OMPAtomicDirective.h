...
class MX_EXPORT OMPAtomicDirective : public OMPExecutableDirective {
 private:
 ...
 public:
  ...
  static std::optional<OMPAtomicDirective> from(const ir::hl::Operation &op);
  static gap::generator<std::pair<OMPAtomicDirective, ir::hl::Operation>> in(const Compilation &tu);
