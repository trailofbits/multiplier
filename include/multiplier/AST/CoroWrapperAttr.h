...
class MX_EXPORT CoroWrapperAttr : public InheritableAttr {
 private:
 ...
 public:
  ...
  static std::optional<CoroWrapperAttr> from(const std::optional<Attr> &parent);
  static std::optional<CoroWrapperAttr> from(const Reference &r);
  static std::optional<CoroWrapperAttr> from(const VariantEntity &e);
  static std::optional<CoroWrapperAttr> from(const TokenContext &t);

};

static_assert(sizeof(CoroWrapperAttr) == sizeof(InheritableAttr));
