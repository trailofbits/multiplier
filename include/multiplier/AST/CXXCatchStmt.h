...
class MX_EXPORT CXXCatchStmt : public Stmt {
 private:
 ...
 public:
  ...
  static std::optional<CXXCatchStmt> from(const ir::hl::Operation &op);
  static gap::generator<std::pair<CXXCatchStmt, ir::hl::Operation>> in(const Compilation &tu);
