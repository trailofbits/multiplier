...
class MX_EXPORT OMPTeamsDistributeSimdDirective : public OMPLoopDirective {
 ...
 public:
  ...
  static std::optional<OMPTeamsDistributeSimdDirective> from(const ir::Operation &op);
  static gap::generator<std::pair<OMPTeamsDistributeSimdDirective, ir::Operation>> in(const Compilation &tu);
