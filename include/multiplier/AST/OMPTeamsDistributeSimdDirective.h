...
class MX_EXPORT OMPTeamsDistributeSimdDirective : public OMPLoopDirective {
 private:
 ...
 public:
  ...
  static std::optional<OMPTeamsDistributeSimdDirective> from(const ir::hl::Operation &op);
  static gap::generator<std::pair<OMPTeamsDistributeSimdDirective, ir::hl::Operation>> in(const Compilation &tu);
  ...
  static std::optional<OMPTeamsDistributeSimdDirective> from_base(const Stmt &parent);
  inline static std::optional<OMPTeamsDistributeSimdDirective> from(const Stmt &parent) {
    return from_base(parent);
  }
  static std::optional<OMPTeamsDistributeSimdDirective> from(const std::optional<Stmt> &parent);
  static std::optional<OMPTeamsDistributeSimdDirective> from(const Reference &r);
  static std::optional<OMPTeamsDistributeSimdDirective> from(const VariantEntity &e);
