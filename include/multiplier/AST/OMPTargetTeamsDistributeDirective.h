...
class MX_EXPORT OMPTargetTeamsDistributeDirective : public OMPLoopDirective {
 private:
 ...
 public:
  ...
  static std::optional<OMPTargetTeamsDistributeDirective> from(const ir::hl::Operation &op);
  static gap::generator<std::pair<OMPTargetTeamsDistributeDirective, ir::hl::Operation>> in(const Compilation &tu);
