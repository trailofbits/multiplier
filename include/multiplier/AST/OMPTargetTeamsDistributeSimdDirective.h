...
class MX_EXPORT OMPTargetTeamsDistributeSimdDirective : public OMPLoopDirective {
 ...
 public:
  ...
  static std::optional<OMPTargetTeamsDistributeSimdDirective> from(const ir::hl::Operation &op);
  static gap::generator<std::pair<OMPTargetTeamsDistributeSimdDirective, ir::hl::Operation>> in(const Compilation &tu);
