...
class MX_EXPORT OMPParallelDirective : public OMPExecutableDirective {
 ...
 public:
  ...
  static std::optional<OMPParallelDirective> from(const ir::hl::Operation &op);
  static gap::generator<std::pair<OMPParallelDirective, ir::hl::Operation>> in(const Compilation &tu);
