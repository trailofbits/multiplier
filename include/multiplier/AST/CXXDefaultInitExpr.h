...
class MX_EXPORT CXXDefaultInitExpr : public Expr {
 ...
 public:
  ...
  static std::optional<CXXDefaultInitExpr> from(const ir::Operation &op);
  static gap::generator<std::pair<CXXDefaultInitExpr, ir::Operation>> in(const Compilation &tu);
