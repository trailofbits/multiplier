...
class MX_EXPORT ImplicitCastExpr : public CastExpr {
 ...
 public:
  ...
  static std::optional<ImplicitCastExpr> from(const ir::hl::Operation &op);
  static gap::generator<std::pair<ImplicitCastExpr, ir::hl::Operation>> in(const Compilation &tu);
