...
class MX_EXPORT IfStmt : public Stmt {
 ...
 public:
  ...
  static std::optional<IfStmt> from_base(const Stmt &parent);
  inline static std::optional<IfStmt> from(const Stmt &parent) {
    return from_base(parent);
  }
  static std::optional<IfStmt> from(const std::optional<Stmt> &parent);
  static std::optional<IfStmt> from(const Reference &r);
  static std::optional<IfStmt> from(const VariantEntity &e);
