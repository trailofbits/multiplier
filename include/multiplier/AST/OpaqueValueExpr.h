...
class MX_EXPORT OpaqueValueExpr : public Expr {
 private:
 ...
 public:
  ...
  static std::optional<OpaqueValueExpr> from(const ir::hl::Operation &op);
  static gap::generator<std::pair<OpaqueValueExpr, ir::hl::Operation>> in(const Compilation &tu);
