...
enum class AttrKind : unsigned short {
  ...
  SWIFT_ERROR,
  SWIFT_ERROR_RESULT,
  SWIFT_IMPORT_AS_NON_GENERIC,
  SWIFT_IMPORT_PROPERTY_AS_ACCESSORS,
  SWIFT_INDIRECT_RESULT,
  SWIFT_NAME,
  SWIFT_NEW_TYPE,
  SWIFT_OBJ_C_MEMBERS,
  SWIFT_PRIVATE,
  SWIFT_VERSIONED_ADDITION,
  SWIFT_VERSIONED_REMOVAL,
  SYS_VABI,
  TLS_MODEL,
  TARGET,
  TARGET_CLONES,
...
MX_EXPORT const char *EnumeratorName(AttrKind);
