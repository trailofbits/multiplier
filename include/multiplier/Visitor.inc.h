...
MX_BEGIN_VISIT_STMT(CharacterLiteral)
  ...
  MX_VISIT_ENUM(CharacterLiteral, character_kind, getVal98, setVal98, initVal98, Kind, CharacterLiteralCharacterKind, NthStmt)
...
MX_BEGIN_VISIT_STMT(UnaryExprOrTypeTraitExpr)
  ...
  MX_VISIT_ENUM(UnaryExprOrTypeTraitExpr, expression_or_trait_kind, getVal98, setVal98, initVal98, Kind, UnaryExprOrTypeTrait, NthStmt)
...
MX_BEGIN_VISIT_STMT(StringLiteral)
  ...
  MX_VISIT_ENUM(StringLiteral, string_kind, getVal98, setVal98, initVal98, Kind, StringLiteralStringKind, NthStmt)
