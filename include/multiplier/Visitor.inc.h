...
MX_BEGIN_ENUM_CLASS(AArch64VectorPcsAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(AArch64VectorPcsAttrSpelling, C2_XCLANG_AARCH64_VECTOR_PCS, unsigned char)
...
MX_BEGIN_ENUM_CLASS(ARMInterruptAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(ARMInterruptAttrSpelling, C2_XGNU_INTERRUPT, unsigned char)
...
MX_BEGIN_ENUM_CLASS(AVRInterruptAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(AVRInterruptAttrSpelling, C2_XGNU_INTERRUPT, unsigned char)
...
MX_BEGIN_ENUM_CLASS(AVRSignalAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(AVRSignalAttrSpelling, C2_XGNU_SIGNAL, unsigned char)
...
MX_BEGIN_ENUM_CLASS(AcquireHandleAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(AcquireHandleAttrSpelling, C2_XCLANG_ACQUIRE_HANDLE, unsigned char)
...
MX_BEGIN_ENUM_CLASS(AddressSpaceAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(AddressSpaceAttrSpelling, C2_XCLANG_ADDRESS_SPACE, unsigned char)
...
MX_BEGIN_ENUM_CLASS(AliasAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(AliasAttrSpelling, C2_XGNU_ALIAS, unsigned char)
...
MX_BEGIN_ENUM_CLASS(AlignedAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(AlignedAttrSpelling, C2_XGNU_ALIGNED, unsigned char)
...
MX_BEGIN_ENUM_CLASS(AllocAlignAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(AllocAlignAttrSpelling, C2_XGNU_ALLOC_ALIGN, unsigned char)
...
MX_BEGIN_ENUM_CLASS(AllocSizeAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(AllocSizeAttrSpelling, C2_XGNU_ALLOC_SIZE, unsigned char)
...
MX_BEGIN_ENUM_CLASS(AlwaysInlineAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(AlwaysInlineAttrSpelling, C2_XGNU_ALWAYS_INLINE, unsigned char)
...
MX_BEGIN_ENUM_CLASS(AnnotateAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(AnnotateAttrSpelling, C2_XCLANG_ANNOTATE, unsigned char)
...
MX_BEGIN_ENUM_CLASS(AnyX86InterruptAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(AnyX86InterruptAttrSpelling, C2_XGNU_INTERRUPT, unsigned char)
...
MX_BEGIN_ENUM_CLASS(AnyX86NoCallerSavedRegistersAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(AnyX86NoCallerSavedRegistersAttrSpelling, C2_XGNU_NO_CALLER_SAVED_REGISTERS, unsigned char)
...
MX_BEGIN_ENUM_CLASS(AnyX86NoCfCheckAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(AnyX86NoCfCheckAttrSpelling, C2_XGNU_NOCF_CHECK, unsigned char)
...
MX_BEGIN_ENUM_CLASS(ArcWeakrefUnavailableAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(ArcWeakrefUnavailableAttrSpelling, C2_XCLANG_OBJC_ARC_WEAK_REFERENCE_UNAVAILABLE, unsigned char)
...
MX_BEGIN_ENUM_CLASS(ArgumentWithTypeTagAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(ArgumentWithTypeTagAttrSpelling, C2_XCLANG_ARGUMENT_WITH_TYPE_TAG, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(ArgumentWithTypeTagAttrSpelling, C2_XCLANG_POINTER_WITH_TYPE_TAG, unsigned char)
...
MX_BEGIN_ENUM_CLASS(ArmBuiltinAliasAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(ArmBuiltinAliasAttrSpelling, C2_XCLANG_CLANG_ARM_BUILTIN_ALIAS, unsigned char)
...
MX_BEGIN_ENUM_CLASS(ArmMveStrictPolymorphismAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(ArmMveStrictPolymorphismAttrSpelling, C2_XCLANG_CLANG_ARM_MVE_STRICT_POLYMORPHISM, unsigned char)
...
MX_BEGIN_ENUM_CLASS(ArtificialAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(ArtificialAttrSpelling, C2_XGNU_ARTIFICIAL, unsigned char)
...
MX_BEGIN_ENUM_CLASS(AssumeAlignedAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(AssumeAlignedAttrSpelling, C2_XGNU_ASSUME_ALIGNED, unsigned char)
...
MX_BEGIN_ENUM_CLASS(AssumptionAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(AssumptionAttrSpelling, C2_XCLANG_ASSUME, unsigned char)
...
MX_BEGIN_ENUM_CLASS(AvailabilityAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(AvailabilityAttrSpelling, C2_XCLANG_AVAILABILITY, unsigned char)
...
MX_BEGIN_ENUM_CLASS(BPFPreserveAccessIndexAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(BPFPreserveAccessIndexAttrSpelling, C2_XCLANG_PRESERVE_ACCESS_INDEX, unsigned char)
...
MX_BEGIN_ENUM_CLASS(BTFDeclTagAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(BTFDeclTagAttrSpelling, C2_XCLANG_BTF_DECLARATION_TAG, unsigned char)
...
MX_BEGIN_ENUM_CLASS(BTFTypeTagAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(BTFTypeTagAttrSpelling, C2_XCLANG_BTF_TYPE_TAG, unsigned char)
...
MX_BEGIN_ENUM_CLASS(BlocksAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(BlocksAttrSpelling, C2_XCLANG_BLOCKS, unsigned char)
...
MX_BEGIN_ENUM_CLASS(BuiltinAliasAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(BuiltinAliasAttrSpelling, C2_XCLANG_BUILTIN_ALIAS, unsigned char)
...
MX_BEGIN_ENUM_CLASS(CDeclAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(CDeclAttrSpelling, C2_XGNU_CDECL, unsigned char)
...
MX_BEGIN_ENUM_CLASS(CFAuditedTransferAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(CFAuditedTransferAttrSpelling, C2_XCLANG_CF_AUDITED_TRANSFER, unsigned char)
...
MX_BEGIN_ENUM_CLASS(CFConsumedAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(CFConsumedAttrSpelling, C2_XCLANG_CF_CONSUMED, unsigned char)
...
MX_BEGIN_ENUM_CLASS(CFICanonicalJumpTableAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(CFICanonicalJumpTableAttrSpelling, C2_XCLANG_CFI_CANONICAL_JUMP_TABLE, unsigned char)
...
MX_BEGIN_ENUM_CLASS(CFReturnsNotRetainedAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(CFReturnsNotRetainedAttrSpelling, C2_XCLANG_CF_RETURNS_NOT_RETAINED, unsigned char)
...
MX_BEGIN_ENUM_CLASS(CFReturnsRetainedAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(CFReturnsRetainedAttrSpelling, C2_XCLANG_CF_RETURNS_RETAINED, unsigned char)
...
MX_BEGIN_ENUM_CLASS(CFUnknownTransferAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(CFUnknownTransferAttrSpelling, C2_XCLANG_CF_UNKNOWN_TRANSFER, unsigned char)
...
MX_BEGIN_ENUM_CLASS(CPUDispatchAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(CPUDispatchAttrSpelling, C2_XCLANG_CPU_DISPATCH, unsigned char)
...
MX_BEGIN_ENUM_CLASS(CPUSpecificAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(CPUSpecificAttrSpelling, C2_XCLANG_CPU_SPECIFIC, unsigned char)
...
MX_BEGIN_ENUM_CLASS(CallbackAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(CallbackAttrSpelling, C2_XCLANG_CALLBACK, unsigned char)
...
MX_BEGIN_ENUM_CLASS(CalledOnceAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(CalledOnceAttrSpelling, C2_XCLANG_CALLED_ONCE, unsigned char)
...
MX_BEGIN_ENUM_CLASS(CleanupAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(CleanupAttrSpelling, C2_XGNU_CLEANUP, unsigned char)
...
MX_BEGIN_ENUM_CLASS(ColdAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(ColdAttrSpelling, C2_XGNU_COLD, unsigned char)
...
MX_BEGIN_ENUM_CLASS(CommonAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(CommonAttrSpelling, C2_XGNU_COMMON, unsigned char)
...
MX_BEGIN_ENUM_CLASS(ConstAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(ConstAttrSpelling, C2_XGNU_CONST, unsigned char)
...
MX_BEGIN_ENUM_CLASS(ConstructorAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(ConstructorAttrSpelling, C2_XGNU_CONSTRUCTOR, unsigned char)
...
MX_BEGIN_ENUM_CLASS(ConvergentAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(ConvergentAttrSpelling, C2_XCLANG_CONVERGENT, unsigned char)
...
MX_BEGIN_ENUM_CLASS(DLLExportAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(DLLExportAttrSpelling, C2_XGNU_DLLEXPORT, unsigned char)
...
MX_BEGIN_ENUM_CLASS(DLLImportAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(DLLImportAttrSpelling, C2_XGNU_DLLIMPORT, unsigned char)
...
MX_BEGIN_ENUM_CLASS(DeprecatedAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(DeprecatedAttrSpelling, C2_XGNU_DEPRECATED, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(DeprecatedAttrSpelling, C2_XDEPRECATED, unsigned char)
...
MX_BEGIN_ENUM_CLASS(DestructorAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(DestructorAttrSpelling, C2_XGNU_DESTRUCTOR, unsigned char)
...
MX_BEGIN_ENUM_CLASS(DiagnoseAsBuiltinAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(DiagnoseAsBuiltinAttrSpelling, C2_XCLANG_DIAGNOSE_AS_BUILTIN, unsigned char)
...
MX_BEGIN_ENUM_CLASS(DisableSanitizerInstrumentationAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(DisableSanitizerInstrumentationAttrSpelling, C2_XCLANG_DISABLE_SANITIZER_INSTRUMENTATION, unsigned char)
...
MX_BEGIN_ENUM_CLASS(DisableTailCallsAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(DisableTailCallsAttrSpelling, C2_XCLANG_DISABLE_TAIL_CALLS, unsigned char)
...
MX_BEGIN_ENUM_CLASS(EnforceTCBAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(EnforceTCBAttrSpelling, C2_XCLANG_ENFORCE_TCB, unsigned char)
...
MX_BEGIN_ENUM_CLASS(EnforceTCBLeafAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(EnforceTCBLeafAttrSpelling, C2_XCLANG_ENFORCE_TCB_LEAF, unsigned char)
...
MX_BEGIN_ENUM_CLASS(EnumExtensibilityAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(EnumExtensibilityAttrSpelling, C2_XCLANG_ENUM_EXTENSIBILITY, unsigned char)
...
MX_BEGIN_ENUM_CLASS(ErrorAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(ErrorAttrSpelling, C2_XGNU_ERROR, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(ErrorAttrSpelling, C2_XGNU_WARNING, unsigned char)
...
MX_BEGIN_ENUM_CLASS(ExcludeFromExplicitInstantiationAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(ExcludeFromExplicitInstantiationAttrSpelling, C2_XCLANG_EXCLUDE_FROM_EXPLICIT_INSTANTIATION, unsigned char)
...
MX_BEGIN_ENUM_CLASS(ExternalSourceSymbolAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(ExternalSourceSymbolAttrSpelling, C2_XCLANG_EXTERNAL_SOURCE_SYMBOL, unsigned char)
...
MX_BEGIN_ENUM_CLASS(FallThroughAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(FallThroughAttrSpelling, C2_XFALLTHROUGH, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(FallThroughAttrSpelling, C2_XGNU_FALLTHROUGH, unsigned char)
...
MX_BEGIN_ENUM_CLASS(FastCallAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(FastCallAttrSpelling, C2_XGNU_FASTCALL, unsigned char)
...
MX_BEGIN_ENUM_CLASS(FlagEnumAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(FlagEnumAttrSpelling, C2_XCLANG_FLAG_ENUM, unsigned char)
...
MX_BEGIN_ENUM_CLASS(FlattenAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(FlattenAttrSpelling, C2_XGNU_FLATTEN, unsigned char)
...
MX_BEGIN_ENUM_CLASS(FormatArgAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(FormatArgAttrSpelling, C2_XGNU_FORMAT_ARGUMENT, unsigned char)
...
MX_BEGIN_ENUM_CLASS(FormatAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(FormatAttrSpelling, C2_XGNU_FORMAT, unsigned char)
...
MX_BEGIN_ENUM_CLASS(GNUInlineAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(GNUInlineAttrSpelling, C2_XGNU_GNU_INLINE, unsigned char)
...
MX_BEGIN_ENUM_CLASS(HotAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(HotAttrSpelling, C2_XGNU_HOT, unsigned char)
...
MX_BEGIN_ENUM_CLASS(IBActionAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(IBActionAttrSpelling, C2_XCLANG_IBACTION, unsigned char)
...
MX_BEGIN_ENUM_CLASS(IBOutletAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(IBOutletAttrSpelling, C2_XCLANG_IBOUTLET, unsigned char)
...
MX_BEGIN_ENUM_CLASS(IBOutletCollectionAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(IBOutletCollectionAttrSpelling, C2_XCLANG_IBOUTLETCOLLECTION, unsigned char)
...
MX_BEGIN_ENUM_CLASS(IFuncAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(IFuncAttrSpelling, C2_XGNU_IFUNC, unsigned char)
...
MX_BEGIN_ENUM_CLASS(InternalLinkageAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(InternalLinkageAttrSpelling, C2_XCLANG_INTERNAL_LINKAGE, unsigned char)
...
MX_BEGIN_ENUM_CLASS(LTOVisibilityPublicAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(LTOVisibilityPublicAttrSpelling, C2_XCLANG_LTO_VISIBILITY_PUBLIC, unsigned char)
...
MX_BEGIN_ENUM_CLASS(LeafAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(LeafAttrSpelling, C2_XGNU_LEAF, unsigned char)
...
MX_BEGIN_ENUM_CLASS(LikelyAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(LikelyAttrSpelling, C2_XCLANG_LIKELY, unsigned char)
...
MX_BEGIN_ENUM_CLASS(LoaderUninitializedAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(LoaderUninitializedAttrSpelling, C2_XCLANG_LOADER_UNINITIALIZED, unsigned char)
...
MX_BEGIN_ENUM_CLASS(MIGServerRoutineAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(MIGServerRoutineAttrSpelling, C2_XCLANG_MIG_SERVER_ROUTINE, unsigned char)
...
MX_BEGIN_ENUM_CLASS(MSABIAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(MSABIAttrSpelling, C2_XGNU_MS_ABI, unsigned char)
...
MX_BEGIN_ENUM_CLASS(MSP430InterruptAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(MSP430InterruptAttrSpelling, C2_XGNU_INTERRUPT, unsigned char)
...
MX_BEGIN_ENUM_CLASS(MSStructAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(MSStructAttrSpelling, C2_XGNU_MS_STRUCT, unsigned char)
...
MX_BEGIN_ENUM_CLASS(MayAliasAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(MayAliasAttrSpelling, C2_XGNU_MAY_ALIAS, unsigned char)
...
MX_BEGIN_ENUM_CLASS(MicroMipsAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(MicroMipsAttrSpelling, C2_XGNU_MICROMIPS, unsigned char)
...
MX_BEGIN_ENUM_CLASS(MinSizeAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(MinSizeAttrSpelling, C2_XCLANG_MINSIZE, unsigned char)
...
MX_BEGIN_ENUM_CLASS(MinVectorWidthAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(MinVectorWidthAttrSpelling, C2_XCLANG_MIN_VECTOR_WIDTH, unsigned char)
...
MX_BEGIN_ENUM_CLASS(Mips16AttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(Mips16AttrSpelling, C2_XGNU_MIPS16, unsigned char)
...
MX_BEGIN_ENUM_CLASS(MipsInterruptAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(MipsInterruptAttrSpelling, C2_XGNU_INTERRUPT, unsigned char)
...
MX_BEGIN_ENUM_CLASS(MipsLongCallAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(MipsLongCallAttrSpelling, C2_XGNU_LONG_CALL, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(MipsLongCallAttrSpelling, C2_XGNU_FAR, unsigned char)
...
MX_BEGIN_ENUM_CLASS(MipsShortCallAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(MipsShortCallAttrSpelling, C2_XGNU_SHORT_CALL, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(MipsShortCallAttrSpelling, C2_XGNU_NEAR, unsigned char)
...
MX_BEGIN_ENUM_CLASS(ModeAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(ModeAttrSpelling, C2_XGNU_MODE, unsigned char)
...
MX_BEGIN_ENUM_CLASS(MustTailAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(MustTailAttrSpelling, C2_XCLANG_MUSTTAIL, unsigned char)
...
MX_BEGIN_ENUM_CLASS(NSConsumedAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(NSConsumedAttrSpelling, C2_XCLANG_NS_CONSUMED, unsigned char)
...
MX_BEGIN_ENUM_CLASS(NSConsumesSelfAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(NSConsumesSelfAttrSpelling, C2_XCLANG_NS_CONSUMES_SELF, unsigned char)
...
MX_BEGIN_ENUM_CLASS(NSReturnsAutoreleasedAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(NSReturnsAutoreleasedAttrSpelling, C2_XCLANG_NS_RETURNS_AUTORELEASED, unsigned char)
...
MX_BEGIN_ENUM_CLASS(NSReturnsNotRetainedAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(NSReturnsNotRetainedAttrSpelling, C2_XCLANG_NS_RETURNS_NOT_RETAINED, unsigned char)
...
MX_BEGIN_ENUM_CLASS(NSReturnsRetainedAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(NSReturnsRetainedAttrSpelling, C2_XCLANG_NS_RETURNS_RETAINED, unsigned char)
...
MX_BEGIN_ENUM_CLASS(NakedAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(NakedAttrSpelling, C2_XGNU_NAKED, unsigned char)
...
MX_BEGIN_ENUM_CLASS(NoBuiltinAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(NoBuiltinAttrSpelling, C2_XCLANG_NO_BUILTIN, unsigned char)
...
MX_BEGIN_ENUM_CLASS(NoCommonAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(NoCommonAttrSpelling, C2_XGNU_NOCOMMON, unsigned char)
...
MX_BEGIN_ENUM_CLASS(NoDebugAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(NoDebugAttrSpelling, C2_XGNU_NODEBUG, unsigned char)
...
MX_BEGIN_ENUM_CLASS(NoDerefAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(NoDerefAttrSpelling, C2_XCLANG_NODEREF, unsigned char)
...
MX_BEGIN_ENUM_CLASS(NoDuplicateAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(NoDuplicateAttrSpelling, C2_XCLANG_NODUPLICATE, unsigned char)
...
MX_BEGIN_ENUM_CLASS(NoEscapeAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(NoEscapeAttrSpelling, C2_XCLANG_NOESCAPE, unsigned char)
...
MX_BEGIN_ENUM_CLASS(NoInlineAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(NoInlineAttrSpelling, C2_XGNU_NOINLINE, unsigned char)
...
MX_BEGIN_ENUM_CLASS(NoInstrumentFunctionAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(NoInstrumentFunctionAttrSpelling, C2_XGNU_NO_INSTRUMENT_FUNCTION, unsigned char)
...
MX_BEGIN_ENUM_CLASS(NoMergeAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(NoMergeAttrSpelling, C2_XCLANG_NOMERGE, unsigned char)
...
MX_BEGIN_ENUM_CLASS(NoMicroMipsAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(NoMicroMipsAttrSpelling, C2_XGNU_NOMICROMIPS, unsigned char)
...
MX_BEGIN_ENUM_CLASS(NoMips16AttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(NoMips16AttrSpelling, C2_XGNU_NOMIPS16, unsigned char)
...
MX_BEGIN_ENUM_CLASS(NoProfileFunctionAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(NoProfileFunctionAttrSpelling, C2_XGNU_NO_PROFILE_INSTRUMENT_FUNCTION, unsigned char)
...
MX_BEGIN_ENUM_CLASS(NoReturnAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(NoReturnAttrSpelling, C2_XGNU_NORETURN, unsigned char)
...
MX_BEGIN_ENUM_CLASS(NoSanitizeAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(NoSanitizeAttrSpelling, C2_XCLANG_NO_SANITIZE, unsigned char)
...
MX_BEGIN_ENUM_CLASS(NoSpeculativeLoadHardeningAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(NoSpeculativeLoadHardeningAttrSpelling, C2_XCLANG_NO_SPECULATIVE_LOAD_HARDENING, unsigned char)
...
MX_BEGIN_ENUM_CLASS(NoSplitStackAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(NoSplitStackAttrSpelling, C2_XGNU_NO_SPLIT_STACK, unsigned char)
...
MX_BEGIN_ENUM_CLASS(NoStackProtectorAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(NoStackProtectorAttrSpelling, C2_XCLANG_NO_STACK_PROTECTOR, unsigned char)
...
MX_BEGIN_ENUM_CLASS(NoThreadSafetyAnalysisAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(NoThreadSafetyAnalysisAttrSpelling, C2_XCLANG_NO_THREAD_SAFETY_ANALYSIS, unsigned char)
...
MX_BEGIN_ENUM_CLASS(NoThrowAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(NoThrowAttrSpelling, C2_XGNU_NOTHROW, unsigned char)
...
MX_BEGIN_ENUM_CLASS(NonNullAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(NonNullAttrSpelling, C2_XGNU_NONNULL, unsigned char)
...
MX_BEGIN_ENUM_CLASS(NotTailCalledAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(NotTailCalledAttrSpelling, C2_XCLANG_NOT_TAIL_CALLED, unsigned char)
...
MX_BEGIN_ENUM_CLASS(OSConsumedAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(OSConsumedAttrSpelling, C2_XCLANG_OS_CONSUMED, unsigned char)
...
MX_BEGIN_ENUM_CLASS(OSConsumesThisAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(OSConsumesThisAttrSpelling, C2_XCLANG_OS_CONSUMES_THIS, unsigned char)
...
MX_BEGIN_ENUM_CLASS(OSReturnsNotRetainedAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(OSReturnsNotRetainedAttrSpelling, C2_XCLANG_OS_RETURNS_NOT_RETAINED, unsigned char)
...
MX_BEGIN_ENUM_CLASS(OSReturnsRetainedAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(OSReturnsRetainedAttrSpelling, C2_XCLANG_OS_RETURNS_RETAINED, unsigned char)
...
MX_BEGIN_ENUM_CLASS(OSReturnsRetainedOnNonZeroAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(OSReturnsRetainedOnNonZeroAttrSpelling, C2_XCLANG_OS_RETURNS_RETAINED_ON_NON_ZERO, unsigned char)
...
MX_BEGIN_ENUM_CLASS(OSReturnsRetainedOnZeroAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(OSReturnsRetainedOnZeroAttrSpelling, C2_XCLANG_OS_RETURNS_RETAINED_ON_ZERO, unsigned char)
...
MX_BEGIN_ENUM_CLASS(ObjCBoxableAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(ObjCBoxableAttrSpelling, C2_XCLANG_OBJC_BOXABLE, unsigned char)
...
MX_BEGIN_ENUM_CLASS(ObjCBridgeAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(ObjCBridgeAttrSpelling, C2_XCLANG_OBJC_BRIDGE, unsigned char)
...
MX_BEGIN_ENUM_CLASS(ObjCBridgeMutableAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(ObjCBridgeMutableAttrSpelling, C2_XCLANG_OBJC_BRIDGE_MUTABLE, unsigned char)
...
MX_BEGIN_ENUM_CLASS(ObjCBridgeRelatedAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(ObjCBridgeRelatedAttrSpelling, C2_XCLANG_OBJC_BRIDGE_RELATED, unsigned char)
...
MX_BEGIN_ENUM_CLASS(ObjCClassStubAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(ObjCClassStubAttrSpelling, C2_XCLANG_OBJC_CLASS_STUB, unsigned char)
...
MX_BEGIN_ENUM_CLASS(ObjCDesignatedInitializerAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(ObjCDesignatedInitializerAttrSpelling, C2_XCLANG_OBJC_DESIGNATED_INITIALIZER, unsigned char)
...
MX_BEGIN_ENUM_CLASS(ObjCDirectAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(ObjCDirectAttrSpelling, C2_XCLANG_OBJC_DIRECT, unsigned char)
...
MX_BEGIN_ENUM_CLASS(ObjCDirectMembersAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(ObjCDirectMembersAttrSpelling, C2_XCLANG_OBJC_DIRECT_MEMBERS, unsigned char)
...
MX_BEGIN_ENUM_CLASS(ObjCExceptionAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(ObjCExceptionAttrSpelling, C2_XCLANG_OBJC_EXCEPTION, unsigned char)
...
MX_BEGIN_ENUM_CLASS(ObjCExplicitProtocolImplAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(ObjCExplicitProtocolImplAttrSpelling, C2_XCLANG_OBJC_PROTOCOL_REQUIRES_EXPLICIT_IMPLEMENTATION, unsigned char)
...
MX_BEGIN_ENUM_CLASS(ObjCExternallyRetainedAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(ObjCExternallyRetainedAttrSpelling, C2_XCLANG_OBJC_EXTERNALLY_RETAINED, unsigned char)
...
MX_BEGIN_ENUM_CLASS(ObjCGCAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(ObjCGCAttrSpelling, C2_XCLANG_OBJC_GC, unsigned char)
...
MX_BEGIN_ENUM_CLASS(ObjCIndependentClassAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(ObjCIndependentClassAttrSpelling, C2_XCLANG_OBJC_INDEPENDENT_CLASS, unsigned char)
...
MX_BEGIN_ENUM_CLASS(ObjCMethodFamilyAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(ObjCMethodFamilyAttrSpelling, C2_XCLANG_OBJC_METHOD_FAMILY, unsigned char)
...
MX_BEGIN_ENUM_CLASS(ObjCNSObjectAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(ObjCNSObjectAttrSpelling, C2_XCLANG_NS_OBJECT, unsigned char)
...
MX_BEGIN_ENUM_CLASS(ObjCNonLazyClassAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(ObjCNonLazyClassAttrSpelling, C2_XCLANG_OBJC_NONLAZY_CLASS, unsigned char)
...
MX_BEGIN_ENUM_CLASS(ObjCNonRuntimeProtocolAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(ObjCNonRuntimeProtocolAttrSpelling, C2_XCLANG_OBJC_NON_RUNTIME_PROTOCOL, unsigned char)
...
MX_BEGIN_ENUM_CLASS(ObjCOwnershipAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(ObjCOwnershipAttrSpelling, C2_XCLANG_OBJC_OWNERSHIP, unsigned char)
...
MX_BEGIN_ENUM_CLASS(ObjCPreciseLifetimeAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(ObjCPreciseLifetimeAttrSpelling, C2_XCLANG_OBJC_PRECISE_LIFETIME, unsigned char)
...
MX_BEGIN_ENUM_CLASS(ObjCRequiresPropertyDefsAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(ObjCRequiresPropertyDefsAttrSpelling, C2_XCLANG_OBJC_REQUIRES_PROPERTY_DEFINITIONS, unsigned char)
...
MX_BEGIN_ENUM_CLASS(ObjCRequiresSuperAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(ObjCRequiresSuperAttrSpelling, C2_XCLANG_OBJC_REQUIRES_SUPER, unsigned char)
...
MX_BEGIN_ENUM_CLASS(ObjCReturnsInnerPointerAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(ObjCReturnsInnerPointerAttrSpelling, C2_XCLANG_OBJC_RETURNS_INNER_POINTER, unsigned char)
...
MX_BEGIN_ENUM_CLASS(ObjCRootClassAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(ObjCRootClassAttrSpelling, C2_XCLANG_OBJC_ROOT_CLASS, unsigned char)
...
MX_BEGIN_ENUM_CLASS(ObjCRuntimeNameAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(ObjCRuntimeNameAttrSpelling, C2_XCLANG_OBJC_RUNTIME_NAME, unsigned char)
...
MX_BEGIN_ENUM_CLASS(ObjCRuntimeVisibleAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(ObjCRuntimeVisibleAttrSpelling, C2_XCLANG_OBJC_RUNTIME_VISIBLE, unsigned char)
...
MX_BEGIN_ENUM_CLASS(ObjCSubclassingRestrictedAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(ObjCSubclassingRestrictedAttrSpelling, C2_XCLANG_OBJC_SUBCLASSING_RESTRICTED, unsigned char)
...
MX_BEGIN_ENUM_CLASS(OpenCLConstantAddressSpaceAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(OpenCLConstantAddressSpaceAttrSpelling, C2_XCLANG_OPENCL_CONSTANT, unsigned char)
...
MX_BEGIN_ENUM_CLASS(OpenCLGenericAddressSpaceAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(OpenCLGenericAddressSpaceAttrSpelling, C2_XCLANG_OPENCL_GENERIC, unsigned char)
...
MX_BEGIN_ENUM_CLASS(OpenCLGlobalAddressSpaceAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(OpenCLGlobalAddressSpaceAttrSpelling, C2_XCLANG_OPENCL_GLOBAL, unsigned char)
...
MX_BEGIN_ENUM_CLASS(OpenCLGlobalDeviceAddressSpaceAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(OpenCLGlobalDeviceAddressSpaceAttrSpelling, C2_XCLANG_OPENCL_GLOBAL_DEVICE, unsigned char)
...
MX_BEGIN_ENUM_CLASS(OpenCLGlobalHostAddressSpaceAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(OpenCLGlobalHostAddressSpaceAttrSpelling, C2_XCLANG_OPENCL_GLOBAL_HOST, unsigned char)
...
MX_BEGIN_ENUM_CLASS(OpenCLLocalAddressSpaceAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(OpenCLLocalAddressSpaceAttrSpelling, C2_XCLANG_OPENCL_LOCAL, unsigned char)
...
MX_BEGIN_ENUM_CLASS(OpenCLPrivateAddressSpaceAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(OpenCLPrivateAddressSpaceAttrSpelling, C2_XCLANG_OPENCL_PRIVATE, unsigned char)
...
MX_BEGIN_ENUM_CLASS(OptimizeNoneAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(OptimizeNoneAttrSpelling, C2_XCLANG_OPTNONE, unsigned char)
...
MX_BEGIN_ENUM_CLASS(OverloadableAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(OverloadableAttrSpelling, C2_XCLANG_OVERLOADABLE, unsigned char)
...
MX_BEGIN_ENUM_CLASS(OwnershipAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(OwnershipAttrSpelling, C2_XCLANG_OWNERSHIP_HOLDS, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(OwnershipAttrSpelling, C2_XCLANG_OWNERSHIP_RETURNS, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(OwnershipAttrSpelling, C2_XCLANG_OWNERSHIP_TAKES, unsigned char)
...
MX_BEGIN_ENUM_CLASS(PackedAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(PackedAttrSpelling, C2_XGNU_PACKED, unsigned char)
...
MX_BEGIN_ENUM_CLASS(PascalAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(PascalAttrSpelling, C2_XCLANG_PASCAL, unsigned char)
...
MX_BEGIN_ENUM_CLASS(PassObjectSizeAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(PassObjectSizeAttrSpelling, C2_XCLANG_PASS_OBJECT_SIZE, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(PassObjectSizeAttrSpelling, C2_XCLANG_PASS_DYNAMIC_OBJECT_SIZE, unsigned char)
...
MX_BEGIN_ENUM_CLASS(PatchableFunctionEntryAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(PatchableFunctionEntryAttrSpelling, C2_XGNU_PATCHABLE_FUNCTION_ENTRY, unsigned char)
...
MX_BEGIN_ENUM_CLASS(PcsAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(PcsAttrSpelling, C2_XGNU_PCS, unsigned char)
...
MX_BEGIN_ENUM_CLASS(PreserveAllAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(PreserveAllAttrSpelling, C2_XCLANG_PRESERVE_ALL, unsigned char)
...
MX_BEGIN_ENUM_CLASS(PreserveMostAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(PreserveMostAttrSpelling, C2_XCLANG_PRESERVE_MOST, unsigned char)
...
MX_BEGIN_ENUM_CLASS(PureAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(PureAttrSpelling, C2_XGNU_PURE, unsigned char)
...
MX_BEGIN_ENUM_CLASS(RISCVInterruptAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(RISCVInterruptAttrSpelling, C2_XGNU_INTERRUPT, unsigned char)
...
MX_BEGIN_ENUM_CLASS(RegCallAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(RegCallAttrSpelling, C2_XGNU_REGCALL, unsigned char)
...
MX_BEGIN_ENUM_CLASS(ReleaseHandleAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(ReleaseHandleAttrSpelling, C2_XCLANG_RELEASE_HANDLE, unsigned char)
...
MX_BEGIN_ENUM_CLASS(RestrictAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(RestrictAttrSpelling, C2_XGNU_MALLOC, unsigned char)
...
MX_BEGIN_ENUM_CLASS(RetainAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(RetainAttrSpelling, C2_XGNU_RETAIN, unsigned char)
...
MX_BEGIN_ENUM_CLASS(ReturnsNonNullAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(ReturnsNonNullAttrSpelling, C2_XGNU_RETURNS_NONNULL, unsigned char)
...
MX_BEGIN_ENUM_CLASS(ReturnsTwiceAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(ReturnsTwiceAttrSpelling, C2_XGNU_RETURNS_TWICE, unsigned char)
...
MX_BEGIN_ENUM_CLASS(SYCLKernelAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(SYCLKernelAttrSpelling, C2_XCLANG_SYCL_KERNEL, unsigned char)
...
MX_BEGIN_ENUM_CLASS(SYCLSpecialClassAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(SYCLSpecialClassAttrSpelling, C2_XCLANG_SYCL_SPECIAL_CLASS, unsigned char)
...
MX_BEGIN_ENUM_CLASS(SectionAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(SectionAttrSpelling, C2_XGNU_SECTION, unsigned char)
...
MX_BEGIN_ENUM_CLASS(SelectAnyAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(SelectAnyAttrSpelling, C2_XGNU_SELECTANY, unsigned char)
...
MX_BEGIN_ENUM_CLASS(SentinelAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(SentinelAttrSpelling, C2_XGNU_SENTINEL, unsigned char)
...
MX_BEGIN_ENUM_CLASS(SpeculativeLoadHardeningAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(SpeculativeLoadHardeningAttrSpelling, C2_XCLANG_SPECULATIVE_LOAD_HARDENING, unsigned char)
...
MX_BEGIN_ENUM_CLASS(StdCallAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(StdCallAttrSpelling, C2_XGNU_STDCALL, unsigned char)
...
MX_BEGIN_ENUM_CLASS(SwiftAsyncAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(SwiftAsyncAttrSpelling, C2_XCLANG_SWIFT_ASYNC, unsigned char)
...
MX_BEGIN_ENUM_CLASS(SwiftAsyncCallAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(SwiftAsyncCallAttrSpelling, C2_XCLANG_SWIFTASYNCCALL, unsigned char)
...
MX_BEGIN_ENUM_CLASS(SwiftAsyncContextAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(SwiftAsyncContextAttrSpelling, C2_XCLANG_SWIFT_ASYNC_CONTEXT, unsigned char)
...
MX_BEGIN_ENUM_CLASS(SwiftAsyncErrorAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(SwiftAsyncErrorAttrSpelling, C2_XCLANG_SWIFT_ASYNC_ERROR, unsigned char)
...
MX_BEGIN_ENUM_CLASS(SwiftCallAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(SwiftCallAttrSpelling, C2_XCLANG_SWIFTCALL, unsigned char)
...
MX_BEGIN_ENUM_CLASS(SwiftContextAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(SwiftContextAttrSpelling, C2_XCLANG_SWIFT_CONTEXT, unsigned char)
...
MX_BEGIN_ENUM_CLASS(SwiftErrorResultAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(SwiftErrorResultAttrSpelling, C2_XCLANG_SWIFT_ERROR_RESULT, unsigned char)
...
MX_BEGIN_ENUM_CLASS(SwiftIndirectResultAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(SwiftIndirectResultAttrSpelling, C2_XCLANG_SWIFT_INDIRECT_RESULT, unsigned char)
...
MX_BEGIN_ENUM_CLASS(SysVABIAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(SysVABIAttrSpelling, C2_XGNU_SYSV_ABI, unsigned char)
...
MX_BEGIN_ENUM_CLASS(TLSModelAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(TLSModelAttrSpelling, C2_XGNU_TLS_MODEL, unsigned char)
...
MX_BEGIN_ENUM_CLASS(TargetAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(TargetAttrSpelling, C2_XGNU_TARGET, unsigned char)
...
MX_BEGIN_ENUM_CLASS(TargetClonesAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(TargetClonesAttrSpelling, C2_XGNU_TARGET_CLONES, unsigned char)
...
MX_BEGIN_ENUM_CLASS(ThisCallAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(ThisCallAttrSpelling, C2_XGNU_THISCALL, unsigned char)
...
MX_BEGIN_ENUM_CLASS(TransparentUnionAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(TransparentUnionAttrSpelling, C2_XGNU_TRANSPARENT_UNION, unsigned char)
...
MX_BEGIN_ENUM_CLASS(TypeTagForDatatypeAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(TypeTagForDatatypeAttrSpelling, C2_XCLANG_TYPE_TAG_FOR_DATATYPE, unsigned char)
...
MX_BEGIN_ENUM_CLASS(TypeVisibilityAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(TypeVisibilityAttrSpelling, C2_XCLANG_TYPE_VISIBILITY, unsigned char)
...
MX_BEGIN_ENUM_CLASS(UnavailableAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(UnavailableAttrSpelling, C2_XCLANG_UNAVAILABLE, unsigned char)
...
MX_BEGIN_ENUM_CLASS(UnlikelyAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(UnlikelyAttrSpelling, C2_XCLANG_UNLIKELY, unsigned char)
...
MX_BEGIN_ENUM_CLASS(UnusedAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(UnusedAttrSpelling, C2_XGNU_UNUSED, unsigned char)
  MX_ENUM_CLASS_ENTRY(UnusedAttrSpelling, C2_XMAYBE_UNUSED, unsigned char)
...
MX_BEGIN_ENUM_CLASS(UseHandleAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(UseHandleAttrSpelling, C2_XCLANG_USE_HANDLE, unsigned char)
...
MX_BEGIN_ENUM_CLASS(UsedAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(UsedAttrSpelling, C2_XGNU_USED, unsigned char)
...
MX_BEGIN_ENUM_CLASS(VectorCallAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(VectorCallAttrSpelling, C2_XCLANG_VECTORCALL, unsigned char)
...
MX_BEGIN_ENUM_CLASS(VisibilityAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(VisibilityAttrSpelling, C2_XGNU_VISIBILITY, unsigned char)
...
MX_BEGIN_ENUM_CLASS(WarnUnusedAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(WarnUnusedAttrSpelling, C2_XGNU_WARN_UNUSED, unsigned char)
...
MX_BEGIN_ENUM_CLASS(WarnUnusedResultAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(WarnUnusedResultAttrSpelling, C2_XNODISCARD, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(WarnUnusedResultAttrSpelling, C2_XGNU_WARN_UNUSED_RESULT, unsigned char)
...
MX_BEGIN_ENUM_CLASS(WeakAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(WeakAttrSpelling, C2_XGNU_WEAK, unsigned char)
...
MX_BEGIN_ENUM_CLASS(WeakImportAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(WeakImportAttrSpelling, C2_XCLANG_WEAK_IMPORT, unsigned char)
...
MX_BEGIN_ENUM_CLASS(WeakRefAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(WeakRefAttrSpelling, C2_XGNU_WEAKREF, unsigned char)
...
MX_BEGIN_ENUM_CLASS(WebAssemblyExportNameAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(WebAssemblyExportNameAttrSpelling, C2_XCLANG_EXPORT_NAME, unsigned char)
...
MX_BEGIN_ENUM_CLASS(WebAssemblyImportModuleAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(WebAssemblyImportModuleAttrSpelling, C2_XCLANG_IMPORT_MODULE, unsigned char)
...
MX_BEGIN_ENUM_CLASS(WebAssemblyImportNameAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(WebAssemblyImportNameAttrSpelling, C2_XCLANG_IMPORT_NAME, unsigned char)
...
MX_BEGIN_ENUM_CLASS(X86ForceAlignArgPointerAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(X86ForceAlignArgPointerAttrSpelling, C2_XGNU_FORCE_ALIGN_ARGUMENT_POINTER, unsigned char)
...
MX_BEGIN_ENUM_CLASS(XRayInstrumentAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(XRayInstrumentAttrSpelling, C2_XCLANG_XRAY_ALWAYS_INSTRUMENT, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(XRayInstrumentAttrSpelling, C2_XCLANG_XRAY_NEVER_INSTRUMENT, unsigned char)
...
MX_BEGIN_ENUM_CLASS(XRayLogArgsAttrSpelling, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(XRayLogArgsAttrSpelling, C2_XCLANG_XRAY_LOG_ARGUMENTS, unsigned char)
...
MX_BEGIN_ENUM_CLASS(AttrKind, unsigned short)
  ...
  MX_ENUM_CLASS_ENTRY(AttrKind, ALIGN_MAC68_K, unsigned short)
  ...
  MX_ENUM_CLASS_ENTRY(AttrKind, ASSEMBLY_LABEL, unsigned short)
  ...
  MX_ENUM_CLASS_ENTRY(AttrKind, CONST_INITIALIZER, unsigned short)
  ...
  MX_ENUM_CLASS_ENTRY(AttrKind, FORMAT_ARGUMENT, unsigned short)
  MX_ENUM_CLASS_ENTRY(AttrKind, GNU_INLINE, unsigned short)
  MX_ENUM_CLASS_ENTRY(AttrKind, GUARDED_BY, unsigned short)
  MX_ENUM_CLASS_ENTRY(AttrKind, GUARDED_VARIABLE, unsigned short)
  ...
  MX_ENUM_CLASS_ENTRY(AttrKind, INITIALIZER_PRIORITY, unsigned short)
  ...
  MX_ENUM_CLASS_ENTRY(AttrKind, M68_KINTERRUPT, unsigned short)
  MX_ENUM_CLASS_ENTRY(AttrKind, MIG_SERVER_ROUTINE, unsigned short)
  ...
  MX_ENUM_CLASS_ENTRY(AttrKind, OMP_ALLOCATE_DECLARATION, unsigned short)
  MX_ENUM_CLASS_ENTRY(AttrKind, OMP_CAPTURE_NO_INITIALIZER, unsigned short)
  MX_ENUM_CLASS_ENTRY(AttrKind, OMP_DECLARE_TARGET_DECLARATION, unsigned short)
  MX_ENUM_CLASS_ENTRY(AttrKind, OMP_DECLARE_VARIANT, unsigned short)
  MX_ENUM_CLASS_ENTRY(AttrKind, OMP_THREAD_PRIVATE_DECLARATION, unsigned short)
  ...
  MX_ENUM_CLASS_ENTRY(AttrKind, OBJ_C_EXPLICIT_PROTOCOL_IMPLEMENTATION, unsigned short)
  ...
  MX_ENUM_CLASS_ENTRY(AttrKind, OBJ_C_REQUIRES_PROPERTY_DEFINITIONS, unsigned short)
  ...
  MX_ENUM_CLASS_ENTRY(AttrKind, PARAMETER_TYPESTATE, unsigned short)
  ...
  MX_ENUM_CLASS_ENTRY(AttrKind, PT_GUARDED_VARIABLE, unsigned short)
  ...
  MX_ENUM_CLASS_ENTRY(AttrKind, SWIFT_ATTRIBUTE, unsigned short)
  ...
  MX_ENUM_CLASS_ENTRY(AttrKind, WEAK_REFERENCE, unsigned short)
  ...
  MX_ENUM_CLASS_ENTRY(AttrKind, X86_FORCE_ALIGN_ARGUMENT_POINTER, unsigned short)
  MX_ENUM_CLASS_ENTRY(AttrKind, X_RAY_INSTRUMENT, unsigned short)
  MX_ENUM_CLASS_ENTRY(AttrKind, X_RAY_LOG_ARGUMENTS, unsigned short)
  ...
  MX_ENUM_CLASS_ENTRY(AttrKind, INITIALIZER_SEG, unsigned short)
  ...
  MX_ENUM_CLASS_ENTRY(AttrKind, OMP_DECLARE_SIMD_DECLARATION, unsigned short)
  MX_ENUM_CLASS_ENTRY(AttrKind, OMP_REFERENCED_VARIABLE, unsigned short)
...
MX_BEGIN_ENUM_CLASS(AttributeSyntax, unsigned char)
  ...
  MX_ENUM_CLASS_ENTRY(AttributeSyntax, C2_X, unsigned char)
...
MX_BEGIN_VISIT_PSEUDO(Designator)
  ...
  MX_VISIT_PSEUDO_KIND(Designator, 0)
  MX_VISIT_BOOL(Designator, is_field_designator, 1, MX_APPLY_METHOD, IsFieldDesignator, bool, NthPseudo)
  MX_VISIT_BOOL(Designator, is_array_designator, 2, MX_APPLY_METHOD, IsArrayDesignator, bool, NthPseudo)
  MX_VISIT_BOOL(Designator, is_array_range_designator, 3, MX_APPLY_METHOD, IsArrayRangeDesignator, bool, NthPseudo)
  MX_VISIT_OPTIONAL_ENTITY(Designator, field, 4, MX_APPLY_METHOD, Field, FieldDecl, NthPseudo, DeclUseSelector::FIELD)
  MX_VISIT_ENTITY(Designator, dot_token, 8, MX_APPLY_METHOD, DotToken, Token, NthPseudo, TokenUseSelector::DOT_TOKEN)
  MX_VISIT_ENTITY(Designator, field_token, 9, MX_APPLY_METHOD, FieldToken, Token, NthPseudo, TokenUseSelector::FIELD_TOKEN)
  MX_VISIT_ENTITY(Designator, left_bracket_token, 10, MX_APPLY_METHOD, LeftBracketToken, Token, NthPseudo, TokenUseSelector::LEFT_BRACKET_TOKEN)
  MX_VISIT_ENTITY(Designator, right_bracket_token, 11, MX_APPLY_METHOD, RightBracketToken, Token, NthPseudo, TokenUseSelector::RIGHT_BRACKET_TOKEN)
  MX_VISIT_ENTITY(Designator, ellipsis_token, 12, MX_APPLY_METHOD, EllipsisToken, Token, NthPseudo, TokenUseSelector::ELLIPSIS_TOKEN)
  MX_VISIT_OPTIONAL_INT(Designator, first_expression_index, 13, MX_APPLY_METHOD, FirstExpressionIndex, unsigned, NthPseudo)
...
MX_BEGIN_VISIT_PSEUDO(TemplateParameterList)
  ...
  MX_VISIT_INT(TemplateParameterList, num_parameters, 13, MX_APPLY_METHOD, NumParameters, unsigned, NthPseudo)
  MX_VISIT_INT(TemplateParameterList, num_required_parameters, 15, MX_APPLY_METHOD, NumRequiredParameters, unsigned, NthPseudo)
  MX_VISIT_INT(TemplateParameterList, depth, 16, MX_APPLY_METHOD, Depth, unsigned, NthPseudo)
  MX_VISIT_BOOL(TemplateParameterList, has_unexpanded_parameter_pack, 1, MX_APPLY_METHOD, HasUnexpandedParameterPack, bool, NthPseudo)
  MX_VISIT_BOOL(TemplateParameterList, has_parameter_pack, 2, MX_APPLY_METHOD, HasParameterPack, bool, NthPseudo)
  MX_VISIT_OPTIONAL_ENTITY(TemplateParameterList, requires_clause, 4, MX_APPLY_METHOD, RequiresClause, Expr, NthPseudo, StmtUseSelector::REQUIRES_CLAUSE)
  MX_VISIT_ENTITY(TemplateParameterList, template_keyword_token, 6, MX_APPLY_METHOD, TemplateKeywordToken, Token, NthPseudo, TokenUseSelector::TEMPLATE_KEYWORD_TOKEN)
  MX_VISIT_ENTITY(TemplateParameterList, left_angle_token, 7, MX_APPLY_METHOD, LeftAngleToken, Token, NthPseudo, TokenUseSelector::LEFT_ANGLE_TOKEN)
  MX_VISIT_ENTITY(TemplateParameterList, right_angle_token, 8, MX_APPLY_METHOD, RightAngleToken, Token, NthPseudo, TokenUseSelector::RIGHT_ANGLE_TOKEN)
  MX_VISIT_ENTITY_LIST(TemplateParameterList, parameters, 17, MX_APPLY_METHOD, Parameters, NamedDecl, NthPseudo)
...
MX_BEGIN_VISIT_PSEUDO(TemplateArgument)
  ...
  MX_VISIT_ENUM(TemplateArgument, kind, 18, MX_APPLY_METHOD, Kind, TemplateArgumentKind, NthPseudo)
  MX_VISIT_BOOL(TemplateArgument, is_null, 1, MX_APPLY_METHOD, IsNull, bool, NthPseudo)
  MX_VISIT_BOOL(TemplateArgument, is_dependent, 2, MX_APPLY_METHOD, IsDependent, bool, NthPseudo)
  MX_VISIT_BOOL(TemplateArgument, is_instantiation_dependent, 3, MX_APPLY_METHOD, IsInstantiationDependent, bool, NthPseudo)
  MX_VISIT_BOOL(TemplateArgument, contains_unexpanded_parameter_pack, 5, MX_APPLY_METHOD, ContainsUnexpandedParameterPack, bool, NthPseudo)
  MX_VISIT_BOOL(TemplateArgument, is_pack_expansion, 14, MX_APPLY_METHOD, IsPackExpansion, bool, NthPseudo)
  MX_VISIT_OPTIONAL_ENTITY(TemplateArgument, as_declaration, 4, MX_APPLY_METHOD, AsDeclaration, ValueDecl, NthPseudo, DeclUseSelector::AS_DECLARATION)
  MX_VISIT_OPTIONAL_ENTITY(TemplateArgument, as_type, 6, MX_APPLY_METHOD, AsType, Type, NthPseudo, TypeUseSelector::AS_TYPE)
  MX_VISIT_OPTIONAL_ENTITY(TemplateArgument, parameter_type_for_declaration, 7, MX_APPLY_METHOD, ParameterTypeForDeclaration, Type, NthPseudo, TypeUseSelector::PARAMETER_TYPE_FOR_DECLARATION)
  MX_VISIT_OPTIONAL_ENTITY(TemplateArgument, null_pointer_type, 8, MX_APPLY_METHOD, NullPointerType, Type, NthPseudo, TypeUseSelector::NULL_POINTER_TYPE)
...
MX_BEGIN_VISIT_PSEUDO(CXXBaseSpecifier)
  ...
  MX_VISIT_ENTITY(CXXBaseSpecifier, base_type_token, 7, MX_APPLY_METHOD, BaseTypeToken, Token, NthPseudo, TokenUseSelector::BASE_TYPE_TOKEN)
  MX_VISIT_BOOL(CXXBaseSpecifier, is_virtual, 1, MX_APPLY_METHOD, IsVirtual, bool, NthPseudo)
  MX_VISIT_ENUM(CXXBaseSpecifier, base_kind, 18, MX_APPLY_METHOD, BaseKind, TagTypeKind, NthPseudo)
  ...
  MX_VISIT_OPTIONAL_ENTITY(CXXBaseSpecifier, ellipsis_token, 8, MX_APPLY_METHOD, EllipsisToken, Token, NthPseudo, TokenUseSelector::ELLIPSIS_TOKEN)
  MX_VISIT_ENUM(CXXBaseSpecifier, semantic_access_specifier, 23, MX_APPLY_METHOD, SemanticAccessSpecifier, AccessSpecifier, NthPseudo)
  MX_VISIT_ENUM(CXXBaseSpecifier, lexical_access_specifier, 24, MX_APPLY_METHOD, LexicalAccessSpecifier, AccessSpecifier, NthPseudo)
  MX_VISIT_ENTITY(CXXBaseSpecifier, base_type, 9, MX_APPLY_METHOD, BaseType, Type, NthPseudo, TypeUseSelector::BASE_TYPE)
...
MX_BEGIN_VISIT_STMT(DesignatedInitExpr)
  ...
  MX_VISIT_PSEUDO_LIST(DesignatedInitExpr, designators, 94, MX_APPLY_METHOD, Designators, Designator, NthStmt)
  ...
  MX_VISIT_BOOL(DesignatedInitExpr, is_direct_initializer, 95, MX_APPLY_METHOD, IsDirectInitializer, bool, NthStmt)
  MX_VISIT_BOOL(DesignatedInitExpr, uses_gnu_syntax, 96, MX_APPLY_METHOD, UsesGNUSyntax, bool, NthStmt)
...
MX_BEGIN_VISIT_STMT(DependentScopeDeclRefExpr)
  ...
  MX_VISIT_BOOL(DependentScopeDeclRefExpr, has_explicit_template_arguments, 95, MX_APPLY_METHOD, HasExplicitTemplateArguments, bool, NthStmt)
  MX_VISIT_BOOL(DependentScopeDeclRefExpr, has_template_keyword, 96, MX_APPLY_METHOD, HasTemplateKeyword, bool, NthStmt)
...
MX_BEGIN_VISIT_STMT(DeclRefExpr)
  ...
  MX_VISIT_BOOL(DeclRefExpr, had_multiple_candidates, 95, MX_APPLY_METHOD, HadMultipleCandidates, bool, NthStmt)
  MX_VISIT_BOOL(DeclRefExpr, has_explicit_template_arguments, 96, MX_APPLY_METHOD, HasExplicitTemplateArguments, bool, NthStmt)
  MX_VISIT_BOOL(DeclRefExpr, has_qualifier, 97, MX_APPLY_METHOD, HasQualifier, bool, NthStmt)
  MX_VISIT_BOOL(DeclRefExpr, has_template_keyword_and_arguments_info, 98, MX_APPLY_METHOD, HasTemplateKeywordAndArgumentsInfo, bool, NthStmt)
  MX_VISIT_BOOL(DeclRefExpr, has_template_keyword, 99, MX_APPLY_METHOD, HasTemplateKeyword, bool, NthStmt)
  MX_VISIT_ENUM(DeclRefExpr, is_non_odr_use, 100, MX_APPLY_METHOD, IsNonOdrUse, NonOdrUseReason, NthStmt)
  MX_VISIT_BOOL(DeclRefExpr, refers_to_enclosing_variable_or_capture, 101, MX_APPLY_METHOD, RefersToEnclosingVariableOrCapture, bool, NthStmt)
...
MX_BEGIN_VISIT_STMT(CoawaitExpr)
  ...
  MX_VISIT_BOOL(CoawaitExpr, is_implicit, 95, MX_APPLY_METHOD, IsImplicit, bool, NthStmt)
...
MX_BEGIN_VISIT_STMT(ConceptSpecializationExpr)
  ...
  MX_VISIT_PSEUDO_LIST(ConceptSpecializationExpr, template_arguments, 94, MX_APPLY_METHOD, TemplateArguments, TemplateArgument, NthStmt)
  MX_VISIT_BOOL(ConceptSpecializationExpr, is_satisfied, 95, MX_APPLY_METHOD, IsSatisfied, bool, NthStmt)
...
MX_BEGIN_VISIT_STMT(CompoundLiteralExpr)
  ...
  MX_VISIT_BOOL(CompoundLiteralExpr, is_file_scope, 95, MX_APPLY_METHOD, IsFileScope, bool, NthStmt)
...
MX_BEGIN_VISIT_STMT(ChooseExpr)
  ...
  MX_VISIT_BOOL(ChooseExpr, is_condition_dependent, 95, MX_APPLY_METHOD, IsConditionDependent, bool, NthStmt)
  MX_VISIT_BOOL(ChooseExpr, is_condition_true, 96, MX_APPLY_METHOD, IsConditionTrue, bool, NthStmt)
...
MX_BEGIN_VISIT_STMT(CharacterLiteral)
  ...
  MX_VISIT_ENUM(CharacterLiteral, character_kind, 100, MX_APPLY_METHOD, Kind, CharacterLiteralCharacterKind, NthStmt)
...
MX_BEGIN_VISIT_ABSTRACT_STMT(CastExpr)
  ...
  MX_VISIT_ENUM(CastExpr, cast_kind, 100, MX_APPLY_METHOD, CastKind, CastKind, NthStmt)
  ...
  MX_VISIT_BOOL(CastExpr, has_stored_fp_features, 97, MX_APPLY_METHOD, HasStoredFPFeatures, bool, NthStmt)
...
MX_BEGIN_VISIT_STMT(ImplicitCastExpr)
  ...
  MX_VISIT_BOOL(ImplicitCastExpr, is_part_of_explicit_cast, 98, MX_APPLY_METHOD, IsPartOfExplicitCast, bool, NthStmt)
...
MX_BEGIN_VISIT_STMT(CXXDynamicCastExpr)
  ...
  MX_VISIT_BOOL(CXXDynamicCastExpr, is_always_null, 98, MX_APPLY_METHOD, IsAlwaysNull, bool, NthStmt)
...
MX_BEGIN_VISIT_STMT(CXXFunctionalCastExpr)
  ...
  MX_VISIT_BOOL(CXXFunctionalCastExpr, is_list_initialization, 98, MX_APPLY_METHOD, IsListInitialization, bool, NthStmt)
...
MX_BEGIN_VISIT_STMT(CallExpr)
  ...
  MX_VISIT_ENUM(CallExpr, adl_call_kind, 100, MX_APPLY_METHOD, ADLCallKind, CallExprADLCallKind, NthStmt)
...
MX_BEGIN_VISIT_STMT(CXXUuidofExpr)
  ...
  MX_VISIT_BOOL(CXXUuidofExpr, is_type_operand, 96, MX_APPLY_METHOD, IsTypeOperand, bool, NthStmt)
...
MX_BEGIN_VISIT_STMT(CXXUnresolvedConstructExpr)
  ...
  MX_VISIT_BOOL(CXXUnresolvedConstructExpr, is_list_initialization, 95, MX_APPLY_METHOD, IsListInitialization, bool, NthStmt)
...
MX_BEGIN_VISIT_STMT(CXXTypeidExpr)
  ...
  MX_VISIT_OPTIONAL_BOOL(CXXTypeidExpr, is_most_derived, 96, MX_APPLY_METHOD, IsMostDerived, bool, NthStmt)
  MX_VISIT_BOOL(CXXTypeidExpr, is_potentially_evaluated, 98, MX_APPLY_METHOD, IsPotentiallyEvaluated, bool, NthStmt)
  MX_VISIT_BOOL(CXXTypeidExpr, is_type_operand, 99, MX_APPLY_METHOD, IsTypeOperand, bool, NthStmt)
...
MX_BEGIN_VISIT_STMT(CXXThrowExpr)
  ...
  MX_VISIT_BOOL(CXXThrowExpr, is_thrown_variable_in_scope, 96, MX_APPLY_METHOD, IsThrownVariableInScope, bool, NthStmt)
...
MX_BEGIN_VISIT_STMT(CXXThisExpr)
  ...
  MX_VISIT_BOOL(CXXThisExpr, is_implicit, 95, MX_APPLY_METHOD, IsImplicit, bool, NthStmt)
...
MX_BEGIN_VISIT_STMT(CXXRewrittenBinaryOperator)
  ...
  MX_VISIT_ENUM(CXXRewrittenBinaryOperator, opcode, 100, MX_APPLY_METHOD, Opcode, BinaryOperatorKind, NthStmt)
  ...
  MX_VISIT_BOOL(CXXRewrittenBinaryOperator, is_assignment_operation, 95, MX_APPLY_METHOD, IsAssignmentOperation, bool, NthStmt)
  MX_VISIT_BOOL(CXXRewrittenBinaryOperator, is_comparison_operation, 96, MX_APPLY_METHOD, IsComparisonOperation, bool, NthStmt)
  MX_VISIT_BOOL(CXXRewrittenBinaryOperator, is_reversed, 97, MX_APPLY_METHOD, IsReversed, bool, NthStmt)
...
MX_BEGIN_VISIT_STMT(CXXPseudoDestructorExpr)
  ...
  MX_VISIT_BOOL(CXXPseudoDestructorExpr, has_qualifier, 96, MX_APPLY_METHOD, HasQualifier, bool, NthStmt)
  MX_VISIT_BOOL(CXXPseudoDestructorExpr, is_arrow, 97, MX_APPLY_METHOD, IsArrow, bool, NthStmt)
...
MX_BEGIN_VISIT_STMT(CXXNoexceptExpr)
  ...
  MX_VISIT_BOOL(CXXNoexceptExpr, value, 95, MX_APPLY_METHOD, Value, bool, NthStmt)
...
MX_BEGIN_VISIT_STMT(CXXNewExpr)
  ...
  MX_VISIT_BOOL(CXXNewExpr, does_usual_array_delete_want_size, 95, MX_APPLY_METHOD, DoesUsualArrayDeleteWantSize, bool, NthStmt)
  ...
  MX_VISIT_ENUM(CXXNewExpr, initialization_style, 100, MX_APPLY_METHOD, InitializationStyle, CXXNewExprInitializationStyle, NthStmt)
  ...
  MX_VISIT_BOOL(CXXNewExpr, has_initializer, 99, MX_APPLY_METHOD, HasInitializer, bool, NthStmt)
  MX_VISIT_BOOL(CXXNewExpr, is_array, 101, MX_APPLY_METHOD, IsArray, bool, NthStmt)
...
MX_BEGIN_VISIT_STMT(CXXInheritedCtorInitExpr)
  ...
  MX_VISIT_BOOL(CXXInheritedCtorInitExpr, constructs_virtual_base, 95, MX_APPLY_METHOD, ConstructsVirtualBase, bool, NthStmt)
  MX_VISIT_ENUM(CXXInheritedCtorInitExpr, construction_kind, 100, MX_APPLY_METHOD, ConstructionKind, CXXConstructExprConstructionKind, NthStmt)
  ...
  MX_VISIT_BOOL(CXXInheritedCtorInitExpr, inherited_from_virtual_base, 96, MX_APPLY_METHOD, InheritedFromVirtualBase, bool, NthStmt)
...
MX_BEGIN_VISIT_STMT(CXXFoldExpr)
  ...
  MX_VISIT_BOOL(CXXFoldExpr, is_left_fold, 96, MX_APPLY_METHOD, IsLeftFold, bool, NthStmt)
  MX_VISIT_BOOL(CXXFoldExpr, is_right_fold, 97, MX_APPLY_METHOD, IsRightFold, bool, NthStmt)
...
MX_BEGIN_VISIT_STMT(CXXDependentScopeMemberExpr)
  ...
  MX_VISIT_BOOL(CXXDependentScopeMemberExpr, has_explicit_template_arguments, 97, MX_APPLY_METHOD, HasExplicitTemplateArguments, bool, NthStmt)
  MX_VISIT_BOOL(CXXDependentScopeMemberExpr, has_template_keyword, 98, MX_APPLY_METHOD, HasTemplateKeyword, bool, NthStmt)
  MX_VISIT_BOOL(CXXDependentScopeMemberExpr, is_arrow, 99, MX_APPLY_METHOD, IsArrow, bool, NthStmt)
  MX_VISIT_BOOL(CXXDependentScopeMemberExpr, is_implicit_access, 101, MX_APPLY_METHOD, IsImplicitAccess, bool, NthStmt)
...
MX_BEGIN_VISIT_STMT(CXXDeleteExpr)
  ...
  MX_VISIT_BOOL(CXXDeleteExpr, does_usual_array_delete_want_size, 95, MX_APPLY_METHOD, DoesUsualArrayDeleteWantSize, bool, NthStmt)
  ...
  MX_VISIT_BOOL(CXXDeleteExpr, is_array_form, 96, MX_APPLY_METHOD, IsArrayForm, bool, NthStmt)
  MX_VISIT_BOOL(CXXDeleteExpr, is_array_form_as_written, 97, MX_APPLY_METHOD, IsArrayFormAsWritten, bool, NthStmt)
  MX_VISIT_BOOL(CXXDeleteExpr, is_global_delete, 98, MX_APPLY_METHOD, IsGlobalDelete, bool, NthStmt)
...
MX_BEGIN_VISIT_STMT(CXXConstructExpr)
  ...
  MX_VISIT_ENUM(CXXConstructExpr, construction_kind, 100, MX_APPLY_METHOD, ConstructionKind, CXXConstructExprConstructionKind, NthStmt)
  ...
  MX_VISIT_BOOL(CXXConstructExpr, had_multiple_candidates, 95, MX_APPLY_METHOD, HadMultipleCandidates, bool, NthStmt)
  MX_VISIT_BOOL(CXXConstructExpr, is_elidable, 96, MX_APPLY_METHOD, IsElidable, bool, NthStmt)
  MX_VISIT_BOOL(CXXConstructExpr, is_list_initialization, 97, MX_APPLY_METHOD, IsListInitialization, bool, NthStmt)
  MX_VISIT_BOOL(CXXConstructExpr, is_std_initializer_list_initialization, 98, MX_APPLY_METHOD, IsStdInitializerListInitialization, bool, NthStmt)
  MX_VISIT_BOOL(CXXConstructExpr, requires_zero_initialization, 99, MX_APPLY_METHOD, RequiresZeroInitialization, bool, NthStmt)
...
MX_BEGIN_VISIT_STMT(CXXBoolLiteralExpr)
  ...
  MX_VISIT_BOOL(CXXBoolLiteralExpr, value, 95, MX_APPLY_METHOD, Value, bool, NthStmt)
...
MX_BEGIN_VISIT_STMT(BinaryOperator)
  ...
  MX_VISIT_ENUM(BinaryOperator, opcode, 100, MX_APPLY_METHOD, Opcode, BinaryOperatorKind, NthStmt)
  ...
  MX_VISIT_BOOL(BinaryOperator, has_stored_fp_features, 95, MX_APPLY_METHOD, HasStoredFPFeatures, bool, NthStmt)
  MX_VISIT_BOOL(BinaryOperator, is_additive_operation, 96, MX_APPLY_METHOD, IsAdditiveOperation, bool, NthStmt)
  MX_VISIT_BOOL(BinaryOperator, is_assignment_operation, 97, MX_APPLY_METHOD, IsAssignmentOperation, bool, NthStmt)
  MX_VISIT_BOOL(BinaryOperator, is_bitwise_operation, 98, MX_APPLY_METHOD, IsBitwiseOperation, bool, NthStmt)
  MX_VISIT_BOOL(BinaryOperator, is_comma_operation, 99, MX_APPLY_METHOD, IsCommaOperation, bool, NthStmt)
  MX_VISIT_BOOL(BinaryOperator, is_comparison_operation, 101, MX_APPLY_METHOD, IsComparisonOperation, bool, NthStmt)
...
MX_BEGIN_VISIT_STMT(AtomicExpr)
  ...
  MX_VISIT_ENUM(AtomicExpr, operation, 100, MX_APPLY_METHOD, Operation, AtomicExprAtomicOp, NthStmt)
  ...
  MX_VISIT_BOOL(AtomicExpr, is_cmp_x_chg, 101, MX_APPLY_METHOD, IsCmpXChg, bool, NthStmt)
...
MX_BEGIN_VISIT_STMT(ArrayTypeTraitExpr)
  ...
  MX_VISIT_ENUM(ArrayTypeTraitExpr, trait, 100, MX_APPLY_METHOD, Trait, ArrayTypeTrait, NthStmt)
...
MX_BEGIN_VISIT_STMT(VAArgExpr)
  ...
  MX_VISIT_BOOL(VAArgExpr, is_microsoft_abi, 95, MX_APPLY_METHOD, IsMicrosoftABI, bool, NthStmt)
...
MX_BEGIN_VISIT_STMT(UnaryOperator)
  ...
  MX_VISIT_BOOL(UnaryOperator, can_overflow, 95, MX_APPLY_METHOD, CanOverflow, bool, NthStmt)
  MX_VISIT_ENUM(UnaryOperator, opcode, 100, MX_APPLY_METHOD, Opcode, UnaryOperatorKind, NthStmt)
  ...
  MX_VISIT_BOOL(UnaryOperator, has_stored_fp_features, 96, MX_APPLY_METHOD, HasStoredFPFeatures, bool, NthStmt)
  MX_VISIT_BOOL(UnaryOperator, is_arithmetic_operation, 97, MX_APPLY_METHOD, IsArithmeticOperation, bool, NthStmt)
  MX_VISIT_BOOL(UnaryOperator, is_decrement_operation, 98, MX_APPLY_METHOD, IsDecrementOperation, bool, NthStmt)
  MX_VISIT_BOOL(UnaryOperator, is_increment_decrement_operation, 99, MX_APPLY_METHOD, IsIncrementDecrementOperation, bool, NthStmt)
  MX_VISIT_BOOL(UnaryOperator, is_increment_operation, 101, MX_APPLY_METHOD, IsIncrementOperation, bool, NthStmt)
...
MX_BEGIN_VISIT_STMT(UnaryExprOrTypeTraitExpr)
  ...
  MX_VISIT_ENUM(UnaryExprOrTypeTraitExpr, expression_or_trait_kind, 100, MX_APPLY_METHOD, Kind, UnaryExprOrTypeTrait, NthStmt)
  ...
  MX_VISIT_BOOL(UnaryExprOrTypeTraitExpr, is_argument_type, 97, MX_APPLY_METHOD, IsArgumentType, bool, NthStmt)
...
MX_BEGIN_VISIT_STMT(TypeTraitExpr)
  ...
  MX_VISIT_ENUM(TypeTraitExpr, trait, 100, MX_APPLY_METHOD, Trait, TypeTrait, NthStmt)
  MX_VISIT_OPTIONAL_BOOL(TypeTraitExpr, value, 95, MX_APPLY_METHOD, Value, bool, NthStmt)
...
MX_BEGIN_VISIT_STMT(SubstNonTypeTemplateParmExpr)
  ...
  MX_VISIT_BOOL(SubstNonTypeTemplateParmExpr, is_reference_parameter, 95, MX_APPLY_METHOD, IsReferenceParameter, bool, NthStmt)
...
MX_BEGIN_VISIT_STMT(StringLiteral)
  ...
  MX_VISIT_OPTIONAL_BOOL(StringLiteral, contains_non_ascii, 95, MX_APPLY_METHOD, ContainsNonAscii, bool, NthStmt)
  MX_VISIT_OPTIONAL_BOOL(StringLiteral, contains_non_ascii_or_null, 97, MX_APPLY_METHOD, ContainsNonAsciiOrNull, bool, NthStmt)
  MX_VISIT_TEXT(StringLiteral, bytes, 65, MX_APPLY_METHOD, Bytes, basic_string_view, NthStmt)
  MX_VISIT_ENUM(StringLiteral, string_kind, 100, MX_APPLY_METHOD, Kind, StringLiteralStringKind, NthStmt)
  MX_VISIT_OPTIONAL_TEXT(StringLiteral, string, 70, MX_APPLY_METHOD, String, basic_string_view, NthStmt)
  MX_VISIT_BOOL(StringLiteral, is_ascii, 101, MX_APPLY_METHOD, IsAscii, bool, NthStmt)
...
MX_BEGIN_VISIT_STMT(SourceLocExpr)
  ...
  MX_VISIT_ENUM(SourceLocExpr, identifier_kind, 100, MX_APPLY_METHOD, IdentifierKind, SourceLocExprIdentKind, NthStmt)
  MX_VISIT_ENTITY(SourceLocExpr, token, 37, MX_APPLY_METHOD, Token, Token, NthStmt, TokenUseSelector::TOKEN)
  MX_VISIT_BOOL(SourceLocExpr, is_int_type, 95, MX_APPLY_METHOD, IsIntType, bool, NthStmt)
  MX_VISIT_BOOL(SourceLocExpr, is_string_type, 96, MX_APPLY_METHOD, IsStringType, bool, NthStmt)
...
MX_BEGIN_VISIT_STMT(SizeOfPackExpr)
  ...
  MX_VISIT_BOOL(SizeOfPackExpr, is_partially_substituted, 97, MX_APPLY_METHOD, IsPartiallySubstituted, bool, NthStmt)
...
MX_BEGIN_VISIT_STMT(RequiresExpr)
  ...
  MX_VISIT_BOOL(RequiresExpr, is_satisfied, 95, MX_APPLY_METHOD, IsSatisfied, bool, NthStmt)
...
MX_BEGIN_VISIT_STMT(PredefinedExpr)
  ...
  MX_VISIT_ENUM(PredefinedExpr, identifier_kind, 100, MX_APPLY_METHOD, IdentifierKind, PredefinedExprIdentKind, NthStmt)
...
MX_BEGIN_VISIT_ABSTRACT_STMT(OverloadExpr)
  ...
  MX_VISIT_BOOL(OverloadExpr, has_explicit_template_arguments, 96, MX_APPLY_METHOD, HasExplicitTemplateArguments, bool, NthStmt)
  MX_VISIT_BOOL(OverloadExpr, has_template_keyword, 97, MX_APPLY_METHOD, HasTemplateKeyword, bool, NthStmt)
...
MX_BEGIN_VISIT_STMT(UnresolvedMemberExpr)
  ...
  MX_VISIT_BOOL(UnresolvedMemberExpr, has_unresolved_using, 98, MX_APPLY_METHOD, HasUnresolvedUsing, bool, NthStmt)
  MX_VISIT_BOOL(UnresolvedMemberExpr, is_arrow, 99, MX_APPLY_METHOD, IsArrow, bool, NthStmt)
  MX_VISIT_BOOL(UnresolvedMemberExpr, is_implicit_access, 101, MX_APPLY_METHOD, IsImplicitAccess, bool, NthStmt)
...
MX_BEGIN_VISIT_STMT(UnresolvedLookupExpr)
  ...
  MX_VISIT_BOOL(UnresolvedLookupExpr, is_overloaded, 98, MX_APPLY_METHOD, IsOverloaded, bool, NthStmt)
  MX_VISIT_BOOL(UnresolvedLookupExpr, requires_adl, 99, MX_APPLY_METHOD, RequiresADL, bool, NthStmt)
...
MX_BEGIN_VISIT_STMT(OpaqueValueExpr)
  ...
  MX_VISIT_BOOL(OpaqueValueExpr, is_unique, 95, MX_APPLY_METHOD, IsUnique, bool, NthStmt)
...
MX_BEGIN_VISIT_STMT(ObjCSubscriptRefExpr)
  ...
  MX_VISIT_BOOL(ObjCSubscriptRefExpr, is_array_subscript_reference_expression, 95, MX_APPLY_METHOD, IsArraySubscriptReferenceExpression, bool, NthStmt)
...
MX_BEGIN_VISIT_STMT(ObjCPropertyRefExpr)
  ...
  MX_VISIT_BOOL(ObjCPropertyRefExpr, is_class_receiver, 95, MX_APPLY_METHOD, IsClassReceiver, bool, NthStmt)
  MX_VISIT_BOOL(ObjCPropertyRefExpr, is_explicit_property, 96, MX_APPLY_METHOD, IsExplicitProperty, bool, NthStmt)
  MX_VISIT_BOOL(ObjCPropertyRefExpr, is_implicit_property, 97, MX_APPLY_METHOD, IsImplicitProperty, bool, NthStmt)
  MX_VISIT_BOOL(ObjCPropertyRefExpr, is_messaging_getter, 98, MX_APPLY_METHOD, IsMessagingGetter, bool, NthStmt)
  MX_VISIT_BOOL(ObjCPropertyRefExpr, is_messaging_setter, 99, MX_APPLY_METHOD, IsMessagingSetter, bool, NthStmt)
  MX_VISIT_BOOL(ObjCPropertyRefExpr, is_object_receiver, 101, MX_APPLY_METHOD, IsObjectReceiver, bool, NthStmt)
...
MX_BEGIN_VISIT_STMT(ObjCMessageExpr)
  ...
  MX_VISIT_ENUM(ObjCMessageExpr, method_family, 100, MX_APPLY_METHOD, MethodFamily, ObjCMethodFamily, NthStmt)
  ...
  MX_VISIT_BOOL(ObjCMessageExpr, is_class_message, 95, MX_APPLY_METHOD, IsClassMessage, bool, NthStmt)
  MX_VISIT_BOOL(ObjCMessageExpr, is_delegate_initializer_call, 96, MX_APPLY_METHOD, IsDelegateInitializerCall, bool, NthStmt)
  MX_VISIT_BOOL(ObjCMessageExpr, is_implicit, 97, MX_APPLY_METHOD, IsImplicit, bool, NthStmt)
  MX_VISIT_BOOL(ObjCMessageExpr, is_instance_message, 98, MX_APPLY_METHOD, IsInstanceMessage, bool, NthStmt)
...
MX_BEGIN_VISIT_STMT(ObjCIvarRefExpr)
  ...
  MX_VISIT_BOOL(ObjCIvarRefExpr, is_arrow, 95, MX_APPLY_METHOD, IsArrow, bool, NthStmt)
  MX_VISIT_BOOL(ObjCIvarRefExpr, is_free_instance_variable, 96, MX_APPLY_METHOD, IsFreeInstanceVariable, bool, NthStmt)
...
MX_BEGIN_VISIT_STMT(ObjCIsaExpr)
  ...
  MX_VISIT_BOOL(ObjCIsaExpr, is_arrow, 95, MX_APPLY_METHOD, IsArrow, bool, NthStmt)
...
MX_BEGIN_VISIT_STMT(ObjCIndirectCopyRestoreExpr)
  ...
  MX_VISIT_BOOL(ObjCIndirectCopyRestoreExpr, should_copy, 95, MX_APPLY_METHOD, ShouldCopy, bool, NthStmt)
...
MX_BEGIN_VISIT_STMT(ObjCBoxedExpr)
  ...
  MX_VISIT_BOOL(ObjCBoxedExpr, is_expressible_as_constant_initializer, 95, MX_APPLY_METHOD, IsExpressibleAsConstantInitializer, bool, NthStmt)
...
MX_BEGIN_VISIT_STMT(ObjCBoolLiteralExpr)
  ...
  MX_VISIT_BOOL(ObjCBoolLiteralExpr, value, 95, MX_APPLY_METHOD, Value, bool, NthStmt)
...
MX_BEGIN_VISIT_STMT(ObjCAvailabilityCheckExpr)
  ...
  MX_VISIT_BOOL(ObjCAvailabilityCheckExpr, has_version, 95, MX_APPLY_METHOD, HasVersion, bool, NthStmt)
...
MX_BEGIN_VISIT_STMT(MemberExpr)
  ...
  MX_VISIT_BOOL(MemberExpr, had_multiple_candidates, 95, MX_APPLY_METHOD, HadMultipleCandidates, bool, NthStmt)
  MX_VISIT_BOOL(MemberExpr, has_explicit_template_arguments, 96, MX_APPLY_METHOD, HasExplicitTemplateArguments, bool, NthStmt)
  MX_VISIT_BOOL(MemberExpr, has_qualifier, 97, MX_APPLY_METHOD, HasQualifier, bool, NthStmt)
  MX_VISIT_BOOL(MemberExpr, has_template_keyword, 98, MX_APPLY_METHOD, HasTemplateKeyword, bool, NthStmt)
  MX_VISIT_BOOL(MemberExpr, is_arrow, 99, MX_APPLY_METHOD, IsArrow, bool, NthStmt)
  MX_VISIT_BOOL(MemberExpr, is_implicit_access, 101, MX_APPLY_METHOD, IsImplicitAccess, bool, NthStmt)
  MX_VISIT_ENUM(MemberExpr, is_non_odr_use, 100, MX_APPLY_METHOD, IsNonOdrUse, NonOdrUseReason, NthStmt)
...
MX_BEGIN_VISIT_STMT(MatrixSubscriptExpr)
  ...
  MX_VISIT_BOOL(MatrixSubscriptExpr, is_incomplete, 95, MX_APPLY_METHOD, IsIncomplete, bool, NthStmt)
...
MX_BEGIN_VISIT_STMT(MaterializeTemporaryExpr)
  ...
  MX_VISIT_ENUM(MaterializeTemporaryExpr, storage_duration, 100, MX_APPLY_METHOD, StorageDuration, StorageDuration, NthStmt)
  ...
  MX_VISIT_BOOL(MaterializeTemporaryExpr, is_bound_to_lvalue_reference, 97, MX_APPLY_METHOD, IsBoundToLvalueReference, bool, NthStmt)
  MX_VISIT_BOOL(MaterializeTemporaryExpr, is_usable_in_constant_expressions, 98, MX_APPLY_METHOD, IsUsableInConstantExpressions, bool, NthStmt)
...
MX_BEGIN_VISIT_STMT(MSPropertyRefExpr)
  ...
  MX_VISIT_BOOL(MSPropertyRefExpr, is_arrow, 95, MX_APPLY_METHOD, IsArrow, bool, NthStmt)
  MX_VISIT_BOOL(MSPropertyRefExpr, is_implicit_access, 96, MX_APPLY_METHOD, IsImplicitAccess, bool, NthStmt)
...
MX_BEGIN_VISIT_STMT(LambdaExpr)
  ...
  MX_VISIT_ENUM(LambdaExpr, capture_default, 100, MX_APPLY_METHOD, CaptureDefault, LambdaCaptureDefault, NthStmt)
  ...
  MX_VISIT_BOOL(LambdaExpr, is_generic_lambda, 99, MX_APPLY_METHOD, IsGenericLambda, bool, NthStmt)
  MX_VISIT_BOOL(LambdaExpr, is_mutable, 101, MX_APPLY_METHOD, IsMutable, bool, NthStmt)
...
MX_BEGIN_VISIT_STMT(InitListExpr)
  ...
  MX_VISIT_BOOL(InitListExpr, had_array_range_designator, 99, MX_APPLY_METHOD, HadArrayRangeDesignator, bool, NthStmt)
  MX_VISIT_BOOL(InitListExpr, has_array_filler, 101, MX_APPLY_METHOD, HasArrayFiller, bool, NthStmt)
...
MX_BEGIN_VISIT_STMT(GenericSelectionExpr)
  ...
  MX_VISIT_BOOL(GenericSelectionExpr, is_result_dependent, 95, MX_APPLY_METHOD, IsResultDependent, bool, NthStmt)
...
MX_BEGIN_VISIT_STMT(ExprWithCleanups)
  ...
  MX_VISIT_BOOL(ExprWithCleanups, cleanups_have_side_effects, 95, MX_APPLY_METHOD, CleanupsHaveSideEffects, bool, NthStmt)
...
MX_BEGIN_VISIT_STMT(ConstantExpr)
  ...
  MX_VISIT_ENUM(ConstantExpr, result_storage_kind, 100, MX_APPLY_METHOD, ResultStorageKind, ConstantExprResultStorageKind, NthStmt)
  MX_VISIT_BOOL(ConstantExpr, has_ap_value_result, 95, MX_APPLY_METHOD, HasAPValueResult, bool, NthStmt)
  MX_VISIT_BOOL(ConstantExpr, is_immediate_invocation, 96, MX_APPLY_METHOD, IsImmediateInvocation, bool, NthStmt)
...
MX_BEGIN_VISIT_STMT(FloatingLiteral)
  ...
  MX_VISIT_BOOL(FloatingLiteral, is_exact, 95, MX_APPLY_METHOD, IsExact, bool, NthStmt)
...
MX_BEGIN_VISIT_STMT(ExtVectorElementExpr)
  ...
  MX_VISIT_BOOL(ExtVectorElementExpr, contains_duplicate_elements, 95, MX_APPLY_METHOD, ContainsDuplicateElements, bool, NthStmt)
  ...
  MX_VISIT_BOOL(ExtVectorElementExpr, is_arrow, 96, MX_APPLY_METHOD, IsArrow, bool, NthStmt)
...
MX_BEGIN_VISIT_STMT(ExpressionTraitExpr)
  ...
  MX_VISIT_ENUM(ExpressionTraitExpr, trait, 100, MX_APPLY_METHOD, Trait, ExpressionTrait, NthStmt)
  MX_VISIT_BOOL(ExpressionTraitExpr, value, 95, MX_APPLY_METHOD, Value, bool, NthStmt)
