...
MX_BEGIN_VISIT_ABSTRACT_TYPE(Type)
  ...
  MX_VISIT_BOOL(Type, is_structural_type, getVal237, setVal237, initVal237, IsStructuralType, bool, NthType)
  MX_VISIT_BOOL(Type, is_structure_or_class_type, getVal238, setVal238, initVal238, IsStructureOrClassType, bool, NthType)
  MX_VISIT_BOOL(Type, is_structure_type, getVal239, setVal239, initVal239, IsStructureType, bool, NthType)
  MX_VISIT_BOOL(Type, is_template_type_parm_type, getVal240, setVal240, initVal240, IsTemplateTypeParmType, bool, NthType)
  MX_VISIT_BOOL(Type, is_typedef_name_type, getVal241, setVal241, initVal241, IsTypedefNameType, bool, NthType)
  MX_VISIT_BOOL(Type, is_undeduced_auto_type, getVal242, setVal242, initVal242, IsUndeducedAutoType, bool, NthType)
  MX_VISIT_BOOL(Type, is_undeduced_type, getVal243, setVal243, initVal243, IsUndeducedType, bool, NthType)
  MX_VISIT_BOOL(Type, is_union_type, getVal244, setVal244, initVal244, IsUnionType, bool, NthType)
  MX_VISIT_BOOL(Type, is_unsaturated_fixed_point_type, getVal245, setVal245, initVal245, IsUnsaturatedFixedPointType, bool, NthType)
  MX_VISIT_BOOL(Type, is_unscoped_enumeration_type, getVal246, setVal246, initVal246, IsUnscopedEnumerationType, bool, NthType)
  MX_VISIT_BOOL(Type, is_unsigned_fixed_point_type, getVal247, setVal247, initVal247, IsUnsignedFixedPointType, bool, NthType)
  MX_VISIT_BOOL(Type, is_unsigned_integer_or_enumeration_type, getVal248, setVal248, initVal248, IsUnsignedIntegerOrEnumerationType, bool, NthType)
  MX_VISIT_BOOL(Type, is_unsigned_integer_type, getVal249, setVal249, initVal249, IsUnsignedIntegerType, bool, NthType)
  MX_VISIT_BOOL(Type, is_vlst_builtin_type, getVal250, setVal250, initVal250, IsVLSTBuiltinType, bool, NthType)
  MX_VISIT_BOOL(Type, is_variable_array_type, getVal251, setVal251, initVal251, IsVariableArrayType, bool, NthType)
  MX_VISIT_BOOL(Type, is_variably_modified_type, getVal252, setVal252, initVal252, IsVariablyModifiedType, bool, NthType)
  MX_VISIT_BOOL(Type, is_vector_type, getVal253, setVal253, initVal253, IsVectorType, bool, NthType)
  MX_VISIT_BOOL(Type, is_visibility_explicit, getVal254, setVal254, initVal254, IsVisibilityExplicit, bool, NthType)
  MX_VISIT_BOOL(Type, is_void_pointer_type, getVal255, setVal255, initVal255, IsVoidPointerType, bool, NthType)
  MX_VISIT_BOOL(Type, is_void_type, getVal256, setVal256, initVal256, IsVoidType, bool, NthType)
  MX_VISIT_BOOL(Type, is_wide_character_type, getVal257, setVal257, initVal257, IsWideCharacterType, bool, NthType)
  MX_VISIT_ENTITY(Type, ignore_parentheses, getVal258, setVal258, initVal258, IgnoreParentheses, Type, NthType, TypeUseSelector::IGNORE_PARENTHESES)
  MX_VISIT_ENUM(Type, address_space, getVal259, setVal259, initVal259, AddressSpace, LangAS, NthType)
  MX_VISIT_ENTITY(Type, atomic_unqualified_type, getVal260, setVal260, initVal260, AtomicUnqualifiedType, Type, NthType, TypeUseSelector::ATOMIC_UNQUALIFIED_TYPE)
  MX_VISIT_ENTITY(Type, canonical_type, getVal261, setVal261, initVal261, CanonicalType, Type, NthType, TypeUseSelector::CANONICAL_TYPE)
  MX_VISIT_ENTITY(Type, desugared_type, getVal262, setVal262, initVal262, DesugaredType, Type, NthType, TypeUseSelector::DESUGARED_TYPE)
  MX_VISIT_ENTITY(Type, local_unqualified_type, getVal263, setVal263, initVal263, LocalUnqualifiedType, Type, NthType, TypeUseSelector::LOCAL_UNQUALIFIED_TYPE)
  MX_VISIT_ENTITY(Type, non_l_value_expression_type, getVal264, setVal264, initVal264, NonLValueExpressionType, Type, NthType, TypeUseSelector::NON_L_VALUE_EXPRESSION_TYPE)
  MX_VISIT_ENTITY(Type, non_pack_expansion_type, getVal265, setVal265, initVal265, NonPackExpansionType, Type, NthType, TypeUseSelector::NON_PACK_EXPANSION_TYPE)
  MX_VISIT_ENTITY(Type, non_reference_type, getVal266, setVal266, initVal266, NonReferenceType, Type, NthType, TypeUseSelector::NON_REFERENCE_TYPE)
  MX_VISIT_ENTITY(Type, single_step_desugared_type, getVal267, setVal267, initVal267, SingleStepDesugaredType, Type, NthType, TypeUseSelector::SINGLE_STEP_DESUGARED_TYPE)
  MX_VISIT_BOOL(Type, has_address_space, getVal268, setVal268, initVal268, HasAddressSpace, bool, NthType)
  MX_VISIT_BOOL(Type, has_local_non_fast_qualifiers, getVal269, setVal269, initVal269, HasLocalNonFastQualifiers, bool, NthType)
  MX_VISIT_BOOL(Type, has_local_qualifiers, getVal270, setVal270, initVal270, HasLocalQualifiers, bool, NthType)
  MX_VISIT_BOOL(Type, has_non_trivial_obj_c_lifetime, getVal271, setVal271, initVal271, HasNonTrivialObjCLifetime, bool, NthType)
  MX_VISIT_BOOL(Type, has_non_trivial_to_primitive_copy_c_union, getVal272, setVal272, initVal272, HasNonTrivialToPrimitiveCopyCUnion, bool, NthType)
  MX_VISIT_BOOL(Type, has_non_trivial_to_primitive_default_initialize_c_union, getVal273, setVal273, initVal273, HasNonTrivialToPrimitiveDefaultInitializeCUnion, bool, NthType)
  MX_VISIT_BOOL(Type, has_non_trivial_to_primitive_destruct_c_union, getVal274, setVal274, initVal274, HasNonTrivialToPrimitiveDestructCUnion, bool, NthType)
  MX_VISIT_BOOL(Type, has_qualifiers, getVal275, setVal275, initVal275, HasQualifiers, bool, NthType)
  MX_VISIT_BOOL(Type, has_strong_or_weak_obj_c_lifetime, getVal276, setVal276, initVal276, HasStrongOrWeakObjCLifetime, bool, NthType)
  MX_VISIT_BOOL(Type, is_c_forbidden_l_value_type, getVal277, setVal277, initVal277, IsCForbiddenLValueType, bool, NthType)
  MX_VISIT_BOOL(Type, is_cxx11_pod_type, getVal278, setVal278, initVal278, IsCXX11PODType, bool, NthType)
  MX_VISIT_BOOL(Type, is_cxx98_pod_type, getVal279, setVal279, initVal279, IsCXX98PODType, bool, NthType)
  MX_VISIT_BOOL(Type, is_canonical, getVal280, setVal280, initVal280, IsCanonical, bool, NthType)
  MX_VISIT_BOOL(Type, is_canonical_as_parameter, getVal281, setVal281, initVal281, IsCanonicalAsParameter, bool, NthType)
  MX_VISIT_BOOL(Type, is_const_qualified, getVal282, setVal282, initVal282, IsConstQualified, bool, NthType)
  MX_VISIT_BOOL(Type, is_constant, getVal283, setVal283, initVal283, IsConstant, bool, NthType)
  MX_VISIT_ENUM(Type, is_destructed_type, getVal284, setVal284, initVal284, IsDestructedType, QualTypeDestructionKind, NthType)
  MX_VISIT_BOOL(Type, is_local_const_qualified, getVal285, setVal285, initVal285, IsLocalConstQualified, bool, NthType)
  MX_VISIT_BOOL(Type, is_local_restrict_qualified, getVal286, setVal286, initVal286, IsLocalRestrictQualified, bool, NthType)
  MX_VISIT_BOOL(Type, is_local_volatile_qualified, getVal287, setVal287, initVal287, IsLocalVolatileQualified, bool, NthType)
  MX_VISIT_ENUM(Type, is_non_trivial_to_primitive_copy, getVal288, setVal288, initVal288, IsNonTrivialToPrimitiveCopy, QualTypePrimitiveCopyKind, NthType)
  MX_VISIT_ENUM(Type, is_non_trivial_to_primitive_default_initialize, getVal289, setVal289, initVal289, IsNonTrivialToPrimitiveDefaultInitialize, QualTypePrimitiveDefaultInitializeKind, NthType)
  MX_VISIT_ENUM(Type, is_non_trivial_to_primitive_destructive_move, getVal290, setVal290, initVal290, IsNonTrivialToPrimitiveDestructiveMove, QualTypePrimitiveCopyKind, NthType)
  MX_VISIT_BOOL(Type, is_non_weak_in_mrr_with_obj_c_weak, getVal291, setVal291, initVal291, IsNonWeakInMRRWithObjCWeak, bool, NthType)
  MX_VISIT_BOOL(Type, is_null, getVal292, setVal292, initVal292, IsNull, bool, NthType)
  MX_VISIT_BOOL(Type, is_obj_cgc_strong, getVal293, setVal293, initVal293, IsObjCGCStrong, bool, NthType)
  MX_VISIT_BOOL(Type, is_obj_cgc_weak, getVal294, setVal294, initVal294, IsObjCGCWeak, bool, NthType)
  MX_VISIT_BOOL(Type, is_pod_type, getVal295, setVal295, initVal295, IsPODType, bool, NthType)
  MX_VISIT_BOOL(Type, is_restrict_qualified, getVal296, setVal296, initVal296, IsRestrictQualified, bool, NthType)
  MX_VISIT_BOOL(Type, is_trivial_type, getVal297, setVal297, initVal297, IsTrivialType, bool, NthType)
  MX_VISIT_BOOL(Type, is_trivially_copyable_type, getVal298, setVal298, initVal298, IsTriviallyCopyableType, bool, NthType)
  MX_VISIT_BOOL(Type, is_volatile_qualified, getVal299, setVal299, initVal299, IsVolatileQualified, bool, NthType)
  MX_VISIT_BOOL(Type, may_be_dynamic_class, getVal300, setVal300, initVal300, MayBeDynamicClass, bool, NthType)
  MX_VISIT_BOOL(Type, may_be_not_dynamic_class, getVal301, setVal301, initVal301, MayBeNotDynamicClass, bool, NthType)
  MX_VISIT_ENTITY(Type, strip_obj_c_kind_of_type, getVal302, setVal302, initVal302, StripObjCKindOfType, Type, NthType, TypeUseSelector::STRIP_OBJ_C_KIND_OF_TYPE)
  MX_VISIT_ENTITY(Type, with_const, getVal303, setVal303, initVal303, WithConst, Type, NthType, TypeUseSelector::WITH_CONST)
  MX_VISIT_ENTITY(Type, with_restrict, getVal304, setVal304, initVal304, WithRestrict, Type, NthType, TypeUseSelector::WITH_RESTRICT)
  MX_VISIT_ENTITY(Type, with_volatile, getVal305, setVal305, initVal305, WithVolatile, Type, NthType, TypeUseSelector::WITH_VOLATILE)
  MX_VISIT_ENTITY(Type, without_local_fast_qualifiers, getVal306, setVal306, initVal306, WithoutLocalFastQualifiers, Type, NthType, TypeUseSelector::WITHOUT_LOCAL_FAST_QUALIFIERS)
  MX_EXIT_VISIT_Type
...
MX_BEGIN_VISIT_TYPE(TemplateTypeParmType)
  ...
  MX_VISIT_ENTITY(TemplateTypeParmType, desugar, getVal307, setVal307, initVal307, Desugar, Type, NthType, TypeUseSelector::DESUGAR)
  MX_VISIT_OPTIONAL_ENTITY(TemplateTypeParmType, declaration, getVal308, setVal308, initVal308, Declaration, TemplateTypeParmDecl, NthType, DeclUseSelector::DECLARATION)
  MX_VISIT_BOOL(TemplateTypeParmType, is_parameter_pack, getVal310, setVal310, initVal310, IsParameterPack, bool, NthType)
  MX_VISIT_BOOL(TemplateTypeParmType, is_sugared, getVal311, setVal311, initVal311, IsSugared, bool, NthType)
...
MX_BEGIN_VISIT_TYPE(TemplateSpecializationType)
  ...
  MX_VISIT_ENTITY(TemplateSpecializationType, desugar, getVal307, setVal307, initVal307, Desugar, Type, NthType, TypeUseSelector::DESUGAR)
  MX_VISIT_OPTIONAL_ENTITY(TemplateSpecializationType, aliased_type, getVal308, setVal308, initVal308, AliasedType, Type, NthType, TypeUseSelector::ALIASED_TYPE)
  MX_VISIT_BOOL(TemplateSpecializationType, is_current_instantiation, getVal310, setVal310, initVal310, IsCurrentInstantiation, bool, NthType)
  MX_VISIT_BOOL(TemplateSpecializationType, is_sugared, getVal311, setVal311, initVal311, IsSugared, bool, NthType)
  MX_VISIT_BOOL(TemplateSpecializationType, is_type_alias, getVal312, setVal312, initVal312, IsTypeAlias, bool, NthType)
  MX_VISIT_PSEUDO_LIST(TemplateSpecializationType, template_arguments, getVal313, setVal313, initVal313, TemplateArguments, TemplateArgument, NthType)
...
MX_BEGIN_VISIT_ABSTRACT_TYPE(TagType)
  ...
  MX_VISIT_ENTITY(TagType, declaration, getVal307, setVal307, initVal307, Declaration, TagDecl, NthType, DeclUseSelector::DECLARATION)
  MX_VISIT_BOOL(TagType, is_being_defined, getVal309, setVal309, initVal309, IsBeingDefined, bool, NthType)
...
MX_BEGIN_VISIT_TYPE(RecordType)
  ...
  MX_VISIT_ENTITY(RecordType, desugar, getVal308, setVal308, initVal308, Desugar, Type, NthType, TypeUseSelector::DESUGAR)
  MX_VISIT_BOOL(RecordType, has_const_fields, getVal310, setVal310, initVal310, HasConstFields, bool, NthType)
  MX_VISIT_BOOL(RecordType, is_sugared, getVal311, setVal311, initVal311, IsSugared, bool, NthType)
...
MX_BEGIN_VISIT_TYPE(EnumType)
  ...
  MX_VISIT_ENTITY(EnumType, desugar, getVal308, setVal308, initVal308, Desugar, Type, NthType, TypeUseSelector::DESUGAR)
  MX_VISIT_BOOL(EnumType, is_sugared, getVal310, setVal310, initVal310, IsSugared, bool, NthType)
...
MX_BEGIN_VISIT_TYPE(SubstTemplateTypeParmType)
  ...
  MX_VISIT_ENTITY(SubstTemplateTypeParmType, desugar, getVal307, setVal307, initVal307, Desugar, Type, NthType, TypeUseSelector::DESUGAR)
  MX_VISIT_ENTITY(SubstTemplateTypeParmType, replaced_parameter, getVal308, setVal308, initVal308, ReplacedParameter, TemplateTypeParmType, NthType, TypeUseSelector::REPLACED_PARAMETER)
  MX_VISIT_ENTITY(SubstTemplateTypeParmType, replacement_type, getVal314, setVal314, initVal314, ReplacementType, Type, NthType, TypeUseSelector::REPLACEMENT_TYPE)
  MX_VISIT_BOOL(SubstTemplateTypeParmType, is_sugared, getVal309, setVal309, initVal309, IsSugared, bool, NthType)
...
MX_BEGIN_VISIT_TYPE(SubstTemplateTypeParmPackType)
  ...
  MX_VISIT_ENTITY(SubstTemplateTypeParmPackType, desugar, getVal307, setVal307, initVal307, Desugar, Type, NthType, TypeUseSelector::DESUGAR)
  MX_VISIT_ENTITY(SubstTemplateTypeParmPackType, replaced_parameter, getVal308, setVal308, initVal308, ReplacedParameter, TemplateTypeParmType, NthType, TypeUseSelector::REPLACED_PARAMETER)
  MX_VISIT_BOOL(SubstTemplateTypeParmPackType, is_sugared, getVal309, setVal309, initVal309, IsSugared, bool, NthType)
...
MX_BEGIN_VISIT_ABSTRACT_TYPE(ReferenceType)
  ...
  MX_VISIT_ENTITY(ReferenceType, pointee_type_as_written, getVal307, setVal307, initVal307, PointeeTypeAsWritten, Type, NthType, TypeUseSelector::POINTEE_TYPE_AS_WRITTEN)
  MX_VISIT_BOOL(ReferenceType, is_inner_reference, getVal309, setVal309, initVal309, IsInnerReference, bool, NthType)
  MX_VISIT_BOOL(ReferenceType, is_spelled_as_l_value, getVal310, setVal310, initVal310, IsSpelledAsLValue, bool, NthType)
...
MX_BEGIN_VISIT_TYPE(RValueReferenceType)
  ...
  MX_VISIT_ENTITY(RValueReferenceType, desugar, getVal308, setVal308, initVal308, Desugar, Type, NthType, TypeUseSelector::DESUGAR)
  MX_VISIT_BOOL(RValueReferenceType, is_sugared, getVal311, setVal311, initVal311, IsSugared, bool, NthType)
...
MX_BEGIN_VISIT_TYPE(LValueReferenceType)
  ...
  MX_VISIT_ENTITY(LValueReferenceType, desugar, getVal308, setVal308, initVal308, Desugar, Type, NthType, TypeUseSelector::DESUGAR)
  MX_VISIT_BOOL(LValueReferenceType, is_sugared, getVal311, setVal311, initVal311, IsSugared, bool, NthType)
...
MX_BEGIN_VISIT_TYPE(PointerType)
  ...
  MX_VISIT_ENTITY(PointerType, desugar, getVal307, setVal307, initVal307, Desugar, Type, NthType, TypeUseSelector::DESUGAR)
  MX_VISIT_BOOL(PointerType, is_sugared, getVal309, setVal309, initVal309, IsSugared, bool, NthType)
...
MX_BEGIN_VISIT_TYPE(PipeType)
  ...
  MX_VISIT_ENTITY(PipeType, desugar, getVal307, setVal307, initVal307, Desugar, Type, NthType, TypeUseSelector::DESUGAR)
  MX_VISIT_ENTITY(PipeType, element_type, getVal308, setVal308, initVal308, ElementType, Type, NthType, TypeUseSelector::ELEMENT_TYPE)
  MX_VISIT_BOOL(PipeType, is_read_only, getVal309, setVal309, initVal309, IsReadOnly, bool, NthType)
  MX_VISIT_BOOL(PipeType, is_sugared, getVal310, setVal310, initVal310, IsSugared, bool, NthType)
...
MX_BEGIN_VISIT_TYPE(ParenType)
  ...
  MX_VISIT_ENTITY(ParenType, desugar, getVal307, setVal307, initVal307, Desugar, Type, NthType, TypeUseSelector::DESUGAR)
  MX_VISIT_ENTITY(ParenType, inner_type, getVal308, setVal308, initVal308, InnerType, Type, NthType, TypeUseSelector::INNER_TYPE)
  MX_VISIT_BOOL(ParenType, is_sugared, getVal309, setVal309, initVal309, IsSugared, bool, NthType)
...
MX_BEGIN_VISIT_TYPE(PackExpansionType)
  ...
  MX_VISIT_ENTITY(PackExpansionType, desugar, getVal307, setVal307, initVal307, Desugar, Type, NthType, TypeUseSelector::DESUGAR)
  MX_VISIT_OPTIONAL_INT(PackExpansionType, num_expansions, getVal315, setVal315, initVal315, NumExpansions, unsigned, NthType)
  MX_VISIT_ENTITY(PackExpansionType, pattern, getVal308, setVal308, initVal308, Pattern, Type, NthType, TypeUseSelector::PATTERN)
  MX_VISIT_BOOL(PackExpansionType, is_sugared, getVal310, setVal310, initVal310, IsSugared, bool, NthType)
...
MX_BEGIN_VISIT_TYPE(ObjCTypeParamType)
  ...
  MX_VISIT_ENTITY(ObjCTypeParamType, desugar, getVal307, setVal307, initVal307, Desugar, Type, NthType, TypeUseSelector::DESUGAR)
  MX_VISIT_ENTITY(ObjCTypeParamType, declaration, getVal308, setVal308, initVal308, Declaration, ObjCTypeParamDecl, NthType, DeclUseSelector::DECLARATION)
  MX_VISIT_BOOL(ObjCTypeParamType, is_sugared, getVal309, setVal309, initVal309, IsSugared, bool, NthType)
...
MX_BEGIN_VISIT_TYPE(ObjCObjectType)
  ...
  MX_VISIT_ENTITY(ObjCObjectType, desugar, getVal307, setVal307, initVal307, Desugar, Type, NthType, TypeUseSelector::DESUGAR)
  MX_VISIT_ENTITY(ObjCObjectType, base_type, getVal308, setVal308, initVal308, BaseType, Type, NthType, TypeUseSelector::BASE_TYPE)
  MX_VISIT_ENTITY(ObjCObjectType, interface, getVal314, setVal314, initVal314, Interface, ObjCInterfaceDecl, NthType, DeclUseSelector::INTERFACE)
  MX_VISIT_OPTIONAL_ENTITY(ObjCObjectType, super_class_type, getVal316, setVal316, initVal316, SuperClassType, Type, NthType, TypeUseSelector::SUPER_CLASS_TYPE)
  MX_VISIT_ENTITY_LIST(ObjCObjectType, type_arguments, getVal317, setVal317, initVal317, TypeArguments, Type, NthType)
  MX_VISIT_ENTITY_LIST(ObjCObjectType, type_arguments_as_written, getVal318, setVal318, initVal318, TypeArgumentsAsWritten, Type, NthType)
  MX_VISIT_BOOL(ObjCObjectType, is_kind_of_type, getVal310, setVal310, initVal310, IsKindOfType, bool, NthType)
  MX_VISIT_BOOL(ObjCObjectType, is_kind_of_type_as_written, getVal311, setVal311, initVal311, IsKindOfTypeAsWritten, bool, NthType)
  MX_VISIT_BOOL(ObjCObjectType, is_obj_c_class, getVal312, setVal312, initVal312, IsObjCClass, bool, NthType)
  MX_VISIT_BOOL(ObjCObjectType, is_obj_c_id, getVal319, setVal319, initVal319, IsObjCId, bool, NthType)
  MX_VISIT_BOOL(ObjCObjectType, is_obj_c_qualified_class, getVal320, setVal320, initVal320, IsObjCQualifiedClass, bool, NthType)
  MX_VISIT_BOOL(ObjCObjectType, is_obj_c_qualified_id, getVal321, setVal321, initVal321, IsObjCQualifiedId, bool, NthType)
  MX_VISIT_BOOL(ObjCObjectType, is_obj_c_unqualified_class, getVal322, setVal322, initVal322, IsObjCUnqualifiedClass, bool, NthType)
  MX_VISIT_BOOL(ObjCObjectType, is_obj_c_unqualified_id, getVal323, setVal323, initVal323, IsObjCUnqualifiedId, bool, NthType)
  MX_VISIT_BOOL(ObjCObjectType, is_obj_c_unqualified_id_or_class, getVal324, setVal324, initVal324, IsObjCUnqualifiedIdOrClass, bool, NthType)
  MX_VISIT_BOOL(ObjCObjectType, is_specialized, getVal325, setVal325, initVal325, IsSpecialized, bool, NthType)
  MX_VISIT_BOOL(ObjCObjectType, is_specialized_as_written, getVal326, setVal326, initVal326, IsSpecializedAsWritten, bool, NthType)
  MX_VISIT_BOOL(ObjCObjectType, is_sugared, getVal327, setVal327, initVal327, IsSugared, bool, NthType)
  MX_VISIT_BOOL(ObjCObjectType, is_unspecialized, getVal328, setVal328, initVal328, IsUnspecialized, bool, NthType)
  MX_VISIT_BOOL(ObjCObjectType, is_unspecialized_as_written, getVal329, setVal329, initVal329, IsUnspecializedAsWritten, bool, NthType)
  MX_VISIT_ENTITY(ObjCObjectType, strip_obj_c_kind_of_type_and_qualifieds, getVal330, setVal330, initVal330, StripObjCKindOfTypeAndQualifieds, Type, NthType, TypeUseSelector::STRIP_OBJ_C_KIND_OF_TYPE_AND_QUALIFIEDS)
...
MX_BEGIN_VISIT_TYPE(ObjCInterfaceType)
  ...
  MX_VISIT_ENTITY(ObjCInterfaceType, declaration, getVal331, setVal331, initVal331, Declaration, ObjCInterfaceDecl, NthType, DeclUseSelector::DECLARATION)
...
MX_BEGIN_VISIT_TYPE(ObjCObjectPointerType)
  ...
  MX_VISIT_ENTITY(ObjCObjectPointerType, desugar, getVal307, setVal307, initVal307, Desugar, Type, NthType, TypeUseSelector::DESUGAR)
  MX_VISIT_ENTITY(ObjCObjectPointerType, interface_declaration, getVal308, setVal308, initVal308, InterfaceDeclaration, ObjCInterfaceDecl, NthType, DeclUseSelector::INTERFACE_DECLARATION)
  MX_VISIT_ENTITY(ObjCObjectPointerType, interface_type, getVal314, setVal314, initVal314, InterfaceType, ObjCInterfaceType, NthType, TypeUseSelector::INTERFACE_TYPE)
  MX_VISIT_ENTITY(ObjCObjectPointerType, object_type, getVal316, setVal316, initVal316, ObjectType, ObjCObjectType, NthType, TypeUseSelector::OBJECT_TYPE)
  MX_VISIT_ENTITY(ObjCObjectPointerType, super_class_type, getVal330, setVal330, initVal330, SuperClassType, Type, NthType, TypeUseSelector::SUPER_CLASS_TYPE)
  MX_VISIT_ENTITY_LIST(ObjCObjectPointerType, type_arguments, getVal317, setVal317, initVal317, TypeArguments, Type, NthType)
  MX_VISIT_ENTITY_LIST(ObjCObjectPointerType, type_arguments_as_written, getVal318, setVal318, initVal318, TypeArgumentsAsWritten, Type, NthType)
  MX_VISIT_BOOL(ObjCObjectPointerType, is_kind_of_type, getVal309, setVal309, initVal309, IsKindOfType, bool, NthType)
  MX_VISIT_BOOL(ObjCObjectPointerType, is_obj_c_id_or_class_type, getVal310, setVal310, initVal310, IsObjCIdOrClassType, bool, NthType)
  MX_VISIT_BOOL(ObjCObjectPointerType, is_specialized, getVal311, setVal311, initVal311, IsSpecialized, bool, NthType)
  MX_VISIT_BOOL(ObjCObjectPointerType, is_specialized_as_written, getVal312, setVal312, initVal312, IsSpecializedAsWritten, bool, NthType)
  MX_VISIT_BOOL(ObjCObjectPointerType, is_sugared, getVal319, setVal319, initVal319, IsSugared, bool, NthType)
  MX_VISIT_BOOL(ObjCObjectPointerType, is_unspecialized, getVal320, setVal320, initVal320, IsUnspecialized, bool, NthType)
  MX_VISIT_BOOL(ObjCObjectPointerType, is_unspecialized_as_written, getVal321, setVal321, initVal321, IsUnspecializedAsWritten, bool, NthType)
  MX_VISIT_ENTITY_LIST(ObjCObjectPointerType, qualifieds, getVal332, setVal332, initVal332, Qualifieds, ObjCProtocolDecl, NthType)
  MX_VISIT_ENTITY(ObjCObjectPointerType, strip_obj_c_kind_of_type_and_qualifieds, getVal331, setVal331, initVal331, StripObjCKindOfTypeAndQualifieds, ObjCObjectPointerType, NthType, TypeUseSelector::STRIP_OBJ_C_KIND_OF_TYPE_AND_QUALIFIEDS)
  MX_VISIT_ENTITY_LIST(ObjCObjectPointerType, protocols, getVal333, setVal333, initVal333, Protocols, ObjCProtocolDecl, NthType)
...
MX_BEGIN_VISIT_TYPE(MemberPointerType)
  ...
  MX_VISIT_ENTITY(MemberPointerType, desugar, getVal307, setVal307, initVal307, Desugar, Type, NthType, TypeUseSelector::DESUGAR)
  MX_VISIT_ENTITY(MemberPointerType, class_, getVal308, setVal308, initVal308, Class, Type, NthType, TypeUseSelector::CLASS_)
  MX_VISIT_ENTITY(MemberPointerType, most_recent_cxx_record_declaration, getVal314, setVal314, initVal314, MostRecentCXXRecordDeclaration, CXXRecordDecl, NthType, DeclUseSelector::MOST_RECENT_CXX_RECORD_DECLARATION)
  MX_VISIT_BOOL(MemberPointerType, is_member_data_pointer, getVal309, setVal309, initVal309, IsMemberDataPointer, bool, NthType)
  MX_VISIT_BOOL(MemberPointerType, is_member_function_pointer, getVal310, setVal310, initVal310, IsMemberFunctionPointer, bool, NthType)
  MX_VISIT_BOOL(MemberPointerType, is_sugared, getVal311, setVal311, initVal311, IsSugared, bool, NthType)
...
MX_BEGIN_VISIT_ABSTRACT_TYPE(MatrixType)
  ...
  MX_VISIT_ENTITY(MatrixType, desugar, getVal307, setVal307, initVal307, Desugar, Type, NthType, TypeUseSelector::DESUGAR)
  MX_VISIT_ENTITY(MatrixType, element_type, getVal308, setVal308, initVal308, ElementType, Type, NthType, TypeUseSelector::ELEMENT_TYPE)
  MX_VISIT_BOOL(MatrixType, is_sugared, getVal309, setVal309, initVal309, IsSugared, bool, NthType)
...
MX_BEGIN_VISIT_TYPE(DependentSizedMatrixType)
  ...
  MX_VISIT_ENTITY(DependentSizedMatrixType, attribute_token, getVal314, setVal314, initVal314, AttributeToken, Token, NthType, TokenUseSelector::ATTRIBUTE_TOKEN)
  MX_VISIT_ENTITY(DependentSizedMatrixType, column_expression, getVal316, setVal316, initVal316, ColumnExpression, Expr, NthType, StmtUseSelector::COLUMN_EXPRESSION)
  MX_VISIT_ENTITY(DependentSizedMatrixType, row_expression, getVal330, setVal330, initVal330, RowExpression, Expr, NthType, StmtUseSelector::ROW_EXPRESSION)
...
MX_BEGIN_VISIT_TYPE(MacroQualifiedType)
  ...
  MX_VISIT_ENTITY(MacroQualifiedType, desugar, getVal307, setVal307, initVal307, Desugar, Type, NthType, TypeUseSelector::DESUGAR)
  MX_VISIT_ENTITY(MacroQualifiedType, modified_type, getVal308, setVal308, initVal308, ModifiedType, Type, NthType, TypeUseSelector::MODIFIED_TYPE)
  MX_VISIT_ENTITY(MacroQualifiedType, underlying_type, getVal314, setVal314, initVal314, UnderlyingType, Type, NthType, TypeUseSelector::UNDERLYING_TYPE)
  MX_VISIT_BOOL(MacroQualifiedType, is_sugared, getVal309, setVal309, initVal309, IsSugared, bool, NthType)
...
MX_BEGIN_VISIT_TYPE(InjectedClassNameType)
  ...
  MX_VISIT_ENTITY(InjectedClassNameType, desugar, getVal307, setVal307, initVal307, Desugar, Type, NthType, TypeUseSelector::DESUGAR)
  MX_VISIT_ENTITY(InjectedClassNameType, declaration, getVal308, setVal308, initVal308, Declaration, CXXRecordDecl, NthType, DeclUseSelector::DECLARATION)
  MX_VISIT_ENTITY(InjectedClassNameType, injected_specialization_type, getVal314, setVal314, initVal314, InjectedSpecializationType, Type, NthType, TypeUseSelector::INJECTED_SPECIALIZATION_TYPE)
  MX_VISIT_ENTITY(InjectedClassNameType, injected_tst, getVal316, setVal316, initVal316, InjectedTST, TemplateSpecializationType, NthType, TypeUseSelector::INJECTED_TST)
  MX_VISIT_BOOL(InjectedClassNameType, is_sugared, getVal309, setVal309, initVal309, IsSugared, bool, NthType)
...
MX_BEGIN_VISIT_ABSTRACT_TYPE(FunctionType)
  ...
  MX_VISIT_ENUM(FunctionType, call_conv, getVal334, setVal334, initVal334, CallConv, CallingConv, NthType)
  MX_VISIT_ENTITY(FunctionType, call_result_type, getVal307, setVal307, initVal307, CallResultType, Type, NthType, TypeUseSelector::CALL_RESULT_TYPE)
  MX_VISIT_BOOL(FunctionType, cmse_ns_call_attribute, getVal309, setVal309, initVal309, CmseNSCallAttribute, bool, NthType)
  MX_VISIT_BOOL(FunctionType, has_reg_parm, getVal310, setVal310, initVal310, HasRegParm, bool, NthType)
  MX_VISIT_BOOL(FunctionType, no_return_attribute, getVal311, setVal311, initVal311, NoReturnAttribute, bool, NthType)
  MX_VISIT_ENTITY(FunctionType, return_type, getVal308, setVal308, initVal308, ReturnType, Type, NthType, TypeUseSelector::RETURN_TYPE)
  MX_VISIT_BOOL(FunctionType, is_const, getVal312, setVal312, initVal312, IsConst, bool, NthType)
  MX_VISIT_BOOL(FunctionType, is_restrict, getVal319, setVal319, initVal319, IsRestrict, bool, NthType)
  MX_VISIT_BOOL(FunctionType, is_volatile, getVal320, setVal320, initVal320, IsVolatile, bool, NthType)
...
MX_BEGIN_VISIT_TYPE(FunctionProtoType)
  ...
  MX_VISIT_OPTIONAL_ENUM(FunctionProtoType, can_throw, getVal335, setVal335, initVal335, CanThrow, CanThrowResult, NthType)
  MX_VISIT_ENTITY(FunctionProtoType, desugar, getVal314, setVal314, initVal314, Desugar, Type, NthType, TypeUseSelector::DESUGAR)
  MX_VISIT_ENTITY_LIST(FunctionProtoType, exceptions, getVal317, setVal317, initVal317, Exceptions, Type, NthType)
  MX_VISIT_ENTITY(FunctionProtoType, ellipsis_token, getVal316, setVal316, initVal316, EllipsisToken, Token, NthType, TokenUseSelector::ELLIPSIS_TOKEN)
  MX_VISIT_OPTIONAL_ENTITY(FunctionProtoType, exception_spec_declaration, getVal330, setVal330, initVal330, ExceptionSpecDeclaration, FunctionDecl, NthType, DeclUseSelector::EXCEPTION_SPEC_DECLARATION)
  MX_VISIT_OPTIONAL_ENTITY(FunctionProtoType, exception_spec_template, getVal331, setVal331, initVal331, ExceptionSpecTemplate, FunctionDecl, NthType, DeclUseSelector::EXCEPTION_SPEC_TEMPLATE)
  MX_VISIT_ENUM(FunctionProtoType, exception_spec_type, getVal336, setVal336, initVal336, ExceptionSpecType, ExceptionSpecificationType, NthType)
  MX_VISIT_OPTIONAL_ENTITY(FunctionProtoType, noexcept_expression, getVal337, setVal337, initVal337, NoexceptExpression, Expr, NthType, StmtUseSelector::NOEXCEPT_EXPRESSION)
  MX_VISIT_ENTITY_LIST(FunctionProtoType, parameter_types, getVal318, setVal318, initVal318, ParameterTypes, Type, NthType)
  MX_VISIT_ENUM(FunctionProtoType, reference_qualifier, getVal338, setVal338, initVal338, ReferenceQualifier, RefQualifierKind, NthType)
  MX_VISIT_BOOL(FunctionProtoType, has_dependent_exception_spec, getVal325, setVal325, initVal325, HasDependentExceptionSpec, bool, NthType)
  MX_VISIT_BOOL(FunctionProtoType, has_dynamic_exception_spec, getVal326, setVal326, initVal326, HasDynamicExceptionSpec, bool, NthType)
  MX_VISIT_BOOL(FunctionProtoType, has_exception_spec, getVal327, setVal327, initVal327, HasExceptionSpec, bool, NthType)
  MX_VISIT_BOOL(FunctionProtoType, has_ext_parameter_infos, getVal328, setVal328, initVal328, HasExtParameterInfos, bool, NthType)
  MX_VISIT_BOOL(FunctionProtoType, has_instantiation_dependent_exception_spec, getVal329, setVal329, initVal329, HasInstantiationDependentExceptionSpec, bool, NthType)
  MX_VISIT_BOOL(FunctionProtoType, has_noexcept_exception_spec, getVal339, setVal339, initVal339, HasNoexceptExceptionSpec, bool, NthType)
  MX_VISIT_BOOL(FunctionProtoType, has_trailing_return, getVal340, setVal340, initVal340, HasTrailingReturn, bool, NthType)
  MX_VISIT_OPTIONAL_BOOL(FunctionProtoType, is_nothrow, getVal341, setVal341, initVal341, IsNothrow, bool, NthType)
  MX_VISIT_BOOL(FunctionProtoType, is_sugared, getVal343, setVal343, initVal343, IsSugared, bool, NthType)
  MX_VISIT_BOOL(FunctionProtoType, is_template_variadic, getVal344, setVal344, initVal344, IsTemplateVariadic, bool, NthType)
  MX_VISIT_BOOL(FunctionProtoType, is_variadic, getVal345, setVal345, initVal345, IsVariadic, bool, NthType)
  MX_VISIT_ENTITY_LIST(FunctionProtoType, exception_types, getVal332, setVal332, initVal332, ExceptionTypes, Type, NthType)
...
MX_BEGIN_VISIT_TYPE(FunctionNoProtoType)
  ...
  MX_VISIT_ENTITY(FunctionNoProtoType, desugar, getVal314, setVal314, initVal314, Desugar, Type, NthType, TypeUseSelector::DESUGAR)
  MX_VISIT_BOOL(FunctionNoProtoType, is_sugared, getVal321, setVal321, initVal321, IsSugared, bool, NthType)
...
MX_BEGIN_VISIT_TYPE(DependentVectorType)
  ...
  MX_VISIT_ENTITY(DependentVectorType, desugar, getVal307, setVal307, initVal307, Desugar, Type, NthType, TypeUseSelector::DESUGAR)
  MX_VISIT_ENTITY(DependentVectorType, attribute_token, getVal308, setVal308, initVal308, AttributeToken, Token, NthType, TokenUseSelector::ATTRIBUTE_TOKEN)
  MX_VISIT_ENTITY(DependentVectorType, element_type, getVal314, setVal314, initVal314, ElementType, Type, NthType, TypeUseSelector::ELEMENT_TYPE)
  MX_VISIT_ENTITY(DependentVectorType, size_expression, getVal316, setVal316, initVal316, SizeExpression, Expr, NthType, StmtUseSelector::SIZE_EXPRESSION)
  MX_VISIT_ENUM(DependentVectorType, vector_kind, getVal334, setVal334, initVal334, VectorKind, VectorTypeVectorKind, NthType)
  MX_VISIT_BOOL(DependentVectorType, is_sugared, getVal309, setVal309, initVal309, IsSugared, bool, NthType)
...
MX_BEGIN_VISIT_TYPE(DependentSizedExtVectorType)
  ...
  MX_VISIT_ENTITY(DependentSizedExtVectorType, desugar, getVal307, setVal307, initVal307, Desugar, Type, NthType, TypeUseSelector::DESUGAR)
  MX_VISIT_ENTITY(DependentSizedExtVectorType, attribute_token, getVal308, setVal308, initVal308, AttributeToken, Token, NthType, TokenUseSelector::ATTRIBUTE_TOKEN)
  MX_VISIT_ENTITY(DependentSizedExtVectorType, element_type, getVal314, setVal314, initVal314, ElementType, Type, NthType, TypeUseSelector::ELEMENT_TYPE)
  MX_VISIT_ENTITY(DependentSizedExtVectorType, size_expression, getVal316, setVal316, initVal316, SizeExpression, Expr, NthType, StmtUseSelector::SIZE_EXPRESSION)
  MX_VISIT_BOOL(DependentSizedExtVectorType, is_sugared, getVal309, setVal309, initVal309, IsSugared, bool, NthType)
...
MX_BEGIN_VISIT_TYPE(DependentBitIntType)
  ...
  MX_VISIT_ENTITY(DependentBitIntType, desugar, getVal307, setVal307, initVal307, Desugar, Type, NthType, TypeUseSelector::DESUGAR)
  MX_VISIT_ENTITY(DependentBitIntType, num_bits_expression, getVal308, setVal308, initVal308, NumBitsExpression, Expr, NthType, StmtUseSelector::NUM_BITS_EXPRESSION)
  MX_VISIT_BOOL(DependentBitIntType, is_signed, getVal309, setVal309, initVal309, IsSigned, bool, NthType)
  MX_VISIT_BOOL(DependentBitIntType, is_sugared, getVal310, setVal310, initVal310, IsSugared, bool, NthType)
  MX_VISIT_BOOL(DependentBitIntType, is_unsigned, getVal311, setVal311, initVal311, IsUnsigned, bool, NthType)
...
MX_BEGIN_VISIT_TYPE(DependentAddressSpaceType)
  ...
  MX_VISIT_ENTITY(DependentAddressSpaceType, desugar, getVal307, setVal307, initVal307, Desugar, Type, NthType, TypeUseSelector::DESUGAR)
  MX_VISIT_ENTITY(DependentAddressSpaceType, addr_space_expression, getVal308, setVal308, initVal308, AddrSpaceExpression, Expr, NthType, StmtUseSelector::ADDR_SPACE_EXPRESSION)
  MX_VISIT_ENTITY(DependentAddressSpaceType, attribute_token, getVal314, setVal314, initVal314, AttributeToken, Token, NthType, TokenUseSelector::ATTRIBUTE_TOKEN)
  MX_VISIT_BOOL(DependentAddressSpaceType, is_sugared, getVal309, setVal309, initVal309, IsSugared, bool, NthType)
...
MX_BEGIN_VISIT_ABSTRACT_TYPE(DeducedType)
  ...
  MX_VISIT_ENTITY(DeducedType, desugar, getVal307, setVal307, initVal307, Desugar, Type, NthType, TypeUseSelector::DESUGAR)
  MX_VISIT_OPTIONAL_ENTITY(DeducedType, resolved_type, getVal308, setVal308, initVal308, ResolvedType, Type, NthType, TypeUseSelector::RESOLVED_TYPE)
  MX_VISIT_BOOL(DeducedType, is_deduced, getVal310, setVal310, initVal310, IsDeduced, bool, NthType)
  MX_VISIT_BOOL(DeducedType, is_sugared, getVal311, setVal311, initVal311, IsSugared, bool, NthType)
...
MX_BEGIN_VISIT_TYPE(AutoType)
  ...
  MX_VISIT_ENUM(AutoType, keyword, getVal334, setVal334, initVal334, Keyword, AutoTypeKeyword, NthType)
  MX_VISIT_PSEUDO_LIST(AutoType, type_constraint_arguments, getVal313, setVal313, initVal313, TypeConstraintArguments, TemplateArgument, NthType)
  MX_VISIT_OPTIONAL_ENTITY(AutoType, type_constraint_concept, getVal314, setVal314, initVal314, TypeConstraintConcept, ConceptDecl, NthType, DeclUseSelector::TYPE_CONSTRAINT_CONCEPT)
  MX_VISIT_BOOL(AutoType, is_constrained, getVal319, setVal319, initVal319, IsConstrained, bool, NthType)
  MX_VISIT_BOOL(AutoType, is_decltype_auto, getVal320, setVal320, initVal320, IsDecltypeAuto, bool, NthType)
...
MX_BEGIN_VISIT_TYPE(DecltypeType)
  ...
  MX_VISIT_ENTITY(DecltypeType, desugar, getVal307, setVal307, initVal307, Desugar, Type, NthType, TypeUseSelector::DESUGAR)
  MX_VISIT_ENTITY(DecltypeType, underlying_expression, getVal308, setVal308, initVal308, UnderlyingExpression, Expr, NthType, StmtUseSelector::UNDERLYING_EXPRESSION)
  MX_VISIT_ENTITY(DecltypeType, underlying_type, getVal314, setVal314, initVal314, UnderlyingType, Type, NthType, TypeUseSelector::UNDERLYING_TYPE)
  MX_VISIT_BOOL(DecltypeType, is_sugared, getVal309, setVal309, initVal309, IsSugared, bool, NthType)
...
MX_BEGIN_VISIT_TYPE(ComplexType)
  ...
  MX_VISIT_ENTITY(ComplexType, desugar, getVal307, setVal307, initVal307, Desugar, Type, NthType, TypeUseSelector::DESUGAR)
  MX_VISIT_ENTITY(ComplexType, element_type, getVal308, setVal308, initVal308, ElementType, Type, NthType, TypeUseSelector::ELEMENT_TYPE)
  MX_VISIT_BOOL(ComplexType, is_sugared, getVal309, setVal309, initVal309, IsSugared, bool, NthType)
...
MX_BEGIN_VISIT_TYPE(BuiltinType)
  ...
  MX_VISIT_ENTITY(BuiltinType, desugar, getVal307, setVal307, initVal307, Desugar, Type, NthType, TypeUseSelector::DESUGAR)
  MX_VISIT_ENUM(BuiltinType, builtin_kind, getVal334, setVal334, initVal334, Kind, BuiltinTypeKind, NthType)
  MX_VISIT_BOOL(BuiltinType, is_floating_point, getVal309, setVal309, initVal309, IsFloatingPoint, bool, NthType)
  MX_VISIT_BOOL(BuiltinType, is_integer, getVal310, setVal310, initVal310, IsInteger, bool, NthType)
  MX_VISIT_BOOL(BuiltinType, is_signed_integer, getVal311, setVal311, initVal311, IsSignedInteger, bool, NthType)
  MX_VISIT_BOOL(BuiltinType, is_sugared, getVal312, setVal312, initVal312, IsSugared, bool, NthType)
  MX_VISIT_BOOL(BuiltinType, is_unsigned_integer, getVal319, setVal319, initVal319, IsUnsignedInteger, bool, NthType)
...
MX_BEGIN_VISIT_TYPE(BlockPointerType)
  ...
  MX_VISIT_ENTITY(BlockPointerType, desugar, getVal307, setVal307, initVal307, Desugar, Type, NthType, TypeUseSelector::DESUGAR)
  MX_VISIT_BOOL(BlockPointerType, is_sugared, getVal309, setVal309, initVal309, IsSugared, bool, NthType)
...
MX_BEGIN_VISIT_TYPE(BitIntType)
  ...
  MX_VISIT_ENTITY(BitIntType, desugar, getVal307, setVal307, initVal307, Desugar, Type, NthType, TypeUseSelector::DESUGAR)
  MX_VISIT_BOOL(BitIntType, is_signed, getVal309, setVal309, initVal309, IsSigned, bool, NthType)
  MX_VISIT_BOOL(BitIntType, is_sugared, getVal310, setVal310, initVal310, IsSugared, bool, NthType)
  MX_VISIT_BOOL(BitIntType, is_unsigned, getVal311, setVal311, initVal311, IsUnsigned, bool, NthType)
...
MX_BEGIN_VISIT_TYPE(AttributedType)
  ...
  MX_VISIT_ENTITY(AttributedType, desugar, getVal307, setVal307, initVal307, Desugar, Type, NthType, TypeUseSelector::DESUGAR)
  MX_VISIT_ENUM(AttributedType, attribute_kind, getVal346, setVal346, initVal346, AttributeKind, AttributeKind, NthType)
  MX_VISIT_ENTITY(AttributedType, equivalent_type, getVal308, setVal308, initVal308, EquivalentType, Type, NthType, TypeUseSelector::EQUIVALENT_TYPE)
  MX_VISIT_OPTIONAL_ENUM(AttributedType, immediate_nullability, getVal334, setVal334, initVal334, ImmediateNullability, NullabilityKind, NthType)
  MX_VISIT_ENTITY(AttributedType, modified_type, getVal314, setVal314, initVal314, ModifiedType, Type, NthType, TypeUseSelector::MODIFIED_TYPE)
  MX_VISIT_BOOL(AttributedType, is_calling_conv, getVal310, setVal310, initVal310, IsCallingConv, bool, NthType)
  MX_VISIT_BOOL(AttributedType, is_ms_type_spec, getVal311, setVal311, initVal311, IsMSTypeSpec, bool, NthType)
  MX_VISIT_BOOL(AttributedType, is_qualifier, getVal312, setVal312, initVal312, IsQualifier, bool, NthType)
  MX_VISIT_BOOL(AttributedType, is_sugared, getVal319, setVal319, initVal319, IsSugared, bool, NthType)
...
MX_BEGIN_VISIT_TYPE(AtomicType)
  ...
  MX_VISIT_ENTITY(AtomicType, desugar, getVal307, setVal307, initVal307, Desugar, Type, NthType, TypeUseSelector::DESUGAR)
  MX_VISIT_ENTITY(AtomicType, value_type, getVal308, setVal308, initVal308, ValueType, Type, NthType, TypeUseSelector::VALUE_TYPE)
  MX_VISIT_BOOL(AtomicType, is_sugared, getVal309, setVal309, initVal309, IsSugared, bool, NthType)
...
MX_BEGIN_VISIT_ABSTRACT_TYPE(ArrayType)
  ...
  MX_VISIT_ENTITY(ArrayType, element_type, getVal307, setVal307, initVal307, ElementType, Type, NthType, TypeUseSelector::ELEMENT_TYPE)
  MX_VISIT_ENUM(ArrayType, size_modifier, getVal334, setVal334, initVal334, SizeModifier, ArrayTypeArraySizeModifier, NthType)
...
MX_BEGIN_VISIT_TYPE(VariableArrayType)
  ...
  MX_VISIT_ENTITY(VariableArrayType, desugar, getVal308, setVal308, initVal308, Desugar, Type, NthType, TypeUseSelector::DESUGAR)
  MX_VISIT_ENTITY(VariableArrayType, l_bracket_token, getVal330, setVal330, initVal330, LBracketToken, Token, NthType, TokenUseSelector::L_BRACKET_TOKEN)
  MX_VISIT_ENTITY(VariableArrayType, r_bracket_token, getVal331, setVal331, initVal331, RBracketToken, Token, NthType, TokenUseSelector::R_BRACKET_TOKEN)
  MX_VISIT_ENTITY(VariableArrayType, size_expression, getVal337, setVal337, initVal337, SizeExpression, Expr, NthType, StmtUseSelector::SIZE_EXPRESSION)
  MX_VISIT_BOOL(VariableArrayType, is_sugared, getVal309, setVal309, initVal309, IsSugared, bool, NthType)
...
MX_BEGIN_VISIT_TYPE(IncompleteArrayType)
  ...
  MX_VISIT_ENTITY(IncompleteArrayType, desugar, getVal308, setVal308, initVal308, Desugar, Type, NthType, TypeUseSelector::DESUGAR)
  MX_VISIT_BOOL(IncompleteArrayType, is_sugared, getVal309, setVal309, initVal309, IsSugared, bool, NthType)
...
MX_BEGIN_VISIT_TYPE(DependentSizedArrayType)
  ...
  MX_VISIT_ENTITY(DependentSizedArrayType, desugar, getVal308, setVal308, initVal308, Desugar, Type, NthType, TypeUseSelector::DESUGAR)
  MX_VISIT_ENTITY(DependentSizedArrayType, l_bracket_token, getVal330, setVal330, initVal330, LBracketToken, Token, NthType, TokenUseSelector::L_BRACKET_TOKEN)
  MX_VISIT_ENTITY(DependentSizedArrayType, r_bracket_token, getVal331, setVal331, initVal331, RBracketToken, Token, NthType, TokenUseSelector::R_BRACKET_TOKEN)
  MX_VISIT_ENTITY(DependentSizedArrayType, size_expression, getVal337, setVal337, initVal337, SizeExpression, Expr, NthType, StmtUseSelector::SIZE_EXPRESSION)
  MX_VISIT_BOOL(DependentSizedArrayType, is_sugared, getVal309, setVal309, initVal309, IsSugared, bool, NthType)
...
MX_BEGIN_VISIT_TYPE(ConstantArrayType)
  ...
  MX_VISIT_ENTITY(ConstantArrayType, desugar, getVal308, setVal308, initVal308, Desugar, Type, NthType, TypeUseSelector::DESUGAR)
  MX_VISIT_OPTIONAL_ENTITY(ConstantArrayType, size_expression, getVal314, setVal314, initVal314, SizeExpression, Expr, NthType, StmtUseSelector::SIZE_EXPRESSION)
  MX_VISIT_BOOL(ConstantArrayType, is_sugared, getVal310, setVal310, initVal310, IsSugared, bool, NthType)
...
MX_BEGIN_VISIT_TYPE(AdjustedType)
  ...
  MX_VISIT_ENTITY(AdjustedType, desugar, getVal307, setVal307, initVal307, Desugar, Type, NthType, TypeUseSelector::DESUGAR)
  MX_VISIT_ENTITY(AdjustedType, resolved_type, getVal308, setVal308, initVal308, ResolvedType, Type, NthType, TypeUseSelector::RESOLVED_TYPE)
  MX_VISIT_ENTITY(AdjustedType, original_type, getVal314, setVal314, initVal314, OriginalType, Type, NthType, TypeUseSelector::ORIGINAL_TYPE)
  MX_VISIT_BOOL(AdjustedType, is_sugared, getVal309, setVal309, initVal309, IsSugared, bool, NthType)
...
MX_BEGIN_VISIT_ABSTRACT_TYPE(TypeWithKeyword)
  ...
  MX_VISIT_ENUM(TypeWithKeyword, keyword, getVal334, setVal334, initVal334, Keyword, ElaboratedTypeKeyword, NthType)
...
MX_BEGIN_VISIT_TYPE(ElaboratedType)
  ...
  MX_VISIT_ENTITY(ElaboratedType, desugar, getVal307, setVal307, initVal307, Desugar, Type, NthType, TypeUseSelector::DESUGAR)
  MX_VISIT_ENTITY(ElaboratedType, named_type, getVal308, setVal308, initVal308, NamedType, Type, NthType, TypeUseSelector::NAMED_TYPE)
  MX_VISIT_OPTIONAL_ENTITY(ElaboratedType, owned_tag_declaration, getVal314, setVal314, initVal314, OwnedTagDeclaration, TagDecl, NthType, DeclUseSelector::OWNED_TAG_DECLARATION)
  MX_VISIT_BOOL(ElaboratedType, is_sugared, getVal310, setVal310, initVal310, IsSugared, bool, NthType)
...
MX_BEGIN_VISIT_TYPE(DependentTemplateSpecializationType)
  ...
  MX_VISIT_ENTITY(DependentTemplateSpecializationType, desugar, getVal307, setVal307, initVal307, Desugar, Type, NthType, TypeUseSelector::DESUGAR)
  MX_VISIT_BOOL(DependentTemplateSpecializationType, is_sugared, getVal309, setVal309, initVal309, IsSugared, bool, NthType)
  MX_VISIT_PSEUDO_LIST(DependentTemplateSpecializationType, template_arguments, getVal313, setVal313, initVal313, TemplateArguments, TemplateArgument, NthType)
...
MX_BEGIN_VISIT_TYPE(DependentNameType)
  ...
  MX_VISIT_ENTITY(DependentNameType, desugar, getVal307, setVal307, initVal307, Desugar, Type, NthType, TypeUseSelector::DESUGAR)
  MX_VISIT_BOOL(DependentNameType, is_sugared, getVal309, setVal309, initVal309, IsSugared, bool, NthType)
...
MX_BEGIN_VISIT_TYPE(VectorType)
  ...
  MX_VISIT_ENTITY(VectorType, desugar, getVal307, setVal307, initVal307, Desugar, Type, NthType, TypeUseSelector::DESUGAR)
  MX_VISIT_ENTITY(VectorType, element_type, getVal308, setVal308, initVal308, ElementType, Type, NthType, TypeUseSelector::ELEMENT_TYPE)
  MX_VISIT_ENUM(VectorType, vector_kind, getVal334, setVal334, initVal334, VectorKind, VectorTypeVectorKind, NthType)
  MX_VISIT_BOOL(VectorType, is_sugared, getVal309, setVal309, initVal309, IsSugared, bool, NthType)
...
MX_BEGIN_VISIT_TYPE(UsingType)
  ...
  MX_VISIT_ENTITY(UsingType, desugar, getVal307, setVal307, initVal307, Desugar, Type, NthType, TypeUseSelector::DESUGAR)
  MX_VISIT_ENTITY(UsingType, found_declaration, getVal308, setVal308, initVal308, FoundDeclaration, UsingShadowDecl, NthType, DeclUseSelector::FOUND_DECLARATION)
  MX_VISIT_ENTITY(UsingType, underlying_type, getVal314, setVal314, initVal314, UnderlyingType, Type, NthType, TypeUseSelector::UNDERLYING_TYPE)
  MX_VISIT_BOOL(UsingType, is_sugared, getVal309, setVal309, initVal309, IsSugared, bool, NthType)
...
MX_BEGIN_VISIT_TYPE(UnresolvedUsingType)
  ...
  MX_VISIT_ENTITY(UnresolvedUsingType, desugar, getVal307, setVal307, initVal307, Desugar, Type, NthType, TypeUseSelector::DESUGAR)
  MX_VISIT_ENTITY(UnresolvedUsingType, declaration, getVal308, setVal308, initVal308, Declaration, UnresolvedUsingTypenameDecl, NthType, DeclUseSelector::DECLARATION)
  MX_VISIT_BOOL(UnresolvedUsingType, is_sugared, getVal309, setVal309, initVal309, IsSugared, bool, NthType)
...
MX_BEGIN_VISIT_TYPE(UnaryTransformType)
  ...
  MX_VISIT_ENTITY(UnaryTransformType, desugar, getVal307, setVal307, initVal307, Desugar, Type, NthType, TypeUseSelector::DESUGAR)
  MX_VISIT_ENTITY(UnaryTransformType, base_type, getVal308, setVal308, initVal308, BaseType, Type, NthType, TypeUseSelector::BASE_TYPE)
  MX_VISIT_ENUM(UnaryTransformType, utt_kind, getVal334, setVal334, initVal334, UTTKind, UnaryTransformTypeUTTKind, NthType)
  MX_VISIT_ENTITY(UnaryTransformType, underlying_type, getVal314, setVal314, initVal314, UnderlyingType, Type, NthType, TypeUseSelector::UNDERLYING_TYPE)
  MX_VISIT_BOOL(UnaryTransformType, is_sugared, getVal309, setVal309, initVal309, IsSugared, bool, NthType)
...
MX_BEGIN_VISIT_TYPE(TypedefType)
  ...
  MX_VISIT_ENTITY(TypedefType, desugar, getVal307, setVal307, initVal307, Desugar, Type, NthType, TypeUseSelector::DESUGAR)
  MX_VISIT_ENTITY(TypedefType, declaration, getVal308, setVal308, initVal308, Declaration, TypedefNameDecl, NthType, DeclUseSelector::DECLARATION)
  MX_VISIT_BOOL(TypedefType, is_sugared, getVal309, setVal309, initVal309, IsSugared, bool, NthType)
...
MX_BEGIN_VISIT_TYPE(TypeOfType)
  ...
  MX_VISIT_ENTITY(TypeOfType, desugar, getVal307, setVal307, initVal307, Desugar, Type, NthType, TypeUseSelector::DESUGAR)
  MX_VISIT_ENTITY(TypeOfType, underlying_type, getVal308, setVal308, initVal308, UnderlyingType, Type, NthType, TypeUseSelector::UNDERLYING_TYPE)
  MX_VISIT_BOOL(TypeOfType, is_sugared, getVal309, setVal309, initVal309, IsSugared, bool, NthType)
...
MX_BEGIN_VISIT_TYPE(TypeOfExprType)
  ...
  MX_VISIT_ENTITY(TypeOfExprType, desugar, getVal307, setVal307, initVal307, Desugar, Type, NthType, TypeUseSelector::DESUGAR)
  MX_VISIT_ENTITY(TypeOfExprType, underlying_expression, getVal308, setVal308, initVal308, UnderlyingExpression, Expr, NthType, StmtUseSelector::UNDERLYING_EXPRESSION)
  MX_VISIT_BOOL(TypeOfExprType, is_sugared, getVal309, setVal309, initVal309, IsSugared, bool, NthType)
