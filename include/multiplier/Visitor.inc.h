...
MX_BEGIN_VISIT_STMT(DeclRefExpr)
  ...
  MX_VISIT_BOOL(DeclRefExpr, has_template_keyword_and_arguments_info, getVal101, setVal101, initVal101, HasTemplateKeywordAndArgumentsInfo, bool, NthStmt)
...
MX_BEGIN_VISIT_STMT(RequiresExpr)
  ...
  MX_VISIT_ENTITY(RequiresExpr, requires_keyword_token, getVal40, setVal40, initVal40, RequiresKeywordToken, Token, NthStmt, TokenUseSelector::REQUIRES_KEYWORD_TOKEN)
