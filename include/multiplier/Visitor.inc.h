...
MX_BEGIN_VISIT_DECL(VarDecl)
  ...
  MX_VISIT_BOOL(VarDecl, is_this_declaration_a_demoted_definition, 122, MX_APPLY_METHOD, IsThisDeclarationADemotedDefinition, bool, NthDecl)
...
MX_BEGIN_VISIT_DECL(FunctionDecl)
  ...
  MX_VISIT_BOOL(FunctionDecl, is_definition, 149, MX_APPLY_METHOD, IsThisDeclarationADefinition, bool, NthDecl)
  MX_VISIT_BOOL(FunctionDecl, is_this_declaration_instantiated_from_a_friend_definition, 150, MX_APPLY_METHOD, IsThisDeclarationInstantiatedFromAFriendDefinition, bool, NthDecl)
  MX_VISIT_BOOL(FunctionDecl, is_trivial, 151, MX_APPLY_METHOD, IsTrivial, bool, NthDecl)
  MX_VISIT_BOOL(FunctionDecl, is_trivial_for_call, 152, MX_APPLY_METHOD, IsTrivialForCall, bool, NthDecl)
  MX_VISIT_BOOL(FunctionDecl, is_user_provided, 153, MX_APPLY_METHOD, IsUserProvided, bool, NthDecl)
  MX_VISIT_BOOL(FunctionDecl, is_variadic, 154, MX_APPLY_METHOD, IsVariadic, bool, NthDecl)
  MX_VISIT_BOOL(FunctionDecl, is_virtual_as_written, 155, MX_APPLY_METHOD, IsVirtualAsWritten, bool, NthDecl)
  MX_VISIT_ENTITY_LIST(FunctionDecl, parameters, 45, MX_APPLY_METHOD, Parameters, ParmVarDecl, NthDecl)
  MX_VISIT_BOOL(FunctionDecl, uses_seh_try, 156, MX_APPLY_METHOD, UsesSEHTry, bool, NthDecl)
  MX_VISIT_BOOL(FunctionDecl, will_have_body, 157, MX_APPLY_METHOD, WillHaveBody, bool, NthDecl)
  MX_VISIT_OPTIONAL_ENTITY(FunctionDecl, body, 158, MX_APPLY_METHOD, Body, Stmt, NthDecl, StmtUseSelector::BODY)
...
MX_BEGIN_VISIT_DECL(CXXMethodDecl)
  ...
  MX_VISIT_OPTIONAL_ENTITY(CXXMethodDecl, this_object_type, 160, MX_APPLY_METHOD, ThisObjectType, Type, NthDecl, TypeUseSelector::THIS_OBJECT_TYPE)
  MX_VISIT_OPTIONAL_ENTITY(CXXMethodDecl, this_type, 162, MX_APPLY_METHOD, ThisType, Type, NthDecl, TypeUseSelector::THIS_TYPE)
  MX_VISIT_BOOL(CXXMethodDecl, has_inline_body, 164, MX_APPLY_METHOD, HasInlineBody, bool, NthDecl)
  MX_VISIT_BOOL(CXXMethodDecl, is_const, 165, MX_APPLY_METHOD, IsConst, bool, NthDecl)
  MX_VISIT_BOOL(CXXMethodDecl, is_copy_assignment_operator, 166, MX_APPLY_METHOD, IsCopyAssignmentOperator, bool, NthDecl)
  MX_VISIT_BOOL(CXXMethodDecl, is_instance, 167, MX_APPLY_METHOD, IsInstance, bool, NthDecl)
  MX_VISIT_BOOL(CXXMethodDecl, is_lambda_static_invoker, 168, MX_APPLY_METHOD, IsLambdaStaticInvoker, bool, NthDecl)
  MX_VISIT_BOOL(CXXMethodDecl, is_move_assignment_operator, 169, MX_APPLY_METHOD, IsMoveAssignmentOperator, bool, NthDecl)
  MX_VISIT_BOOL(CXXMethodDecl, is_virtual, 170, MX_APPLY_METHOD, IsVirtual, bool, NthDecl)
  MX_VISIT_BOOL(CXXMethodDecl, is_volatile, 171, MX_APPLY_METHOD, IsVolatile, bool, NthDecl)
  MX_VISIT_ENTITY_LIST(CXXMethodDecl, overridden_methods, 57, MX_APPLY_METHOD, OverriddenMethods, CXXMethodDecl, NthDecl)
  MX_VISIT_ENTITY_LIST(CXXMethodDecl, parameter_declarations, 172, MX_APPLY_METHOD, ParameterDeclarations, ParmVarDecl, NthDecl)
...
MX_BEGIN_VISIT_DECL(CXXDestructorDecl)
  ...
  MX_VISIT_OPTIONAL_ENTITY(CXXDestructorDecl, operator_delete, 173, MX_APPLY_METHOD, OperatorDelete, FunctionDecl, NthDecl, DeclUseSelector::OPERATOR_DELETE)
  MX_VISIT_OPTIONAL_ENTITY(CXXDestructorDecl, operator_delete_this_argument, 175, MX_APPLY_METHOD, OperatorDeleteThisArgument, Expr, NthDecl, StmtUseSelector::OPERATOR_DELETE_THIS_ARGUMENT)
...
MX_BEGIN_VISIT_DECL(CXXConversionDecl)
  ...
  MX_VISIT_ENTITY(CXXConversionDecl, conversion_type, 173, MX_APPLY_METHOD, ConversionType, Type, NthDecl, TypeUseSelector::CONVERSION_TYPE)
  MX_VISIT_BOOL(CXXConversionDecl, is_explicit, 174, MX_APPLY_METHOD, IsExplicit, bool, NthDecl)
  MX_VISIT_BOOL(CXXConversionDecl, is_lambda_to_block_pointer_conversion, 176, MX_APPLY_METHOD, IsLambdaToBlockPointerConversion, bool, NthDecl)
...
MX_BEGIN_VISIT_DECL(CXXConstructorDecl)
  ...
  MX_VISIT_OPTIONAL_ENTITY(CXXConstructorDecl, target_constructor, 173, MX_APPLY_METHOD, TargetConstructor, CXXConstructorDecl, NthDecl, DeclUseSelector::TARGET_CONSTRUCTOR)
  MX_VISIT_BOOL(CXXConstructorDecl, is_default_constructor, 176, MX_APPLY_METHOD, IsDefaultConstructor, bool, NthDecl)
  MX_VISIT_BOOL(CXXConstructorDecl, is_delegating_constructor, 177, MX_APPLY_METHOD, IsDelegatingConstructor, bool, NthDecl)
  MX_VISIT_BOOL(CXXConstructorDecl, is_explicit, 178, MX_APPLY_METHOD, IsExplicit, bool, NthDecl)
  MX_VISIT_BOOL(CXXConstructorDecl, is_inheriting_constructor, 179, MX_APPLY_METHOD, IsInheritingConstructor, bool, NthDecl)
  MX_VISIT_BOOL(CXXConstructorDecl, is_specialization_copying_object, 180, MX_APPLY_METHOD, IsSpecializationCopyingObject, bool, NthDecl)
...
MX_BEGIN_VISIT_DECL(CXXDeductionGuideDecl)
  ...
  MX_VISIT_ENTITY(CXXDeductionGuideDecl, corresponding_constructor, 160, MX_APPLY_METHOD, CorrespondingConstructor, CXXConstructorDecl, NthDecl, DeclUseSelector::CORRESPONDING_CONSTRUCTOR)
  MX_VISIT_BOOL(CXXDeductionGuideDecl, is_copy_deduction_candidate, 161, MX_APPLY_METHOD, IsCopyDeductionCandidate, bool, NthDecl)
  MX_VISIT_BOOL(CXXDeductionGuideDecl, is_explicit, 163, MX_APPLY_METHOD, IsExplicit, bool, NthDecl)
...
MX_BEGIN_VISIT_DECL(TagDecl)
  ...
  MX_VISIT_BOOL(TagDecl, is_definition, 96, MX_APPLY_METHOD, IsThisDeclarationADefinition, bool, NthDecl)
  MX_VISIT_BOOL(TagDecl, is_union, 97, MX_APPLY_METHOD, IsUnion, bool, NthDecl)
  MX_VISIT_BOOL(TagDecl, may_have_out_of_date_definition, 98, MX_APPLY_METHOD, MayHaveOutOfDateDefinition, bool, NthDecl)
...
MX_BEGIN_VISIT_DECL(RecordDecl)
  ...
  MX_VISIT_BOOL(RecordDecl, can_pass_in_registers, 99, MX_APPLY_METHOD, CanPassInRegisters, bool, NthDecl)
  ...
  MX_VISIT_BOOL(RecordDecl, has_flexible_array_member, 100, MX_APPLY_METHOD, HasFlexibleArrayMember, bool, NthDecl)
  MX_VISIT_BOOL(RecordDecl, has_loaded_fields_from_external_storage, 101, MX_APPLY_METHOD, HasLoadedFieldsFromExternalStorage, bool, NthDecl)
  MX_VISIT_BOOL(RecordDecl, has_non_trivial_to_primitive_copy_c_union, 102, MX_APPLY_METHOD, HasNonTrivialToPrimitiveCopyCUnion, bool, NthDecl)
  MX_VISIT_BOOL(RecordDecl, has_non_trivial_to_primitive_default_initialize_c_union, 103, MX_APPLY_METHOD, HasNonTrivialToPrimitiveDefaultInitializeCUnion, bool, NthDecl)
  MX_VISIT_BOOL(RecordDecl, has_non_trivial_to_primitive_destruct_c_union, 104, MX_APPLY_METHOD, HasNonTrivialToPrimitiveDestructCUnion, bool, NthDecl)
  MX_VISIT_BOOL(RecordDecl, has_object_member, 105, MX_APPLY_METHOD, HasObjectMember, bool, NthDecl)
  MX_VISIT_BOOL(RecordDecl, has_volatile_member, 106, MX_APPLY_METHOD, HasVolatileMember, bool, NthDecl)
  MX_VISIT_BOOL(RecordDecl, is_anonymous_struct_or_union, 107, MX_APPLY_METHOD, IsAnonymousStructOrUnion, bool, NthDecl)
  MX_VISIT_BOOL(RecordDecl, is_captured_record, 108, MX_APPLY_METHOD, IsCapturedRecord, bool, NthDecl)
  MX_VISIT_BOOL(RecordDecl, is_injected_class_name, 109, MX_APPLY_METHOD, IsInjectedClassName, bool, NthDecl)
  MX_VISIT_BOOL(RecordDecl, is_lambda, 110, MX_APPLY_METHOD, IsLambda, bool, NthDecl)
  MX_VISIT_BOOL(RecordDecl, is_ms_struct, 111, MX_APPLY_METHOD, IsMsStruct, bool, NthDecl)
  MX_VISIT_BOOL(RecordDecl, is_non_trivial_to_primitive_copy, 112, MX_APPLY_METHOD, IsNonTrivialToPrimitiveCopy, bool, NthDecl)
  MX_VISIT_BOOL(RecordDecl, is_non_trivial_to_primitive_default_initialize, 113, MX_APPLY_METHOD, IsNonTrivialToPrimitiveDefaultInitialize, bool, NthDecl)
  MX_VISIT_BOOL(RecordDecl, is_non_trivial_to_primitive_destroy, 114, MX_APPLY_METHOD, IsNonTrivialToPrimitiveDestroy, bool, NthDecl)
  MX_VISIT_BOOL(RecordDecl, is_or_contains_union, 115, MX_APPLY_METHOD, IsOrContainsUnion, bool, NthDecl)
  MX_VISIT_BOOL(RecordDecl, is_parameter_destroyed_in_callee, 116, MX_APPLY_METHOD, IsParameterDestroyedInCallee, bool, NthDecl)
  MX_VISIT_BOOL(RecordDecl, may_insert_extra_padding, 117, MX_APPLY_METHOD, MayInsertExtraPadding, bool, NthDecl)
...
MX_BEGIN_VISIT_DECL(CXXRecordDecl)
  ...
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, allow_const_default_initializer, 118, MX_APPLY_METHOD, AllowConstDefaultInitializer, bool, NthDecl)
  ...
  MX_VISIT_OPTIONAL_ENTITY_LIST(CXXRecordDecl, friends, 172, MX_APPLY_METHOD, Friends, FriendDecl, NthDecl)
  ...
  MX_VISIT_OPTIONAL_ENTITY_LIST(CXXRecordDecl, lambda_explicit_template_parameters, 181, MX_APPLY_METHOD, LambdaExplicitTemplateParameters, NamedDecl, NthDecl)
  MX_VISIT_OPTIONAL_INT(CXXRecordDecl, lambda_mangling_number, 182, MX_APPLY_METHOD, LambdaManglingNumber, unsigned, NthDecl)
  ...
  MX_VISIT_OPTIONAL_INT(CXXRecordDecl, num_bases, 183, MX_APPLY_METHOD, NumBases, unsigned, NthDecl)
  MX_VISIT_OPTIONAL_INT(CXXRecordDecl, num_virtual_bases, 184, MX_APPLY_METHOD, NumVirtualBases, unsigned, NthDecl)
  MX_VISIT_OPTIONAL_INT(CXXRecordDecl, odr_hash, 185, MX_APPLY_METHOD, ODRHash, unsigned, NthDecl)
  ...
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, has_any_dependent_bases, 149, MX_APPLY_METHOD, HasAnyDependentBases, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, has_constexpr_default_constructor, 151, MX_APPLY_METHOD, HasConstexprDefaultConstructor, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, has_constexpr_destructor, 153, MX_APPLY_METHOD, HasConstexprDestructor, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, has_constexpr_non_copy_move_constructor, 155, MX_APPLY_METHOD, HasConstexprNonCopyMoveConstructor, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, has_copy_assignment_with_const_parameter, 157, MX_APPLY_METHOD, HasCopyAssignmentWithConstParameter, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, has_copy_constructor_with_const_parameter, 161, MX_APPLY_METHOD, HasCopyConstructorWithConstParameter, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, has_default_constructor, 164, MX_APPLY_METHOD, HasDefaultConstructor, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, has_definition, 166, MX_APPLY_METHOD, HasDefinition, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, has_direct_fields, 168, MX_APPLY_METHOD, HasDirectFields, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, has_friends, 170, MX_APPLY_METHOD, HasFriends, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, has_in_class_initializer, 174, MX_APPLY_METHOD, HasInClassInitializer, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, has_inherited_assignment, 177, MX_APPLY_METHOD, HasInheritedAssignment, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, has_inherited_constructor, 179, MX_APPLY_METHOD, HasInheritedConstructor, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, has_initializer_method, 186, MX_APPLY_METHOD, HasInitializerMethod, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, has_irrelevant_destructor, 188, MX_APPLY_METHOD, HasIrrelevantDestructor, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, has_known_lambda_internal_linkage, 190, MX_APPLY_METHOD, HasKnownLambdaInternalLinkage, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, has_move_assignment, 192, MX_APPLY_METHOD, HasMoveAssignment, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, has_move_constructor, 194, MX_APPLY_METHOD, HasMoveConstructor, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, has_mutable_fields, 196, MX_APPLY_METHOD, HasMutableFields, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, has_non_literal_type_fields_or_bases, 198, MX_APPLY_METHOD, HasNonLiteralTypeFieldsOrBases, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, has_non_trivial_copy_assignment, 200, MX_APPLY_METHOD, HasNonTrivialCopyAssignment, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, has_non_trivial_copy_constructor, 202, MX_APPLY_METHOD, HasNonTrivialCopyConstructor, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, has_non_trivial_copy_constructor_for_call, 204, MX_APPLY_METHOD, HasNonTrivialCopyConstructorForCall, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, has_non_trivial_default_constructor, 206, MX_APPLY_METHOD, HasNonTrivialDefaultConstructor, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, has_non_trivial_destructor, 208, MX_APPLY_METHOD, HasNonTrivialDestructor, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, has_non_trivial_destructor_for_call, 210, MX_APPLY_METHOD, HasNonTrivialDestructorForCall, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, has_non_trivial_move_assignment, 212, MX_APPLY_METHOD, HasNonTrivialMoveAssignment, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, has_non_trivial_move_constructor, 214, MX_APPLY_METHOD, HasNonTrivialMoveConstructor, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, has_non_trivial_move_constructor_for_call, 216, MX_APPLY_METHOD, HasNonTrivialMoveConstructorForCall, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, has_private_fields, 218, MX_APPLY_METHOD, HasPrivateFields, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, has_protected_fields, 220, MX_APPLY_METHOD, HasProtectedFields, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, has_simple_copy_assignment, 222, MX_APPLY_METHOD, HasSimpleCopyAssignment, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, has_simple_copy_constructor, 224, MX_APPLY_METHOD, HasSimpleCopyConstructor, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, has_simple_destructor, 226, MX_APPLY_METHOD, HasSimpleDestructor, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, has_simple_move_assignment, 228, MX_APPLY_METHOD, HasSimpleMoveAssignment, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, has_simple_move_constructor, 230, MX_APPLY_METHOD, HasSimpleMoveConstructor, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, has_trivial_copy_assignment, 232, MX_APPLY_METHOD, HasTrivialCopyAssignment, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, has_trivial_copy_constructor, 234, MX_APPLY_METHOD, HasTrivialCopyConstructor, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, has_trivial_copy_constructor_for_call, 236, MX_APPLY_METHOD, HasTrivialCopyConstructorForCall, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, has_trivial_default_constructor, 238, MX_APPLY_METHOD, HasTrivialDefaultConstructor, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, has_trivial_destructor, 240, MX_APPLY_METHOD, HasTrivialDestructor, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, has_trivial_destructor_for_call, 242, MX_APPLY_METHOD, HasTrivialDestructorForCall, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, has_trivial_move_assignment, 244, MX_APPLY_METHOD, HasTrivialMoveAssignment, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, has_trivial_move_constructor, 246, MX_APPLY_METHOD, HasTrivialMoveConstructor, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, has_trivial_move_constructor_for_call, 248, MX_APPLY_METHOD, HasTrivialMoveConstructorForCall, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, has_uninitialized_reference_member, 250, MX_APPLY_METHOD, HasUninitializedReferenceMember, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, has_user_declared_constructor, 252, MX_APPLY_METHOD, HasUserDeclaredConstructor, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, has_user_declared_copy_assignment, 254, MX_APPLY_METHOD, HasUserDeclaredCopyAssignment, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, has_user_declared_copy_constructor, 256, MX_APPLY_METHOD, HasUserDeclaredCopyConstructor, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, has_user_declared_destructor, 258, MX_APPLY_METHOD, HasUserDeclaredDestructor, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, has_user_declared_move_assignment, 260, MX_APPLY_METHOD, HasUserDeclaredMoveAssignment, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, has_user_declared_move_constructor, 262, MX_APPLY_METHOD, HasUserDeclaredMoveConstructor, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, has_user_declared_move_operation, 264, MX_APPLY_METHOD, HasUserDeclaredMoveOperation, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, has_user_provided_default_constructor, 266, MX_APPLY_METHOD, HasUserProvidedDefaultConstructor, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, has_variant_members, 268, MX_APPLY_METHOD, HasVariantMembers, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, implicit_copy_assignment_has_const_parameter, 270, MX_APPLY_METHOD, ImplicitCopyAssignmentHasConstParameter, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, implicit_copy_constructor_has_const_parameter, 272, MX_APPLY_METHOD, ImplicitCopyConstructorHasConstParameter, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, is_abstract, 274, MX_APPLY_METHOD, IsAbstract, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, is_aggregate, 276, MX_APPLY_METHOD, IsAggregate, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, is_any_destructor_no_return, 278, MX_APPLY_METHOD, IsAnyDestructorNoReturn, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, is_c_like, 280, MX_APPLY_METHOD, IsCLike, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, is_cxx11_standard_layout, 282, MX_APPLY_METHOD, IsCXX11StandardLayout, bool, NthDecl)
  MX_VISIT_BOOL(CXXRecordDecl, is_dependent_lambda, 284, MX_APPLY_METHOD, IsDependentLambda, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, is_dynamic_class, 285, MX_APPLY_METHOD, IsDynamicClass, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, is_effectively_final, 287, MX_APPLY_METHOD, IsEffectivelyFinal, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, is_empty, 289, MX_APPLY_METHOD, IsEmpty, bool, NthDecl)
  MX_VISIT_BOOL(CXXRecordDecl, is_generic_lambda, 291, MX_APPLY_METHOD, IsGenericLambda, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, is_interface_like, 292, MX_APPLY_METHOD, IsInterfaceLike, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, is_literal, 294, MX_APPLY_METHOD, IsLiteral, bool, NthDecl)
  ...
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, is_pod, 297, MX_APPLY_METHOD, IsPOD, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, is_polymorphic, 299, MX_APPLY_METHOD, IsPolymorphic, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, is_standard_layout, 301, MX_APPLY_METHOD, IsStandardLayout, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, is_structural, 303, MX_APPLY_METHOD, IsStructural, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, is_trivial, 305, MX_APPLY_METHOD, IsTrivial, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, is_trivially_copyable, 307, MX_APPLY_METHOD, IsTriviallyCopyable, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, lambda_is_default_constructible_and_assignable, 309, MX_APPLY_METHOD, LambdaIsDefaultConstructibleAndAssignable, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, may_be_abstract, 311, MX_APPLY_METHOD, MayBeAbstract, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, may_be_dynamic_class, 313, MX_APPLY_METHOD, MayBeDynamicClass, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, may_be_non_dynamic_class, 315, MX_APPLY_METHOD, MayBeNonDynamicClass, bool, NthDecl)
  MX_VISIT_OPTIONAL_ENTITY_LIST(CXXRecordDecl, methods, 317, MX_APPLY_METHOD, Methods, CXXMethodDecl, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, needs_implicit_copy_assignment, 319, MX_APPLY_METHOD, NeedsImplicitCopyAssignment, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, needs_implicit_copy_constructor, 321, MX_APPLY_METHOD, NeedsImplicitCopyConstructor, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, needs_implicit_default_constructor, 323, MX_APPLY_METHOD, NeedsImplicitDefaultConstructor, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, needs_implicit_destructor, 325, MX_APPLY_METHOD, NeedsImplicitDestructor, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, needs_implicit_move_assignment, 327, MX_APPLY_METHOD, NeedsImplicitMoveAssignment, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, needs_implicit_move_constructor, 329, MX_APPLY_METHOD, NeedsImplicitMoveConstructor, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, needs_overload_resolution_for_copy_assignment, 331, MX_APPLY_METHOD, NeedsOverloadResolutionForCopyAssignment, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, needs_overload_resolution_for_copy_constructor, 333, MX_APPLY_METHOD, NeedsOverloadResolutionForCopyConstructor, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, needs_overload_resolution_for_destructor, 335, MX_APPLY_METHOD, NeedsOverloadResolutionForDestructor, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, needs_overload_resolution_for_move_assignment, 337, MX_APPLY_METHOD, NeedsOverloadResolutionForMoveAssignment, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, needs_overload_resolution_for_move_constructor, 339, MX_APPLY_METHOD, NeedsOverloadResolutionForMoveConstructor, bool, NthDecl)
  MX_VISIT_OPTIONAL_BOOL(CXXRecordDecl, null_field_offset_is_zero, 341, MX_APPLY_METHOD, NullFieldOffsetIsZero, bool, NthDecl)
...
MX_BEGIN_VISIT_DECL(ClassTemplateSpecializationDecl)
  ...
  MX_VISIT_PSEUDO_LIST(ClassTemplateSpecializationDecl, template_arguments, 344, MX_APPLY_METHOD, TemplateArguments, TemplateArgument, NthDecl)
  MX_VISIT_PSEUDO_LIST(ClassTemplateSpecializationDecl, template_instantiation_arguments, 345, MX_APPLY_METHOD, TemplateInstantiationArguments, TemplateArgument, NthDecl)
  ...
  MX_VISIT_BOOL(ClassTemplateSpecializationDecl, is_class_scope_explicit_specialization, 347, MX_APPLY_METHOD, IsClassScopeExplicitSpecialization, bool, NthDecl)
  MX_VISIT_BOOL(ClassTemplateSpecializationDecl, is_explicit_instantiation_or_specialization, 348, MX_APPLY_METHOD, IsExplicitInstantiationOrSpecialization, bool, NthDecl)
  MX_VISIT_BOOL(ClassTemplateSpecializationDecl, is_explicit_specialization, 349, MX_APPLY_METHOD, IsExplicitSpecialization, bool, NthDecl)
...
MX_BEGIN_VISIT_DECL(EnumDecl)
  ...
  MX_VISIT_BOOL(EnumDecl, is_closed, 103, MX_APPLY_METHOD, IsClosed, bool, NthDecl)
  MX_VISIT_BOOL(EnumDecl, is_closed_flag, 104, MX_APPLY_METHOD, IsClosedFlag, bool, NthDecl)
  MX_VISIT_BOOL(EnumDecl, is_closed_non_flag, 105, MX_APPLY_METHOD, IsClosedNonFlag, bool, NthDecl)
  MX_VISIT_BOOL(EnumDecl, is_complete, 106, MX_APPLY_METHOD, IsComplete, bool, NthDecl)
  MX_VISIT_BOOL(EnumDecl, is_fixed, 107, MX_APPLY_METHOD, IsFixed, bool, NthDecl)
  MX_VISIT_BOOL(EnumDecl, is_scoped, 108, MX_APPLY_METHOD, IsScoped, bool, NthDecl)
  MX_VISIT_BOOL(EnumDecl, is_scoped_using_class_tag, 109, MX_APPLY_METHOD, IsScopedUsingClassTag, bool, NthDecl)
...
MX_BEGIN_VISIT_DECL(ObjCMethodDecl)
  ...
  MX_VISIT_BOOL(ObjCMethodDecl, is_definition, 98, MX_APPLY_METHOD, IsThisDeclarationADefinition, bool, NthDecl)
  MX_VISIT_BOOL(ObjCMethodDecl, is_this_declaration_a_designated_initializer, 99, MX_APPLY_METHOD, IsThisDeclarationADesignatedInitializer, bool, NthDecl)
  MX_VISIT_BOOL(ObjCMethodDecl, is_variadic, 100, MX_APPLY_METHOD, IsVariadic, bool, NthDecl)
...
MX_BEGIN_VISIT_DECL(ObjCContainerDecl)
  ...
  MX_VISIT_ENTITY_LIST(ObjCContainerDecl, instance_properties, 172, MX_APPLY_METHOD, InstanceProperties, ObjCPropertyDecl, NthDecl)
  MX_VISIT_ENTITY_LIST(ObjCContainerDecl, methods, 181, MX_APPLY_METHOD, Methods, ObjCMethodDecl, NthDecl)
  MX_VISIT_ENTITY_LIST(ObjCContainerDecl, properties, 317, MX_APPLY_METHOD, Properties, ObjCPropertyDecl, NthDecl)
  MX_VISIT_DECL_CONTEXT(ObjCContainerDecl, declarations_in_context, 350, MX_APPLY_METHOD, AlreadyLoadedDeclarations, Decl, NthDecl)
...
MX_BEGIN_VISIT_DECL(ObjCCategoryDecl)
  ...
  MX_VISIT_ENTITY_LIST(ObjCCategoryDecl, instance_variables, 351, MX_APPLY_METHOD, InstanceVariables, ObjCIvarDecl, NthDecl)
  MX_VISIT_ENTITY_LIST(ObjCCategoryDecl, protocol_tokens, 352, MX_APPLY_METHOD, ProtocolTokens, Token, NthDecl)
...
MX_BEGIN_VISIT_DECL(ObjCProtocolDecl)
  ...
  MX_VISIT_BOOL(ObjCProtocolDecl, is_definition, 70, MX_APPLY_METHOD, IsThisDeclarationADefinition, bool, NthDecl)
  MX_VISIT_ENTITY_LIST(ObjCProtocolDecl, protocol_tokens, 351, MX_APPLY_METHOD, ProtocolTokens, Token, NthDecl)
  MX_VISIT_ENTITY_LIST(ObjCProtocolDecl, protocols, 352, MX_APPLY_METHOD, Protocols, ObjCProtocolDecl, NthDecl)
...
MX_BEGIN_VISIT_DECL(ObjCInterfaceDecl)
  ...
  MX_VISIT_ENTITY_LIST(ObjCInterfaceDecl, all_referenced_protocols, 351, MX_APPLY_METHOD, AllReferencedProtocols, ObjCProtocolDecl, NthDecl)
  ...
  MX_VISIT_BOOL(ObjCInterfaceDecl, is_definition, 90, MX_APPLY_METHOD, IsThisDeclarationADefinition, bool, NthDecl)
  MX_VISIT_ENTITY_LIST(ObjCInterfaceDecl, instance_variables, 352, MX_APPLY_METHOD, InstanceVariables, ObjCIvarDecl, NthDecl)
  ...
  MX_VISIT_ENTITY_LIST(ObjCInterfaceDecl, protocol_tokens, 355, MX_APPLY_METHOD, ProtocolTokens, Token, NthDecl)
  MX_VISIT_ENTITY_LIST(ObjCInterfaceDecl, protocols, 356, MX_APPLY_METHOD, Protocols, ObjCProtocolDecl, NthDecl)
  MX_VISIT_ENTITY_LIST(ObjCInterfaceDecl, visible_categories, 357, MX_APPLY_METHOD, VisibleCategories, ObjCCategoryDecl, NthDecl)
  MX_VISIT_ENTITY_LIST(ObjCInterfaceDecl, visible_extensions, 358, MX_APPLY_METHOD, VisibleExtensions, ObjCCategoryDecl, NthDecl)
...
MX_BEGIN_VISIT_DECL(ObjCImplDecl)
  ...
  MX_VISIT_ENTITY_LIST(ObjCImplDecl, property_implementations, 351, MX_APPLY_METHOD, PropertyImplementations, ObjCPropertyImplDecl, NthDecl)
