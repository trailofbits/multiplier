...
class OMPTeamsDistributeParallelForDirective : public OMPLoopDirective {
 private:
  ...
  friend class Stmt;
 public:
  inline static gap::generator<OMPTeamsDistributeParallelForDirective> in(const Fragment &frag) {
  ...
  inline static gap::generator<OMPTeamsDistributeParallelForDirective> containing(const Token &tok) {
