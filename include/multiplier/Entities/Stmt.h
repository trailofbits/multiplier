...
class Stmt {
 ...
 public:
  ...
  std::optional<MacroSubstitution> nth_aligned_substitution(unsigned n) const;
  unsigned num_aligned_substitutions(void) const;
  gap::generator<MacroSubstitution> aligned_substitutions(void) const &;
