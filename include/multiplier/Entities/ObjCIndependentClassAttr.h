...
class ObjCIndependentClassAttr : public InheritableAttr {
 private:
  ...
  friend class Attr;
 public:
  inline static gap::generator<ObjCIndependentClassAttr> in(const Fragment &frag) {
  ...
  inline static gap::generator<ObjCIndependentClassAttr> containing(const Token &tok) {
