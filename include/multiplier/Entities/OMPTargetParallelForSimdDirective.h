...
class OMPTargetParallelForSimdDirective : public OMPLoopDirective {
 ...
 public:
  ...
  std::optional<OMPTargetParallelForSimdDirective> by(const Index &, EntityId);
  ...
  inline static std::optional<OMPTargetParallelForSimdDirective> from(const Reference &r) {
    return from(r.as_statement());
  }

  inline static std::optional<OMPTargetParallelForSimdDirective> from(const TokenContext &t) {
