...
class TypeNullUnspecifiedAttr : public TypeAttr {
 private:
  ...
  friend class Attr;
 public:
  inline static gap::generator<TypeNullUnspecifiedAttr> in(const Fragment &frag) {
  ...
  inline static gap::generator<TypeNullUnspecifiedAttr> containing(const Token &tok) {
