...
class CXXStdInitializerListExpr : public Expr {
 private:
  ...
  friend class Stmt;
 public:
  inline static gap::generator<CXXStdInitializerListExpr> in(const Fragment &frag) {
  ...
  inline static gap::generator<CXXStdInitializerListExpr> containing(const Token &tok) {
