...
class OMPTeamsDistributeSimdDirective : public OMPLoopDirective {
 ...
 public:
  ...
  inline static std::optional<OMPTeamsDistributeSimdDirective> from(const Reference &r) {
    return OMPTeamsDistributeSimdDirective::from(r.as_statement());
  }

  inline static std::optional<OMPTeamsDistributeSimdDirective> from(const TokenContext &t) {
    return OMPTeamsDistributeSimdDirective::from(t.as_statement());
  }
