...
class OSReturnsRetainedOnNonZeroAttr : public InheritableAttr {
 ...
 public:
  ...
  inline static std::optional<OSReturnsRetainedOnNonZeroAttr> from(const Reference &r) {
    return OSReturnsRetainedOnNonZeroAttr::from(r.as_attribute());
  }

  inline static std::optional<OSReturnsRetainedOnNonZeroAttr> from(const TokenContext &t) {
    return OSReturnsRetainedOnNonZeroAttr::from(t.as_attribute());
  }
