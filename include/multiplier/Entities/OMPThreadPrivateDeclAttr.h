...
class OMPThreadPrivateDeclAttr : public InheritableAttr {
 ...
 public:
  ...
  inline static std::optional<OMPThreadPrivateDeclAttr> from(const Reference &r) {
    return from(r.as_attribute());
  }

  inline static std::optional<OMPThreadPrivateDeclAttr> from(const TokenContext &t) {
