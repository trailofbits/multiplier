...
class ConsumableSetOnReadAttr : public InheritableAttr {
 private:
  ...
  friend class Attr;
 public:
  inline static gap::generator<ConsumableSetOnReadAttr> in(const Fragment &frag) {
  ...
  inline static gap::generator<ConsumableSetOnReadAttr> containing(const Token &tok) {
