...
class OMPTargetTeamsDistributeParallelForSimdDirective : public OMPLoopDirective {
 ...
 public:
  ...
  std::optional<OMPTargetTeamsDistributeParallelForSimdDirective> by(const Index &, EntityId);
  ...
  inline static std::optional<OMPTargetTeamsDistributeParallelForSimdDirective> from(const Reference &r) {
    return from(r.as_statement());
  }

  inline static std::optional<OMPTargetTeamsDistributeParallelForSimdDirective> from(const TokenContext &t) {
