...
class AssertExclusiveLockAttr : public InheritableAttr {
 private:
  ...
  friend class Attr;
 public:
  inline static gap::generator<AssertExclusiveLockAttr> in(const Fragment &frag) {
  ...
  inline static gap::generator<AssertExclusiveLockAttr> containing(const Token &tok) {
