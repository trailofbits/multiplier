...
class DLLExportStaticLocalAttr : public InheritableAttr {
 private:
  ...
  friend class Attr;
 public:
  inline static gap::generator<DLLExportStaticLocalAttr> in(const Fragment &frag) {
  ...
  inline static gap::generator<DLLExportStaticLocalAttr> containing(const Token &tok) {
