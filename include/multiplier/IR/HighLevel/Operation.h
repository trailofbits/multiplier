...
class MX_EXPORT BinLAndOp final : public Operation {
 public:
  ...
  // Imported methods:
  ::mx::ir::Value result(void) const;
  //::mlir::Region & lhs(void) const;
  //::mlir::Region & rhs(void) const;
};
...
class MX_EXPORT ClassDeclOp final : public Operation {
 public:
  ...
  // Imported methods:
  //::mlir::Region & bases(void) const;
  //::mlir::Region & fields(void) const;
...
class MX_EXPORT EnumDeclOp final : public Operation {
 public:
  ...
  // Imported methods:
  //::mlir::Region & constants(void) const;
  std::string_view name(void) const;
...
class MX_EXPORT ExprOp final : public Operation {
 public:
  ...
  // Imported methods:
  ::mx::ir::Value result(void) const;
  //::mlir::Region & subexpr(void) const;
};
...
class MX_EXPORT CondOp final : public Operation {
 public:
  ...
  // Imported methods:
  ::mx::ir::Value result(void) const;
  //::mlir::Region & cond_region(void) const;
  //::mlir::Region & then_region(void) const;
  //::mlir::Region & else_region(void) const;
};
...
class MX_EXPORT ForOp final : public Operation {
 public:
  ...
  // Imported methods:
  //::mlir::Region & cond_region(void) const;
  //::mlir::Region & incr_region(void) const;
  //::mlir::Region & body_region(void) const;
};
...
class MX_EXPORT VarDeclOp final : public Operation {
 public:
  ...
  //::mlir::Region & allocation_size(void) const;
  std::string_view name(void) const;
...
class MX_EXPORT StmtExprOp final : public Operation {
 public:
  ...
  // Imported methods:
  ::mx::ir::Value result(void) const;
  //::mlir::Region & substmt(void) const;
};
