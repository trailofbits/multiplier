...
class VarAnnotation final : public Operation {
 public:
  inline static OperationKind static_kind(void) {
    return OperationKind::LLVM_INTR_VAR_ANNOTATION;
  }

  static std::optional<VarAnnotation> from(const ::mx::ir::Operation &that);
  static std::optional<VarAnnotation> producing(const ::mx::ir::Value &val);

  ::mlir::LLVM::VarAnnotation underlying_op(void) const noexcept;
...
static_assert(sizeof(VarAnnotation) == sizeof(Operation));
