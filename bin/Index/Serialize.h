...
void SerializeArmNewZAAttr(const PendingFragment &, const EntityMapper &, mx::ast::Attr::Builder, const pasta::ArmNewZAAttr &, const TokenTree *);
void SerializeArmPreservesZAAttr(const PendingFragment &, const EntityMapper &, mx::ast::Attr::Builder, const pasta::ArmPreservesZAAttr &, const TokenTree *);
void SerializeArmSharedZAAttr(const PendingFragment &, const EntityMapper &, mx::ast::Attr::Builder, const pasta::ArmSharedZAAttr &, const TokenTree *);
