...
void SerializeOMPScopeDirective(const PendingFragment &, const EntityMapper &, mx::ast::Stmt::Builder, const pasta::OMPScopeDirective &, const TokenTree *);
...
void SerializeM68kRTDAttr(const PendingFragment &, const EntityMapper &, mx::ast::Attr::Builder, const pasta::M68kRTDAttr &, const TokenTree *);
...
void SerializeMSConstexprAttr(const PendingFragment &, const EntityMapper &, mx::ast::Attr::Builder, const pasta::MSConstexprAttr &, const TokenTree *);
...
void SerializePreferredTypeAttr(const PendingFragment &, const EntityMapper &, mx::ast::Attr::Builder, const pasta::PreferredTypeAttr &, const TokenTree *);
...
void SerializeSwiftImportAsNonGenericAttr(const PendingFragment &, const EntityMapper &, mx::ast::Attr::Builder, const pasta::SwiftImportAsNonGenericAttr &, const TokenTree *);
void SerializeSwiftImportPropertyAsAccessorsAttr(const PendingFragment &, const EntityMapper &, mx::ast::Attr::Builder, const pasta::SwiftImportPropertyAsAccessorsAttr &, const TokenTree *);
...
void SerializeSwiftVersionedAdditionAttr(const PendingFragment &, const EntityMapper &, mx::ast::Attr::Builder, const pasta::SwiftVersionedAdditionAttr &, const TokenTree *);
void SerializeSwiftVersionedRemovalAttr(const PendingFragment &, const EntityMapper &, mx::ast::Attr::Builder, const pasta::SwiftVersionedRemovalAttr &, const TokenTree *);
...
void SerializeArmInAttr(const PendingFragment &, const EntityMapper &, mx::ast::Attr::Builder, const pasta::ArmInAttr &, const TokenTree *);
void SerializeArmInOutAttr(const PendingFragment &, const EntityMapper &, mx::ast::Attr::Builder, const pasta::ArmInOutAttr &, const TokenTree *);
void SerializeArmLocallyStreamingAttr(const PendingFragment &, const EntityMapper &, mx::ast::Attr::Builder, const pasta::ArmLocallyStreamingAttr &, const TokenTree *);
...
void SerializeArmNewAttr(const PendingFragment &, const EntityMapper &, mx::ast::Attr::Builder, const pasta::ArmNewAttr &, const TokenTree *);
void SerializeArmOutAttr(const PendingFragment &, const EntityMapper &, mx::ast::Attr::Builder, const pasta::ArmOutAttr &, const TokenTree *);
void SerializeArmPreservesAttr(const PendingFragment &, const EntityMapper &, mx::ast::Attr::Builder, const pasta::ArmPreservesAttr &, const TokenTree *);
...
void SerializeArmStreamingCompatibleAttr(const PendingFragment &, const EntityMapper &, mx::ast::Attr::Builder, const pasta::ArmStreamingCompatibleAttr &, const TokenTree *);
...
void SerializeBPFPreserveStaticOffsetAttr(const PendingFragment &, const EntityMapper &, mx::ast::Attr::Builder, const pasta::BPFPreserveStaticOffsetAttr &, const TokenTree *);
...
void SerializeCodeAlignAttr(const PendingFragment &, const EntityMapper &, mx::ast::Attr::Builder, const pasta::CodeAlignAttr &, const TokenTree *);
void SerializeCodeModelAttr(const PendingFragment &, const EntityMapper &, mx::ast::Attr::Builder, const pasta::CodeModelAttr &, const TokenTree *);
...
void SerializeCoroDisableLifetimeBoundAttr(const PendingFragment &, const EntityMapper &, mx::ast::Attr::Builder, const pasta::CoroDisableLifetimeBoundAttr &, const TokenTree *);
void SerializeCoroLifetimeBoundAttr(const PendingFragment &, const EntityMapper &, mx::ast::Attr::Builder, const pasta::CoroLifetimeBoundAttr &, const TokenTree *);
void SerializeCoroOnlyDestroyWhenCompleteAttr(const PendingFragment &, const EntityMapper &, mx::ast::Attr::Builder, const pasta::CoroOnlyDestroyWhenCompleteAttr &, const TokenTree *);
void SerializeCoroReturnTypeAttr(const PendingFragment &, const EntityMapper &, mx::ast::Attr::Builder, const pasta::CoroReturnTypeAttr &, const TokenTree *);
void SerializeCoroWrapperAttr(const PendingFragment &, const EntityMapper &, mx::ast::Attr::Builder, const pasta::CoroWrapperAttr &, const TokenTree *);
void SerializeCountedByAttr(const PendingFragment &, const EntityMapper &, mx::ast::Attr::Builder, const pasta::CountedByAttr &, const TokenTree *);
...
void SerializeHLSLParamModifierAttr(const PendingFragment &, const EntityMapper &, mx::ast::Attr::Builder, const pasta::HLSLParamModifierAttr &, const TokenTree *);
