...
void SerializeType(EntitySerializer &, mx::ast::Type::Builder, const pasta::Type &);
void SerializeTypeOfExprType(EntitySerializer &, mx::ast::Type::Builder, const pasta::TypeOfExprType &);
void SerializeTypeOfType(EntitySerializer &, mx::ast::Type::Builder, const pasta::TypeOfType &);
void SerializeTypedefType(EntitySerializer &, mx::ast::Type::Builder, const pasta::TypedefType &);
void SerializeUnaryTransformType(EntitySerializer &, mx::ast::Type::Builder, const pasta::UnaryTransformType &);
void SerializeUnresolvedUsingType(EntitySerializer &, mx::ast::Type::Builder, const pasta::UnresolvedUsingType &);
void SerializeVectorType(EntitySerializer &, mx::ast::Type::Builder, const pasta::VectorType &);
void SerializeTypeWithKeyword(EntitySerializer &, mx::ast::Type::Builder, const pasta::TypeWithKeyword &);
void SerializeAdjustedType(EntitySerializer &, mx::ast::Type::Builder, const pasta::AdjustedType &);
void SerializeArrayType(EntitySerializer &, mx::ast::Type::Builder, const pasta::ArrayType &);
void SerializeAtomicType(EntitySerializer &, mx::ast::Type::Builder, const pasta::AtomicType &);
void SerializeAttributedType(EntitySerializer &, mx::ast::Type::Builder, const pasta::AttributedType &);
void SerializeBlockPointerType(EntitySerializer &, mx::ast::Type::Builder, const pasta::BlockPointerType &);
void SerializeBuiltinType(EntitySerializer &, mx::ast::Type::Builder, const pasta::BuiltinType &);
void SerializeComplexType(EntitySerializer &, mx::ast::Type::Builder, const pasta::ComplexType &);
void SerializeConstantArrayType(EntitySerializer &, mx::ast::Type::Builder, const pasta::ConstantArrayType &);
void SerializeDecayedType(EntitySerializer &, mx::ast::Type::Builder, const pasta::DecayedType &);
void SerializeDecltypeType(EntitySerializer &, mx::ast::Type::Builder, const pasta::DecltypeType &);
void SerializeDeducedType(EntitySerializer &, mx::ast::Type::Builder, const pasta::DeducedType &);
void SerializeDependentAddressSpaceType(EntitySerializer &, mx::ast::Type::Builder, const pasta::DependentAddressSpaceType &);
void SerializeDependentExtIntType(EntitySerializer &, mx::ast::Type::Builder, const pasta::DependentExtIntType &);
void SerializeDependentNameType(EntitySerializer &, mx::ast::Type::Builder, const pasta::DependentNameType &);
void SerializeDependentSizedArrayType(EntitySerializer &, mx::ast::Type::Builder, const pasta::DependentSizedArrayType &);
void SerializeDependentSizedExtVectorType(EntitySerializer &, mx::ast::Type::Builder, const pasta::DependentSizedExtVectorType &);
void SerializeDependentTemplateSpecializationType(EntitySerializer &, mx::ast::Type::Builder, const pasta::DependentTemplateSpecializationType &);
void SerializeDependentVectorType(EntitySerializer &, mx::ast::Type::Builder, const pasta::DependentVectorType &);
void SerializeElaboratedType(EntitySerializer &, mx::ast::Type::Builder, const pasta::ElaboratedType &);
void SerializeExtIntType(EntitySerializer &, mx::ast::Type::Builder, const pasta::ExtIntType &);
void SerializeExtVectorType(EntitySerializer &, mx::ast::Type::Builder, const pasta::ExtVectorType &);
void SerializeFunctionType(EntitySerializer &, mx::ast::Type::Builder, const pasta::FunctionType &);
void SerializeIncompleteArrayType(EntitySerializer &, mx::ast::Type::Builder, const pasta::IncompleteArrayType &);
void SerializeInjectedClassNameType(EntitySerializer &, mx::ast::Type::Builder, const pasta::InjectedClassNameType &);
void SerializeMacroQualifiedType(EntitySerializer &, mx::ast::Type::Builder, const pasta::MacroQualifiedType &);
void SerializeMatrixType(EntitySerializer &, mx::ast::Type::Builder, const pasta::MatrixType &);
void SerializeMemberPointerType(EntitySerializer &, mx::ast::Type::Builder, const pasta::MemberPointerType &);
void SerializeObjCObjectPointerType(EntitySerializer &, mx::ast::Type::Builder, const pasta::ObjCObjectPointerType &);
void SerializeObjCObjectType(EntitySerializer &, mx::ast::Type::Builder, const pasta::ObjCObjectType &);
void SerializeObjCTypeParamType(EntitySerializer &, mx::ast::Type::Builder, const pasta::ObjCTypeParamType &);
void SerializePackExpansionType(EntitySerializer &, mx::ast::Type::Builder, const pasta::PackExpansionType &);
void SerializeParenType(EntitySerializer &, mx::ast::Type::Builder, const pasta::ParenType &);
void SerializePipeType(EntitySerializer &, mx::ast::Type::Builder, const pasta::PipeType &);
void SerializePointerType(EntitySerializer &, mx::ast::Type::Builder, const pasta::PointerType &);
void SerializeReferenceType(EntitySerializer &, mx::ast::Type::Builder, const pasta::ReferenceType &);
void SerializeSubstTemplateTypeParmPackType(EntitySerializer &, mx::ast::Type::Builder, const pasta::SubstTemplateTypeParmPackType &);
void SerializeSubstTemplateTypeParmType(EntitySerializer &, mx::ast::Type::Builder, const pasta::SubstTemplateTypeParmType &);
void SerializeTagType(EntitySerializer &, mx::ast::Type::Builder, const pasta::TagType &);
void SerializeTemplateSpecializationType(EntitySerializer &, mx::ast::Type::Builder, const pasta::TemplateSpecializationType &);
void SerializeTemplateTypeParmType(EntitySerializer &, mx::ast::Type::Builder, const pasta::TemplateTypeParmType &);
void SerializeVariableArrayType(EntitySerializer &, mx::ast::Type::Builder, const pasta::VariableArrayType &);
void SerializeAutoType(EntitySerializer &, mx::ast::Type::Builder, const pasta::AutoType &);
void SerializeConstantMatrixType(EntitySerializer &, mx::ast::Type::Builder, const pasta::ConstantMatrixType &);
void SerializeDeducedTemplateSpecializationType(EntitySerializer &, mx::ast::Type::Builder, const pasta::DeducedTemplateSpecializationType &);
void SerializeDependentSizedMatrixType(EntitySerializer &, mx::ast::Type::Builder, const pasta::DependentSizedMatrixType &);
void SerializeEnumType(EntitySerializer &, mx::ast::Type::Builder, const pasta::EnumType &);
void SerializeFunctionNoProtoType(EntitySerializer &, mx::ast::Type::Builder, const pasta::FunctionNoProtoType &);
void SerializeFunctionProtoType(EntitySerializer &, mx::ast::Type::Builder, const pasta::FunctionProtoType &);
void SerializeLValueReferenceType(EntitySerializer &, mx::ast::Type::Builder, const pasta::LValueReferenceType &);
void SerializeObjCInterfaceType(EntitySerializer &, mx::ast::Type::Builder, const pasta::ObjCInterfaceType &);
void SerializeRValueReferenceType(EntitySerializer &, mx::ast::Type::Builder, const pasta::RValueReferenceType &);
void SerializeRecordType(EntitySerializer &, mx::ast::Type::Builder, const pasta::RecordType &);
