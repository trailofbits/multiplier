...
MX_BEGIN_SERIALIZE_DECL(Decl)
  ...
  MX_SERIALIZE_ENTITY(Decl, begin_token, getVal4, setVal4, initVal4, BeginToken, Token, NthDecl)
  MX_SERIALIZE_ENTITY(Decl, canonical_declaration, getVal5, setVal5, initVal5, CanonicalDeclaration, Decl, NthDecl)
  ...
  MX_SERIALIZE_ENTITY_LIST(Decl, redeclarations, getVal43, setVal43, initVal43, Redeclarations, Decl, NthDecl)
  MX_SERIALIZE_ENTITY(Decl, token, getVal45, setVal45, initVal45, Token, Token, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(ClassScopeFunctionSpecializationDecl)
  ...
  MX_SERIALIZE_ENTITY(ClassScopeFunctionSpecializationDecl, specialization, getVal48, setVal48, initVal48, Specialization, CXXMethodDecl, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(CapturedDecl)
  ...
  MX_SERIALIZE_ENTITY(CapturedDecl, context_parameter, getVal48, setVal48, initVal48, ContextParameter, ImplicitParamDecl, NthDecl)
  MX_SERIALIZE_ENTITY_LIST(CapturedDecl, parameters, getVal50, setVal50, initVal50, Parameters, ImplicitParamDecl, NthDecl)
  MX_SERIALIZE_DECL_CONTEXT(CapturedDecl, declarations_in_context, getVal51, setVal51, initVal51, AlreadyLoadedDeclarations, Decl, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(BlockDecl)
  ...
  MX_SERIALIZE_OPTIONAL_ENTITY(BlockDecl, block_mangling_context_declaration, getVal48, setVal48, initVal48, BlockManglingContextDeclaration, Decl, NthDecl)
  MX_SERIALIZE_ENTITY(BlockDecl, caret_token, getVal56, setVal56, initVal56, CaretToken, Token, NthDecl)
  MX_SERIALIZE_ENTITY(BlockDecl, compound_body, getVal57, setVal57, initVal57, CompoundBody, CompoundStmt, NthDecl)
  MX_SERIALIZE_ENTITY(BlockDecl, signature_as_written, getVal58, setVal58, initVal58, SignatureAsWritten, Type, NthDecl)
  MX_SERIALIZE_ENTITY_LIST(BlockDecl, parameters, getVal50, setVal50, initVal50, Parameters, ParmVarDecl, NthDecl)
  MX_SERIALIZE_ENTITY_LIST(BlockDecl, parameter_declarations, getVal51, setVal51, initVal51, ParameterDeclarations, ParmVarDecl, NthDecl)
  MX_SERIALIZE_DECL_CONTEXT(BlockDecl, declarations_in_context, getVal62, setVal62, initVal62, AlreadyLoadedDeclarations, Decl, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(AccessSpecDecl)
  ...
  MX_SERIALIZE_ENTITY(AccessSpecDecl, access_specifier_token, getVal48, setVal48, initVal48, AccessSpecifierToken, Token, NthDecl)
  MX_SERIALIZE_ENTITY(AccessSpecDecl, colon_token, getVal56, setVal56, initVal56, ColonToken, Token, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(OMPThreadPrivateDecl)
  ...
  MX_SERIALIZE_ENTITY_LIST(OMPThreadPrivateDecl, varlists, getVal50, setVal50, initVal50, Varlists, Expr, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(OMPAllocateDecl)
  ...
  MX_SERIALIZE_ENTITY_LIST(OMPAllocateDecl, varlists, getVal50, setVal50, initVal50, Varlists, Expr, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(TranslationUnitDecl)
  ...
  MX_SERIALIZE_DECL_CONTEXT(TranslationUnitDecl, declarations_in_context, getVal50, setVal50, initVal50, AlreadyLoadedDeclarations, Decl, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(StaticAssertDecl)
  ...
  MX_SERIALIZE_ENTITY(StaticAssertDecl, assert_expression, getVal48, setVal48, initVal48, AssertExpression, Expr, NthDecl)
  MX_SERIALIZE_ENTITY(StaticAssertDecl, message, getVal56, setVal56, initVal56, Message, StringLiteral, NthDecl)
  MX_SERIALIZE_ENTITY(StaticAssertDecl, r_paren_token, getVal57, setVal57, initVal57, RParenToken, Token, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(RequiresExprBodyDecl)
  ...
  MX_SERIALIZE_DECL_CONTEXT(RequiresExprBodyDecl, declarations_in_context, getVal50, setVal50, initVal50, AlreadyLoadedDeclarations, Decl, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(ObjCPropertyImplDecl)
  ...
  MX_SERIALIZE_ENTITY(ObjCPropertyImplDecl, getter_cxx_constructor, getVal48, setVal48, initVal48, GetterCXXConstructor, Expr, NthDecl)
  MX_SERIALIZE_ENTITY(ObjCPropertyImplDecl, getter_method_declaration, getVal56, setVal56, initVal56, GetterMethodDeclaration, ObjCMethodDecl, NthDecl)
  MX_SERIALIZE_ENTITY(ObjCPropertyImplDecl, property_declaration, getVal57, setVal57, initVal57, PropertyDeclaration, ObjCPropertyDecl, NthDecl)
  MX_SERIALIZE_ENTITY(ObjCPropertyImplDecl, property_instance_variable_declaration, getVal58, setVal58, initVal58, PropertyInstanceVariableDeclaration, ObjCIvarDecl, NthDecl)
  MX_SERIALIZE_ENTITY(ObjCPropertyImplDecl, property_instance_variable_declaration_token, getVal66, setVal66, initVal66, PropertyInstanceVariableDeclarationToken, Token, NthDecl)
  MX_SERIALIZE_ENTITY(ObjCPropertyImplDecl, setter_cxx_assignment, getVal67, setVal67, initVal67, SetterCXXAssignment, Expr, NthDecl)
  MX_SERIALIZE_ENTITY(ObjCPropertyImplDecl, setter_method_declaration, getVal68, setVal68, initVal68, SetterMethodDeclaration, ObjCMethodDecl, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(NamedDecl)
  ...
  MX_SERIALIZE_ENTITY(NamedDecl, underlying_declaration, getVal48, setVal48, initVal48, UnderlyingDeclaration, NamedDecl, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(LabelDecl)
  ...
  MX_SERIALIZE_ENTITY(LabelDecl, statement, getVal56, setVal56, initVal56, Statement, LabelStmt, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(BaseUsingDecl)
  ...
  MX_SERIALIZE_ENTITY_LIST(BaseUsingDecl, shadows, getVal50, setVal50, initVal50, Shadows, UsingShadowDecl, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(UsingEnumDecl)
  ...
  MX_SERIALIZE_ENTITY(UsingEnumDecl, enum_declaration, getVal56, setVal56, initVal56, EnumDeclaration, EnumDecl, NthDecl)
  MX_SERIALIZE_ENTITY(UsingEnumDecl, enum_token, getVal57, setVal57, initVal57, EnumToken, Token, NthDecl)
  MX_SERIALIZE_ENTITY(UsingEnumDecl, using_token, getVal58, setVal58, initVal58, UsingToken, Token, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(UsingDecl)
  ...
  MX_SERIALIZE_ENTITY(UsingDecl, using_token, getVal56, setVal56, initVal56, UsingToken, Token, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(ValueDecl)
  ...
  MX_SERIALIZE_ENTITY(ValueDecl, type, getVal56, setVal56, initVal56, Type, Type, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(UnresolvedUsingValueDecl)
  ...
  MX_SERIALIZE_ENTITY(UnresolvedUsingValueDecl, ellipsis_token, getVal57, setVal57, initVal57, EllipsisToken, Token, NthDecl)
  MX_SERIALIZE_ENTITY(UnresolvedUsingValueDecl, using_token, getVal58, setVal58, initVal58, UsingToken, Token, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(OMPDeclareReductionDecl)
  ...
  MX_SERIALIZE_ENTITY(OMPDeclareReductionDecl, combiner, getVal57, setVal57, initVal57, Combiner, Expr, NthDecl)
  MX_SERIALIZE_ENTITY(OMPDeclareReductionDecl, combiner_in, getVal58, setVal58, initVal58, CombinerIn, Expr, NthDecl)
  MX_SERIALIZE_ENTITY(OMPDeclareReductionDecl, combiner_out, getVal66, setVal66, initVal66, CombinerOut, Expr, NthDecl)
  MX_SERIALIZE_ENTITY(OMPDeclareReductionDecl, initializer_original, getVal67, setVal67, initVal67, InitializerOriginal, Expr, NthDecl)
  MX_SERIALIZE_ENTITY(OMPDeclareReductionDecl, initializer_private, getVal68, setVal68, initVal68, InitializerPrivate, Expr, NthDecl)
  MX_SERIALIZE_ENTITY(OMPDeclareReductionDecl, initializer, getVal77, setVal77, initVal77, Initializer, Expr, NthDecl)
  MX_SERIALIZE_ENTITY(OMPDeclareReductionDecl, prev_declaration_in_scope, getVal79, setVal79, initVal79, PrevDeclarationInScope, OMPDeclareReductionDecl, NthDecl)
  MX_SERIALIZE_DECL_CONTEXT(OMPDeclareReductionDecl, declarations_in_context, getVal50, setVal50, initVal50, AlreadyLoadedDeclarations, Decl, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(IndirectFieldDecl)
  ...
  MX_SERIALIZE_ENTITY_LIST(IndirectFieldDecl, chain, getVal50, setVal50, initVal50, Chain, NamedDecl, NthDecl)
  MX_SERIALIZE_OPTIONAL_ENTITY(IndirectFieldDecl, anonymous_field, getVal57, setVal57, initVal57, AnonymousField, FieldDecl, NthDecl)
  MX_SERIALIZE_OPTIONAL_ENTITY(IndirectFieldDecl, variable_declaration, getVal58, setVal58, initVal58, VariableDeclaration, VarDecl, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(EnumConstantDecl)
  ...
  MX_SERIALIZE_OPTIONAL_ENTITY(EnumConstantDecl, initializer_expression, getVal57, setVal57, initVal57, InitializerExpression, Expr, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(DeclaratorDecl)
  ...
  MX_SERIALIZE_ENTITY(DeclaratorDecl, inner_token_start, getVal57, setVal57, initVal57, InnerTokenStart, Token, NthDecl)
  MX_SERIALIZE_ENTITY(DeclaratorDecl, outer_token_start, getVal58, setVal58, initVal58, OuterTokenStart, Token, NthDecl)
  MX_SERIALIZE_OPTIONAL_ENTITY(DeclaratorDecl, trailing_requires_clause, getVal66, setVal66, initVal66, TrailingRequiresClause, Expr, NthDecl)
  MX_SERIALIZE_OPTIONAL_ENTITY(DeclaratorDecl, type_source_info, getVal67, setVal67, initVal67, TypeSourceInfo, Type, NthDecl)
  MX_SERIALIZE_ENTITY(DeclaratorDecl, type_spec_end_token, getVal68, setVal68, initVal68, TypeSpecEndToken, Token, NthDecl)
  MX_SERIALIZE_ENTITY(DeclaratorDecl, type_spec_start_token, getVal77, setVal77, initVal77, TypeSpecStartToken, Token, NthDecl)
  MX_SERIALIZE_PSEUDO_LIST(DeclaratorDecl, template_parameter_lists, getVal80, setVal80, initVal80, TemplateParameterLists, TemplateParameterList, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(VarDecl)
  ...
  MX_SERIALIZE_OPTIONAL_ENTITY(VarDecl, acting_definition, getVal79, setVal79, initVal79, ActingDefinition, VarDecl, NthDecl)
  MX_SERIALIZE_OPTIONAL_ENTITY(VarDecl, initializer, getVal82, setVal82, initVal82, Initializer, Expr, NthDecl)
  MX_SERIALIZE_OPTIONAL_ENTITY(VarDecl, initializing_declaration, getVal84, setVal84, initVal84, InitializingDeclaration, VarDecl, NthDecl)
  MX_SERIALIZE_OPTIONAL_ENTITY(VarDecl, instantiated_from_static_data_member, getVal86, setVal86, initVal86, InstantiatedFromStaticDataMember, VarDecl, NthDecl)
  MX_SERIALIZE_ENTITY(VarDecl, point_of_instantiation, getVal89, setVal89, initVal89, PointOfInstantiation, Token, NthDecl)
  MX_SERIALIZE_OPTIONAL_ENTITY(VarDecl, template_instantiation_pattern, getVal94, setVal94, initVal94, TemplateInstantiationPattern, VarDecl, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(ParmVarDecl)
  ...
  MX_SERIALIZE_OPTIONAL_ENTITY(ParmVarDecl, default_argument, getVal134, setVal134, initVal134, DefaultArgument, Expr, NthDecl)
  MX_SERIALIZE_ENTITY(ParmVarDecl, original_type, getVal139, setVal139, initVal139, OriginalType, Type, NthDecl)
  MX_SERIALIZE_OPTIONAL_ENTITY(ParmVarDecl, uninstantiated_default_argument, getVal140, setVal140, initVal140, UninstantiatedDefaultArgument, Expr, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(DecompositionDecl)
  ...
  MX_SERIALIZE_ENTITY_LIST(DecompositionDecl, bindings, getVal50, setVal50, initVal50, Bindings, BindingDecl, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(VarTemplateSpecializationDecl)
  ...
  MX_SERIALIZE_ENTITY(VarTemplateSpecializationDecl, extern_token, getVal134, setVal134, initVal134, ExternToken, Token, NthDecl)
  MX_SERIALIZE_PSEUDO_LIST(VarTemplateSpecializationDecl, template_arguments, getVal149, setVal149, initVal149, TemplateArguments, TemplateArgument, NthDecl)
  MX_SERIALIZE_PSEUDO_LIST(VarTemplateSpecializationDecl, template_instantiation_arguments, getVal150, setVal150, initVal150, TemplateInstantiationArguments, TemplateArgument, NthDecl)
  MX_SERIALIZE_ENTITY(VarTemplateSpecializationDecl, template_keyword_token, getVal136, setVal136, initVal136, TemplateKeywordToken, Token, NthDecl)
  MX_SERIALIZE_ENTITY(VarTemplateSpecializationDecl, type_as_written, getVal137, setVal137, initVal137, TypeAsWritten, Type, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(NonTypeTemplateParmDecl)
  ...
  MX_SERIALIZE_ENTITY(NonTypeTemplateParmDecl, default_argument, getVal79, setVal79, initVal79, DefaultArgument, Expr, NthDecl)
  MX_SERIALIZE_ENTITY(NonTypeTemplateParmDecl, default_argument_token, getVal82, setVal82, initVal82, DefaultArgumentToken, Token, NthDecl)
  MX_SERIALIZE_ENTITY(NonTypeTemplateParmDecl, placeholder_type_constraint, getVal84, setVal84, initVal84, PlaceholderTypeConstraint, Expr, NthDecl)
  MX_SERIALIZE_ENTITY_LIST(NonTypeTemplateParmDecl, expansion_types, getVal50, setVal50, initVal50, ExpansionTypes, Type, NthDecl)
  MX_SERIALIZE_ENTITY_LIST(NonTypeTemplateParmDecl, expansion_type_source_infos, getVal51, setVal51, initVal51, ExpansionTypeSourceInfos, Type, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(FunctionDecl)
  ...
  MX_SERIALIZE_ENTITY(FunctionDecl, call_result_type, getVal79, setVal79, initVal79, CallResultType, Type, NthDecl)
  MX_SERIALIZE_ENTITY(FunctionDecl, declared_return_type, getVal82, setVal82, initVal82, DeclaredReturnType, Type, NthDecl)
  MX_SERIALIZE_OPTIONAL_ENTITY(FunctionDecl, definition, getVal84, setVal84, initVal84, Definition, FunctionDecl, NthDecl)
  MX_SERIALIZE_ENTITY(FunctionDecl, ellipsis_token, getVal86, setVal86, initVal86, EllipsisToken, Token, NthDecl)
  MX_SERIALIZE_OPTIONAL_ENTITY(FunctionDecl, instantiated_from_member_function, getVal134, setVal134, initVal134, InstantiatedFromMemberFunction, FunctionDecl, NthDecl)
  MX_SERIALIZE_ENTITY(FunctionDecl, point_of_instantiation, getVal139, setVal139, initVal139, PointOfInstantiation, Token, NthDecl)
  MX_SERIALIZE_ENTITY(FunctionDecl, return_type, getVal140, setVal140, initVal140, ReturnType, Type, NthDecl)
  MX_SERIALIZE_OPTIONAL_ENTITY(FunctionDecl, template_instantiation_pattern, getVal154, setVal154, initVal154, TemplateInstantiationPattern, FunctionDecl, NthDecl)
  MX_SERIALIZE_ENTITY_LIST(FunctionDecl, parameters, getVal50, setVal50, initVal50, Parameters, ParmVarDecl, NthDecl)
  MX_SERIALIZE_OPTIONAL_ENTITY(FunctionDecl, body, getVal166, setVal166, initVal166, Body, Stmt, NthDecl)
  MX_SERIALIZE_DECL_CONTEXT(FunctionDecl, declarations_in_context, getVal51, setVal51, initVal51, AlreadyLoadedDeclarations, Decl, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(CXXMethodDecl)
  ...
  MX_SERIALIZE_ENTITY(CXXMethodDecl, parent, getVal168, setVal168, initVal168, Parent, CXXRecordDecl, NthDecl)
  MX_SERIALIZE_ENTITY(CXXMethodDecl, this_object_type, getVal169, setVal169, initVal169, ThisObjectType, Type, NthDecl)
  MX_SERIALIZE_ENTITY(CXXMethodDecl, this_type, getVal170, setVal170, initVal170, ThisType, Type, NthDecl)
  MX_SERIALIZE_ENTITY_LIST(CXXMethodDecl, overridden_methods, getVal62, setVal62, initVal62, OverriddenMethods, CXXMethodDecl, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(CXXDestructorDecl)
  ...
  MX_SERIALIZE_OPTIONAL_ENTITY(CXXDestructorDecl, operator_delete, getVal179, setVal179, initVal179, OperatorDelete, FunctionDecl, NthDecl)
  MX_SERIALIZE_OPTIONAL_ENTITY(CXXDestructorDecl, operator_delete_this_argument, getVal181, setVal181, initVal181, OperatorDeleteThisArgument, Expr, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(CXXConversionDecl)
  ...
  MX_SERIALIZE_ENTITY(CXXConversionDecl, conversion_type, getVal179, setVal179, initVal179, ConversionType, Type, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(CXXConstructorDecl)
  ...
  MX_SERIALIZE_OPTIONAL_ENTITY(CXXConstructorDecl, target_constructor, getVal179, setVal179, initVal179, TargetConstructor, CXXConstructorDecl, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(CXXDeductionGuideDecl)
  ...
  MX_SERIALIZE_ENTITY(CXXDeductionGuideDecl, corresponding_constructor, getVal168, setVal168, initVal168, CorrespondingConstructor, CXXConstructorDecl, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(FieldDecl)
  ...
  MX_SERIALIZE_OPTIONAL_ENTITY(FieldDecl, bit_width, getVal79, setVal79, initVal79, BitWidth, Expr, NthDecl)
  MX_SERIALIZE_OPTIONAL_ENTITY(FieldDecl, captured_vla_type, getVal82, setVal82, initVal82, CapturedVLAType, VariableArrayType, NthDecl)
  MX_SERIALIZE_OPTIONAL_ENTITY(FieldDecl, in_class_initializer, getVal84, setVal84, initVal84, InClassInitializer, Expr, NthDecl)
  MX_SERIALIZE_ENTITY(FieldDecl, parent, getVal86, setVal86, initVal86, Parent, RecordDecl, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(ObjCIvarDecl)
  ...
  MX_SERIALIZE_ENTITY(ObjCIvarDecl, containing_interface, getVal89, setVal89, initVal89, ContainingInterface, ObjCInterfaceDecl, NthDecl)
  MX_SERIALIZE_ENTITY(ObjCIvarDecl, next_instance_variable, getVal94, setVal94, initVal94, NextInstanceVariable, ObjCIvarDecl, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(BindingDecl)
  ...
  MX_SERIALIZE_ENTITY(BindingDecl, binding, getVal57, setVal57, initVal57, Binding, Expr, NthDecl)
  MX_SERIALIZE_ENTITY(BindingDecl, decomposed_declaration, getVal58, setVal58, initVal58, DecomposedDeclaration, ValueDecl, NthDecl)
  MX_SERIALIZE_ENTITY(BindingDecl, holding_variable, getVal66, setVal66, initVal66, HoldingVariable, VarDecl, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(OMPDeclareMapperDecl)
  ...
  MX_SERIALIZE_ENTITY(OMPDeclareMapperDecl, mapper_variable_reference, getVal57, setVal57, initVal57, MapperVariableReference, Expr, NthDecl)
  MX_SERIALIZE_ENTITY(OMPDeclareMapperDecl, prev_declaration_in_scope, getVal58, setVal58, initVal58, PrevDeclarationInScope, OMPDeclareMapperDecl, NthDecl)
  MX_SERIALIZE_DECL_CONTEXT(OMPDeclareMapperDecl, declarations_in_context, getVal50, setVal50, initVal50, AlreadyLoadedDeclarations, Decl, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(UsingShadowDecl)
  ...
  MX_SERIALIZE_ENTITY(UsingShadowDecl, introducer, getVal56, setVal56, initVal56, Introducer, BaseUsingDecl, NthDecl)
  MX_SERIALIZE_OPTIONAL_ENTITY(UsingShadowDecl, next_using_shadow_declaration, getVal57, setVal57, initVal57, NextUsingShadowDeclaration, UsingShadowDecl, NthDecl)
  MX_SERIALIZE_ENTITY(UsingShadowDecl, target_declaration, getVal58, setVal58, initVal58, TargetDeclaration, NamedDecl, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(ConstructorUsingShadowDecl)
  ...
  MX_SERIALIZE_ENTITY(ConstructorUsingShadowDecl, constructed_base_class, getVal66, setVal66, initVal66, ConstructedBaseClass, CXXRecordDecl, NthDecl)
  MX_SERIALIZE_OPTIONAL_ENTITY(ConstructorUsingShadowDecl, constructed_base_class_shadow_declaration, getVal67, setVal67, initVal67, ConstructedBaseClassShadowDeclaration, ConstructorUsingShadowDecl, NthDecl)
  MX_SERIALIZE_ENTITY(ConstructorUsingShadowDecl, nominated_base_class, getVal68, setVal68, initVal68, NominatedBaseClass, CXXRecordDecl, NthDecl)
  MX_SERIALIZE_OPTIONAL_ENTITY(ConstructorUsingShadowDecl, nominated_base_class_shadow_declaration, getVal77, setVal77, initVal77, NominatedBaseClassShadowDeclaration, ConstructorUsingShadowDecl, NthDecl)
  MX_SERIALIZE_ENTITY(ConstructorUsingShadowDecl, parent, getVal79, setVal79, initVal79, Parent, CXXRecordDecl, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(UsingPackDecl)
  ...
  MX_SERIALIZE_ENTITY_LIST(UsingPackDecl, expansions, getVal50, setVal50, initVal50, Expansions, NamedDecl, NthDecl)
  MX_SERIALIZE_ENTITY(UsingPackDecl, instantiated_from_using_declaration, getVal56, setVal56, initVal56, InstantiatedFromUsingDeclaration, NamedDecl, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(UsingDirectiveDecl)
  ...
  MX_SERIALIZE_ENTITY(UsingDirectiveDecl, identifier_token, getVal56, setVal56, initVal56, IdentifierToken, Token, NthDecl)
  MX_SERIALIZE_ENTITY(UsingDirectiveDecl, namespace_key_token, getVal57, setVal57, initVal57, NamespaceKeyToken, Token, NthDecl)
  MX_SERIALIZE_ENTITY(UsingDirectiveDecl, nominated_namespace_as_written, getVal58, setVal58, initVal58, NominatedNamespaceAsWritten, NamedDecl, NthDecl)
  MX_SERIALIZE_ENTITY(UsingDirectiveDecl, using_token, getVal66, setVal66, initVal66, UsingToken, Token, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(TypeDecl)
  ...
  MX_SERIALIZE_OPTIONAL_ENTITY(TypeDecl, type_for_declaration, getVal56, setVal56, initVal56, TypeForDeclaration, Type, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(TemplateTypeParmDecl)
  ...
  MX_SERIALIZE_ENTITY(TemplateTypeParmDecl, default_argument, getVal57, setVal57, initVal57, DefaultArgument, Type, NthDecl)
  MX_SERIALIZE_ENTITY(TemplateTypeParmDecl, default_argument_info, getVal58, setVal58, initVal58, DefaultArgumentInfo, Type, NthDecl)
  MX_SERIALIZE_ENTITY(TemplateTypeParmDecl, default_argument_token, getVal66, setVal66, initVal66, DefaultArgumentToken, Token, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(TagDecl)
  ...
  MX_SERIALIZE_OPTIONAL_ENTITY(TagDecl, definition, getVal66, setVal66, initVal66, Definition, TagDecl, NthDecl)
  MX_SERIALIZE_ENTITY(TagDecl, inner_token_start, getVal67, setVal67, initVal67, InnerTokenStart, Token, NthDecl)
  MX_SERIALIZE_ENTITY(TagDecl, outer_token_start, getVal68, setVal68, initVal68, OuterTokenStart, Token, NthDecl)
  MX_SERIALIZE_OPTIONAL_ENTITY(TagDecl, typedef_name_for_anonymous_declaration, getVal77, setVal77, initVal77, TypedefNameForAnonymousDeclaration, TypedefNameDecl, NthDecl)
  MX_SERIALIZE_PSEUDO_LIST(TagDecl, template_parameter_lists, getVal80, setVal80, initVal80, TemplateParameterLists, TemplateParameterList, NthDecl)
  MX_SERIALIZE_DECL_CONTEXT(TagDecl, declarations_in_context, getVal50, setVal50, initVal50, AlreadyLoadedDeclarations, Decl, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(RecordDecl)
  ...
  MX_SERIALIZE_ENTITY_LIST(RecordDecl, fields, getVal51, setVal51, initVal51, Fields, FieldDecl, NthDecl)
  MX_SERIALIZE_OPTIONAL_ENTITY(RecordDecl, find_first_named_data_member, getVal79, setVal79, initVal79, FindFirstNamedDataMember, FieldDecl, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(CXXRecordDecl)
  ...
  MX_SERIALIZE_OPTIONAL_PSEUDO_LIST(CXXRecordDecl, bases, getVal149, setVal149, initVal149, Bases, CXXBaseSpecifier, NthDecl)
  MX_SERIALIZE_ENTITY_LIST(CXXRecordDecl, constructors, getVal62, setVal62, initVal62, Constructors, CXXConstructorDecl, NthDecl)
  MX_SERIALIZE_OPTIONAL_ENTITY_LIST(CXXRecordDecl, friends, getVal187, setVal187, initVal187, Friends, FriendDecl, NthDecl)
  MX_SERIALIZE_OPTIONAL_ENTITY(CXXRecordDecl, destructor, getVal82, setVal82, initVal82, Destructor, CXXDestructorDecl, NthDecl)
  MX_SERIALIZE_OPTIONAL_PSEUDO(CXXRecordDecl, generic_lambda_template_parameter_list, getVal151, setVal151, initVal151, GenericLambdaTemplateParameterList, TemplateParameterList, NthDecl)
  MX_SERIALIZE_OPTIONAL_ENTITY(CXXRecordDecl, instantiated_from_member_class, getVal84, setVal84, initVal84, InstantiatedFromMemberClass, CXXRecordDecl, NthDecl)
  MX_SERIALIZE_OPTIONAL_ENTITY(CXXRecordDecl, lambda_call_operator, getVal86, setVal86, initVal86, LambdaCallOperator, CXXMethodDecl, NthDecl)
  MX_SERIALIZE_OPTIONAL_ENTITY(CXXRecordDecl, lambda_context_declaration, getVal89, setVal89, initVal89, LambdaContextDeclaration, Decl, NthDecl)
  MX_SERIALIZE_OPTIONAL_ENTITY_LIST(CXXRecordDecl, lambda_explicit_template_parameters, getVal188, setVal188, initVal188, LambdaExplicitTemplateParameters, NamedDecl, NthDecl)
  MX_SERIALIZE_OPTIONAL_ENTITY(CXXRecordDecl, lambda_type_info, getVal94, setVal94, initVal94, LambdaTypeInfo, Type, NthDecl)
  MX_SERIALIZE_OPTIONAL_ENTITY(CXXRecordDecl, template_instantiation_pattern, getVal134, setVal134, initVal134, TemplateInstantiationPattern, CXXRecordDecl, NthDecl)
  MX_SERIALIZE_OPTIONAL_ENTITY(CXXRecordDecl, is_local_class, getVal136, setVal136, initVal136, IsLocalClass, FunctionDecl, NthDecl)
  MX_SERIALIZE_OPTIONAL_ENTITY_LIST(CXXRecordDecl, methods, getVal326, setVal326, initVal326, Methods, CXXMethodDecl, NthDecl)
  MX_SERIALIZE_OPTIONAL_PSEUDO_LIST(CXXRecordDecl, virtual_bases, getVal150, setVal150, initVal150, VirtualBases, CXXBaseSpecifier, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(ClassTemplateSpecializationDecl)
  ...
  MX_SERIALIZE_ENTITY(ClassTemplateSpecializationDecl, extern_token, getVal137, setVal137, initVal137, ExternToken, Token, NthDecl)
  MX_SERIALIZE_ENTITY(ClassTemplateSpecializationDecl, point_of_instantiation, getVal139, setVal139, initVal139, PointOfInstantiation, Token, NthDecl)
  MX_SERIALIZE_PSEUDO_LIST(ClassTemplateSpecializationDecl, template_arguments, getVal353, setVal353, initVal353, TemplateArguments, TemplateArgument, NthDecl)
  MX_SERIALIZE_PSEUDO_LIST(ClassTemplateSpecializationDecl, template_instantiation_arguments, getVal354, setVal354, initVal354, TemplateInstantiationArguments, TemplateArgument, NthDecl)
  MX_SERIALIZE_ENTITY(ClassTemplateSpecializationDecl, template_keyword_token, getVal140, setVal140, initVal140, TemplateKeywordToken, Token, NthDecl)
  MX_SERIALIZE_ENTITY(ClassTemplateSpecializationDecl, type_as_written, getVal152, setVal152, initVal152, TypeAsWritten, Type, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(EnumDecl)
  ...
  MX_SERIALIZE_ENTITY_LIST(EnumDecl, enumerators, getVal51, setVal51, initVal51, Enumerators, EnumConstantDecl, NthDecl)
  MX_SERIALIZE_OPTIONAL_ENTITY(EnumDecl, instantiated_from_member_enum, getVal79, setVal79, initVal79, InstantiatedFromMemberEnum, EnumDecl, NthDecl)
  MX_SERIALIZE_OPTIONAL_ENTITY(EnumDecl, integer_type, getVal82, setVal82, initVal82, IntegerType, Type, NthDecl)
  MX_SERIALIZE_OPTIONAL_ENTITY(EnumDecl, integer_type_source_info, getVal89, setVal89, initVal89, IntegerTypeSourceInfo, Type, NthDecl)
  MX_SERIALIZE_ENTITY(EnumDecl, promotion_type, getVal94, setVal94, initVal94, PromotionType, Type, NthDecl)
  MX_SERIALIZE_OPTIONAL_ENTITY(EnumDecl, template_instantiation_pattern, getVal134, setVal134, initVal134, TemplateInstantiationPattern, EnumDecl, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(UnresolvedUsingTypenameDecl)
  ...
  MX_SERIALIZE_ENTITY(UnresolvedUsingTypenameDecl, ellipsis_token, getVal57, setVal57, initVal57, EllipsisToken, Token, NthDecl)
  MX_SERIALIZE_ENTITY(UnresolvedUsingTypenameDecl, typename_token, getVal58, setVal58, initVal58, TypenameToken, Token, NthDecl)
  MX_SERIALIZE_ENTITY(UnresolvedUsingTypenameDecl, using_token, getVal66, setVal66, initVal66, UsingToken, Token, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(TypedefNameDecl)
  ...
  MX_SERIALIZE_OPTIONAL_ENTITY(TypedefNameDecl, anonymous_declaration_with_typedef_name, getVal57, setVal57, initVal57, AnonymousDeclarationWithTypedefName, TagDecl, NthDecl)
  MX_SERIALIZE_ENTITY(TypedefNameDecl, type_source_info, getVal58, setVal58, initVal58, TypeSourceInfo, Type, NthDecl)
  MX_SERIALIZE_ENTITY(TypedefNameDecl, underlying_type, getVal66, setVal66, initVal66, UnderlyingType, Type, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(TypeAliasDecl)
  ...
  MX_SERIALIZE_OPTIONAL_ENTITY(TypeAliasDecl, described_alias_template, getVal67, setVal67, initVal67, DescribedAliasTemplate, TypeAliasTemplateDecl, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(ObjCTypeParamDecl)
  ...
  MX_SERIALIZE_ENTITY(ObjCTypeParamDecl, colon_token, getVal67, setVal67, initVal67, ColonToken, Token, NthDecl)
  MX_SERIALIZE_ENTITY(ObjCTypeParamDecl, variance_token, getVal68, setVal68, initVal68, VarianceToken, Token, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(ConceptDecl)
  ...
  MX_SERIALIZE_ENTITY(ConceptDecl, constraint_expression, getVal56, setVal56, initVal56, ConstraintExpression, Expr, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(ObjCPropertyDecl)
  ...
  MX_SERIALIZE_ENTITY(ObjCPropertyDecl, at_token, getVal56, setVal56, initVal56, AtToken, Token, NthDecl)
  MX_SERIALIZE_ENTITY(ObjCPropertyDecl, getter_method_declaration, getVal57, setVal57, initVal57, GetterMethodDeclaration, ObjCMethodDecl, NthDecl)
  MX_SERIALIZE_ENTITY(ObjCPropertyDecl, getter_name_token, getVal58, setVal58, initVal58, GetterNameToken, Token, NthDecl)
  MX_SERIALIZE_ENTITY(ObjCPropertyDecl, l_paren_token, getVal66, setVal66, initVal66, LParenToken, Token, NthDecl)
  MX_SERIALIZE_ENTITY(ObjCPropertyDecl, property_instance_variable_declaration, getVal67, setVal67, initVal67, PropertyInstanceVariableDeclaration, ObjCIvarDecl, NthDecl)
  MX_SERIALIZE_ENTITY(ObjCPropertyDecl, setter_method_declaration, getVal68, setVal68, initVal68, SetterMethodDeclaration, ObjCMethodDecl, NthDecl)
  MX_SERIALIZE_ENTITY(ObjCPropertyDecl, setter_name_token, getVal77, setVal77, initVal77, SetterNameToken, Token, NthDecl)
  MX_SERIALIZE_ENTITY(ObjCPropertyDecl, type, getVal79, setVal79, initVal79, Type, Type, NthDecl)
  MX_SERIALIZE_ENTITY(ObjCPropertyDecl, type_source_info, getVal82, setVal82, initVal82, TypeSourceInfo, Type, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(ObjCMethodDecl)
  ...
  MX_SERIALIZE_ENTITY(ObjCMethodDecl, find_property_declaration, getVal56, setVal56, initVal56, FindPropertyDeclaration, ObjCPropertyDecl, NthDecl)
  MX_SERIALIZE_ENTITY(ObjCMethodDecl, category, getVal57, setVal57, initVal57, Category, ObjCCategoryDecl, NthDecl)
  MX_SERIALIZE_ENTITY(ObjCMethodDecl, class_interface, getVal58, setVal58, initVal58, ClassInterface, ObjCInterfaceDecl, NthDecl)
  MX_SERIALIZE_ENTITY(ObjCMethodDecl, cmd_declaration, getVal66, setVal66, initVal66, CmdDeclaration, ImplicitParamDecl, NthDecl)
  MX_SERIALIZE_ENTITY(ObjCMethodDecl, declarator_end_token, getVal67, setVal67, initVal67, DeclaratorEndToken, Token, NthDecl)
  MX_SERIALIZE_ENTITY(ObjCMethodDecl, return_type, getVal68, setVal68, initVal68, ReturnType, Type, NthDecl)
  MX_SERIALIZE_ENTITY(ObjCMethodDecl, return_type_source_info, getVal77, setVal77, initVal77, ReturnTypeSourceInfo, Type, NthDecl)
  MX_SERIALIZE_ENTITY(ObjCMethodDecl, selector_start_token, getVal84, setVal84, initVal84, SelectorStartToken, Token, NthDecl)
  MX_SERIALIZE_ENTITY(ObjCMethodDecl, self_declaration, getVal86, setVal86, initVal86, SelfDeclaration, ImplicitParamDecl, NthDecl)
  MX_SERIALIZE_ENTITY_LIST(ObjCMethodDecl, parameters, getVal50, setVal50, initVal50, Parameters, ParmVarDecl, NthDecl)
  MX_SERIALIZE_ENTITY_LIST(ObjCMethodDecl, selector_tokens, getVal51, setVal51, initVal51, SelectorTokens, Token, NthDecl)
  MX_SERIALIZE_DECL_CONTEXT(ObjCMethodDecl, declarations_in_context, getVal62, setVal62, initVal62, AlreadyLoadedDeclarations, Decl, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(ObjCContainerDecl)
  ...
  MX_SERIALIZE_ENTITY_LIST(ObjCContainerDecl, class_methods, getVal50, setVal50, initVal50, ClassMethods, ObjCMethodDecl, NthDecl)
  MX_SERIALIZE_ENTITY_LIST(ObjCContainerDecl, class_properties, getVal51, setVal51, initVal51, ClassProperties, ObjCPropertyDecl, NthDecl)
  MX_SERIALIZE_ENTITY(ObjCContainerDecl, at_start_token, getVal58, setVal58, initVal58, AtStartToken, Token, NthDecl)
  MX_SERIALIZE_ENTITY_LIST(ObjCContainerDecl, instance_methods, getVal62, setVal62, initVal62, InstanceMethods, ObjCMethodDecl, NthDecl)
  MX_SERIALIZE_ENTITY_LIST(ObjCContainerDecl, instance_properties, getVal187, setVal187, initVal187, InstanceProperties, ObjCPropertyDecl, NthDecl)
  MX_SERIALIZE_ENTITY_LIST(ObjCContainerDecl, methods, getVal188, setVal188, initVal188, Methods, ObjCMethodDecl, NthDecl)
  MX_SERIALIZE_ENTITY_LIST(ObjCContainerDecl, properties, getVal326, setVal326, initVal326, Properties, ObjCPropertyDecl, NthDecl)
  MX_SERIALIZE_DECL_CONTEXT(ObjCContainerDecl, declarations_in_context, getVal358, setVal358, initVal358, AlreadyLoadedDeclarations, Decl, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(ObjCCategoryDecl)
  ...
  MX_SERIALIZE_ENTITY(ObjCCategoryDecl, category_name_token, getVal66, setVal66, initVal66, CategoryNameToken, Token, NthDecl)
  MX_SERIALIZE_ENTITY(ObjCCategoryDecl, class_interface, getVal67, setVal67, initVal67, ClassInterface, ObjCInterfaceDecl, NthDecl)
  MX_SERIALIZE_ENTITY(ObjCCategoryDecl, implementation, getVal68, setVal68, initVal68, Implementation, ObjCCategoryImplDecl, NthDecl)
  MX_SERIALIZE_ENTITY(ObjCCategoryDecl, instance_variable_l_brace_token, getVal77, setVal77, initVal77, InstanceVariableLBraceToken, Token, NthDecl)
  MX_SERIALIZE_ENTITY(ObjCCategoryDecl, instance_variable_r_brace_token, getVal79, setVal79, initVal79, InstanceVariableRBraceToken, Token, NthDecl)
  MX_SERIALIZE_ENTITY(ObjCCategoryDecl, next_class_category, getVal82, setVal82, initVal82, NextClassCategory, ObjCCategoryDecl, NthDecl)
  MX_SERIALIZE_ENTITY(ObjCCategoryDecl, next_class_category_raw, getVal84, setVal84, initVal84, NextClassCategoryRaw, ObjCCategoryDecl, NthDecl)
  MX_SERIALIZE_ENTITY_LIST(ObjCCategoryDecl, instance_variables, getVal359, setVal359, initVal359, InstanceVariables, ObjCIvarDecl, NthDecl)
  MX_SERIALIZE_ENTITY_LIST(ObjCCategoryDecl, protocol_tokens, getVal360, setVal360, initVal360, ProtocolTokens, Token, NthDecl)
  MX_SERIALIZE_ENTITY_LIST(ObjCCategoryDecl, protocols, getVal361, setVal361, initVal361, Protocols, ObjCProtocolDecl, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(ObjCProtocolDecl)
  ...
  MX_SERIALIZE_ENTITY(ObjCProtocolDecl, definition, getVal66, setVal66, initVal66, Definition, ObjCProtocolDecl, NthDecl)
  MX_SERIALIZE_ENTITY_LIST(ObjCProtocolDecl, protocol_tokens, getVal359, setVal359, initVal359, ProtocolTokens, Token, NthDecl)
  MX_SERIALIZE_ENTITY_LIST(ObjCProtocolDecl, protocols, getVal360, setVal360, initVal360, Protocols, ObjCProtocolDecl, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(ObjCInterfaceDecl)
  ...
  MX_SERIALIZE_ENTITY_LIST(ObjCInterfaceDecl, all_referenced_protocols, getVal359, setVal359, initVal359, AllReferencedProtocols, ObjCProtocolDecl, NthDecl)
  MX_SERIALIZE_ENTITY(ObjCInterfaceDecl, category_list_raw, getVal66, setVal66, initVal66, CategoryListRaw, ObjCCategoryDecl, NthDecl)
  MX_SERIALIZE_ENTITY(ObjCInterfaceDecl, definition, getVal67, setVal67, initVal67, Definition, ObjCInterfaceDecl, NthDecl)
  MX_SERIALIZE_ENTITY(ObjCInterfaceDecl, end_of_definition_token, getVal68, setVal68, initVal68, EndOfDefinitionToken, Token, NthDecl)
  MX_SERIALIZE_ENTITY(ObjCInterfaceDecl, implementation, getVal77, setVal77, initVal77, Implementation, ObjCImplementationDecl, NthDecl)
  MX_SERIALIZE_OPTIONAL_ENTITY(ObjCInterfaceDecl, super_class, getVal79, setVal79, initVal79, SuperClass, ObjCInterfaceDecl, NthDecl)
  MX_SERIALIZE_ENTITY(ObjCInterfaceDecl, super_class_token, getVal82, setVal82, initVal82, SuperClassToken, Token, NthDecl)
  MX_SERIALIZE_OPTIONAL_ENTITY(ObjCInterfaceDecl, super_class_type_info, getVal84, setVal84, initVal84, SuperClassTypeInfo, Type, NthDecl)
  MX_SERIALIZE_OPTIONAL_ENTITY(ObjCInterfaceDecl, super_class_type, getVal86, setVal86, initVal86, SuperClassType, ObjCObjectType, NthDecl)
  MX_SERIALIZE_ENTITY(ObjCInterfaceDecl, type_for_declaration, getVal89, setVal89, initVal89, TypeForDeclaration, Type, NthDecl)
  MX_SERIALIZE_ENTITY(ObjCInterfaceDecl, is_obj_c_requires_property_definitions, getVal94, setVal94, initVal94, IsObjCRequiresPropertyDefinitions, ObjCInterfaceDecl, NthDecl)
  MX_SERIALIZE_ENTITY_LIST(ObjCInterfaceDecl, instance_variables, getVal360, setVal360, initVal360, InstanceVariables, ObjCIvarDecl, NthDecl)
  MX_SERIALIZE_ENTITY_LIST(ObjCInterfaceDecl, known_categories, getVal361, setVal361, initVal361, KnownCategories, ObjCCategoryDecl, NthDecl)
  MX_SERIALIZE_ENTITY_LIST(ObjCInterfaceDecl, known_extensions, getVal362, setVal362, initVal362, KnownExtensions, ObjCCategoryDecl, NthDecl)
  MX_SERIALIZE_ENTITY_LIST(ObjCInterfaceDecl, protocol_tokens, getVal363, setVal363, initVal363, ProtocolTokens, Token, NthDecl)
  MX_SERIALIZE_ENTITY_LIST(ObjCInterfaceDecl, protocols, getVal364, setVal364, initVal364, Protocols, ObjCProtocolDecl, NthDecl)
  MX_SERIALIZE_ENTITY_LIST(ObjCInterfaceDecl, visible_categories, getVal365, setVal365, initVal365, VisibleCategories, ObjCCategoryDecl, NthDecl)
  MX_SERIALIZE_ENTITY_LIST(ObjCInterfaceDecl, visible_extensions, getVal366, setVal366, initVal366, VisibleExtensions, ObjCCategoryDecl, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(ObjCImplDecl)
  ...
  MX_SERIALIZE_ENTITY(ObjCImplDecl, class_interface, getVal66, setVal66, initVal66, ClassInterface, ObjCInterfaceDecl, NthDecl)
  MX_SERIALIZE_ENTITY_LIST(ObjCImplDecl, property_implementations, getVal359, setVal359, initVal359, PropertyImplementations, ObjCPropertyImplDecl, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(ObjCCategoryImplDecl)
  ...
  MX_SERIALIZE_ENTITY(ObjCCategoryImplDecl, category_declaration, getVal67, setVal67, initVal67, CategoryDeclaration, ObjCCategoryDecl, NthDecl)
  MX_SERIALIZE_ENTITY(ObjCCategoryImplDecl, category_name_token, getVal68, setVal68, initVal68, CategoryNameToken, Token, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(ObjCImplementationDecl)
  ...
  MX_SERIALIZE_ENTITY(ObjCImplementationDecl, instance_variable_l_brace_token, getVal67, setVal67, initVal67, InstanceVariableLBraceToken, Token, NthDecl)
  MX_SERIALIZE_ENTITY(ObjCImplementationDecl, instance_variable_r_brace_token, getVal68, setVal68, initVal68, InstanceVariableRBraceToken, Token, NthDecl)
  MX_SERIALIZE_ENTITY(ObjCImplementationDecl, super_class, getVal77, setVal77, initVal77, SuperClass, ObjCInterfaceDecl, NthDecl)
  MX_SERIALIZE_ENTITY(ObjCImplementationDecl, super_class_token, getVal79, setVal79, initVal79, SuperClassToken, Token, NthDecl)
  MX_SERIALIZE_ENTITY_LIST(ObjCImplementationDecl, instance_variables, getVal360, setVal360, initVal360, InstanceVariables, ObjCIvarDecl, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(ObjCCompatibleAliasDecl)
  ...
  MX_SERIALIZE_ENTITY(ObjCCompatibleAliasDecl, class_interface, getVal56, setVal56, initVal56, ClassInterface, ObjCInterfaceDecl, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(NamespaceDecl)
  ...
  MX_SERIALIZE_DECL_CONTEXT(NamespaceDecl, declarations_in_context, getVal50, setVal50, initVal50, AlreadyLoadedDeclarations, Decl, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(NamespaceAliasDecl)
  ...
  MX_SERIALIZE_ENTITY(NamespaceAliasDecl, alias_token, getVal56, setVal56, initVal56, AliasToken, Token, NthDecl)
  MX_SERIALIZE_ENTITY(NamespaceAliasDecl, aliased_namespace, getVal57, setVal57, initVal57, AliasedNamespace, NamedDecl, NthDecl)
  MX_SERIALIZE_ENTITY(NamespaceAliasDecl, namespace_token, getVal58, setVal58, initVal58, NamespaceToken, Token, NthDecl)
  MX_SERIALIZE_ENTITY(NamespaceAliasDecl, target_name_token, getVal66, setVal66, initVal66, TargetNameToken, Token, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(LinkageSpecDecl)
  ...
  MX_SERIALIZE_DECL_CONTEXT(LinkageSpecDecl, declarations_in_context, getVal50, setVal50, initVal50, AlreadyLoadedDeclarations, Decl, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(LifetimeExtendedTemporaryDecl)
  ...
  MX_SERIALIZE_ENTITY_LIST(LifetimeExtendedTemporaryDecl, children_expression, getVal50, setVal50, initVal50, ChildrenExpression, Stmt, NthDecl)
  MX_SERIALIZE_ENTITY(LifetimeExtendedTemporaryDecl, extending_declaration, getVal48, setVal48, initVal48, ExtendingDeclaration, ValueDecl, NthDecl)
  MX_SERIALIZE_ENTITY(LifetimeExtendedTemporaryDecl, temporary_expression, getVal56, setVal56, initVal56, TemporaryExpression, Expr, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(ImportDecl)
  ...
  MX_SERIALIZE_ENTITY_LIST(ImportDecl, identifier_tokens, getVal50, setVal50, initVal50, IdentifierTokens, Token, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(FriendDecl)
  ...
  MX_SERIALIZE_OPTIONAL_ENTITY(FriendDecl, friend_declaration, getVal48, setVal48, initVal48, FriendDeclaration, NamedDecl, NthDecl)
  MX_SERIALIZE_ENTITY(FriendDecl, friend_token, getVal56, setVal56, initVal56, FriendToken, Token, NthDecl)
  MX_SERIALIZE_ENTITY(FriendDecl, friend_type, getVal57, setVal57, initVal57, FriendType, Type, NthDecl)
  MX_SERIALIZE_PSEUDO_LIST(FriendDecl, friend_type_template_parameter_lists, getVal80, setVal80, initVal80, FriendTypeTemplateParameterLists, TemplateParameterList, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(FileScopeAsmDecl)
  ...
  MX_SERIALIZE_ENTITY(FileScopeAsmDecl, assembly_token, getVal48, setVal48, initVal48, AssemblyToken, Token, NthDecl)
  MX_SERIALIZE_ENTITY(FileScopeAsmDecl, assembly_string, getVal56, setVal56, initVal56, AssemblyString, StringLiteral, NthDecl)
  MX_SERIALIZE_ENTITY(FileScopeAsmDecl, r_paren_token, getVal57, setVal57, initVal57, RParenToken, Token, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(ExternCContextDecl)
  ...
  MX_SERIALIZE_DECL_CONTEXT(ExternCContextDecl, declarations_in_context, getVal50, setVal50, initVal50, AlreadyLoadedDeclarations, Decl, NthDecl)
...
MX_BEGIN_SERIALIZE_DECL(ExportDecl)
  ...
  MX_SERIALIZE_ENTITY(ExportDecl, export_token, getVal48, setVal48, initVal48, ExportToken, Token, NthDecl)
  MX_SERIALIZE_ENTITY(ExportDecl, r_brace_token, getVal56, setVal56, initVal56, RBraceToken, Token, NthDecl)
  MX_SERIALIZE_DECL_CONTEXT(ExportDecl, declarations_in_context, getVal50, setVal50, initVal50, AlreadyLoadedDeclarations, Decl, NthDecl)
