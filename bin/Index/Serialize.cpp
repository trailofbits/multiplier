...
void SerializeIndirectFieldDecl(EntityMapper &es, mx::ast::Decl::Builder b, const pasta::IndirectFieldDecl &e) {
  ...
  if (v52) {
    if (auto id52 = es.EntityId(v52.value())) {
      b.setVal52(id52);
      b.setVal70(true);
    } else {
      b.setVal70(false);
...
void SerializeVarDecl(EntityMapper &es, mx::ast::Decl::Builder b, const pasta::VarDecl &e) {
  ...
  if (v81) {
    if (auto id81 = es.EntityId(v81.value())) {
      b.setVal81(id81);
      b.setVal82(true);
    } else {
      b.setVal82(false);
...
void SerializeParmVarDecl(EntityMapper &es, mx::ast::Decl::Builder b, const pasta::ParmVarDecl &e) {
  ...
  if (v129) {
    if (auto id129 = es.EntityId(v129.value())) {
      b.setVal129(id129);
      b.setVal130(true);
    } else {
      b.setVal130(false);
...
void SerializeFunctionDecl(EntityMapper &es, mx::ast::Decl::Builder b, const pasta::FunctionDecl &e) {
  ...
  if (v148) {
    if (auto id148 = es.EntityId(v148.value())) {
      b.setVal148(id148);
      b.setVal93(true);
    } else {
      b.setVal93(false);
  ...
  auto v158 = e.Body();
  if (v158) {
    if (auto id158 = es.EntityId(v158.value())) {
      b.setVal158(id158);
      b.setVal159(true);
    } else {
      b.setVal159(false);
...
void SerializeCXXDestructorDecl(EntityMapper &es, mx::ast::Decl::Builder b, const pasta::CXXDestructorDecl &e) {
  ...
  if (v173) {
    if (auto id173 = es.EntityId(v173.value())) {
      b.setVal173(id173);
      b.setVal174(true);
    } else {
      b.setVal174(false);
...
void SerializeTypeDecl(EntityMapper &es, mx::ast::Decl::Builder b, const pasta::TypeDecl &e) {
  ...
  if (v51) {
    if (auto id51 = es.EntityId(v51.value())) {
      b.setVal51(id51);
      b.setVal69(true);
    } else {
      b.setVal69(false);
